...
:   Computes a taxonomy of [The Algorithms - Python](https://github.com/TheAlgorithms/Python) (not versionned here) and generates [`tree.txt`](https://repo/docs/resources/tree.txt), a JavaScript list ready to send to the [Google Chart API](https://developers.google.com/chart/interactive/docs/gallery/wordtree) used to draw [this word-tree](../docs_user_manual/index.html#taxonomy).
