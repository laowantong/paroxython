...
['• flow loop for elements_and_indexes.', 25],
['• flow loop for indexes.', 80],
...
['• pattern elements accumulate in_list.', 23],
['• pattern elements accumulate in_list extension.', 2],
['• pattern elements accumulate in_list filtered.', 32],
['• pattern elements accumulate in_set.', 1],
['• pattern elements accumulate in_set filtered.', 3],
['• pattern elements accumulate product.', 9],
['• pattern elements accumulate product filtered.', 3],
['• pattern elements accumulate substraction.', 2],
['• pattern elements accumulate substraction filtered.', 1],
['• pattern elements accumulate summation.', 86],
['• pattern elements accumulate summation filtered.', 29],
['• pattern elements find best.', 13],
['• pattern elements find best max.', 7],
['• pattern elements find best max filtered.', 1],
['• pattern elements find best min filtered.', 2],
['• pattern elements find first.', 5],
['• pattern elements satisfy all.', 25],
['• pattern elements satisfy some.', 3],
['• pattern expression mid naive.', 12],
['• pattern expression mid recommended.', 4],
['• pattern inputs find_first_good.', 4],
...
['• var assignment sequence swap.', 13],
