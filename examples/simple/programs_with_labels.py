...
with open("stocks.csv", "w", newline="") as stocksFileW: # argument:, empty_literal:Str, external_free_call:open, free_call:open, free_call_with_keyword_argument:open:newline, keyword_argument:newline, literal:Str, node:Call, node:Name, node:Str, node:With (-> +6), node:keyword
