...
# ----------------------------------------------------------------------------------------
print("Hello World") # argument:, external_free_call:print, flat_style, free_call:print, free_call_without_result:print, imperative_style, literal:Str, node:Call, node:Expr, node:Name, node:Str, one_liner_style, whole_span:1

# ----------------------------------------------------------------------------------------
# 002.0011-print-hello-10-times.py
# ----------------------------------------------------------------------------------------
for i in range(10): # argument:10, external_free_call:range, for:i (-> +1), for_range:10 (-> +1), free_call:range, global_scope:i (-> +1), imperative_style (-> +1), iteration_variable:i, literal:10, loop:for (-> +1), loop_with_late_exit:for (-> +1), magic_number:10, node:Call, node:For (-> +1), node:Name, node:Num, range:10, scope:i (-> +1), whole_span:2 (-> +1)
...
# ----------------------------------------------------------------------------------------
x = reversed(x) # argument:x, assignment:reversed, assignment_lhs_identifier:x, assignment_rhs_atom:x, external_free_call:reversed, flat_style, free_call:reversed, global_scope:x, imperative_style, loaded_variable:x, node:Assign, node:Call, node:Name, one_liner_style, scope:x, single_assignment:x, whole_span:1
...
# ----------------------------------------------------------------------------------------
i = int(s) # argument:s, assignment:int, assignment_lhs_identifier:i, assignment_rhs_atom:s, external_free_call:int, flat_style, free_call:int, global_scope:i, imperative_style, loaded_variable:s, node:Assign, node:Call, node:Name, one_liner_style, scope:i, single_assignment:i, whole_span:1
...
class T(object): # global_scope:x (-> +2), loaded_variable:object, node:ClassDef (-> +1), node:Name, object_oriented_style (-> +2), scope:x (-> +2), whole_span:3 (-> +2)
    pass # node:Pass
x = set(T()) # argument:, assignment:set, assignment_lhs_identifier:x, composition, external_free_call:T, external_free_call:set, free_call:T, free_call:set, free_call_without_arguments:T, node:Assign, node:Call, node:Name, single_assignment:x
...
# ----------------------------------------------------------------------------------------
y = ", ".join(x) # argument:x, assignment:join, assignment_lhs_identifier:y, assignment_rhs_atom:x, flat_style, global_scope:y, imperative_style, literal:Str, loaded_variable:x, member_call_method:join, node:Assign, node:Attribute, node:Call, node:Name, node:Str, one_liner_style, scope:y, single_assignment:y, whole_span:1
...
# ----------------------------------------------------------------------------------------
s = sum(x) # argument:x, assignment:sum, assignment_lhs_identifier:s, assignment_rhs_atom:x, external_free_call:sum, flat_style, free_call:sum, global_scope:s, imperative_style, loaded_variable:x, node:Assign, node:Call, node:Name, one_liner_style, scope:s, single_assignment:s, whole_span:1

# ----------------------------------------------------------------------------------------
# 055.0575-convert-integer-to-string.py
# ----------------------------------------------------------------------------------------
s = str(i) # argument:i, assignment:str, assignment_lhs_identifier:s, assignment_rhs_atom:i, external_free_call:str, flat_style, free_call:str, global_scope:s, imperative_style, loaded_variable:i, node:Assign, node:Call, node:Name, one_liner_style, scope:s, single_assignment:s, whole_span:1
...
# ----------------------------------------------------------------------------------------
i = x.find(y) # argument:y, assignment:find, assignment_lhs_identifier:i, assignment_rhs_atom:x, assignment_rhs_atom:y, flat_style, global_scope:i, imperative_style, loaded_variable:x, loaded_variable:y, member_call_method:find, node:Assign, node:Attribute, node:Call, node:Name, one_liner_style, scope:i, single_assignment:i, whole_span:1
...
# ----------------------------------------------------------------------------------------
y = float(x) # argument:x, assignment:float, assignment_lhs_identifier:y, assignment_rhs_atom:x, external_free_call:float, flat_style, free_call:float, global_scope:y, imperative_style, loaded_variable:x, node:Assign, node:Call, node:Name, one_liner_style, scope:y, single_assignment:y, whole_span:1

# ----------------------------------------------------------------------------------------
# 080.1092-truncate-floating-point-number-to-integer.py
# ----------------------------------------------------------------------------------------
y = int(x) # argument:x, assignment:int, assignment_lhs_identifier:y, assignment_rhs_atom:x, external_free_call:int, flat_style, free_call:int, global_scope:y, imperative_style, loaded_variable:x, node:Assign, node:Call, node:Name, one_liner_style, scope:y, single_assignment:y, whole_span:1
...
# ----------------------------------------------------------------------------------------
count = s.count(t) # argument:t, assignment:count, assignment_lhs_identifier:count, assignment_rhs_atom:s, assignment_rhs_atom:t, flat_style, global_scope:count, imperative_style, loaded_variable:s, loaded_variable:t, member_call_method:count, node:Assign, node:Attribute, node:Call, node:Name, one_liner_style, scope:count, single_assignment:count, whole_span:1
...
# ----------------------------------------------------------------------------------------
raise ValueError("x is invalid") # argument:, external_free_call:ValueError, flat_style, free_call:ValueError, imperative_style, literal:Str, node:Call, node:Name, node:Raise, node:Str, one_liner_style, raise:ValueError, whole_span:1
...
# ----------------------------------------------------------------------------------------
print(type(x)) # argument:, argument:x, composition, external_free_call:print, external_free_call:type, flat_style, free_call:print, free_call:type, free_call_without_result:print, imperative_style, loaded_variable:x, node:Call, node:Expr, node:Name, one_liner_style, whole_span:1

# ----------------------------------------------------------------------------------------
# 094.1864-print-type-of-variable.py
# ----------------------------------------------------------------------------------------
print(x.__class__) # argument:, external_free_call:print, flat_style, free_call:print, free_call_without_result:print, imperative_style, loaded_variable:x, node:Attribute, node:Call, node:Expr, node:Name, one_liner_style, whole_span:1
...
# ----------------------------------------------------------------------------------------
b = s.endswith(suffix) # argument:suffix, assignment:endswith, assignment_lhs_identifier:b, assignment_rhs_atom:s, assignment_rhs_atom:suffix, flat_style, global_scope:b, imperative_style, loaded_variable:s, loaded_variable:suffix, member_call_method:endswith, node:Assign, node:Attribute, node:Call, node:Name, one_liner_style, scope:b, single_assignment:b, whole_span:1
...
# ----------------------------------------------------------------------------------------
items.sort(c) # argument:c, flat_style, imperative_style, loaded_variable:c, loaded_variable:items, member_call:items:sort, member_call_method:sort, member_call_object:items, node:Attribute, node:Call, node:Expr, node:Name, one_liner_style, whole_span:1
...
# ----------------------------------------------------------------------------------------
for k in sorted(mymap): # argument:mymap, external_free_call:sorted, for:k (-> +1), free_call:sorted, global_scope:k (-> +1), imperative_style (-> +1), iteration_variable:k, loaded_variable:mymap, loop:for (-> +1), loop_with_late_exit:for (-> +1), node:Call, node:For (-> +1), node:Name, scope:k (-> +1), whole_span:2 (-> +1)
...
# ----------------------------------------------------------------------------------------
n = len(x) # argument:x, assignment:len, assignment_lhs_identifier:n, assignment_rhs_atom:x, external_free_call:len, flat_style, free_call:len, global_scope:n, imperative_style, loaded_variable:x, node:Assign, node:Call, node:Name, one_liner_style, scope:n, single_assignment:n, whole_span:1

# ----------------------------------------------------------------------------------------
# 118.1254-list-to-set.py
# ----------------------------------------------------------------------------------------
y = set(x) # argument:x, assignment:set, assignment_lhs_identifier:y, assignment_rhs_atom:x, external_free_call:set, flat_style, free_call:set, global_scope:y, imperative_style, loaded_variable:x, node:Assign, node:Call, node:Name, one_liner_style, scope:y, single_assignment:y, whole_span:1

# ----------------------------------------------------------------------------------------
# 118.3266-list-to-set.py
# ----------------------------------------------------------------------------------------
set(x) # argument:x, external_free_call:set, flat_style, free_call:set, free_call_without_result:set, imperative_style, loaded_variable:x, node:Call, node:Expr, node:Name, one_liner_style, whole_span:1

# ----------------------------------------------------------------------------------------
# 119.1253-deduplicate-list.py
# ----------------------------------------------------------------------------------------
x = list(set(x)) # argument:, argument:x, assignment:list, assignment_lhs_identifier:x, assignment_rhs_atom:x, composition, external_free_call:list, external_free_call:set, flat_style, free_call:list, free_call:set, global_scope:x, imperative_style, loaded_variable:x, node:Assign, node:Call, node:Name, one_liner_style, scope:x, single_assignment:x, whole_span:1
...
# ----------------------------------------------------------------------------------------
s = hex(x) # argument:x, assignment:hex, assignment_lhs_identifier:s, assignment_rhs_atom:x, external_free_call:hex, flat_style, free_call:hex, global_scope:s, imperative_style, loaded_variable:x, node:Assign, node:Call, node:Name, one_liner_style, scope:s, single_assignment:s, whole_span:1
...
# ----------------------------------------------------------------------------------------
f = float(s) # argument:s, assignment:float, assignment_lhs_identifier:f, assignment_rhs_atom:s, external_free_call:float, flat_style, free_call:float, global_scope:f, imperative_style, loaded_variable:s, node:Assign, node:Call, node:Name, one_liner_style, scope:f, single_assignment:f, whole_span:1

# ----------------------------------------------------------------------------------------
# 146.2739-convert-string-to-floating-point-number.py
# ----------------------------------------------------------------------------------------
float("1.3") # argument:, external_free_call:float, flat_style, free_call:float, free_call_without_result:float, imperative_style, literal:Str, node:Call, node:Expr, node:Name, node:Str, one_liner_style, whole_span:1
...
# ----------------------------------------------------------------------------------------
p = p.rstrip("/") # argument:, assignment:rstrip, assignment_lhs_identifier:p, assignment_rhs_atom:p, flat_style, global_scope:p, imperative_style, literal:Str, loaded_variable:p, member_call_method:rstrip, node:Assign, node:Attribute, node:Call, node:Name, node:Str, one_liner_style, scope:p, single_assignment:p, whole_span:1
...
# ----------------------------------------------------------------------------------------
t = s.lstrip(p) # argument:p, assignment:lstrip, assignment_lhs_identifier:t, assignment_rhs_atom:p, assignment_rhs_atom:s, flat_style, global_scope:t, imperative_style, loaded_variable:p, loaded_variable:s, member_call_method:lstrip, node:Assign, node:Attribute, node:Call, node:Name, one_liner_style, scope:t, single_assignment:t, whole_span:1
...
# ----------------------------------------------------------------------------------------
n = len(s) # argument:s, assignment:len, assignment_lhs_identifier:n, assignment_rhs_atom:s, external_free_call:len, flat_style, free_call:len, global_scope:n, imperative_style, loaded_variable:s, node:Assign, node:Call, node:Name, one_liner_style, scope:n, single_assignment:n, whole_span:1

# ----------------------------------------------------------------------------------------
# 170.2275-get-map-size.py
# ----------------------------------------------------------------------------------------
n = len(mymap) # argument:mymap, assignment:len, assignment_lhs_identifier:n, assignment_rhs_atom:mymap, external_free_call:len, flat_style, free_call:len, global_scope:n, imperative_style, loaded_variable:mymap, node:Assign, node:Call, node:Name, one_liner_style, scope:n, single_assignment:n, whole_span:1

# ----------------------------------------------------------------------------------------
# 171.2446-add-an-element-at-the-end-of-a-list.py
# ----------------------------------------------------------------------------------------
s.append(x) # argument:x, flat_style, imperative_style, loaded_variable:s, loaded_variable:x, member_call:s:append, member_call_method:append, member_call_object:s, node:Attribute, node:Call, node:Expr, node:Name, one_liner_style, update:s:x, update_by_member_call:s:x, update_by_member_call_with:append, update_with:append, whole_span:1
...
# ----------------------------------------------------------------------------------------
print("f'{1000:,}'") # argument:, external_free_call:print, flat_style, free_call:print, free_call_without_result:print, imperative_style, literal:Str, node:Call, node:Expr, node:Name, node:Str, one_liner_style, whole_span:1

# ----------------------------------------------------------------------------------------
# 173.2428-format-a-number-with-grouped-thousands.py
# ----------------------------------------------------------------------------------------
print("format(1000, ',')") # argument:, external_free_call:print, flat_style, free_call:print, free_call_without_result:print, imperative_style, literal:Str, node:Call, node:Expr, node:Name, node:Str, one_liner_style, whole_span:1
...
# ----------------------------------------------------------------------------------------
with open(path) as f: # argument:path, external_free_call:open, flat_style (-> +1), free_call:open, global_scope:lines (-> +1), imperative_style (-> +1), loaded_variable:path, node:Call, node:Name, node:With (-> +1), scope:lines (-> +1), whole_span:2 (-> +1)
