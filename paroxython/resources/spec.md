- [AST](#ast-1)
      - [Feature `node`](#feature-node-1)
- [Expressions](#expressions-2)
  - [Literals](#literals-1)
      - [Feature `literal`](#feature-literal-1)
      - [Feature `empty_literal`](#feature-empty_literal-1)
  - [Subscripts](#subscripts-1)
      - [Feature `index`](#feature-index-1)
      - [Feature `nested_index` (SQL)](#feature-nested_index-1)
      - [Feature `index_arithmetic`](#feature-index_arithmetic-1)
      - [Feature `negative_index`](#feature-negative_index-1)
      - [Feature `slice_lower`](#feature-slice_lower-1)
      - [Feature `slice_upper`](#feature-slice_upper-1)
      - [Feature `slice_step`](#feature-slice_step-1)
      - [Feature `slice` (SQL)](#feature-slice-1)
  - [Operators](#operators-1)
      - [Feature `unary_operator`](#feature-unary_operator-1)
      - [Feature `binary_operator`](#feature-binary_operator-1)
      - [Feature `concatenation_operator|replication_operator` (SQL)](#feature-concatenation_operatorreplication_operator-1)
      - [Feature `string_formatting_operator` (SQL)](#feature-string_formatting_operator-1)
      - [Feature `addition_operator` (SQL)](#feature-addition_operator-1)
      - [Feature `multiplication_operator` (SQL)](#feature-multiplication_operator-1)
      - [Feature `modulo_operator` (SQL)](#feature-modulo_operator-1)
  - [Boolean expressions](#boolean-expressions-1)
      - [Feature `boolean_operator`](#feature-boolean_operator-1)
      - [Feature `comparison_operator`](#feature-comparison_operator-1)
      - [Feature `yoda_comparison` (SQL)](#feature-yoda_comparison-1)
      - [Feature `chained_comparison`](#feature-chained_comparison-1)
      - [Feature `chained_equalities|chained_inequalities` (SQL)](#feature-chained_equalitieschained_inequalities-1)
      - [Feature `divisibility_test`](#feature-divisibility_test-1)
      - [Feature `short_circuit`](#feature-short_circuit-1)
  - [Calls](#calls-1)
    - [Generalities](#generalities-1)
      - [Feature `call_argument`](#feature-call_argument-1)
      - [Feature `composition`](#feature-composition-1)
    - [Calls of the form `callable(arguments)`](#calls-of-the-form-callablearguments-1)
      - [Feature `free_call`](#feature-free_call-1)
      - [Feature `free_call_without_result`](#feature-free_call_without_result-1)
      - [Feature `free_call_without_arguments`](#feature-free_call_without_arguments-1)
      - [Feature `free_tail_call`](#feature-free_tail_call-1)
      - [Feature `internal_free_call` (SQL)](#feature-internal_free_call-1)
      - [Feature `external_free_call` (SQL)](#feature-external_free_call-1)
    - [Calls of the form `identifier.callable(arguments)`](#calls-of-the-form-identifiercallablearguments-1)
      - [Feature `member_call`](#feature-member_call-1)
      - [Feature `member_call_without_result`](#feature-member_call_without_result-1)
      - [Feature `member_call_object`](#feature-member_call_object-1)
      - [Feature `method_chaining`](#feature-method_chaining-1)
  - [Iterables](#iterables-1)
      - [Feature `range` (SQL)](#feature-range-1)
      - [Feature `comprehension`](#feature-comprehension-1)
      - [Feature `comprehension_for_count`](#feature-comprehension_for_count-1)
      - [Feature `filtered_comprehension`](#feature-filtered_comprehension-1)
- [Statements](#statements-1)
  - [Bindings](#bindings-1)
      - [Feature `assignment`](#feature-assignment-1)
      - [Feature `unbinding`](#feature-unbinding-1)
      - [Feature `single_assignment`](#feature-single_assignment-1)
      - [Feature `parallel_assignment`](#feature-parallel_assignment-1)
      - [Feature `augmented_assignment`](#feature-augmented_assignment-1)
      - [Feature `subscript_augmented_assignment`](#feature-subscript_augmented_assignment-1)
      - [Feature `chained_assignment`](#feature-chained_assignment-1)
      - [Feature `assignment_lhs_identifier`](#feature-assignment_lhs_identifier-1)
      - [Feature `assignment_rhs_atom`](#feature-assignment_rhs_atom-1)
    - [Assignment idioms](#assignment-idioms-1)
      - [Feature `update_by_assignment` (SQL)](#feature-update_by_assignment-1)
      - [Feature `update_by_augmented_assignment` (SQL)](#feature-update_by_augmented_assignment-1)
      - [Feature `update_by_member_call` (SQL)](#feature-update_by_member_call-1)
      - [Feature `update` (SQL)](#feature-update-1)
      - [Feature `update_by_assignment_with` (SQL)](#feature-update_by_assignment_with-1)
      - [Feature `update_by_augmented_assignment_with` (SQL)](#feature-update_by_augmented_assignment_with-1)
      - [Feature `update_by_member_call_with` (SQL)](#feature-update_by_member_call_with-1)
      - [Feature `update_with` (SQL)](#feature-update_with-1)
      - [Feature `increment`](#feature-increment-1)
      - [Feature `swap`](#feature-swap-1)
      - [Feature `slide`](#feature-slide-1)
      - [Feature `negate`](#feature-negate-1)
      - [Feature `verbose_conditional_assignment`](#feature-verbose_conditional_assignment-1)
      - [Feature `compact_conditional_assignment`](#feature-compact_conditional_assignment-1)
      - [Feature `corrective_conditional_assignment`](#feature-corrective_conditional_assignment-1)
  - [Function definitions](#function-definitions-1)
    - [Interface](#interface-1)
      - [Feature `function`](#feature-function-1)
      - [Feature `return`](#feature-return-1)
      - [Feature `yield`](#feature-yield-1)
      - [Feature `generator` (SQL)](#feature-generator-1)
      - [Feature `function_returning_something` (SQL)](#feature-function_returning_something-1)
      - [Feature `function_returning_nothing` (SQL)](#feature-function_returning_nothing-1)
      - [Feature `function_argument`](#feature-function_argument-1)
      - [Feature `function_argument_flavor`](#feature-function_argument_flavor-1)
      - [Feature `function_without_arguments`](#feature-function_without_arguments-1)
      - [Feature `decorated_function`](#feature-decorated_function-1)
      - [Feature `function_decorator`](#feature-function_decorator-1)
    - [Nesting](#nesting-1)
      - [Feature `nested_function`](#feature-nested_function-1)
      - [Feature `closure` (SQL)](#feature-closure-1)
      - [Feature `higher-order function` (SQL)](#feature-higher-order-function-1)
    - [Recursion](#recursion-1)
      - [Feature `recursive_function` (SQL)](#feature-recursive_function-1)
      - [Feature `deeply_recursive_function` (SQL)](#feature-deeply_recursive_function-1)
      - [Feature `body_recursive_function` (SQL)](#feature-body_recursive_function-1)
      - [Feature `tail_recursive_function` (SQL)](#feature-tail_recursive_function-1)
  - [Conditionals](#conditionals-1)
      - [Feature `if` (SQL)](#feature-if-1)
      - [Feature `if_test_atom`](#feature-if_test_atom-1)
      - [Feature `if_then_branch`](#feature-if_then_branch-1)
      - [Feature `if_elif_branch`](#feature-if_elif_branch-1)
      - [Feature `if_else_branch`](#feature-if_else_branch-1)
      - [Feature `if_without_else` (SQL)](#feature-if_without_else-1)
      - [Feature `if_guard` (SQL)](#feature-if_guard-1)
      - [Feature `nested_if` (SQL)](#feature-nested_if-1)
  - [Iterations](#iterations-1)
    - [Iteration keywords](#iteration-keywords-1)
      - [Feature `for`](#feature-for-1)
      - [Feature `loop` (SQL)](#feature-loop-1)
      - [Feature `loop_else`](#feature-loop_else-1)
    - [Sequential loops](#sequential-loops-2)
      - [Feature `for_each`](#feature-for_each-1)
      - [Feature `for_range` (SQL)](#feature-for_range-1)
      - [Feature `for_indexes_elements`](#feature-for_indexes_elements-1)
      - [Feature `for_indexes`](#feature-for_indexes-1)
      - [Feature `nested_for` (SQL)](#feature-nested_for-1)
      - [Feature `triangular_nested_for`](#feature-triangular_nested_for-1)
      - [Feature `square_nested_for`](#feature-square_nested_for-1)
    - [Non-sequential loops](#non-sequential-loops-2)
      - [Feature `infinite_while`](#feature-infinite_while-1)
    - [Loop exit](#loop-exit-1)
      - [Feature `loop_with_raise` (SQL)](#feature-loop_with_raise-1)
      - [Feature `loop_with_return` (SQL)](#feature-loop_with_return-1)
      - [Feature `loop_with_break` (SQL)](#feature-loop_with_break-1)
      - [Feature `loop_with_early_exit` (SQL)](#feature-loop_with_early_exit-1)
      - [Feature `loop_with_else` (SQL)](#feature-loop_with_else-1)
      - [Feature `loop_with_late_exit` (SQL)](#feature-loop_with_late_exit-1)
    - [Exceptions](#exceptions-1)
      - [Feature `raise`](#feature-raise-1)
      - [Feature `except`](#feature-except-1)
      - [Feature `try_raise|try_except` (SQL)](#feature-try_raisetry_except-1)
  - [Class definitions](#class-definitions-1)
      - [Feature `class`](#feature-class-1)
      - [Feature `method` (SQL)](#feature-method-1)
      - [Feature `instance_method|class_method|static_method` (SQL)](#feature-instance_methodclass_methodstatic_method-1)
  - [Modules](#modules-1)
      - [Feature `import_module`](#feature-import_module-1)
      - [Feature `import_name`](#feature-import_name-1)
      - [Feature `import` (SQL)](#feature-import-1)
- [Iterative patterns](#iterative-patterns-1)
  - [Loops](#loops-1)
      - [Feature `count_elements|count_states` (SQL)](#feature-count_elementscount_states-1)
  - [Sequential loops](#sequential-loops-3)
    - [Sequential loops with late exit](#sequential-loops-with-late-exit-1)
      - [Feature `accumulate_elements` (SQL)](#feature-accumulate_elements-1)
      - [Feature `accumulate_some_elements` (SQL)](#feature-accumulate_some_elements-1)
      - [Feature `accumulate_all_elements` (SQL)](#feature-accumulate_all_elements-1)
      - [Feature `find_best_element` (SQL)](#feature-find_best_element-1)
    - [Sequential loops with early exit](#sequential-loops-with-early-exit-1)
      - [Feature `universal_quantification|existential_quantification` (SQL)](#feature-universal_quantificationexistential_quantification-1)
      - [Feature `find_first_element` (SQL)](#feature-find_first_element-1)
  - [Non-sequential loops](#non-sequential-loops-3)
    - [Non-sequential infinite loops](#non-sequential-infinite-loops-1)
      - [Feature `get_valid_input` (SQL)](#feature-get_valid_input-1)
      - [Feature `count_inputs` (SQL)](#feature-count_inputs-1)
      - [Feature `accumulate_inputs` (SQL)](#feature-accumulate_inputs-1)
- [Programs](#programs-1)
      - [Feature `whole_span`](#feature-whole_span-1)
      - [Feature `topic`](#feature-topic-1)
- [Suggestions](#suggestions-1)
  - [Assignments](#assignments-1)
      - [Feature `suggest_augmented_assignment`](#feature-suggest_augmented_assignment-1)
  - [Expressions](#expressions-3)
      - [Feature `suggest_comparison_chaining`](#feature-suggest_comparison_chaining-1)
      - [Feature `suggest_constant_definition`](#feature-suggest_constant_definition-1)
  - [Subroutines](#subroutines-1)
      - [Feature `suggest_condition_return`](#feature-suggest_condition_return-1)
