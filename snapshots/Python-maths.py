...
def n31(a: int) -> Tuple[List[int], int]: # function:n31 (-> +12), function_argument:a, function_argument_flavor:arg, function_returning_something:n31 (-> +12), index:_, index:int
    ...
    while a != 1: # comparison_operator:NotEq, evolve_state (-> +5), int_literal, literal:Num, loop:while (-> +5), while (-> +5)
        if a % 2 == 0: # binary_operator:Mod, comparison_operator:Eq, divisibility_test:2, falsey_literal:0, if (-> +3), if_test_atom:0, if_test_atom:2, if_test_atom:a, int_literal, literal:Num, suggest_conditional_expression (-> +3)
            a = a // 2 # assignment:FloorDiv, assignment_lhs_identifier:a, assignment_rhs_atom:2, assignment_rhs_atom:a, binary_operator:FloorDiv, if_then_branch, int_literal, literal:Num, single_assignment:a, suggest_augmented_assignment, update:a:2, update_by_assignment:a:2, update_by_assignment_with:FloorDiv, update_with:FloorDiv
        else:
            a = 3 * a + 1 # assignment:Add, assignment_lhs_identifier:a, assignment_rhs_atom:1, assignment_rhs_atom:3, assignment_rhs_atom:a, binary_operator:Add, binary_operator:Mult, if_else_branch, int_literal, literal:Num, single_assignment:a, suggest_constant_definition, update:a:1, update:a:3, update_by_assignment:a:1, update_by_assignment:a:3, update_by_assignment_with:Add, update_with:Add
...
def median(nums): # function:median (-> +10), function_argument:nums, function_argument_flavor:arg, function_returning_something:median (-> +10), lines_of_code:16 (-> +15)
    ...
    if len(sorted_list) % 2 == 0: # binary_operator:Mod, call_argument:sorted_list, comparison_operator:Eq, divisibility_test:2, falsey_literal:0, function_call:len, if (-> +6), if_test_atom:0, if_test_atom:2, if_test_atom:sorted_list, int_literal, literal:Num
        mid_index_1 = len(sorted_list) // 2 # assignment:FloorDiv, assignment_lhs_identifier:mid_index_1, assignment_rhs_atom:2, assignment_rhs_atom:sorted_list, binary_operator:FloorDiv, call_argument:sorted_list, function_call:len, if_then_branch (-> +2), int_literal, literal:Num, single_assignment:mid_index_1
        mid_index_2 = (len(sorted_list) // 2) - 1 # assignment:Sub, assignment_lhs_identifier:mid_index_2, assignment_rhs_atom:1, assignment_rhs_atom:2, assignment_rhs_atom:sorted_list, binary_operator:FloorDiv, binary_operator:Sub, call_argument:sorted_list, function_call:len, int_literal, literal:Num, single_assignment:mid_index_2
...
def prime_factors(n: int) -> list: # function:prime_factors (-> +11), function_argument:n, function_argument_flavor:arg, function_returning_something:prime_factors (-> +11)
    ...
    while n % 2 == 0: # binary_operator:Mod, comparison_operator:Eq, divisibility_test:2, evolve_state (-> +2), falsey_literal:0, int_literal, literal:Num, loop:while (-> +2), while (-> +2)
        pf.append(2) # call_argument:2, int_literal, literal:Num, method_call:append, method_call_object:pf, update:pf:2, update_by_method_call:pf:2, update_by_method_call_with:append, update_with:append
        n = int(n / 2) # assignment:int, assignment_lhs_identifier:n, assignment_rhs_atom:2, assignment_rhs_atom:n, binary_operator:Div, call_argument:, function_call:int, int_literal, literal:Num, single_assignment:n, update:n:2, update_by_assignment:n:2, update_by_assignment_with:int, update_with:int
...
def number_of_divisors(n: int) -> int: # function:number_of_divisors (-> +13), function_argument:n, function_argument_flavor:arg, function_returning_something:number_of_divisors (-> +13)
    div = 1 # assignment:1, assignment_lhs_identifier:div, assignment_rhs_atom:1, int_literal, literal:Num, single_assignment:div
...
def euler_phi(n: int) -> int: # function:euler_phi (-> +4), function_argument:n, function_argument_flavor:arg, function_returning_something:euler_phi (-> +4)
    ...
    for x in set(prime_factors(n)): # accumulate_all_elements:Mult (-> +1), accumulate_elements:Mult (-> +1), call_argument:, call_argument:n, composition, for:x (-> +1), function_call:prime_factors, function_call:set, loop:for (-> +1)
        s *= (x - 1) / x # assignment_lhs_identifier:s, assignment_rhs_atom:1, assignment_rhs_atom:x, augmented_assignment:Mult, binary_operator:Div, binary_operator:Sub, int_literal, literal:Num, update:s:1, update:s:x, update_by_augmented_assignment:s:1, update_by_augmented_assignment:s:x, update_by_augmented_assignment_with:Mult, update_with:Mult
    return int(s) # call_argument:s, function_call:int, function_tail_call:int, return
...
def binomial_coefficient(n, r): # function:binomial_coefficient (-> +8), function_argument:n, function_argument:r, function_argument_flavor:arg, function_returning_something:binomial_coefficient (-> +8), lines_of_code:10 (-> +9)
    ...
    C[0] = 1 # assignment:1, assignment_lhs_identifier:C, assignment_rhs_atom:1, falsey_literal:0, index:0, int_literal, literal:Num
    for i in range(1, n + 1): # binary_operator:Add, call_argument:, call_argument:1, for:i (-> +4), for_range:1:_ (-> +4), function_call:range, int_literal, literal:Num, loop:for (-> +4), range:1:_
        ...
        while j > 0: # comparison_operator:Gt, evolve_state (-> +2), falsey_literal:0, int_literal, literal:Num, loop:while (-> +2), while (-> +2)
            C[j] += C[j - 1] # assignment_lhs_identifier:C, assignment_rhs_atom:1, assignment_rhs_atom:C, assignment_rhs_atom:j, augmented_assignment:Add, binary_operator:Sub, index:_, index:j, index_arithmetic, int_literal, literal:Num, update:C:1, update:C:C, update:C:j, update_by_augmented_assignment:C:1, update_by_augmented_assignment:C:C, update_by_augmented_assignment:C:j, update_by_augmented_assignment_with:Add, update_with:Add
            j -= 1 # assignment_lhs_identifier:j, assignment_rhs_atom:1, augmented_assignment:Sub, int_literal, literal:Num, update:j:1, update_by_augmented_assignment:j:1, update_by_augmented_assignment_with:Sub, update_with:Sub
...
def main(): # function:main (-> +4), function_returning_nothing:main (-> +4), function_without_arguments:main (-> +4)
    n = 43 # assignment:43, assignment_lhs_identifier:n, assignment_rhs_atom:43, int_literal, literal:Num, single_assignment:n, suggest_constant_definition
...
def explicit_euler(ode_func, y0, x0, stepsize, x_end): # function:explicit_euler (-> +8), function_argument:ode_func, function_argument:stepsize, function_argument:x0, function_argument:x_end, function_argument:y0, function_argument_flavor:arg, function_returning_something:explicit_euler (-> +8)
    ...
    y = np.zeros((N + 1,)) # assignment:zeros, assignment_lhs_identifier:y, assignment_rhs_atom:1, assignment_rhs_atom:N, assignment_rhs_atom:np, binary_operator:Add, call_argument:, int_literal, literal:Num, method_call:zeros, single_assignment:y
...
def extended_euclidean_algorithm(m, n): # function:extended_euclidean_algorithm (-> +31), function_argument:m, function_argument:n, function_argument_flavor:arg, function_returning_something:extended_euclidean_algorithm (-> +31)
    ...
    a_prime = 1 # assignment:1, assignment_lhs_identifier:a_prime, assignment_rhs_atom:1, int_literal, literal:Num, single_assignment:a_prime
    b = 1 # assignment:1, assignment_lhs_identifier:b, assignment_rhs_atom:1, int_literal, literal:Num, single_assignment:b
    b_prime = 0 # assignment:0, assignment_lhs_identifier:b_prime, assignment_rhs_atom:0, falsey_literal:0, int_literal, literal:Num, single_assignment:b_prime
    q = 0 # assignment:0, assignment_lhs_identifier:q, assignment_rhs_atom:0, falsey_literal:0, int_literal, literal:Num, single_assignment:q
...
def main(): # function:main (-> +6), function_returning_nothing:main (-> +6), function_without_arguments:main (-> +6)
    ...
    m = int(sys.argv[1]) # assignment:int, assignment_lhs_identifier:m, assignment_rhs_atom:1, assignment_rhs_atom:sys, call_argument:, function_call:int, index:1, int_literal, literal:Num, single_assignment:m
    n = int(sys.argv[2]) # assignment:int, assignment_lhs_identifier:n, assignment_rhs_atom:2, assignment_rhs_atom:sys, call_argument:, function_call:int, index:2, int_literal, literal:Num, single_assignment:n
...
def factorial(input_number: int) -> int: # function:factorial (-> +8), function_argument:input_number, function_argument_flavor:arg, function_returning_something:factorial (-> +8), lines_of_code:9 (-> +8)
    ...
    result = 1 # assignment:1, assignment_lhs_identifier:result, assignment_rhs_atom:1, int_literal, literal:Num, single_assignment:result
    for i in range(1, input_number): # accumulate_all_elements:Mult (-> +1), accumulate_elements:Mult (-> +1), call_argument:1, call_argument:input_number, for:i (-> +1), for_range:1:input_number (-> +1), function_call:range, int_literal, literal:Num, loop:for (-> +1), range:1:input_number
        result = result * (i + 1) # assignment:Mult, assignment_lhs_identifier:result, assignment_rhs_atom:1, assignment_rhs_atom:i, assignment_rhs_atom:result, binary_operator:Add, binary_operator:Mult, int_literal, literal:Num, single_assignment:result, suggest_augmented_assignment, update:result:1, update:result:i, update_by_assignment:result:1, update_by_assignment:result:i, update_by_assignment_with:Mult, update_with:Mult
...
p = 701 # assignment:701, assignment_lhs_identifier:p, assignment_rhs_atom:701, int_literal, literal:Num, single_assignment:p, suggest_constant_definition
a = 1000000000 # assignment:1000000000, assignment_lhs_identifier:a, assignment_rhs_atom:1000000000, int_literal, literal:Num, single_assignment:a, suggest_constant_definition
b = 10 # assignment:10, assignment_lhs_identifier:b, assignment_rhs_atom:10, int_literal, literal:Num, single_assignment:b, suggest_constant_definition
...
getcontext().prec = 100 # assignment:100, assignment_rhs_atom:100, function_call:getcontext, function_call_without_arguments:getcontext, int_literal, literal:Num
...
def fib_formula(n): # function_argument:n, function_argument_flavor:arg
    ...
    if _check_number_input(n, 2, 1000000): # call_argument:1000000, call_argument:2, call_argument:n, function_call:_check_number_input, if (-> +9), if_test_atom:1000000, if_test_atom:2, if_test_atom:n, int_literal, literal:Num, suggest_constant_definition
        sqrt = Decimal(math.sqrt(5)) # assignment:Decimal, assignment_lhs_identifier:sqrt, assignment_rhs_atom:5, assignment_rhs_atom:math, call_argument:, call_argument:5, composition, function_call:Decimal, if_then_branch (-> +8), int_literal, literal:Num, method_call:sqrt, single_assignment:sqrt, suggest_constant_definition
        phi_1 = Decimal(1 + sqrt) / Decimal(2) # assignment:Div, assignment_lhs_identifier:phi_1, assignment_rhs_atom:1, assignment_rhs_atom:2, assignment_rhs_atom:sqrt, binary_operator:Add, binary_operator:Div, call_argument:, call_argument:2, function_call:Decimal, int_literal, literal:Num, single_assignment:phi_1
        phi_2 = Decimal(1 - sqrt) / Decimal(2) # assignment:Div, assignment_lhs_identifier:phi_2, assignment_rhs_atom:1, assignment_rhs_atom:2, assignment_rhs_atom:sqrt, binary_operator:Div, binary_operator:Sub, call_argument:, call_argument:2, function_call:Decimal, int_literal, literal:Num, single_assignment:phi_2
...
def find_max(nums, left, right): # body_recursive_function:find_max (-> +6), function:find_max (-> +6), function_argument:left, function_argument:nums, function_argument:right, function_argument_flavor:arg, function_returning_something:find_max (-> +6), lines_of_code:7 (-> +6), recursive_function:find_max (-> +6)
    ...
    mid = (left + right) >> 1 # assignment:RShift, assignment_lhs_identifier:mid, assignment_rhs_atom:1, assignment_rhs_atom:left, assignment_rhs_atom:right, binary_operator:Add, binary_operator:RShift, int_literal, literal:Num, single_assignment:mid
...
def main(): # function:main (-> +10), function_returning_nothing:main (-> +10), function_without_arguments:main (-> +10)
    try: # try (-> +9), try_except:IndexError (-> +9), try_except:UnboundLocalError (-> +9), try_except:ValueError (-> +9)
        ...
        num_1 = int(nums[0]) # assignment:int, assignment_lhs_identifier:num_1, assignment_rhs_atom:0, assignment_rhs_atom:nums, call_argument:, falsey_literal:0, function_call:int, index:0, int_literal, literal:Num, single_assignment:num_1
        num_2 = int(nums[1]) # assignment:int, assignment_lhs_identifier:num_2, assignment_rhs_atom:1, assignment_rhs_atom:nums, call_argument:, function_call:int, index:1, int_literal, literal:Num, single_assignment:num_2
...
def exactPrimeFactorCount(n): # function:exactPrimeFactorCount (-> +15), function_argument:n, function_argument_flavor:arg, function_returning_something:exactPrimeFactorCount (-> +15)
    ...
    if n % 2 == 0: # binary_operator:Mod, comparison_operator:Eq, divisibility_test:2, falsey_literal:0, if (-> +3), if_test_atom:0, if_test_atom:2, if_test_atom:n, int_literal, literal:Num
        count += 1 # assignment_lhs_identifier:count, assignment_rhs_atom:1, augmented_assignment:Add, if_then_branch (-> +2), increment:count, int_literal, literal:Num, update:count:1, update_by_augmented_assignment:count:1, update_by_augmented_assignment_with:Add, update_with:Add
        while n % 2 == 0: # binary_operator:Mod, comparison_operator:Eq, divisibility_test:2, evolve_state (-> +1), falsey_literal:0, int_literal, literal:Num, loop:while (-> +1), while (-> +1)
            n = int(n / 2) # assignment:int, assignment_lhs_identifier:n, assignment_rhs_atom:2, assignment_rhs_atom:n, binary_operator:Div, call_argument:, function_call:int, int_literal, literal:Num, single_assignment:n, update:n:2, update_by_assignment:n:2, update_by_assignment_with:int, update_with:int
    i = 3 # assignment:3, assignment_lhs_identifier:i, assignment_rhs_atom:3, int_literal, literal:Num, single_assignment:i, suggest_constant_definition
    while i <= int(math.sqrt(n)): # call_argument:, call_argument:n, comparison_operator:LtE, composition, evolve_state (-> +5), function_call:int, loop:while (-> +5), method_call:sqrt, while (-> +5)
        if n % i == 0: # binary_operator:Mod, comparison_operator:Eq, divisibility_test, falsey_literal:0, if (-> +3), if_test_atom:0, if_test_atom:i, if_test_atom:n, int_literal, literal:Num
            ...
            while n % i == 0: # binary_operator:Mod, comparison_operator:Eq, divisibility_test, falsey_literal:0, int_literal, literal:Num, loop:while (-> +1), while (-> +1)
                n = int(n / i) # assignment:int, assignment_lhs_identifier:n, assignment_rhs_atom:i, assignment_rhs_atom:n, binary_operator:Div, call_argument:, function_call:int, single_assignment:n, update:n:i, update_by_assignment:n:i, update_by_assignment_with:int, update_with:int
        i = i + 2 # assignment:Add, assignment_lhs_identifier:i, assignment_rhs_atom:2, assignment_rhs_atom:i, binary_operator:Add, int_literal, literal:Num, single_assignment:i, suggest_augmented_assignment, update:i:2, update_by_assignment:i:2, update_by_assignment_with:Add, update_with:Add
    if n > 2: # comparison_operator:Gt, if (-> +1), if_test_atom:2, if_test_atom:n, int_literal, literal:Num
        count += 1 # assignment_lhs_identifier:count, assignment_rhs_atom:1, augmented_assignment:Add, if_then_branch, increment:count, int_literal, literal:Num, update:count:1, update_by_augmented_assignment:count:1, update_by_augmented_assignment_with:Add, update_with:Add
...
def karatsuba(a, b): # body_recursive_function:karatsuba (-> +11), function:karatsuba (-> +11), function_argument:a, function_argument:b, function_argument_flavor:arg, function_returning_something:karatsuba (-> +11), lines_of_code:14 (-> +13), recursive_function:karatsuba (-> +11)
    if len(str(a)) == 1 or len(str(b)) == 1: # boolean_operator:Or, call_argument:, call_argument:a, call_argument:b, comparison_operator:Eq, composition, function_call:len, function_call:str, if (-> +10), if_test_atom:1, if_test_atom:a, if_test_atom:b, int_literal, literal:Num
        ...
        m2 = m1 // 2 # assignment:FloorDiv, assignment_lhs_identifier:m2, assignment_rhs_atom:2, assignment_rhs_atom:m1, binary_operator:FloorDiv, int_literal, literal:Num, single_assignment:m2
        a1, a2 = divmod(a, 10 ** m2) # assignment:divmod, assignment_lhs_identifier:a1, assignment_lhs_identifier:a2, assignment_rhs_atom:10, assignment_rhs_atom:a, assignment_rhs_atom:m2, binary_operator:Pow, call_argument:, call_argument:a, function_call:divmod, int_literal, literal:Num, suggest_constant_definition
        b1, b2 = divmod(b, 10 ** m2) # assignment:divmod, assignment_lhs_identifier:b1, assignment_lhs_identifier:b2, assignment_rhs_atom:10, assignment_rhs_atom:b, assignment_rhs_atom:m2, binary_operator:Pow, call_argument:, call_argument:b, function_call:divmod, int_literal, literal:Num, suggest_constant_definition
...
class Matrix(object): # class:Matrix (-> +14)
    def __init__(self, arg): # function:__init__ (-> +6), function_argument:arg, function_argument:self, function_argument_flavor:arg, function_returning_nothing:__init__ (-> +6), instance_method:__init__ (-> +6), method:__init__ (-> +6)
        if isinstance(arg, list): # call_argument:arg, call_argument:list, function_call:isinstance, if (-> +5), if_test_atom:arg, if_test_atom:list
            ...
            self.t = [[0 for _ in range(self.n)] for _ in range(self.n)] # assignment, assignment_lhs_identifier:self, assignment_rhs_atom:0, assignment_rhs_atom:_, assignment_rhs_atom:self, call_argument:, comprehension:List, comprehension_for_count:1, falsey_literal:0, function_call:range, int_literal, literal:Num, range:_, update:self:0, update:self:_, update_by_assignment:self:0, update_by_assignment:self:_, update_by_assignment_with, update_with
...
def modular_exponentiation(a, b): # function:modular_exponentiation (-> +7), function_argument:a, function_argument:b, function_argument_flavor:arg, function_returning_something:modular_exponentiation (-> +7)
    matrix = Matrix([[1, 0], [0, 1]]) # assignment:Matrix, assignment_lhs_identifier:matrix, assignment_rhs_atom:0, assignment_rhs_atom:1, call_argument:, falsey_literal:0, function_call:Matrix, int_literal, literal:List, literal:Num, single_assignment:matrix
    while b > 0: # comparison_operator:Gt, evolve_state (-> +4), falsey_literal:0, int_literal, literal:Num, loop:while (-> +4), while (-> +4)
        ...
        b >>= 1 # assignment_lhs_identifier:b, assignment_rhs_atom:1, augmented_assignment:RShift, int_literal, literal:Num, update:b:1, update_by_augmented_assignment:b:1, update_by_augmented_assignment_with:RShift, update_with:RShift
    return matrix # return:matrix
def fibonacci_with_matrix_exponentiation(n, f1, f2): # function:fibonacci_with_matrix_exponentiation (-> +7), function_argument:f1, function_argument:f2, function_argument:n, function_argument_flavor:arg, function_returning_something:fibonacci_with_matrix_exponentiation (-> +7)
    ...
    matrix = Matrix([[1, 1], [1, 0]]) # assignment:Matrix, assignment_lhs_identifier:matrix, assignment_rhs_atom:0, assignment_rhs_atom:1, call_argument:, falsey_literal:0, function_call:Matrix, int_literal, literal:List, literal:Num, single_assignment:matrix
    matrix = modular_exponentiation(matrix, n - 2) # assignment:modular_exponentiation, assignment_lhs_identifier:matrix, assignment_rhs_atom:2, assignment_rhs_atom:matrix, assignment_rhs_atom:n, binary_operator:Sub, call_argument:, call_argument:matrix, function_call:modular_exponentiation, int_literal, literal:Num, single_assignment:matrix, update:matrix:2, update:matrix:n, update_by_assignment:matrix:2, update_by_assignment:matrix:n, update_by_assignment_with:modular_exponentiation, update_with:modular_exponentiation
...
def simple_fibonacci(n, f1, f2): # function:simple_fibonacci (-> +11), function_argument:f1, function_argument:f2, function_argument:n, function_argument_flavor:arg, function_returning_something:simple_fibonacci (-> +11)
    ...
    n -= 2 # assignment_lhs_identifier:n, assignment_rhs_atom:2, augmented_assignment:Sub, int_literal, literal:Num, update:n:2, update_by_augmented_assignment:n:2, update_by_augmented_assignment_with:Sub, update_with:Sub
    while n > 0: # comparison_operator:Gt, evolve_state (-> +2), falsey_literal:0, int_literal, literal:Num, loop:while (-> +2), while (-> +2)
        ...
        n -= 1 # assignment_lhs_identifier:n, assignment_rhs_atom:1, augmented_assignment:Sub, int_literal, literal:Num, update:n:1, update_by_augmented_assignment:n:1, update_by_augmented_assignment_with:Sub, update_with:Sub
...
""" # literal:Str
    ...
    exec_time = timeit.timeit(setup=setup, stmt=code, number=100) # assignment:timeit, assignment_lhs_identifier:exec_time, assignment_rhs_atom:100, assignment_rhs_atom:code, assignment_rhs_atom:setup, assignment_rhs_atom:timeit, int_literal, literal:Num, method_call:timeit, single_assignment:exec_time, suggest_constant_definition
...
def modular_exponential(base, power, mod): # function:modular_exponential (-> +10), function_argument:base, function_argument:mod, function_argument:power, function_argument_flavor:arg, function_returning_something:modular_exponential (-> +10), lines_of_code:13 (-> +12)
    ...
    while power > 0: # comparison_operator:Gt, evolve_state (-> +4), falsey_literal:0, int_literal, literal:Num, loop:while (-> +4), while (-> +4)
        ...
        power = power >> 1 # assignment:RShift, assignment_lhs_identifier:power, assignment_rhs_atom:1, assignment_rhs_atom:power, binary_operator:RShift, int_literal, literal:Num, single_assignment:power, suggest_augmented_assignment, update:power:1, update_by_assignment:power:1, update_by_assignment_with:RShift, update_with:RShift
...
def horner(poly: Sequence[float], x: float) -> float: # function:horner (-> +4), function_argument:poly, function_argument:x, function_argument_flavor:arg, function_returning_something:horner (-> +4)
    result = 0.0 # assignment:0.0, assignment_lhs_identifier:result, assignment_rhs_atom:0.0, falsey_literal:0.0, float_literal, literal:Num, single_assignment:result, suggest_constant_definition
...
def primes(max: int) -> List[int]: # function:primes (-> +9), function_argument:max, function_argument_flavor:arg, function_returning_something:primes (-> +9), index:int
    max += 1 # assignment_lhs_identifier:max, assignment_rhs_atom:1, augmented_assignment:Add, increment:max, int_literal, literal:Num, update:max:1, update_by_augmented_assignment:max:1, update_by_augmented_assignment_with:Add, update_with:Add
    ...
    for i in range(2, max): # accumulate_elements:append (-> +4), accumulate_some_elements:append (-> +4), call_argument:2, call_argument:max, for:i (-> +4), for_range:2:max (-> +4), for_range:i:max:i (-> +4), function_call:range, int_literal, literal:Num, loop:for (-> +4), range:2:max
...
def prime_sieve_eratosthenes(num): # function:prime_sieve_eratosthenes (-> +10), function_argument:num, function_argument_flavor:arg, function_returning_nothing:prime_sieve_eratosthenes (-> +10), lines_of_code:11 (-> +10)
    ...
    p = 2 # assignment:2, assignment_lhs_identifier:p, assignment_rhs_atom:2, int_literal, literal:Num, single_assignment:p
    while p * p <= num: # binary_operator:Mult, comparison_operator:LtE, loop:while (-> +4), while (-> +4)
        ...
        p += 1 # assignment_lhs_identifier:p, assignment_rhs_atom:1, augmented_assignment:Add, increment:p, int_literal, literal:Num, update:p:1, update_by_augmented_assignment:p:1, update_by_augmented_assignment_with:Add, update_with:Add
...
def qr_householder(A): # function:qr_householder (-> +16), function_argument:A, function_argument_flavor:arg, function_returning_something:qr_householder (-> +16)
    ...
    for k in range(t - 1): # accumulate_all_elements:block (-> +10), accumulate_elements:block (-> +10), binary_operator:Sub, call_argument:, for:k (-> +10), for_range:_ (-> +10), function_call:range, int_literal, literal:Num, loop:for (-> +10), range:_
        ...
        e1[0] = 1.0 # assignment:1.0, assignment_lhs_identifier:e1, assignment_rhs_atom:1.0, falsey_literal:0, float_literal, index:0, int_literal, literal:Num, suggest_constant_definition
...
def QuadraticEquation(a: int, b: int, c: int) -> Tuple[str, str]: # function:QuadraticEquation (-> +10), function_argument:a, function_argument:b, function_argument:c, function_argument_flavor:arg, function_returning_something:QuadraticEquation (-> +10), index:_
    ...
    delta = b * b - 4 * a * c # assignment:Sub, assignment_lhs_identifier:delta, assignment_rhs_atom:4, assignment_rhs_atom:a, assignment_rhs_atom:b, assignment_rhs_atom:c, binary_operator:Mult, binary_operator:Sub, int_literal, literal:Num, single_assignment:delta, suggest_constant_definition
...
def main(): # function:main (-> +2), function_returning_nothing:main (-> +2), function_without_arguments:main (-> +2)
    solutions = QuadraticEquation(a=5, b=6, c=1) # assignment:QuadraticEquation, assignment_lhs_identifier:solutions, assignment_rhs_atom:1, assignment_rhs_atom:5, assignment_rhs_atom:6, function_call:QuadraticEquation, int_literal, literal:Num, single_assignment:solutions, suggest_constant_definition
...
class FFT: # class:FFT (-> +89)
    ...
    def __DFT(self, which): # function:__DFT (-> +23), function_argument:self, function_argument:which, function_argument_flavor:arg, function_returning_something:__DFT (-> +23), instance_method:__DFT (-> +23), method:__DFT (-> +23)
        ...
        next_ncol = self.C_max_length // 2 # assignment:FloorDiv, assignment_lhs_identifier:next_ncol, assignment_rhs_atom:2, assignment_rhs_atom:self, binary_operator:FloorDiv, int_literal, literal:Num, single_assignment:next_ncol
        while next_ncol > 0: # comparison_operator:Gt, evolve_state (-> +14), falsey_literal:0, int_literal, literal:Num, loop:while (-> +14), while (-> +14)
            ...
            current_root = 1 # assignment:1, assignment_lhs_identifier:current_root, assignment_rhs_atom:1, int_literal, literal:Num, single_assignment:current_root
            ...
            next_ncol = next_ncol // 2 # assignment:FloorDiv, assignment_lhs_identifier:next_ncol, assignment_rhs_atom:2, assignment_rhs_atom:next_ncol, binary_operator:FloorDiv, int_literal, literal:Num, single_assignment:next_ncol, suggest_augmented_assignment, update:next_ncol:2, update_by_assignment:next_ncol:2, update_by_assignment_with:FloorDiv, update_with:FloorDiv
    ...
    def __multiply(self): # function:__multiply (-> +35), function_argument:self, function_argument_flavor:arg, function_returning_something:__multiply (-> +35), instance_method:__multiply (-> +35), method:__multiply (-> +35)
        ...
        next_ncol = 2 # assignment:2, assignment_lhs_identifier:next_ncol, assignment_rhs_atom:2, int_literal, literal:Num, single_assignment:next_ncol
        while next_ncol <= self.C_max_length: # comparison_operator:LtE, evolve_state (-> +22), loop:while (-> +22), while (-> +22)
            ...
            root = self.root ** (next_ncol // 2) # assignment:Pow, assignment_lhs_identifier:root, assignment_rhs_atom:2, assignment_rhs_atom:next_ncol, assignment_rhs_atom:self, binary_operator:FloorDiv, binary_operator:Pow, int_literal, literal:Num, single_assignment:root
            current_root = 1 # assignment:1, assignment_lhs_identifier:current_root, assignment_rhs_atom:1, int_literal, literal:Num, single_assignment:current_root
            ...
            next_ncol *= 2 # assignment_lhs_identifier:next_ncol, assignment_rhs_atom:2, augmented_assignment:Mult, int_literal, literal:Num, update:next_ncol:2, update_by_augmented_assignment:next_ncol:2, update_by_augmented_assignment_with:Mult, update_with:Mult
        inverseC = [round(x[0].real, 8) + round(x[0].imag, 8) * 1j for x in inverseC] # assignment, assignment_lhs_identifier:inverseC, assignment_rhs_atom:0, assignment_rhs_atom:1j, assignment_rhs_atom:8, assignment_rhs_atom:inverseC, assignment_rhs_atom:x, binary_operator:Add, binary_operator:Mult, call_argument:, call_argument:8, comprehension:List, comprehension_for_count:1, falsey_literal:0, function_call:round, imaginary_literal, index:0, int_literal, literal:Num, single_assignment:inverseC, suggest_constant_definition, update:inverseC:0, update:inverseC:1j, update:inverseC:8, update:inverseC:x, update_by_assignment:inverseC:0, update_by_assignment:inverseC:1j, update_by_assignment:inverseC:8, update_by_assignment:inverseC:x, update_by_assignment_with, update_with
...
def sieve(n): # function:sieve (-> +33), function_argument:n, function_argument_flavor:arg, function_returning_something:sieve (-> +33)
    ...
    start = 2 # assignment:2, assignment_lhs_identifier:start, assignment_rhs_atom:2, int_literal, literal:Num, single_assignment:start
    ...
    temp = [True] * (end + 1) # assignment:Mult, assignment_lhs_identifier:temp, assignment_rhs_atom:1, assignment_rhs_atom:True, assignment_rhs_atom:end, binary_operator:Add, binary_operator:Mult, int_literal, literal:List, literal:Num, literal:True, replication_operator:List, single_assignment:temp
    ...
    while start <= end: # comparison_operator:LtE, loop:while (-> +6), while (-> +6)
        ...
        start += 1 # assignment_lhs_identifier:start, assignment_rhs_atom:1, augmented_assignment:Add, increment:start, int_literal, literal:Num, update:start:1, update_by_augmented_assignment:start:1, update_by_augmented_assignment_with:Add, update_with:Add
    ...
    low = end + 1 # assignment:Add, assignment_lhs_identifier:low, assignment_rhs_atom:1, assignment_rhs_atom:end, binary_operator:Add, int_literal, literal:Num, single_assignment:low
    high = low + end - 1 # assignment:Sub, assignment_lhs_identifier:high, assignment_rhs_atom:1, assignment_rhs_atom:end, assignment_rhs_atom:low, binary_operator:Add, binary_operator:Sub, int_literal, literal:Num, single_assignment:high
    ...
    while low <= n: # comparison_operator:LtE, loop:while (-> +14), while (-> +14)
        ...
        low = high + 1 # assignment:Add, assignment_lhs_identifier:low, assignment_rhs_atom:1, assignment_rhs_atom:high, binary_operator:Add, int_literal, literal:Num, single_assignment:low
        high = low + end - 1 # assignment:Sub, assignment_lhs_identifier:high, assignment_rhs_atom:1, assignment_rhs_atom:end, assignment_rhs_atom:low, binary_operator:Add, binary_operator:Sub, int_literal, literal:Num, single_assignment:high
        if high > n: # comparison_operator:Gt, if (-> +1), if_test_atom:high, if_test_atom:n
            high = n # assignment, assignment_lhs_identifier:high, assignment_rhs_atom:n, if_then_branch, single_assignment:high
...
def sieve(n): # function:sieve (-> +15), function_argument:n, function_argument_flavor:arg, function_returning_something:sieve (-> +15)
    l = [True] * (n + 1) # assignment:Mult, assignment_lhs_identifier:l, assignment_rhs_atom:1, assignment_rhs_atom:True, assignment_rhs_atom:n, binary_operator:Add, binary_operator:Mult, int_literal, literal:List, literal:Num, literal:True, replication_operator:List, single_assignment:l
    prime = [] # assignment, assignment_lhs_identifier:prime, falsey_literal:List, literal:List, single_assignment:prime
    start = 2 # assignment:2, assignment_lhs_identifier:start, assignment_rhs_atom:2, int_literal, literal:Num, single_assignment:start
    end = int(math.sqrt(n)) # assignment:int, assignment_lhs_identifier:end, assignment_rhs_atom:math, assignment_rhs_atom:n, call_argument:, call_argument:n, composition, function_call:int, method_call:sqrt, single_assignment:end
    while start <= end: # comparison_operator:LtE, loop:while (-> +6), while (-> +6)
        ...
        start += 1 # assignment_lhs_identifier:start, assignment_rhs_atom:1, augmented_assignment:Add, increment:start, int_literal, literal:Num, update:start:1, update_by_augmented_assignment:start:1, update_by_augmented_assignment_with:Add, update_with:Add
    for j in range(end + 1, n + 1): # accumulate_elements:append (-> +2), accumulate_some_elements:append (-> +2), binary_operator:Add, call_argument:, for:j (-> +2), for_range:_:_ (-> +2), function_call:range, int_literal, literal:Num, loop:for (-> +2), range:_:_
...
def method_2(boundary, steps): # function:method_2 (-> +12), function_argument:boundary, function_argument:steps, function_argument_flavor:arg, function_returning_something:method_2 (-> +12), lines_of_code:28 (-> +27)
    h = (boundary[1] - boundary[0]) / steps # assignment:Div, assignment_lhs_identifier:h, assignment_rhs_atom:0, assignment_rhs_atom:1, assignment_rhs_atom:boundary, assignment_rhs_atom:steps, binary_operator:Div, binary_operator:Sub, falsey_literal:0, index:0, index:1, int_literal, literal:Num, single_assignment:h
    ...
    y = 0.0 # assignment:0.0, assignment_lhs_identifier:y, assignment_rhs_atom:0.0, falsey_literal:0.0, float_literal, literal:Num, single_assignment:y, suggest_constant_definition
    y += (h / 3.0) * f(a) # assignment_lhs_identifier:y, assignment_rhs_atom:3.0, assignment_rhs_atom:a, assignment_rhs_atom:h, augmented_assignment:Add, binary_operator:Div, binary_operator:Mult, call_argument:a, float_literal, function_call:f, literal:Num, suggest_constant_definition, update:y:3.0, update:y:a, update:y:h, update_by_augmented_assignment:y:3.0, update_by_augmented_assignment:y:a, update_by_augmented_assignment:y:h, update_by_augmented_assignment_with:Add, update_with:Add
    cnt = 2 # assignment:2, assignment_lhs_identifier:cnt, assignment_rhs_atom:2, int_literal, literal:Num, single_assignment:cnt
    for i in x_i: # accumulate_all_elements:Add (-> +2), accumulate_elements:Add (-> +2), count_elements:cnt (-> +2), for:i (-> +2), for_each (-> +2), loop:for (-> +2)
        y += (h / 3) * (4 - 2 * (cnt % 2)) * f(i) # assignment_lhs_identifier:y, assignment_rhs_atom:2, assignment_rhs_atom:3, assignment_rhs_atom:4, assignment_rhs_atom:cnt, assignment_rhs_atom:h, assignment_rhs_atom:i, augmented_assignment:Add, binary_operator:Div, binary_operator:Mod, binary_operator:Mult, binary_operator:Sub, call_argument:i, function_call:f, int_literal, literal:Num, suggest_constant_definition, update:y:2, update:y:3, update:y:4, update:y:cnt, update:y:h, update:y:i, update_by_augmented_assignment:y:2, update_by_augmented_assignment:y:3, update_by_augmented_assignment:y:4, update_by_augmented_assignment:y:cnt, update_by_augmented_assignment:y:h, update_by_augmented_assignment:y:i, update_by_augmented_assignment_with:Add, update_with:Add
        cnt += 1 # assignment_lhs_identifier:cnt, assignment_rhs_atom:1, augmented_assignment:Add, increment:cnt, int_literal, literal:Num, update:cnt:1, update_by_augmented_assignment:cnt:1, update_by_augmented_assignment_with:Add, update_with:Add
    y += (h / 3.0) * f(b) # assignment_lhs_identifier:y, assignment_rhs_atom:3.0, assignment_rhs_atom:b, assignment_rhs_atom:h, augmented_assignment:Add, binary_operator:Div, binary_operator:Mult, call_argument:b, float_literal, function_call:f, literal:Num, suggest_constant_definition, update:y:3.0, update:y:b, update:y:h, update_by_augmented_assignment:y:3.0, update_by_augmented_assignment:y:b, update_by_augmented_assignment:y:h, update_by_augmented_assignment_with:Add, update_with:Add
    return y # return:y
...
def f(x): # function:f (-> +2), function_argument:x, function_argument_flavor:arg, function_returning_something:f (-> +2)
    y = (x - 0) * (x - 0) # assignment:Mult, assignment_lhs_identifier:y, assignment_rhs_atom:0, assignment_rhs_atom:x, binary_operator:Mult, binary_operator:Sub, falsey_literal:0, int_literal, literal:Num, single_assignment:y
    return y # return:y
def main(): # function:main (-> +6), function_returning_nothing:main (-> +6), function_without_arguments:main (-> +6)
    a = 0.0 # assignment:0.0, assignment_lhs_identifier:a, assignment_rhs_atom:0.0, falsey_literal:0.0, float_literal, literal:Num, single_assignment:a, suggest_constant_definition
    b = 1.0 # assignment:1.0, assignment_lhs_identifier:b, assignment_rhs_atom:1.0, float_literal, literal:Num, single_assignment:b, suggest_constant_definition
    steps = 10.0 # assignment:10.0, assignment_lhs_identifier:steps, assignment_rhs_atom:10.0, float_literal, literal:Num, single_assignment:steps, suggest_constant_definition
...
def method_1(boundary, steps): # function:method_1 (-> +10), function_argument:boundary, function_argument:steps, function_argument_flavor:arg, function_returning_something:method_1 (-> +10), lines_of_code:26 (-> +25)
    ...
    x_i = make_points(a, b, h) # assignment:make_points, assignment_lhs_identifier:x_i, assignment_rhs_atom:a, assignment_rhs_atom:b, assignment_rhs_atom:h, call_argument:a, call_argument:b, call_argument:h, function_call:make_points, single_assignment:x_i
    y = 0.0 # assignment:0.0, assignment_lhs_identifier:y, assignment_rhs_atom:0.0, falsey_literal:0.0, float_literal, literal:Num, single_assignment:y, suggest_constant_definition
    y += (h / 2.0) * f(a) # assignment_lhs_identifier:y, assignment_rhs_atom:2.0, assignment_rhs_atom:a, assignment_rhs_atom:h, augmented_assignment:Add, binary_operator:Div, binary_operator:Mult, call_argument:a, float_literal, function_call:f, literal:Num, suggest_constant_definition, update:y:2.0, update:y:a, update:y:h, update_by_augmented_assignment:y:2.0, update_by_augmented_assignment:y:a, update_by_augmented_assignment:y:h, update_by_augmented_assignment_with:Add, update_with:Add
    ...
    y += (h / 2.0) * f(b) # assignment_lhs_identifier:y, assignment_rhs_atom:2.0, assignment_rhs_atom:b, assignment_rhs_atom:h, augmented_assignment:Add, binary_operator:Div, binary_operator:Mult, call_argument:b, float_literal, function_call:f, literal:Num, suggest_constant_definition, update:y:2.0, update:y:b, update:y:h, update_by_augmented_assignment:y:2.0, update_by_augmented_assignment:y:b, update_by_augmented_assignment:y:h, update_by_augmented_assignment_with:Add, update_with:Add
    return y # return:y
def make_points(a, b, h): # function:make_points (-> +4), function_argument:a, function_argument:b, function_argument:h, function_argument_flavor:arg, generator:make_points (-> +4)
    x = a + h # assignment:Add, assignment_lhs_identifier:x, assignment_rhs_atom:a, assignment_rhs_atom:h, binary_operator:Add, single_assignment:x
    while x < (b - h): # binary_operator:Sub, comparison_operator:Lt, loop:while (-> +2), while (-> +2)
...
def zeller(date_input: str) -> str: # function:zeller (-> +46), function_argument:date_input, function_argument_flavor:arg, function_returning_something:zeller (-> +46)
    ...
    if m <= 2: # comparison_operator:LtE, if (-> +2), if_test_atom:2, if_test_atom:m, int_literal, literal:Num
        y = y - 1 # assignment:Sub, assignment_lhs_identifier:y, assignment_rhs_atom:1, assignment_rhs_atom:y, binary_operator:Sub, if_then_branch (-> +1), int_literal, literal:Num, single_assignment:y, suggest_augmented_assignment, update:y:1, update_by_assignment:y:1, update_by_assignment_with:Sub, update_with:Sub
        m = m + 12 # assignment:Add, assignment_lhs_identifier:m, assignment_rhs_atom:12, assignment_rhs_atom:m, binary_operator:Add, increment:m, int_literal, literal:Num, single_assignment:m, suggest_augmented_assignment, suggest_constant_definition, update:m:12, update_by_assignment:m:12, update_by_assignment_with:Add, update_with:Add
