...
def n31(a: int) -> Tuple[List[int], int]: # function:n31 (-> +12), function_returning_something:n31 (-> +12), index
    if not isinstance(a, int): # call_parameter:a, call_parameter:int, function_call:isinstance, if (-> +1), if_test_id:a, if_test_id:int, if_test_id:isinstance, unary_operator:Not
        raise TypeError("Must be int, not {0}".format(type(a).__name__)) # call_parameter:, call_parameter:a, composition, function_call:TypeError, function_call:type, if_then_branch, literal:Str, method_call:format, raise:TypeError
    if a < 1: # comparison_operator:Lt, if (-> +1), if_test_id:a, int_literal, literal:Num
        raise ValueError("Given integer must be greater than 1, not {0}".format(a)) # call_parameter:, call_parameter:a, composition, function_call:ValueError, if_then_branch, literal:Str, method_call:format, raise:ValueError
...
def test_n31(): # function:test_n31 (-> +113), function_returning_nothing:test_n31 (-> +113)
    assert n31(4) == ([4, 2, 1], 3) # assertion, call_parameter:4, comparison_operator:Eq, function_call:n31, int_literal, literal:List, literal:Num, literal:Tuple, suggest_constant_definition
    assert n31(11) == ([11, 34, 17, 52, 26, 13, 40, 20, 10, 5, 16, 8, 4, 2, 1], 15) # assertion, call_parameter:11, comparison_operator:Eq, function_call:n31, int_literal, literal:List, literal:Num, literal:Tuple, suggest_constant_definition
    assert n31(31) == ( # assertion, call_parameter:31, function_call:n31, int_literal, literal:Num, suggest_constant_definition
...
def test_abs_val(): # function:test_abs_val (-> +3), function_returning_nothing:test_abs_val (-> +3)
    assert 0 == abs_val(0) # assertion, call_parameter:0, comparison_operator:Eq, function_call:abs_val, int_literal, literal:Num
    assert 34 == abs_val(34) # assertion, call_parameter:34, comparison_operator:Eq, function_call:abs_val, int_literal, literal:Num, suggest_constant_definition
    assert 100000000000 == abs_val(-100000000000) # assertion, call_parameter:-100000000000, comparison_operator:Eq, function_call:abs_val, int_literal, literal:Num, suggest_constant_definition
...
def main(): # function:main (-> +2), function_returning_nothing:main (-> +2)
    ...
    print(absMin(a)) # call_parameter:, call_parameter:a, composition, function_call:absMin, function_call:print
...
def test_average(): # function:test_average (-> +3), function_returning_nothing:test_average (-> +3)
    assert 12.0 == average([3, 6, 9, 12, 15, 18, 21]) # assertion, call_parameter:, comparison_operator:Eq, float_literal, function_call:average, int_literal, literal:List, literal:Num, suggest_constant_definition
    assert 20 == average([5, 10, 15, 20, 25, 30, 35]) # assertion, call_parameter:, comparison_operator:Eq, function_call:average, int_literal, literal:List, literal:Num, suggest_constant_definition
    assert 4.5 == average([1, 2, 3, 4, 5, 6, 7, 8]) # assertion, call_parameter:, comparison_operator:Eq, float_literal, function_call:average, int_literal, literal:List, literal:Num, suggest_constant_definition
...
def main(): # function:main (-> +4), function_returning_nothing:main (-> +4)
    print("Odd number of numbers:") # call_parameter:, function_call:print, literal:Str
    print(median([2, 4, 6, 8, 20, 50, 70])) # call_parameter:, composition, function_call:median, function_call:print, int_literal, literal:List, literal:Num, suggest_constant_definition
    print("Even number of numbers:") # call_parameter:, function_call:print, literal:Str
    print(median([2, 4, 6, 8, 20, 50])) # call_parameter:, composition, function_call:median, function_call:print, int_literal, literal:List, literal:Num, suggest_constant_definition
...
def mode(input_list): # function:mode (-> +7), function_returning_something:mode (-> +7)
    ...
    for x in input_list: # accumulate_elements:1 (-> +4), for:x (-> +4), for_each (-> +4)
        result.append(input_list.count(x)) # call_parameter:, call_parameter:x, composition, method_call:append, method_call:count, method_call_object:result
...
def prime_factors(n: int) -> list: # function:prime_factors (-> +11), function_returning_something:prime_factors (-> +11)
    ...
    while n % 2 == 0: # binary_operator:Mod, comparison_operator:Eq, divisibility_test:2, evolve_state (-> +2), int_literal, literal:Num, while (-> +2)
        pf.append(2) # call_parameter:2, int_literal, literal:Num, method_call:append, method_call_object:pf
        n = int(n / 2) # assignment, assignment_lhs_identifier:n, assignment_rhs_identifier:int, assignment_rhs_identifier:n, binary_operator:Div, call_parameter:, function_call:int, int_literal, literal:Num
    for i in range(3, int(math.sqrt(n)) + 1, 2): # accumulate_elements:2 (-> +3), binary_operator:Add, call_parameter:, call_parameter:2, call_parameter:3, call_parameter:n, composition, for:i (-> +3), for_range_step:2 (-> +3), function_call:int, function_call:range, int_literal, literal:Num, method_call:sqrt, suggest_constant_definition
        while n % i == 0: # binary_operator:Mod, comparison_operator:Eq, divisibility_test, evolve_state (-> +2), int_literal, literal:Num, while (-> +2)
            ...
            n = int(n / i) # assignment, assignment_lhs_identifier:n, assignment_rhs_identifier:i, assignment_rhs_identifier:int, assignment_rhs_identifier:n, binary_operator:Div, call_parameter:, function_call:int
...
def number_of_divisors(n: int) -> int: # function:number_of_divisors (-> +13), function_returning_something:number_of_divisors (-> +13)
    ...
    for i in range(3, int(math.sqrt(n)) + 1, 2): # accumulate_elements:1 (-> +5), binary_operator:Add, call_parameter:, call_parameter:2, call_parameter:3, call_parameter:n, composition, for:i (-> +5), for_range_step:2 (-> +5), function_call:int, function_call:range, int_literal, literal:Num, method_call:sqrt, suggest_constant_definition
        temp = 1 # assignment, assignment_lhs_identifier:temp, int_literal, literal:Num
...
def sum_of_divisors(n: int) -> int: # function:sum_of_divisors (-> +15), function_returning_something:sum_of_divisors (-> +15)
    ...
    for i in range(3, int(math.sqrt(n)) + 1, 2): # accumulate_elements:2 (-> +6), binary_operator:Add, call_parameter:, call_parameter:2, call_parameter:3, call_parameter:n, composition, for:i (-> +6), for_range_step:2 (-> +6), function_call:int, function_call:range, int_literal, literal:Num, method_call:sqrt, suggest_constant_definition
        temp = 1 # assignment, assignment_lhs_identifier:temp, int_literal, literal:Num
        while n % i == 0: # binary_operator:Mod, comparison_operator:Eq, divisibility_test, int_literal, literal:Num, while (-> +2)
            temp += 1 # assignment_lhs_identifier:temp, augmented_assignment, int_literal, literal:Num
            n = int(n / i) # assignment, assignment_lhs_identifier:n, assignment_rhs_identifier:i, assignment_rhs_identifier:int, assignment_rhs_identifier:n, binary_operator:Div, call_parameter:, function_call:int
...
def euler_phi(n: int) -> int: # function:euler_phi (-> +4), function_returning_something:euler_phi (-> +4)
    ...
    for x in set(prime_factors(n)): # accumulate_elements:1 (-> +1), call_parameter:, call_parameter:n, composition, for:x (-> +1), function_call:prime_factors, function_call:set
...
def binary_exponentiation(a, n): # body_recursive_function:binary_exponentiation (-> +7), function:binary_exponentiation (-> +7), function_returning_something:binary_exponentiation (-> +7), recursive_function:binary_exponentiation (-> +7)
    if n == 0: # comparison_operator:Eq, if (-> +6), if_test_id:n, int_literal, literal:Num
        ...
        return binary_exponentiation(a, n - 1) * a # binary_operator:Mult, binary_operator:Sub, call_parameter:, call_parameter:a, function_call:binary_exponentiation, if_elif_branch, int_literal, literal:Num, return
    else:
        b = binary_exponentiation(a, n / 2) # assignment, assignment_lhs_identifier:b, assignment_rhs_identifier:a, assignment_rhs_identifier:binary_exponentiation, assignment_rhs_identifier:n, binary_operator:Div, call_parameter:, call_parameter:a, function_call:binary_exponentiation, if_else_branch (-> +1), int_literal, literal:Num
...
def binomial_coefficient(n, r): # function:binomial_coefficient (-> +8), function_returning_something:binomial_coefficient (-> +8)
    C = [0 for i in range(r + 1)] # assignment, assignment_lhs_identifier:C, assignment_rhs_identifier:i, assignment_rhs_identifier:r, assignment_rhs_identifier:range, binary_operator:Add, call_parameter:, comprehension:List, comprehension_for_count:1, constant_assignment:C, function_call:range, int_literal, literal:Num
    C[0] = 1 # assignment, assignment_lhs_identifier:C, constant_assignment:C, index, int_literal, literal:Num
    for i in range(1, n + 1): # binary_operator:Add, call_parameter:, call_parameter:1, for:i (-> +4), for_range_start (-> +4), function_call:range, int_literal, literal:Num
...
print(binomial_coefficient(n=10, r=5)) # call_parameter:, composition, function_call:binomial_coefficient, function_call:print, int_literal, literal:Num
...
def ceil(x) -> int: # function:ceil (-> +2), function_returning_something:ceil (-> +2)
    return ( # return
        x if isinstance(x, int) or x - int(x) == 0 else int(x + 1) if x > 0 else int(x) # binary_operator:Add, binary_operator:Sub, boolean_operator:Or, call_parameter:, call_parameter:int, call_parameter:x, comparison_operator:Eq, comparison_operator:Gt, conditional_expression, function_call:int, function_call:isinstance, int_literal, literal:Num
    )
...
def main(): # function:main (-> +4), function_returning_nothing:main (-> +4)
    ...
    print("collatz sequence from %d took %d steps." % (n, len(sequence))) # binary_operator:Mod, call_parameter:, call_parameter:sequence, composition, function_call:len, function_call:print, literal:Str
...
def extended_euclidean_algorithm(m, n): # function:extended_euclidean_algorithm (-> +31), function_returning_something:extended_euclidean_algorithm (-> +31)
    ...
    while True: # literal:True, while (-> +12)
        q = int(c / d) # assignment, assignment_lhs_identifier:q, assignment_rhs_identifier:c, assignment_rhs_identifier:d, assignment_rhs_identifier:int, binary_operator:Div, call_parameter:, function_call:int
...
def main(): # function:main (-> +6), function_returning_nothing:main (-> +6)
    if len(sys.argv) < 3: # call_parameter:, comparison_operator:Lt, function_call:len, if (-> +2), if_test_id:len, if_test_id:sys, int_literal, literal:Num, suggest_constant_definition
        print("2 integer arguments required") # call_parameter:, function_call:print, if_then_branch (-> +1), literal:Str
        exit(1) # call_parameter:1, function_call:exit, int_literal, literal:Num
    m = int(sys.argv[1]) # assignment, assignment_lhs_identifier:m, assignment_rhs_identifier:int, assignment_rhs_identifier:sys, call_parameter:, function_call:int, index, int_literal, literal:Num
    n = int(sys.argv[2]) # assignment, assignment_lhs_identifier:n, assignment_rhs_identifier:int, assignment_rhs_identifier:sys, call_parameter:, function_call:int, index, int_literal, literal:Num
    print(extended_euclidean_algorithm(m, n)) # call_parameter:, call_parameter:m, call_parameter:n, composition, function_call:extended_euclidean_algorithm, function_call:print
...
def factorial(input_number: int) -> int: # function:factorial (-> +8), function_returning_something:factorial (-> +8)
    if input_number < 0: # comparison_operator:Lt, if (-> +1), if_test_id:input_number, int_literal, literal:Num
        raise ValueError("factorial() not defined for negative values") # call_parameter:, function_call:ValueError, if_then_branch, literal:Str, raise:ValueError
    if not isinstance(input_number, int): # call_parameter:input_number, call_parameter:int, function_call:isinstance, if (-> +1), if_test_id:input_number, if_test_id:int, if_test_id:isinstance, unary_operator:Not
        raise ValueError("factorial() only accepts integral values") # call_parameter:, function_call:ValueError, if_then_branch, literal:Str, raise:ValueError
    result = 1 # assignment, assignment_lhs_identifier:result, int_literal, literal:Num
    for i in range(1, input_number): # accumulate_elements:1 (-> +1), call_parameter:1, call_parameter:input_number, for:i (-> +1), for_range_start (-> +1), function_call:range, int_literal, literal:Num
...
def factorial(n: int) -> int: # body_recursive_function:factorial (-> +5), function:factorial (-> +5), function_returning_something:factorial (-> +5), recursive_function:factorial (-> +5)
    ...
    if not isinstance(n, int): # call_parameter:int, call_parameter:n, function_call:isinstance, if (-> +1), if_test_id:int, if_test_id:isinstance, if_test_id:n, unary_operator:Not
        raise ValueError("factorial() only accepts integral values") # call_parameter:, function_call:ValueError, if_then_branch, literal:Str, raise:ValueError
    return 1 if n == 0 or n == 1 else n * factorial(n - 1) # binary_operator:Mult, binary_operator:Sub, boolean_operator:Or, call_parameter:, comparison_operator:Eq, conditional_expression, function_call:factorial, int_literal, literal:Num, return
...
def factors_of_a_number(num: int) -> list: # function:factors_of_a_number (-> +1), function_returning_something:factors_of_a_number (-> +1)
    return [i for i in range(1, num + 1) if num % i == 0] # binary_operator:Add, binary_operator:Mod, call_parameter:, call_parameter:1, comparison_operator:Eq, comprehension:List, comprehension_for_count:1, divisibility_test, filtered_comprehension, function_call:range, int_literal, literal:Num, return
...
def binary_exponentiation(a, n, mod): # body_recursive_function:binary_exponentiation (-> +7), function:binary_exponentiation (-> +7), function_returning_something:binary_exponentiation (-> +7), recursive_function:binary_exponentiation (-> +7)
    if n == 0: # comparison_operator:Eq, if (-> +6), if_test_id:n, int_literal, literal:Num
        ...
        return (binary_exponentiation(a, n - 1, mod) * a) % mod # binary_operator:Mod, binary_operator:Mult, binary_operator:Sub, call_parameter:, call_parameter:a, call_parameter:mod, function_call:binary_exponentiation, if_elif_branch, int_literal, literal:Num, return
    else:
        b = binary_exponentiation(a, n / 2, mod) # assignment, assignment_lhs_identifier:b, assignment_rhs_identifier:a, assignment_rhs_identifier:binary_exponentiation, assignment_rhs_identifier:mod, assignment_rhs_identifier:n, binary_operator:Div, call_parameter:, call_parameter:a, call_parameter:mod, function_call:binary_exponentiation, if_else_branch (-> +1), int_literal, literal:Num
...
print((a / b) % p == (a * binary_exponentiation(b, p - 2, p)) % p) # binary_operator:Div, binary_operator:Mod, binary_operator:Mult, binary_operator:Sub, call_parameter:, call_parameter:b, call_parameter:p, comparison_operator:Eq, composition, divisibility_test, function_call:binary_exponentiation, function_call:print, int_literal, literal:Num
print((a / b) % p == (a * b ** (p - 2)) % p) # binary_operator:Div, binary_operator:Mod, binary_operator:Mult, binary_operator:Pow, binary_operator:Sub, call_parameter:, comparison_operator:Eq, divisibility_test, function_call:print, int_literal, literal:Num
...
def timer_decorator(func): # closure:timer_decorator (-> +10), function:timer_decorator (-> +10), function_returning_something:timer_decorator (-> +10), nested_function:timer_decorator (-> +10)
    def timer_wrapper(*args, **kwargs): # function:timer_wrapper (-> +8), function_returning_something:timer_wrapper (-> +8)
        ...
        func(*args, **kwargs) # call_parameter:, function_call:func
        end = time.time() # assignment, assignment_lhs_identifier:end, assignment_rhs_identifier:time, method_call:time
        if int(end - start) > 0: # binary_operator:Sub, call_parameter:, comparison_operator:Gt, function_call:int, if (-> +3), if_test_id:end, if_test_id:int, if_test_id:start, int_literal, literal:Num
            print(f"Run time for {func.__name__}: {(end - start):0.2f}s") # binary_operator:Sub, call_parameter:, function_call:print, if_then_branch, literal:Str
        else:
            print(f"Run time for {func.__name__}: {(end - start)*1000:0.2f}ms") # binary_operator:Mult, binary_operator:Sub, call_parameter:, function_call:print, if_else_branch, int_literal, literal:Num, literal:Str, suggest_constant_definition
        return func(*args, **kwargs) # call_parameter:, function_call:func, return
...
def _check_number_input(n, min_thresh, max_thresh=None): # function:_check_number_input (-> +22), function_returning_something:_check_number_input (-> +22), function_with_default_positional_arguments:_check_number_input (-> +22), literal:None
    try: # try (-> +19), try_except:ValueLessThanZero (-> +19), try_except:ValueTooLargeError (-> +19), try_except:ValueTooSmallError (-> +19), try_raise:ValueLessThanZero (-> +19), try_raise:ValueTooLargeError (-> +19), try_raise:ValueTooSmallError (-> +19)
        ...
        print("Incorrect Input: number must not be less than 0") # call_parameter:, function_call:print, literal:Str
    except ValueTooSmallError: # except:ValueTooSmallError
        print( # function_call:print
            f"Incorrect Input: input number must be > {min_thresh} for the recursive calculation" # call_parameter:, literal:Str
        )
    except ValueTooLargeError: # except:ValueTooLargeError
        print( # function_call:print
            f"Incorrect Input: input number must be < {max_thresh} for the recursive calculation" # call_parameter:, literal:Str
        )
...
def fib_iterative(n): # function:fib_iterative (-> +8), function_returning_something:fib_iterative (-> +8)
    ...
    if _check_number_input(n, 2): # call_parameter:2, call_parameter:n, function_call:_check_number_input, if (-> +6), if_test_id:_check_number_input, if_test_id:n, int_literal, literal:Num
        ...
        for _ in range(n - len(seq_out)): # binary_operator:Sub, call_parameter:, call_parameter:seq_out, composition, for:_ (-> +2), for_range_stop (-> +2), function_call:len, function_call:range
...
def fib_formula(n): # function:fib_formula (-> +12), function_returning_something:fib_formula (-> +12)
    ...
    n = int(n) # assignment, assignment_lhs_identifier:n, assignment_rhs_identifier:int, assignment_rhs_identifier:n, call_parameter:n, function_call:int
    if _check_number_input(n, 2, 1000000): # call_parameter:1000000, call_parameter:2, call_parameter:n, function_call:_check_number_input, if (-> +9), if_test_id:_check_number_input, if_test_id:n, int_literal, literal:Num, suggest_constant_definition
        sqrt = Decimal(math.sqrt(5)) # assignment, assignment_lhs_identifier:sqrt, assignment_rhs_identifier:Decimal, assignment_rhs_identifier:math, call_parameter:, call_parameter:5, composition, function_call:Decimal, if_then_branch (-> +8), int_literal, literal:Num, method_call:sqrt, suggest_constant_definition
        phi_1 = Decimal(1 + sqrt) / Decimal(2) # assignment, assignment_lhs_identifier:phi_1, assignment_rhs_identifier:Decimal, assignment_rhs_identifier:sqrt, binary_operator:Add, binary_operator:Div, call_parameter:, call_parameter:2, function_call:Decimal, int_literal, literal:Num
        phi_2 = Decimal(1 - sqrt) / Decimal(2) # assignment, assignment_lhs_identifier:phi_2, assignment_rhs_identifier:Decimal, assignment_rhs_identifier:sqrt, binary_operator:Div, binary_operator:Sub, call_parameter:, call_parameter:2, function_call:Decimal, int_literal, literal:Num
        for i in range(2, n): # call_parameter:2, call_parameter:n, for:i (-> +4), for_range_start (-> +4), function_call:range, int_literal, literal:Num
            temp_out = ((phi_1 ** Decimal(i)) - (phi_2 ** Decimal(i))) * ( # assignment, assignment_lhs_identifier:temp_out, assignment_rhs_identifier:Decimal, assignment_rhs_identifier:i, assignment_rhs_identifier:phi_1, assignment_rhs_identifier:phi_2, binary_operator:Mult, binary_operator:Pow, binary_operator:Sub, call_parameter:i, function_call:Decimal
                Decimal(sqrt) ** Decimal(-1) # assignment_rhs_identifier:Decimal, assignment_rhs_identifier:sqrt, binary_operator:Pow, call_parameter:-1, call_parameter:sqrt, function_call:Decimal, int_literal, literal:Num
            )
            seq_out.append(int(temp_out)) # call_parameter:, call_parameter:temp_out, composition, function_call:int, method_call:append, method_call_object:seq_out
        return seq_out # return:seq_out
...
def recur_fibo(n): # body_recursive_function:recur_fibo (-> +1), function:recur_fibo (-> +1), function_returning_something:recur_fibo (-> +1), recursive_function:recur_fibo (-> +1)
    return n if n <= 1 else recur_fibo(n - 1) + recur_fibo(n - 2) # binary_operator:Add, binary_operator:Sub, call_parameter:, comparison_operator:LtE, conditional_expression, function_call:recur_fibo, int_literal, literal:Num, return
def main(): # function:main (-> +6), function_returning_nothing:main (-> +6)
    limit = int(input("How many terms to include in fibonacci series: ")) # assignment, assignment_lhs_identifier:limit, assignment_rhs_identifier:input, assignment_rhs_identifier:int, call_parameter:, composition, function_call:input, function_call:int, literal:Str
    if limit > 0: # comparison_operator:Gt, if (-> +4), if_test_id:limit, int_literal, literal:Num
        print(f"The first {limit} terms of the fibonacci series are as follows:") # call_parameter:, function_call:print, if_then_branch (-> +1), literal:Str
        print([recur_fibo(n) for n in range(limit)]) # call_parameter:, call_parameter:limit, call_parameter:n, composition, comprehension:List, comprehension_for_count:1, function_call:print, function_call:range, function_call:recur_fibo
    else:
        print("Please enter a positive integer: ") # call_parameter:, function_call:print, if_else_branch, literal:Str
...
def main(): # function:main (-> +1), function_returning_nothing:main (-> +1)
    print(find_max([2, 4, 9, 7, 19, 94, 5])) # call_parameter:, composition, function_call:find_max, function_call:print, int_literal, literal:List, literal:Num, suggest_constant_definition
...
def main(): # function:main (-> +1), function_returning_nothing:main (-> +1)
    assert find_min([0, 1, 2, 3, 4, 5, -3, 24, -56]) == -56 # assertion, call_parameter:, comparison_operator:Eq, function_call:find_min, int_literal, literal:List, literal:Num, suggest_constant_definition
...
def floor(x) -> int: # function:floor (-> +2), function_returning_something:floor (-> +2)
    return ( # return
        x if isinstance(x, int) or x - int(x) == 0 else int(x) if x > 0 else int(x - 1) # binary_operator:Sub, boolean_operator:Or, call_parameter:, call_parameter:int, call_parameter:x, comparison_operator:Eq, comparison_operator:Gt, conditional_expression, function_call:int, function_call:isinstance, int_literal, literal:Num
    )
...
def gaussian(x, mu: float = 0.0, sigma: float = 1.0) -> int: # float_literal, function:gaussian (-> +1), function_returning_something:gaussian (-> +1), function_with_default_positional_arguments:gaussian (-> +1), literal:Num
    return 1 / sqrt(2 * pi * sigma ** 2) * exp(-((x - mu) ** 2) / 2 * sigma ** 2) # binary_operator:Div, binary_operator:Mult, binary_operator:Pow, binary_operator:Sub, call_parameter:, function_call:exp, function_call:sqrt, int_literal, literal:Num, return, unary_operator:USub
...
def greatest_common_divisor(a, b): # function:greatest_common_divisor (-> +1), function_returning_something:greatest_common_divisor (-> +1), recursive_function:greatest_common_divisor (-> +1)
    return b if a == 0 else greatest_common_divisor(b % a, a) # binary_operator:Mod, call_parameter:, call_parameter:a, comparison_operator:Eq, conditional_expression, function_call:greatest_common_divisor, int_literal, literal:Num, return
...
def main(): # function:main (-> +10), function_returning_nothing:main (-> +10)
    try: # try (-> +9), try_except:IndexError (-> +9), try_except:UnboundLocalError (-> +9), try_except:ValueError (-> +9)
        nums = input("Enter two integers separated by comma (,): ").split(",") # assignment, assignment_lhs_identifier:nums, assignment_rhs_identifier:input, call_parameter:, function_call:input, literal:Str, method_call:split
        num_1 = int(nums[0]) # assignment, assignment_lhs_identifier:num_1, assignment_rhs_identifier:int, assignment_rhs_identifier:nums, call_parameter:, function_call:int, index, int_literal, literal:Num
        num_2 = int(nums[1]) # assignment, assignment_lhs_identifier:num_2, assignment_rhs_identifier:int, assignment_rhs_identifier:nums, call_parameter:, function_call:int, index, int_literal, literal:Num
        print( # composition, function_call:print
            f"greatest_common_divisor({num_1}, {num_2}) = {greatest_common_divisor(num_1, num_2)}" # call_parameter:, call_parameter:num_1, call_parameter:num_2, function_call:greatest_common_divisor, literal:Str
        )
        print(f"By iterative gcd({num_1}, {num_2}) = {gcd_by_iterative(num_1, num_2)}") # call_parameter:, call_parameter:num_1, call_parameter:num_2, composition, function_call:gcd_by_iterative, function_call:print, literal:Str
    except (IndexError, UnboundLocalError, ValueError): # except:IndexError, except:UnboundLocalError, except:ValueError
        print("Wrong input") # call_parameter:, function_call:print, literal:Str
...
def exactPrimeFactorCount(n): # function:exactPrimeFactorCount (-> +15), function_returning_something:exactPrimeFactorCount (-> +15)
    ...
    while i <= int(math.sqrt(n)): # call_parameter:, call_parameter:n, comparison_operator:LtE, composition, evolve_state (-> +5), function_call:int, method_call:sqrt, while (-> +5)
...
def is_square_free(factors: List[int]) -> bool: # function:is_square_free (-> +1), function_returning_something:is_square_free (-> +1), index
    return len(set(factors)) == len(factors) # call_parameter:, call_parameter:factors, comparison_operator:Eq, composition, function_call:len, function_call:set, return
...
def jaccard_similariy(setA, setB, alternativeUnion=False): # function:jaccard_similariy (-> +14), function_returning_something:jaccard_similariy (-> +14), function_with_default_positional_arguments:jaccard_similariy (-> +14), literal:False
    if isinstance(setA, set) and isinstance(setB, set): # boolean_operator:And, call_parameter:set, call_parameter:setA, call_parameter:setB, function_call:isinstance, if (-> +6), if_test_id:isinstance, if_test_id:set, if_test_id:setA, if_test_id:setB
        intersection = len(setA.intersection(setB)) # assignment, assignment_lhs_identifier:intersection, assignment_rhs_identifier:len, assignment_rhs_identifier:setA, assignment_rhs_identifier:setB, call_parameter:, call_parameter:setB, composition, function_call:len, if_then_branch (-> +5), method_call:intersection
        if alternativeUnion: # if (-> +3), nested_if:1 (-> +3), suggest_conditional_expression (-> +3)
            ...
            union = len(setA.union(setB)) # assignment, assignment_lhs_identifier:union, assignment_rhs_identifier:len, assignment_rhs_identifier:setA, assignment_rhs_identifier:setB, call_parameter:, call_parameter:setB, composition, function_call:len, if_else_branch, method_call:union
        return intersection / union # binary_operator:Div, return
    if isinstance(setA, (list, tuple)) and isinstance(setB, (list, tuple)): # boolean_operator:And, call_parameter:, call_parameter:setA, call_parameter:setB, function_call:isinstance, if (-> +6), if_test_id:isinstance, if_test_id:list, if_test_id:setA, if_test_id:setB, if_test_id:tuple
...
def karatsuba(a, b): # body_recursive_function:karatsuba (-> +11), function:karatsuba (-> +11), function_returning_something:karatsuba (-> +11), recursive_function:karatsuba (-> +11)
    if len(str(a)) == 1 or len(str(b)) == 1: # boolean_operator:Or, call_parameter:, call_parameter:a, call_parameter:b, comparison_operator:Eq, composition, function_call:len, function_call:str, if (-> +10), if_test_id:a, if_test_id:b, if_test_id:len, if_test_id:str, int_literal, literal:Num
        return a * b # binary_operator:Mult, if_then_branch, return
    else:
        m1 = max(len(str(a)), len(str(b))) # assignment, assignment_lhs_identifier:m1, assignment_rhs_identifier:a, assignment_rhs_identifier:b, assignment_rhs_identifier:len, assignment_rhs_identifier:max, assignment_rhs_identifier:str, call_parameter:, call_parameter:a, call_parameter:b, composition, function_call:len, function_call:max, function_call:str, if_else_branch (-> +7)
        ...
        a1, a2 = divmod(a, 10 ** m2) # assignment, assignment_lhs_identifier:a1, assignment_lhs_identifier:a2, assignment_rhs_identifier:a, assignment_rhs_identifier:divmod, assignment_rhs_identifier:m2, binary_operator:Pow, call_parameter:, call_parameter:a, function_call:divmod, int_literal, literal:Num, suggest_constant_definition
        b1, b2 = divmod(b, 10 ** m2) # assignment, assignment_lhs_identifier:b1, assignment_lhs_identifier:b2, assignment_rhs_identifier:b, assignment_rhs_identifier:divmod, assignment_rhs_identifier:m2, binary_operator:Pow, call_parameter:, call_parameter:b, function_call:divmod, int_literal, literal:Num, suggest_constant_definition
        ...
        y = karatsuba((a1 + a2), (b1 + b2)) # assignment, assignment_lhs_identifier:y, assignment_rhs_identifier:a1, assignment_rhs_identifier:a2, assignment_rhs_identifier:b1, assignment_rhs_identifier:b2, assignment_rhs_identifier:karatsuba, binary_operator:Add, call_parameter:, function_call:karatsuba
...
def main(): # function:main (-> +1), function_returning_nothing:main (-> +1)
    print(karatsuba(15463, 23489)) # call_parameter:, call_parameter:15463, call_parameter:23489, composition, function_call:karatsuba, function_call:print, int_literal, literal:Num, suggest_constant_definition
...
def kthPermutation(k, n): # function:kthPermutation (-> +13), function_returning_something:kthPermutation (-> +13)
    ...
    for i in range(2, n): # call_parameter:2, call_parameter:n, for:i (-> +1), for_range_start (-> +1), function_call:range, int_literal, literal:Num
        factorials.append(factorials[-1] * i) # binary_operator:Mult, call_parameter:, index, int_literal, literal:Num, method_call:append, method_call_object:factorials, negative_index:-1
    ...
    elements = list(range(n)) # assignment, assignment_lhs_identifier:elements, assignment_rhs_identifier:list, assignment_rhs_identifier:n, assignment_rhs_identifier:range, call_parameter:, call_parameter:n, composition, function_call:list, function_call:range
    while factorials: # while (-> +4)
        ...
        permutation.append(elements[number]) # call_parameter:, index, method_call:append, method_call_object:permutation
        elements.remove(elements[number]) # call_parameter:, index, method_call:remove, method_call_object:elements
    permutation.append(elements[0]) # call_parameter:, index, int_literal, literal:Num, method_call:append, method_call_object:permutation
...
class TestLeastCommonMultiple(unittest.TestCase):
    ...
    def test_lcm_function(self): # function:test_lcm_function (-> +4), function_returning_nothing:test_lcm_function (-> +4)
        for i, (first_num, second_num) in enumerate(self.test_inputs): # call_parameter:, for:i:first_num:second_num (-> +3), for_indexes_elements (-> +3), function_call:enumerate
            ...
            with self.subTest(i=i): # method_call:subTest
                self.assertEqual(actual_result, self.expected_results[i]) # call_parameter:, call_parameter:actual_result, index, method_call:assertEqual, method_call_object:self
...
def recur_luc(n): # body_recursive_function:recur_luc (-> +5), function:recur_luc (-> +5), function_returning_something:recur_luc (-> +5), recursive_function:recur_luc (-> +5)
    ...
    return recur_luc(n - 1) + recur_luc(n - 2) # binary_operator:Add, binary_operator:Sub, call_parameter:, function_call:recur_luc, int_literal, literal:Num, return
...
class Matrix(object):
    def __init__(self, arg): # function:__init__ (-> +6), function_returning_nothing:__init__ (-> +6)
        if isinstance(arg, list): # call_parameter:arg, call_parameter:list, function_call:isinstance, if (-> +5), if_test_id:arg, if_test_id:isinstance, if_test_id:list
            ...
            self.t = [[0 for _ in range(self.n)] for _ in range(self.n)] # assignment, assignment_lhs_identifier:self, assignment_rhs_identifier:_, assignment_rhs_identifier:range, assignment_rhs_identifier:self, call_parameter:, comprehension:List, comprehension_for_count:1, function_call:range, int_literal, literal:Num
    def __mul__(self, b): # function:__mul__ (-> +6), function_returning_something:__mul__ (-> +6)
        matrix = Matrix(self.n) # assignment, assignment_lhs_identifier:matrix, assignment_rhs_identifier:Matrix, assignment_rhs_identifier:self, call_parameter:, function_call:Matrix
        for i in range(self.n): # accumulate_elements:1 (-> +3), call_parameter:, for:i (-> +3), for_range_stop (-> +3), function_call:range, square_nested_for (-> +3)
            for j in range(self.n): # accumulate_elements:1 (-> +2), call_parameter:, for:j (-> +2), for_range_stop (-> +2), function_call:range, nested_for:1 (-> +2), square_nested_for (-> +2)
                for k in range(self.n): # accumulate_elements:1 (-> +1), call_parameter:, for:k (-> +1), for_range_stop (-> +1), function_call:range, nested_for:2 (-> +1)
...
def modular_exponentiation(a, b): # function:modular_exponentiation (-> +7), function_returning_something:modular_exponentiation (-> +7)
    matrix = Matrix([[1, 0], [0, 1]]) # assignment, assignment_lhs_identifier:matrix, assignment_rhs_identifier:Matrix, call_parameter:, function_call:Matrix, int_literal, literal:List, literal:Num
...
def fibonacci_with_matrix_exponentiation(n, f1, f2): # function:fibonacci_with_matrix_exponentiation (-> +7), function_returning_something:fibonacci_with_matrix_exponentiation (-> +7)
    ...
    matrix = Matrix([[1, 1], [1, 0]]) # assignment, assignment_lhs_identifier:matrix, assignment_rhs_identifier:Matrix, call_parameter:, function_call:Matrix, int_literal, literal:List, literal:Num
    matrix = modular_exponentiation(matrix, n - 2) # assignment, assignment_lhs_identifier:matrix, assignment_rhs_identifier:matrix, assignment_rhs_identifier:modular_exponentiation, assignment_rhs_identifier:n, binary_operator:Sub, call_parameter:, call_parameter:matrix, function_call:modular_exponentiation, int_literal, literal:Num
...
""" # literal:Str
    ...
    print("With matrix exponentiation the average execution time is ", exec_time / 100) # binary_operator:Div, call_parameter:, function_call:print, int_literal, literal:Num, literal:Str, suggest_constant_definition
...
""" # literal:Str
    ...
    exec_time = timeit.timeit(setup=setup, stmt=code, number=100) # assignment, assignment_lhs_identifier:exec_time, assignment_rhs_identifier:code, assignment_rhs_identifier:setup, assignment_rhs_identifier:timeit, int_literal, literal:Num, method_call:timeit, suggest_constant_definition
    print( # function_call:print
        "Without matrix exponentiation the average execution time is ", exec_time / 100 # binary_operator:Div, call_parameter:, int_literal, literal:Num, literal:Str, suggest_constant_definition
    )
    return exec_time # return:exec_time
def main(): # function:main (-> +2), function_returning_nothing:main (-> +2)
...
def modular_exponential(base, power, mod): # function:modular_exponential (-> +10), function_returning_something:modular_exponential (-> +10)
    ...
    return result # return:result
def main(): # function:main (-> +1), function_returning_nothing:main (-> +1)
    print(modular_exponential(3, 200, 13)) # call_parameter:, call_parameter:13, call_parameter:200, call_parameter:3, composition, function_call:modular_exponential, function_call:print, int_literal, literal:Num, suggest_constant_definition
...
def calc_derivative(f, a, h=0.001): # float_literal, function:calc_derivative (-> +1), function_returning_something:calc_derivative (-> +1), function_with_default_positional_arguments:calc_derivative (-> +1), literal:Num
    return (f(a + h) - f(a - h)) / (2 * h) # binary_operator:Add, binary_operator:Div, binary_operator:Mult, binary_operator:Sub, call_parameter:, function_call:f, int_literal, literal:Num, return
def newton_raphson(f, x0=0, maxiter=100, step=0.0001, maxerror=1e-6, logsteps=False): # float_literal, function:newton_raphson (-> +17), function_returning_something:newton_raphson (-> +17), function_with_default_positional_arguments:newton_raphson (-> +17), int_literal, literal:False, literal:Num
    ...
    error = abs(f(a)) # assignment, assignment_lhs_identifier:error, assignment_rhs_identifier:a, assignment_rhs_identifier:abs, assignment_rhs_identifier:f, call_parameter:, call_parameter:a, composition, function_call:abs, function_call:f
    ...
    for _ in range(maxiter): # call_parameter:maxiter, for:_ (-> +9), for_range_stop (-> +9), function_call:range
        if f1(a) == 0: # call_parameter:a, comparison_operator:Eq, function_call:f1, if (-> +1), if_test_id:a, if_test_id:f1, int_literal, literal:Num
            raise ValueError("No converging solution found") # call_parameter:, function_call:ValueError, if_then_branch, literal:Str, raise:ValueError
        ...
        raise ValueError("Iteration limit reached, no converging solution found") # call_parameter:, function_call:ValueError, literal:Str, raise:ValueError
    if logsteps: # if (-> +1)
...
def evaluate_poly(poly: Sequence[float], x: float) -> float: # function:evaluate_poly (-> +1), function_returning_something:evaluate_poly (-> +1), index
    return sum(c * (x ** i) for i, c in enumerate(poly)) # binary_operator:Mult, binary_operator:Pow, call_parameter:, call_parameter:poly, composition, comprehension:Generator, comprehension_for_count:1, function_call:enumerate, function_call:sum, return
...
def prime_check(number): # function:prime_check (-> +8), function_returning_something:prime_check (-> +8)
    ...
    if number % 2 == 0: # binary_operator:Mod, comparison_operator:Eq, divisibility_test:2, if (-> +1), if_test_id:number, int_literal, literal:Num
        return False # if_then_branch, literal:False, return:False
    odd_numbers = range(3, int(math.sqrt(number)) + 1, 2) # assignment, assignment_lhs_identifier:odd_numbers, assignment_rhs_identifier:int, assignment_rhs_identifier:math, assignment_rhs_identifier:number, assignment_rhs_identifier:range, binary_operator:Add, call_parameter:, call_parameter:2, call_parameter:3, call_parameter:number, composition, function_call:int, function_call:range, int_literal, literal:Num, method_call:sqrt, suggest_constant_definition
    return not any(number % i == 0 for i in odd_numbers) # binary_operator:Mod, call_parameter:, comparison_operator:Eq, comprehension:Generator, comprehension_for_count:1, divisibility_test, function_call:any, int_literal, literal:Num, return, unary_operator:Not
class Test(unittest.TestCase):
    def test_primes(self): # function:test_primes (-> +10), function_returning_nothing:test_primes (-> +10)
        self.assertTrue(prime_check(2)) # call_parameter:, call_parameter:2, composition, function_call:prime_check, int_literal, literal:Num, method_call:assertTrue, method_call_object:self
        self.assertTrue(prime_check(3)) # call_parameter:, call_parameter:3, composition, function_call:prime_check, int_literal, literal:Num, method_call:assertTrue, method_call_object:self, suggest_constant_definition
        self.assertTrue(prime_check(5)) # call_parameter:, call_parameter:5, composition, function_call:prime_check, int_literal, literal:Num, method_call:assertTrue, method_call_object:self, suggest_constant_definition
        self.assertTrue(prime_check(7)) # call_parameter:, call_parameter:7, composition, function_call:prime_check, int_literal, literal:Num, method_call:assertTrue, method_call_object:self, suggest_constant_definition
        self.assertTrue(prime_check(11)) # call_parameter:, call_parameter:11, composition, function_call:prime_check, int_literal, literal:Num, method_call:assertTrue, method_call_object:self, suggest_constant_definition
        self.assertTrue(prime_check(13)) # call_parameter:, call_parameter:13, composition, function_call:prime_check, int_literal, literal:Num, method_call:assertTrue, method_call_object:self, suggest_constant_definition
        self.assertTrue(prime_check(17)) # call_parameter:, call_parameter:17, composition, function_call:prime_check, int_literal, literal:Num, method_call:assertTrue, method_call_object:self, suggest_constant_definition
        self.assertTrue(prime_check(19)) # call_parameter:, call_parameter:19, composition, function_call:prime_check, int_literal, literal:Num, method_call:assertTrue, method_call_object:self, suggest_constant_definition
        self.assertTrue(prime_check(23)) # call_parameter:, call_parameter:23, composition, function_call:prime_check, int_literal, literal:Num, method_call:assertTrue, method_call_object:self, suggest_constant_definition
        self.assertTrue(prime_check(29)) # call_parameter:, call_parameter:29, composition, function_call:prime_check, int_literal, literal:Num, method_call:assertTrue, method_call_object:self, suggest_constant_definition
    def test_not_primes(self): # function:test_not_primes (-> +12), function_returning_nothing:test_not_primes (-> +12)
        self.assertFalse(prime_check(-19), "Negative numbers are not prime.") # call_parameter:, call_parameter:-19, composition, function_call:prime_check, int_literal, literal:Num, literal:Str, method_call:assertFalse, method_call_object:self, suggest_constant_definition
        self.assertFalse( # composition, method_call:assertFalse, method_call_object:self
            prime_check(0), "Zero doesn't have any divider, primes must have two" # call_parameter:, call_parameter:0, function_call:prime_check, int_literal, literal:Num, literal:Str
        )
        self.assertFalse( # composition, method_call:assertFalse, method_call_object:self
            prime_check(1), "One just have 1 divider, primes must have two." # call_parameter:, call_parameter:1, function_call:prime_check, int_literal, literal:Num, literal:Str
        )
        self.assertFalse(prime_check(2 * 2)) # binary_operator:Mult, call_parameter:, composition, function_call:prime_check, int_literal, literal:Num, method_call:assertFalse, method_call_object:self
        self.assertFalse(prime_check(2 * 3)) # binary_operator:Mult, call_parameter:, composition, function_call:prime_check, int_literal, literal:Num, method_call:assertFalse, method_call_object:self, suggest_constant_definition
        self.assertFalse(prime_check(3 * 3)) # binary_operator:Mult, call_parameter:, composition, function_call:prime_check, int_literal, literal:Num, method_call:assertFalse, method_call_object:self, suggest_constant_definition
        self.assertFalse(prime_check(3 * 5)) # binary_operator:Mult, call_parameter:, composition, function_call:prime_check, int_literal, literal:Num, method_call:assertFalse, method_call_object:self, suggest_constant_definition
        self.assertFalse(prime_check(3 * 5 * 7)) # binary_operator:Mult, call_parameter:, composition, function_call:prime_check, int_literal, literal:Num, method_call:assertFalse, method_call_object:self, suggest_constant_definition
...
def primes(max: int) -> List[int]: # function:primes (-> +9), function_returning_something:primes (-> +9), index
    ...
    for i in range(2, max): # accumulate_elements:1 (-> +4), call_parameter:2, call_parameter:max, for:i (-> +4), for_range_start (-> +4), function_call:range, int_literal, literal:Num
...
def prime_sieve_eratosthenes(num): # function:prime_sieve_eratosthenes (-> +10), function_returning_nothing:prime_sieve_eratosthenes (-> +10)
    ...
    while p * p <= num: # binary_operator:Mult, comparison_operator:LtE, while (-> +4)
        if primes[p] == True: # comparison_operator:Eq, if (-> +2), if_test_id:p, if_test_id:primes, index, literal:True
            for i in range(p * p, num + 1, p): # binary_operator:Add, binary_operator:Mult, call_parameter:, call_parameter:p, for:i (-> +1), for_range_step (-> +1), function_call:range, if_then_branch (-> +1), int_literal, literal:Num
    ...
    for prime in range(2, num + 1): # binary_operator:Add, call_parameter:, call_parameter:2, for:prime (-> +2), for_range_start (-> +2), function_call:range, int_literal, literal:Num
...
def qr_householder(A): # function:qr_householder (-> +16), function_returning_something:qr_householder (-> +16)
    ...
    for k in range(t - 1): # accumulate_elements:1 (-> +10), binary_operator:Sub, call_parameter:, for:k (-> +10), for_range_stop (-> +10), function_call:range, int_literal, literal:Num
        ...
        v = x + np.sign(x[0]) * alpha * e1 # assignment, assignment_lhs_identifier:v, assignment_rhs_identifier:alpha, assignment_rhs_identifier:e1, assignment_rhs_identifier:np, assignment_rhs_identifier:x, binary_operator:Add, binary_operator:Mult, call_parameter:, index, int_literal, literal:Num, method_call:sign
...
def QuadraticEquation(a: int, b: int, c: int) -> Tuple[str, str]: # function:QuadraticEquation (-> +10), function_returning_something:QuadraticEquation (-> +10), index
    if a == 0: # comparison_operator:Eq, if (-> +1), if_test_id:a, int_literal, literal:Num
        raise ValueError("Coefficient 'a' must not be zero for quadratic equations.") # call_parameter:, function_call:ValueError, if_then_branch, literal:Str, raise:ValueError
    ...
    if delta >= 0: # comparison_operator:GtE, if (-> +1), if_test_id:delta, int_literal, literal:Num
        return str((-b + sqrt(delta)) / (2 * a)), str((-b - sqrt(delta)) / (2 * a)) # binary_operator:Add, binary_operator:Div, binary_operator:Mult, binary_operator:Sub, call_parameter:, call_parameter:delta, composition, function_call:sqrt, function_call:str, if_then_branch, int_literal, literal:Num, return, unary_operator:USub
    snd = sqrt(-delta) # assignment, assignment_lhs_identifier:snd, assignment_rhs_identifier:delta, assignment_rhs_identifier:sqrt, call_parameter:, function_call:sqrt, unary_operator:USub
...
def main(): # function:main (-> +2), function_returning_nothing:main (-> +2)
    ...
    print("The equation solutions are: {} and {}".format(*solutions)) # call_parameter:, composition, function_call:print, literal:Str, method_call:format
...
class FFT:
    def __init__(self, polyA=[0], polyB=[0]): # function:__init__ (-> +17), function_returning_nothing:__init__ (-> +17), function_with_default_positional_arguments:__init__ (-> +17), int_literal, literal:List, literal:Num
        ...
        self.len_A = len(self.polyA) # assignment, assignment_lhs_identifier:self, assignment_rhs_identifier:len, assignment_rhs_identifier:self, call_parameter:, function_call:len
        ...
        self.len_B = len(self.polyB) # assignment, assignment_lhs_identifier:self, assignment_rhs_identifier:len, assignment_rhs_identifier:self, call_parameter:, function_call:len
        self.C_max_length = int( # assignment, assignment_lhs_identifier:self, assignment_rhs_identifier:int, composition, function_call:int
            2 ** np.ceil(np.log2(len(self.polyA) + len(self.polyB) - 1)) # assignment_rhs_identifier:len, assignment_rhs_identifier:np, assignment_rhs_identifier:self, binary_operator:Add, binary_operator:Pow, binary_operator:Sub, call_parameter:, composition, function_call:len, int_literal, literal:Num, method_call:ceil, method_call:log2
        )
        while len(self.polyA) < self.C_max_length: # call_parameter:, comparison_operator:Lt, evolve_state (-> +1), function_call:len, while (-> +1)
            self.polyA.append(0) # call_parameter:0, int_literal, literal:Num, method_call:append
        while len(self.polyB) < self.C_max_length: # call_parameter:, comparison_operator:Lt, evolve_state (-> +1), function_call:len, while (-> +1)
            self.polyB.append(0) # call_parameter:0, int_literal, literal:Num, method_call:append
        self.root = complex(mpmath.root(x=1, n=self.C_max_length, k=1)) # assignment, assignment_lhs_identifier:self, assignment_rhs_identifier:complex, assignment_rhs_identifier:mpmath, assignment_rhs_identifier:self, call_parameter:, composition, function_call:complex, int_literal, literal:Num, method_call:root
    ...
    def __DFT(self, which): # function:__DFT (-> +23), function_returning_something:__DFT (-> +23)
        ...
        while next_ncol > 0: # comparison_operator:Gt, evolve_state (-> +14), int_literal, literal:Num, while (-> +14)
            ...
            for j in range(self.C_max_length // (next_ncol * 2)): # binary_operator:FloorDiv, binary_operator:Mult, call_parameter:, for:j (-> +3), for_range_stop (-> +3), function_call:range, int_literal, literal:Num
                for i in range(next_ncol): # call_parameter:next_ncol, for:i (-> +1), for_range_stop (-> +1), function_call:range, nested_for:1 (-> +1)
                    new_dft[i].append(dft[i][j] + current_root * dft[i + next_ncol][j]) # binary_operator:Add, binary_operator:Mult, call_parameter:, index, index_arithmetic, method_call:append
                current_root *= root # assignment_lhs_identifier:current_root, assignment_rhs_identifier:root, augmented_assignment
            current_root = 1 # assignment, assignment_lhs_identifier:current_root, int_literal, literal:Num
            for j in range(self.C_max_length // (next_ncol * 2)): # binary_operator:FloorDiv, binary_operator:Mult, call_parameter:, for:j (-> +3), for_range_stop (-> +3), function_call:range, int_literal, literal:Num
                for i in range(next_ncol): # call_parameter:next_ncol, for:i (-> +1), for_range_stop (-> +1), function_call:range, nested_for:1 (-> +1)
                    new_dft[i].append(dft[i][j] - current_root * dft[i + next_ncol][j]) # binary_operator:Add, binary_operator:Mult, binary_operator:Sub, call_parameter:, index, index_arithmetic, method_call:append
                current_root *= root # assignment_lhs_identifier:current_root, assignment_rhs_identifier:root, augmented_assignment
    ...
    def __multiply(self): # function:__multiply (-> +35), function_returning_something:__multiply (-> +35)
        dftA = self.__DFT("A") # assignment, assignment_lhs_identifier:dftA, assignment_rhs_identifier:self, call_parameter:, literal:Str, method_call:__DFT
        dftB = self.__DFT("B") # assignment, assignment_lhs_identifier:dftB, assignment_rhs_identifier:self, call_parameter:, literal:Str, method_call:__DFT
        inverseC = [[dftA[i] * dftB[i] for i in range(self.C_max_length)]] # assignment, assignment_lhs_identifier:inverseC, assignment_rhs_identifier:dftA, assignment_rhs_identifier:dftB, assignment_rhs_identifier:i, assignment_rhs_identifier:range, assignment_rhs_identifier:self, binary_operator:Mult, call_parameter:, comprehension:List, comprehension_for_count:1, function_call:range, index
        del dftA
        del dftB
        if len(inverseC[0]) <= 1: # call_parameter:, comparison_operator:LtE, function_call:len, if (-> +1), if_test_id:inverseC, if_test_id:len, index, int_literal, literal:Num
        ...
        while next_ncol <= self.C_max_length: # comparison_operator:LtE, evolve_state (-> +22), while (-> +22)
            ...
            current_root = 1 # assignment, assignment_lhs_identifier:current_root, int_literal, literal:Num
            for j in range(self.C_max_length // next_ncol): # binary_operator:FloorDiv, call_parameter:, for:j (-> +16), for_range_stop (-> +16), function_call:range
                for i in range(next_ncol // 2): # binary_operator:FloorDiv, call_parameter:, for:i (-> +13), for_range_stop (-> +13), function_call:range, int_literal, literal:Num, nested_for:1 (-> +13)
                    new_inverseC[i].append( # index, method_call:append
                        ( # binary_operator:Div, call_parameter:
    ...
    def __str__(self): # function:__str__ (-> +10), function_returning_something:__str__ (-> +10)
        A = "A = " + " + ".join( # assignment, assignment_lhs_identifier:A, binary_operator:Add, composition, constant_assignment:A, literal:Str, method_call:join
            f"{coef}*x^{i}" for coef, i in enumerate(self.polyA[: self.len_A]) # assignment_rhs_identifier:coef, assignment_rhs_identifier:enumerate, assignment_rhs_identifier:i, assignment_rhs_identifier:self, call_parameter:, comprehension:Generator, comprehension_for_count:1, function_call:enumerate, literal:Str, slice
        )
        B = "B = " + " + ".join( # assignment, assignment_lhs_identifier:B, binary_operator:Add, composition, constant_assignment:B, literal:Str, method_call:join
            f"{coef}*x^{i}" for coef, i in enumerate(self.polyB[: self.len_B]) # assignment_rhs_identifier:coef, assignment_rhs_identifier:enumerate, assignment_rhs_identifier:i, assignment_rhs_identifier:self, call_parameter:, comprehension:Generator, comprehension_for_count:1, function_call:enumerate, literal:Str, slice
        )
        C = "A*B = " + " + ".join( # assignment, assignment_lhs_identifier:C, binary_operator:Add, composition, constant_assignment:C, literal:Str, method_call:join
            f"{coef}*x^{i}" for coef, i in enumerate(self.product) # assignment_rhs_identifier:coef, assignment_rhs_identifier:enumerate, assignment_rhs_identifier:i, assignment_rhs_identifier:self, call_parameter:, comprehension:Generator, comprehension_for_count:1, function_call:enumerate, literal:Str
        )
        return "\n".join((A, B, C)) # call_parameter:, literal:Str, method_call:join, return
...
def runge_kutta(f, y0, x0, h, x_end): # function:runge_kutta (-> +12), function_returning_something:runge_kutta (-> +12)
    ...
    for k in range(N): # accumulate_elements:1 (-> +6), call_parameter:N, for:k (-> +6), for_range_stop (-> +6), function_call:range
        k1 = f(x, y[k]) # assignment, assignment_lhs_identifier:k1, assignment_rhs_identifier:f, assignment_rhs_identifier:k, assignment_rhs_identifier:x, assignment_rhs_identifier:y, call_parameter:, call_parameter:x, function_call:f, index
        k2 = f(x + 0.5 * h, y[k] + 0.5 * h * k1) # assignment, assignment_lhs_identifier:k2, assignment_rhs_identifier:f, assignment_rhs_identifier:h, assignment_rhs_identifier:k, assignment_rhs_identifier:k1, assignment_rhs_identifier:x, assignment_rhs_identifier:y, binary_operator:Add, binary_operator:Mult, call_parameter:, float_literal, function_call:f, index, literal:Num, suggest_constant_definition
...
def sieve(n): # function:sieve (-> +33), function_returning_something:sieve (-> +33)
    ...
    end = int(math.sqrt(n)) # assignment, assignment_lhs_identifier:end, assignment_rhs_identifier:int, assignment_rhs_identifier:math, assignment_rhs_identifier:n, call_parameter:, call_parameter:n, composition, function_call:int, method_call:sqrt
    ...
    while start <= end: # comparison_operator:LtE, while (-> +6)
        if temp[start] is True: # comparison_operator:Is, if (-> +4), if_test_id:start, if_test_id:temp, index, literal:True
            ...
            for i in range(start * start, end + 1, start): # binary_operator:Add, binary_operator:Mult, call_parameter:, call_parameter:start, for:i (-> +2), for_range_step (-> +2), function_call:range, int_literal, literal:Num
    ...
    while low <= n: # comparison_operator:LtE, while (-> +14)
        ...
        for each in in_prime: # accumulate_elements:1 (-> +5), for:each (-> +5), for_each (-> +5)
            t = math.floor(low / each) * each # assignment, assignment_lhs_identifier:t, assignment_rhs_identifier:each, assignment_rhs_identifier:low, assignment_rhs_identifier:math, binary_operator:Div, binary_operator:Mult, call_parameter:, method_call:floor
            ...
            for j in range(t, high + 1, each): # binary_operator:Add, call_parameter:, call_parameter:each, call_parameter:t, for:j (-> +1), for_range_step (-> +1), function_call:range, int_literal, literal:Num, nested_for:1 (-> +1)
                temp[j - low] = False # assignment, assignment_lhs_identifier:temp, binary_operator:Sub, index, index_arithmetic, literal:False
        for j in range(len(temp)): # call_parameter:, call_parameter:temp, composition, for:j (-> +2), for_indexes (-> +2), for_range_stop (-> +2), function_call:len, function_call:range
            if temp[j] is True: # comparison_operator:Is, if (-> +1), if_test_id:j, if_test_id:temp, index, literal:True
                prime.append(j + low) # binary_operator:Add, call_parameter:, if_then_branch, method_call:append, method_call_object:prime
...
print(sieve(10 ** 6)) # binary_operator:Pow, call_parameter:, composition, function_call:print, function_call:sieve, int_literal, literal:Num
...
def sieve(n): # function:sieve (-> +15), function_returning_something:sieve (-> +15)
    ...
    while start <= end: # comparison_operator:LtE, while (-> +6)
        if l[start] is True: # comparison_operator:Is, if (-> +4), if_test_id:l, if_test_id:start, index, literal:True
            ...
            for i in range(start * start, n + 1, start): # binary_operator:Add, binary_operator:Mult, call_parameter:, call_parameter:start, for:i (-> +2), for_range_step (-> +2), function_call:range, int_literal, literal:Num
        ...
        start += 1 # assignment_lhs_identifier:start, augmented_assignment, int_literal, literal:Num
    for j in range(end + 1, n + 1): # accumulate_elements:1 (-> +2), binary_operator:Add, call_parameter:, for:j (-> +2), for_range_start (-> +2), function_call:range, int_literal, literal:Num
...
def main(): # function:main (-> +6), function_returning_nothing:main (-> +6)
    ...
    print("y = {0}".format(y)) # call_parameter:, call_parameter:y, composition, function_call:print, literal:Str, method_call:format
...
def main(): # function:main (-> +1), function_returning_nothing:main (-> +1)
    print(sum_of_series(1, 1, 10)) # call_parameter:, call_parameter:1, call_parameter:10, composition, function_call:print, function_call:sum_of_series, int_literal, literal:Num, suggest_constant_definition
...
def vol_cube(side_length): # function:vol_cube (-> +1), function_returning_something:vol_cube (-> +1)
    return float(side_length ** 3) # binary_operator:Pow, call_parameter:, function_call:float, int_literal, literal:Num, return, suggest_constant_definition
def vol_cuboid(width, height, length): # function:vol_cuboid (-> +1), function_returning_something:vol_cuboid (-> +1)
    return float(width * height * length) # binary_operator:Mult, call_parameter:, function_call:float, return
def vol_cone(area_of_base, height): # function:vol_cone (-> +1), function_returning_something:vol_cone (-> +1)
    return (float(1) / 3) * area_of_base * height # binary_operator:Div, binary_operator:Mult, call_parameter:1, function_call:float, int_literal, literal:Num, return, suggest_constant_definition
def vol_right_circ_cone(radius, height): # function:vol_right_circ_cone (-> +1), function_returning_something:vol_right_circ_cone (-> +1)
    return (float(1) / 3) * pi * (radius ** 2) * height # binary_operator:Div, binary_operator:Mult, binary_operator:Pow, call_parameter:1, function_call:float, int_literal, literal:Num, return, suggest_constant_definition
def vol_prism(area_of_base, height): # function:vol_prism (-> +1), function_returning_something:vol_prism (-> +1)
    return float(area_of_base * height) # binary_operator:Mult, call_parameter:, function_call:float, return
...
def vol_sphere(radius): # function:vol_sphere (-> +1), function_returning_something:vol_sphere (-> +1)
    return (float(4) / 3) * pi * radius ** 3 # binary_operator:Div, binary_operator:Mult, binary_operator:Pow, call_parameter:4, function_call:float, int_literal, literal:Num, return, suggest_constant_definition
...
def main(): # function:main (-> +9), function_returning_nothing:main (-> +9)
    print("Volumes:") # call_parameter:, function_call:print, literal:Str
    print("Cube: " + str(vol_cube(2))) # binary_operator:Add, call_parameter:, call_parameter:2, composition, function_call:print, function_call:str, function_call:vol_cube, int_literal, literal:Num, literal:Str
    print("Cuboid: " + str(vol_cuboid(2, 2, 2))) # binary_operator:Add, call_parameter:, call_parameter:2, composition, function_call:print, function_call:str, function_call:vol_cuboid, int_literal, literal:Num, literal:Str
    print("Cone: " + str(vol_cone(2, 2))) # binary_operator:Add, call_parameter:, call_parameter:2, composition, function_call:print, function_call:str, function_call:vol_cone, int_literal, literal:Num, literal:Str
    print("Right Circular Cone: " + str(vol_right_circ_cone(2, 2))) # binary_operator:Add, call_parameter:, call_parameter:2, composition, function_call:print, function_call:str, function_call:vol_right_circ_cone, int_literal, literal:Num, literal:Str
    print("Prism: " + str(vol_prism(2, 2))) # binary_operator:Add, call_parameter:, call_parameter:2, composition, function_call:print, function_call:str, function_call:vol_prism, int_literal, literal:Num, literal:Str
    print("Pyramid: " + str(vol_pyramid(2, 2))) # binary_operator:Add, call_parameter:, call_parameter:2, composition, function_call:print, function_call:str, function_call:vol_pyramid, int_literal, literal:Num, literal:Str
    print("Sphere: " + str(vol_sphere(2))) # binary_operator:Add, call_parameter:, call_parameter:2, composition, function_call:print, function_call:str, function_call:vol_sphere, int_literal, literal:Num, literal:Str
    print("Circular Cylinder: " + str(vol_circular_cylinder(2, 2))) # binary_operator:Add, call_parameter:, call_parameter:2, composition, function_call:print, function_call:str, function_call:vol_circular_cylinder, int_literal, literal:Num, literal:Str
...
def zeller(date_input: str) -> str: # function:zeller (-> +46), function_returning_something:zeller (-> +46)
    ...
    if not 0 < len(date_input) < 11: # call_parameter:date_input, chained_comparison:2, chained_inequalities:2, comparison_operator:Lt, function_call:len, if (-> +1), if_test_id:date_input, if_test_id:len, int_literal, literal:Num, suggest_constant_definition, unary_operator:Not
        raise ValueError("Must be 10 characters long") # call_parameter:, function_call:ValueError, if_then_branch, literal:Str, raise:ValueError
    m: int = int(date_input[0] + date_input[1]) # binary_operator:Add, call_parameter:, function_call:int, index, int_literal, literal:Num
    if not 0 < m < 13: # chained_comparison:2, chained_inequalities:2, comparison_operator:Lt, if (-> +1), if_test_id:m, int_literal, literal:Num, suggest_constant_definition, unary_operator:Not
        raise ValueError("Month must be between 1 - 12") # call_parameter:, function_call:ValueError, if_then_branch, literal:Str, raise:ValueError
    ...
    if sep_1 not in ["-", "/"]: # comparison_operator:NotIn, if (-> +1), if_test_id:sep_1, literal:List, literal:Str
        raise ValueError("Date seperator must be '-' or '/'") # call_parameter:, function_call:ValueError, if_then_branch, literal:Str, raise:ValueError
    d: int = int(date_input[3] + date_input[4]) # binary_operator:Add, call_parameter:, function_call:int, index, int_literal, literal:Num, suggest_constant_definition
    if not 0 < d < 32: # chained_comparison:2, chained_inequalities:2, comparison_operator:Lt, if (-> +1), if_test_id:d, int_literal, literal:Num, suggest_constant_definition, unary_operator:Not
        raise ValueError("Date must be between 1 - 31") # call_parameter:, function_call:ValueError, if_then_branch, literal:Str, raise:ValueError
    ...
    if sep_2 not in ["-", "/"]: # comparison_operator:NotIn, if (-> +1), if_test_id:sep_2, literal:List, literal:Str
        raise ValueError("Date seperator must be '-' or '/'") # call_parameter:, function_call:ValueError, if_then_branch, literal:Str, raise:ValueError
    y: int = int(date_input[6] + date_input[7] + date_input[8] + date_input[9]) # binary_operator:Add, call_parameter:, function_call:int, index, int_literal, literal:Num, suggest_constant_definition
    ...
    c: int = int(str(y)[:2]) # call_parameter:, call_parameter:y, composition, function_call:int, function_call:str, int_literal, literal:Num, slice
    k: int = int(str(y)[2:]) # call_parameter:, call_parameter:y, composition, function_call:int, function_call:str, int_literal, literal:Num, slice
    t: int = int(2.6 * m - 5.39) # binary_operator:Mult, binary_operator:Sub, call_parameter:, float_literal, function_call:int, literal:Num, suggest_constant_definition
    u: int = int(c / 4) # binary_operator:Div, call_parameter:, function_call:int, int_literal, literal:Num, suggest_constant_definition
    v: int = int(k / 4) # binary_operator:Div, call_parameter:, function_call:int, int_literal, literal:Num, suggest_constant_definition
    x: int = int(d + k) # binary_operator:Add, call_parameter:, function_call:int
    z: int = int(t + u + v + x) # binary_operator:Add, call_parameter:, function_call:int
    w: int = int(z - (2 * c)) # binary_operator:Mult, binary_operator:Sub, call_parameter:, function_call:int, int_literal, literal:Num
    f: int = round(w % 7) # binary_operator:Mod, call_parameter:, function_call:round, int_literal, literal:Num, suggest_constant_definition
    if f != convert_datetime_days[dt_ck.weekday()]: # comparison_operator:NotEq, if (-> +1), if_test_id:convert_datetime_days, if_test_id:dt_ck, if_test_id:f, index, method_call:weekday, method_call_object:dt_ck
        raise AssertionError("The date was evaluated incorrectly. Contact developer.") # call_parameter:, function_call:AssertionError, if_then_branch, literal:Str, raise:AssertionError
