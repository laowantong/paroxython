...
def n31(a: int) -> Tuple[List[int], int]: # function:n31 (-> +12), function_returning_something:n31 (-> +12), index
    ...
    while a != 1: # comparison_operator:NotEq, evolve_state (-> +5), int_literal, literal:Num, while (-> +5)
        if a % 2 == 0: # binary_operator:Mod, comparison_operator:Eq, divisibility_test:2, if (-> +3), if_test_atom:0, if_test_atom:2, if_test_atom:a, int_literal, literal:Num, suggest_conditional_expression (-> +3)
            a = a // 2 # assignment, assignment_lhs_identifier:a, assignment_rhs_atom:2, assignment_rhs_atom:a, binary_operator:FloorDiv, if_then_branch, int_literal, literal:Num, suggest_augmented_assignment, variable_update:a:2, variable_update_by_assignment:a:2
        else:
            a = 3 * a + 1 # assignment, assignment_lhs_identifier:a, assignment_rhs_atom:1, assignment_rhs_atom:3, assignment_rhs_atom:a, binary_operator:Add, binary_operator:Mult, if_else_branch, increment_variable:a:1, increment_variable:a:3, int_literal, literal:Num, suggest_constant_definition, variable_update:a:1, variable_update:a:3, variable_update_by_assignment:a:1, variable_update_by_assignment:a:3
        path += [a] # assignment_lhs_identifier:path, assignment_rhs_atom:a, augmented_assignment:Add, increment_variable:path:a, variable_update:path:a, variable_update_by_augmented_assignment:path:a
...
def median(nums): # function:median (-> +10), function_returning_something:median (-> +10)
    ...
    if len(sorted_list) % 2 == 0: # binary_operator:Mod, call_argument:sorted_list, comparison_operator:Eq, divisibility_test:2, function_call:len, if (-> +6), if_test_atom:0, if_test_atom:2, if_test_atom:sorted_list, int_literal, literal:Num
...
def prime_factors(n: int) -> list: # function:prime_factors (-> +11), function_returning_something:prime_factors (-> +11)
    ...
    while n % 2 == 0: # binary_operator:Mod, comparison_operator:Eq, divisibility_test:2, evolve_state (-> +2), int_literal, literal:Num, while (-> +2)
        pf.append(2) # call_argument:2, int_literal, literal:Num, method_call, method_call_name:append, method_call_object:pf, variable_update:pf:2, variable_update_by_method_call:pf:2
        n = int(n / 2) # assignment, assignment_lhs_identifier:n, assignment_rhs_atom:2, assignment_rhs_atom:n, binary_operator:Div, call_argument:, function_call:int, int_literal, literal:Num, variable_update:n:2, variable_update_by_assignment:n:2
    for i in range(3, int(math.sqrt(n)) + 1, 2): # accumulate_elements:n (-> +3), accumulate_elements:pf (-> +3), binary_operator:Add, call_argument:, call_argument:2, call_argument:3, call_argument:n, composition, for:i (-> +3), for_range:3:_:2 (-> +3), function_call:int, function_call:range, int_literal, literal:Num, method_call, method_call_name:sqrt, range:3:_:2, suggest_constant_definition
        while n % i == 0: # binary_operator:Mod, comparison_operator:Eq, divisibility_test, evolve_state (-> +2), int_literal, literal:Num, while (-> +2)
            pf.append(i) # call_argument:i, method_call, method_call_name:append, method_call_object:pf, variable_update:pf:i, variable_update_by_method_call:pf:i
            n = int(n / i) # assignment, assignment_lhs_identifier:n, assignment_rhs_atom:i, assignment_rhs_atom:n, binary_operator:Div, call_argument:, function_call:int, variable_update:n:i, variable_update_by_assignment:n:i
    if n > 2: # comparison_operator:Gt, if (-> +1), if_test_atom:2, if_test_atom:n, int_literal, literal:Num
        pf.append(n) # call_argument:n, if_then_branch, method_call, method_call_name:append, method_call_object:pf, variable_update:pf:n, variable_update_by_method_call:pf:n
    return pf # return:pf
...
def binary_exponentiation(a, n): # body_recursive_function:binary_exponentiation (-> +7), function:binary_exponentiation (-> +7), function_returning_something:binary_exponentiation (-> +7), recursive_function:binary_exponentiation (-> +7)
    if n == 0: # comparison_operator:Eq, if (-> +6), if_test_atom:0, if_test_atom:n, int_literal, literal:Num
...
def binomial_coefficient(n, r): # function:binomial_coefficient (-> +8), function_returning_something:binomial_coefficient (-> +8)
    ...
    for i in range(1, n + 1): # binary_operator:Add, call_argument:, call_argument:1, for:i (-> +4), for_range:1:_ (-> +4), function_call:range, int_literal, literal:Num, range:1:_
        ...
        while j > 0: # comparison_operator:Gt, evolve_state (-> +2), int_literal, literal:Num, while (-> +2)
            C[j] += C[j - 1] # assignment_lhs_identifier:C, assignment_rhs_atom:1, assignment_rhs_atom:C, assignment_rhs_atom:j, augmented_assignment:Add, binary_operator:Sub, increment_variable:C:1, increment_variable:C:C, increment_variable:C:j, index, index_arithmetic, int_literal, literal:Num, variable_update:C:1, variable_update:C:C, variable_update:C:j, variable_update_by_augmented_assignment:C:1, variable_update_by_augmented_assignment:C:C, variable_update_by_augmented_assignment:C:j
            j -= 1 # assignment_lhs_identifier:j, assignment_rhs_atom:1, augmented_assignment:Sub, decrement_variable:j:1, int_literal, literal:Num, variable_update:j:1, variable_update_by_augmented_assignment:j:1
...
def explicit_euler(ode_func, y0, x0, stepsize, x_end): # function:explicit_euler (-> +8), function_returning_something:explicit_euler (-> +8)
    ...
    for k in range(N): # accumulate_elements:y (-> +2), call_argument:N, for:k (-> +2), for_range:N (-> +2), function_call:range, range:N
        y[k + 1] = y[k] + stepsize * ode_func(x, y[k]) # assignment, assignment_lhs_identifier:y, assignment_rhs_atom:k, assignment_rhs_atom:stepsize, assignment_rhs_atom:x, assignment_rhs_atom:y, binary_operator:Add, binary_operator:Mult, call_argument:, call_argument:x, function_call:ode_func, increment_variable:y:k, increment_variable:y:stepsize, increment_variable:y:x, index, index_arithmetic, int_literal, literal:Num, variable_update:y:k, variable_update:y:stepsize, variable_update:y:x, variable_update_by_assignment:y:k, variable_update_by_assignment:y:stepsize, variable_update_by_assignment:y:x
        x += stepsize # assignment_lhs_identifier:x, assignment_rhs_atom:stepsize, augmented_assignment:Add, increment_variable:x:stepsize, variable_update:x:stepsize, variable_update_by_augmented_assignment:x:stepsize
    return y # return:y
...
def extended_euclidean_algorithm(m, n): # function:extended_euclidean_algorithm (-> +31), function_returning_something:extended_euclidean_algorithm (-> +31)
    ...
    while True: # infinite_while (-> +12), literal:True, while (-> +12)
        ...
        if r == 0: # comparison_operator:Eq, if (-> +1), if_test_atom:0, if_test_atom:r, int_literal, literal:Num
        ...
        a = t - q * a # assignment, assignment_lhs_identifier:a, assignment_rhs_atom:a, assignment_rhs_atom:q, assignment_rhs_atom:t, binary_operator:Mult, binary_operator:Sub, decrement_variable:a:q, decrement_variable:a:t, variable_update:a:q, variable_update:a:t, variable_update_by_assignment:a:q, variable_update_by_assignment:a:t
        ...
        b = t - q * b # assignment, assignment_lhs_identifier:b, assignment_rhs_atom:b, assignment_rhs_atom:q, assignment_rhs_atom:t, binary_operator:Mult, binary_operator:Sub, decrement_variable:b:q, decrement_variable:b:t, variable_update:b:q, variable_update:b:t, variable_update_by_assignment:b:q, variable_update_by_assignment:b:t
...
def factorial(input_number: int) -> int: # function:factorial (-> +8), function_returning_something:factorial (-> +8)
    if input_number < 0: # comparison_operator:Lt, if (-> +1), if_test_atom:0, if_test_atom:input_number, int_literal, literal:Num
...
def factorial(n: int) -> int: # body_recursive_function:factorial (-> +5), function:factorial (-> +5), function_returning_something:factorial (-> +5), recursive_function:factorial (-> +5)
    if n < 0: # comparison_operator:Lt, if (-> +1), if_test_atom:0, if_test_atom:n, int_literal, literal:Num
        raise ValueError("factorial() not defined for negative values") # call_argument:, function_call:ValueError, if_then_branch, literal:Str, raise:ValueError
...
def timer_decorator(func): # closure:timer_decorator (-> +10), function:timer_decorator (-> +10), function_returning_something:timer_decorator (-> +10), nested_function:timer_decorator (-> +10)
    def timer_wrapper(*args, **kwargs): # function:timer_wrapper (-> +8), function_returning_something:timer_wrapper (-> +8)
        ...
        if int(end - start) > 0: # binary_operator:Sub, call_argument:, comparison_operator:Gt, function_call:int, if (-> +3), if_test_atom:0, if_test_atom:end, if_test_atom:start, int_literal, literal:Num
...
def _check_number_input(n, min_thresh, max_thresh=None): # function:_check_number_input (-> +22), function_returning_something:_check_number_input (-> +22), function_with_default_positional_arguments:_check_number_input (-> +22), literal:None
    try: # try (-> +19), try_except:ValueLessThanZero (-> +19), try_except:ValueTooLargeError (-> +19), try_except:ValueTooSmallError (-> +19), try_raise:ValueLessThanZero (-> +19), try_raise:ValueTooLargeError (-> +19), try_raise:ValueTooSmallError (-> +19)
        ...
        elif n < 0: # comparison_operator:Lt, if (-> +5), if_test_atom:0, if_test_atom:n, int_literal, literal:Num
...
def fib_formula(n): # function:fib_formula (-> +12), function_returning_something:fib_formula (-> +12)
    ...
    if _check_number_input(n, 2, 1000000): # call_argument:1000000, call_argument:2, call_argument:n, function_call:_check_number_input, if (-> +9), if_test_atom:1000000, if_test_atom:2, if_test_atom:n, int_literal, literal:Num, suggest_constant_definition
        ...
        for i in range(2, n): # call_argument:2, call_argument:n, for:i (-> +4), for_range:2:n (-> +4), function_call:range, int_literal, literal:Num, range:2:n
            ...
            seq_out.append(int(temp_out)) # call_argument:, call_argument:temp_out, composition, function_call:int, method_call, method_call_name:append, method_call_object:seq_out, variable_update:seq_out:temp_out, variable_update_by_method_call:seq_out:temp_out
        return seq_out # return:seq_out
...
def main(): # function:main (-> +6), function_returning_nothing:main (-> +6)
    ...
    if limit > 0: # comparison_operator:Gt, if (-> +4), if_test_atom:0, if_test_atom:limit, int_literal, literal:Num
...
def exactPrimeFactorCount(n): # function:exactPrimeFactorCount (-> +15), function_returning_something:exactPrimeFactorCount (-> +15)
    ...
    if n % 2 == 0: # binary_operator:Mod, comparison_operator:Eq, divisibility_test:2, if (-> +3), if_test_atom:0, if_test_atom:2, if_test_atom:n, int_literal, literal:Num
        count += 1 # assignment_lhs_identifier:count, assignment_rhs_atom:1, augmented_assignment:Add, if_then_branch (-> +2), increment_variable:count:1, int_literal, literal:Num, variable_update:count:1, variable_update_by_augmented_assignment:count:1
    ...
    while i <= int(math.sqrt(n)): # call_argument:, call_argument:n, comparison_operator:LtE, composition, evolve_state (-> +5), function_call:int, method_call, method_call_name:sqrt, while (-> +5)
        if n % i == 0: # binary_operator:Mod, comparison_operator:Eq, divisibility_test, if (-> +3), if_test_atom:0, if_test_atom:i, if_test_atom:n, int_literal, literal:Num
            count += 1 # assignment_lhs_identifier:count, assignment_rhs_atom:1, augmented_assignment:Add, if_then_branch (-> +2), increment_variable:count:1, int_literal, literal:Num, variable_update:count:1, variable_update_by_augmented_assignment:count:1
            while n % i == 0: # binary_operator:Mod, comparison_operator:Eq, divisibility_test, int_literal, literal:Num, while (-> +1)
                n = int(n / i) # assignment, assignment_lhs_identifier:n, assignment_rhs_atom:i, assignment_rhs_atom:n, binary_operator:Div, call_argument:, function_call:int, variable_update:n:i, variable_update_by_assignment:n:i
        i = i + 2 # assignment, assignment_lhs_identifier:i, assignment_rhs_atom:2, assignment_rhs_atom:i, binary_operator:Add, increment_variable:i:2, int_literal, literal:Num, suggest_augmented_assignment, variable_update:i:2, variable_update_by_assignment:i:2
    if n > 2: # comparison_operator:Gt, if (-> +1), if_test_atom:2, if_test_atom:n, int_literal, literal:Num
        count += 1 # assignment_lhs_identifier:count, assignment_rhs_atom:1, augmented_assignment:Add, if_then_branch, increment_variable:count:1, int_literal, literal:Num, variable_update:count:1, variable_update_by_augmented_assignment:count:1
...
def kthPermutation(k, n): # function:kthPermutation (-> +13), function_returning_something:kthPermutation (-> +13)
    ...
    for i in range(2, n): # call_argument:2, call_argument:n, for:i (-> +1), for_range:2:n (-> +1), function_call:range, int_literal, literal:Num, range:2:n
        factorials.append(factorials[-1] * i) # binary_operator:Mult, call_argument:, index, int_literal, literal:Num, method_call, method_call_name:append, method_call_object:factorials, negative_index:-1
    ...
    while factorials: # while (-> +4)
        ...
        permutation.append(elements[number]) # call_argument:, index, method_call, method_call_name:append, method_call_object:permutation
        elements.remove(elements[number]) # call_argument:, index, method_call, method_call_name:remove, method_call_object:elements
    permutation.append(elements[0]) # call_argument:, index, int_literal, literal:Num, method_call, method_call_name:append, method_call_object:permutation
...
def res(x, y): # function:res (-> +7), function_returning_something:res (-> +7)
    if 0 not in (x, y): # comparison_operator:NotIn, if (-> +6), if_test_atom:0, if_test_atom:x, if_test_atom:y, int_literal, literal:Num
        return y * math.log10(x) # binary_operator:Mult, call_argument:x, if_then_branch, method_call, method_call_name:log10, return
    else:
        if x == 0: # comparison_operator:Eq, if (-> +3), if_test_atom:0, if_test_atom:x, int_literal, literal:Num
            return 0 # if_elif_branch, int_literal, literal:Num, return:0
        elif y == 0: # comparison_operator:Eq, if (-> +1), if_test_atom:0, if_test_atom:y, int_literal, literal:Num
...
def find_lcm(first_num: int, second_num: int) -> int: # function:find_lcm (-> +5), function_returning_something:find_lcm (-> +5)
    ...
    while (common_mult % first_num > 0) or (common_mult % second_num > 0): # binary_operator:Mod, boolean_operator:Or, comparison_operator:Gt, int_literal, literal:Num, while (-> +1)
        common_mult += max_num # assignment_lhs_identifier:common_mult, assignment_rhs_atom:max_num, augmented_assignment:Add, increment_variable:common_mult:max_num, variable_update:common_mult:max_num, variable_update_by_augmented_assignment:common_mult:max_num
...
def recur_luc(n): # body_recursive_function:recur_luc (-> +5), function:recur_luc (-> +5), function_returning_something:recur_luc (-> +5), recursive_function:recur_luc (-> +5)
    ...
    if n == 0: # comparison_operator:Eq, if (-> +1), if_test_atom:0, if_test_atom:n, int_literal, literal:Num
        ...
        for i in range(self.n): # call_argument:, for:i (-> +3), for_range:_ (-> +3), function_call:range, range:_, square_nested_for (-> +3)
            for j in range(self.n): # call_argument:, for:j (-> +2), for_range:_ (-> +2), function_call:range, nested_for:1 (-> +2), range:_, square_nested_for (-> +2)
                for k in range(self.n): # call_argument:, for:k (-> +1), for_range:_ (-> +1), function_call:range, nested_for:2 (-> +1), range:_
                    matrix.t[i][j] += self.t[i][k] * b.t[k][j] # assignment_rhs_atom:b, assignment_rhs_atom:i, assignment_rhs_atom:j, assignment_rhs_atom:k, assignment_rhs_atom:self, augmented_assignment:Add, binary_operator:Mult, index
...
def fibonacci_with_matrix_exponentiation(n, f1, f2): # function:fibonacci_with_matrix_exponentiation (-> +7), function_returning_something:fibonacci_with_matrix_exponentiation (-> +7)
    ...
    matrix = modular_exponentiation(matrix, n - 2) # assignment, assignment_lhs_identifier:matrix, assignment_rhs_atom:2, assignment_rhs_atom:matrix, assignment_rhs_atom:n, binary_operator:Sub, call_argument:, call_argument:matrix, decrement_variable:matrix:2, decrement_variable:matrix:n, function_call:modular_exponentiation, int_literal, literal:Num, variable_update:matrix:2, variable_update:matrix:n, variable_update_by_assignment:matrix:2, variable_update_by_assignment:matrix:n
...
def simple_fibonacci(n, f1, f2): # function:simple_fibonacci (-> +11), function_returning_something:simple_fibonacci (-> +11)
    ...
    n -= 2 # assignment_lhs_identifier:n, assignment_rhs_atom:2, augmented_assignment:Sub, decrement_variable:n:2, int_literal, literal:Num, variable_update:n:2, variable_update_by_augmented_assignment:n:2
    while n > 0: # comparison_operator:Gt, evolve_state (-> +2), int_literal, literal:Num, while (-> +2)
        fn_1, fn_2 = fn_1 + fn_2, fn_1 # assignment, assignment_lhs_identifier:fn_1, assignment_lhs_identifier:fn_2, assignment_rhs_atom:fn_1, assignment_rhs_atom:fn_2, binary_operator:Add, increment_variable:fn_1:fn_2, increment_variable:fn_2:fn_1, variable_update:fn_1:fn_2, variable_update:fn_2:fn_1, variable_update_by_assignment:fn_1:fn_2, variable_update_by_assignment:fn_2:fn_1
        n -= 1 # assignment_lhs_identifier:n, assignment_rhs_atom:1, augmented_assignment:Sub, decrement_variable:n:1, int_literal, literal:Num, variable_update:n:1, variable_update_by_augmented_assignment:n:1
...
def modular_exponential(base, power, mod): # function:modular_exponential (-> +10), function_returning_something:modular_exponential (-> +10)
    if power < 0: # comparison_operator:Lt, if (-> +1), if_test_atom:0, if_test_atom:power, int_literal, literal:Num
        return -1 # if_then_branch, int_literal, literal:Num, return:-1
    ...
    while power > 0: # comparison_operator:Gt, evolve_state (-> +4), int_literal, literal:Num, while (-> +4)
        if power & 1: # binary_operator:BitAnd, if (-> +1), if_test_atom:1, if_test_atom:power, int_literal, literal:Num
            result = (result * base) % mod # assignment, assignment_lhs_identifier:result, assignment_rhs_atom:base, assignment_rhs_atom:mod, assignment_rhs_atom:result, binary_operator:Mod, binary_operator:Mult, if_then_branch, variable_update:result:base, variable_update:result:mod, variable_update_by_assignment:result:base, variable_update_by_assignment:result:mod
        power = power >> 1 # assignment, assignment_lhs_identifier:power, assignment_rhs_atom:1, assignment_rhs_atom:power, binary_operator:RShift, int_literal, literal:Num, suggest_augmented_assignment, variable_update:power:1, variable_update_by_assignment:power:1
        base = (base * base) % mod # assignment, assignment_lhs_identifier:base, assignment_rhs_atom:base, assignment_rhs_atom:mod, binary_operator:Mod, binary_operator:Mult, variable_update:base:mod, variable_update_by_assignment:base:mod
    return result # return:result
def main(): # function:main (-> +1), function_returning_nothing:main (-> +1)
...
def newton_raphson(f, x0=0, maxiter=100, step=0.0001, maxerror=1e-6, logsteps=False): # float_literal, function:newton_raphson (-> +17), function_returning_something:newton_raphson (-> +17), function_with_default_positional_arguments:newton_raphson (-> +17), int_literal, literal:False, literal:Num
    ...
    for _ in range(maxiter): # call_argument:maxiter, for:_ (-> +9), for_range:maxiter (-> +9), function_call:range, range:maxiter
        if f1(a) == 0: # call_argument:a, comparison_operator:Eq, function_call:f1, if (-> +1), if_test_atom:0, if_test_atom:a, int_literal, literal:Num
        ...
        if logsteps: # if (-> +1)
            steps.append(a) # call_argument:a, if_then_branch, method_call, method_call_name:append, method_call_object:steps, variable_update:steps:a, variable_update_by_method_call:steps:a
...
def horner(poly: Sequence[float], x: float) -> float: # function:horner (-> +4), function_returning_something:horner (-> +4), index
    ...
    for coeff in reversed(poly): # accumulate_elements:result (-> +1), call_argument:poly, for:coeff (-> +1), function_call:reversed
        result = result * x + coeff # assignment, assignment_lhs_identifier:result, assignment_rhs_atom:coeff, assignment_rhs_atom:result, assignment_rhs_atom:x, binary_operator:Add, binary_operator:Mult, increment_variable:result:coeff, increment_variable:result:x, variable_update:result:coeff, variable_update:result:x, variable_update_by_assignment:result:coeff, variable_update_by_assignment:result:x
    return result # return:result
...
def prime_check(number): # function:prime_check (-> +8), function_returning_something:prime_check (-> +8)
    ...
    if number < 4: # comparison_operator:Lt, if (-> +1), if_test_atom:4, if_test_atom:number, int_literal, literal:Num, suggest_constant_definition
        return True # if_then_branch, literal:True, return:True
    if number % 2 == 0: # binary_operator:Mod, comparison_operator:Eq, divisibility_test:2, if (-> +1), if_test_atom:0, if_test_atom:2, if_test_atom:number, int_literal, literal:Num
        return False # if_then_branch, literal:False, return:False
...
def prime_factors(n: int) -> List[int]: # function:prime_factors (-> +11), function_returning_something:prime_factors (-> +11), index
    ...
    while i * i <= n: # binary_operator:Mult, comparison_operator:LtE, evolve_state (-> +5), while (-> +5)
        if n % i: # binary_operator:Mod, if (-> +4), if_test_atom:i, if_test_atom:n
            ...
            factors.append(i) # call_argument:i, method_call, method_call_name:append, method_call_object:factors, variable_update:factors:i, variable_update_by_method_call:factors:i
    if n > 1: # comparison_operator:Gt, if (-> +1), if_test_atom:1, if_test_atom:n, int_literal, literal:Num
        factors.append(n) # call_argument:n, if_then_branch, method_call, method_call_name:append, method_call_object:factors, variable_update:factors:n, variable_update_by_method_call:factors:n
...
def primes(max: int) -> List[int]: # function:primes (-> +9), function_returning_something:primes (-> +9), index
    max += 1 # assignment_lhs_identifier:max, assignment_rhs_atom:1, augmented_assignment:Add, increment_variable:max:1, int_literal, literal:Num, variable_update:max:1, variable_update_by_augmented_assignment:max:1
    ...
    for i in range(2, max): # accumulate_elements:ret (-> +4), call_argument:2, call_argument:max, for:i (-> +4), for_range:2:max (-> +4), for_range:i:max:i (-> +4), function_call:range, int_literal, literal:Num, range:2:max
        if not numbers[i]: # if (-> +3), if_test_atom:i, if_test_atom:numbers, index, unary_operator:Not
            ...
            ret.append(i) # call_argument:i, method_call, method_call_name:append, method_call_object:ret, variable_update:ret:i, variable_update_by_method_call:ret:i
...
def prime_sieve_eratosthenes(num): # function:prime_sieve_eratosthenes (-> +10), function_returning_nothing:prime_sieve_eratosthenes (-> +10)
    ...
    while p * p <= num: # binary_operator:Mult, comparison_operator:LtE, while (-> +4)
        if primes[p] == True: # comparison_operator:Eq, if (-> +2), if_test_atom:True, if_test_atom:p, if_test_atom:primes, index, literal:True
        ...
        p += 1 # assignment_lhs_identifier:p, assignment_rhs_atom:1, augmented_assignment:Add, increment_variable:p:1, int_literal, literal:Num, variable_update:p:1, variable_update_by_augmented_assignment:p:1
    for prime in range(2, num + 1): # binary_operator:Add, call_argument:, call_argument:2, for:prime (-> +2), for_range:2:_ (-> +2), function_call:range, int_literal, literal:Num, range:2:_
        if primes[prime]: # if (-> +1), if_test_atom:prime, if_test_atom:primes, index
...
def qr_householder(A): # function:qr_householder (-> +16), function_returning_something:qr_householder (-> +16)
    ...
    for k in range(t - 1): # accumulate_elements:Q_k (-> +10), binary_operator:Sub, call_argument:, for:k (-> +10), for_range:_ (-> +10), function_call:range, int_literal, literal:Num, range:_
        ...
        v /= np.linalg.norm(v) # assignment_lhs_identifier:v, assignment_rhs_atom:np, assignment_rhs_atom:v, augmented_assignment:Div, call_argument:v, method_call, method_call_name:norm, variable_update:v:np, variable_update:v:v, variable_update_by_augmented_assignment:v:np, variable_update_by_augmented_assignment:v:v
        ...
        Q_k = np.block([[np.eye(k), np.zeros((k, m - k))], [np.zeros((m - k, k)), Q_k]]) # assignment, assignment_lhs_identifier:Q_k, assignment_rhs_atom:Q_k, assignment_rhs_atom:k, assignment_rhs_atom:m, assignment_rhs_atom:np, binary_operator:Sub, call_argument:, call_argument:k, composition, decrement_variable:Q_k:k, decrement_variable:Q_k:m, decrement_variable:Q_k:np, method_call, method_call_name:block, method_call_name:eye, method_call_name:zeros, variable_update:Q_k:k, variable_update:Q_k:m, variable_update:Q_k:np, variable_update_by_assignment:Q_k:k, variable_update_by_assignment:Q_k:m, variable_update_by_assignment:Q_k:np
        Q = Q @ Q_k.T # assignment, assignment_lhs_identifier:Q, assignment_rhs_atom:Q, assignment_rhs_atom:Q_k, binary_operator:MatMult, suggest_augmented_assignment, variable_update:Q:Q_k, variable_update_by_assignment:Q:Q_k
        R = Q_k @ R # assignment, assignment_lhs_identifier:R, assignment_rhs_atom:Q_k, assignment_rhs_atom:R, binary_operator:MatMult, variable_update:R:Q_k, variable_update_by_assignment:R:Q_k
    return Q, R # return
...
def QuadraticEquation(a: int, b: int, c: int) -> Tuple[str, str]: # function:QuadraticEquation (-> +10), function_returning_something:QuadraticEquation (-> +10), index
    if a == 0: # comparison_operator:Eq, if (-> +1), if_test_atom:0, if_test_atom:a, int_literal, literal:Num
    ...
    if delta >= 0: # comparison_operator:GtE, if (-> +1), if_test_atom:0, if_test_atom:delta, int_literal, literal:Num
    ...
    if b == 0: # comparison_operator:Eq, if (-> +1), if_test_atom:0, if_test_atom:b, int_literal, literal:Num
...
class FFT:
    def __init__(self, polyA=[0], polyB=[0]): # function:__init__ (-> +17), function_returning_nothing:__init__ (-> +17), function_with_default_positional_arguments:__init__ (-> +17), int_literal, literal:List, literal:Num
        ...
        self.C_max_length = int( # assignment, assignment_lhs_identifier:self, composition, decrement_variable:self:1, decrement_variable:self:2, decrement_variable:self:np, function_call:int, variable_update:self:1, variable_update:self:2, variable_update:self:np, variable_update_by_assignment:self:1, variable_update_by_assignment:self:2, variable_update_by_assignment:self:np
        ...
        self.root = complex(mpmath.root(x=1, n=self.C_max_length, k=1)) # assignment, assignment_lhs_identifier:self, assignment_rhs_atom:1, assignment_rhs_atom:mpmath, assignment_rhs_atom:self, call_argument:, composition, function_call:complex, int_literal, literal:Num, method_call, method_call_name:root, variable_update:self:1, variable_update:self:mpmath, variable_update_by_assignment:self:1, variable_update_by_assignment:self:mpmath
    ...
    def __DFT(self, which): # function:__DFT (-> +23), function_returning_something:__DFT (-> +23)
        ...
        while next_ncol > 0: # comparison_operator:Gt, evolve_state (-> +14), int_literal, literal:Num, while (-> +14)
            ...
            next_ncol = next_ncol // 2 # assignment, assignment_lhs_identifier:next_ncol, assignment_rhs_atom:2, assignment_rhs_atom:next_ncol, binary_operator:FloorDiv, int_literal, literal:Num, suggest_augmented_assignment, variable_update:next_ncol:2, variable_update_by_assignment:next_ncol:2
    ...
    def __multiply(self): # function:__multiply (-> +35), function_returning_something:__multiply (-> +35)
        ...
        del dftA
        del dftB
        if len(inverseC[0]) <= 1: # call_argument:, comparison_operator:LtE, function_call:len, if (-> +1), if_test_atom:0, if_test_atom:1, if_test_atom:inverseC, index, int_literal, literal:Num
        ...
        inverseC = [round(x[0].real, 8) + round(x[0].imag, 8) * 1j for x in inverseC] # assignment, assignment_lhs_identifier:inverseC, assignment_rhs_atom:0, assignment_rhs_atom:1j, assignment_rhs_atom:8, assignment_rhs_atom:inverseC, assignment_rhs_atom:x, binary_operator:Add, binary_operator:Mult, call_argument:, call_argument:8, comprehension:List, comprehension_for_count:1, function_call:round, imaginary_literal, increment_variable:inverseC:0, increment_variable:inverseC:1j, increment_variable:inverseC:8, increment_variable:inverseC:x, index, int_literal, literal:Num, suggest_constant_definition, variable_update:inverseC:0, variable_update:inverseC:1j, variable_update:inverseC:8, variable_update:inverseC:x, variable_update_by_assignment:inverseC:0, variable_update_by_assignment:inverseC:1j, variable_update_by_assignment:inverseC:8, variable_update_by_assignment:inverseC:x
...
def runge_kutta(f, y0, x0, h, x_end): # function:runge_kutta (-> +12), function_returning_something:runge_kutta (-> +12)
    ...
    for k in range(N): # accumulate_elements:y (-> +6), call_argument:N, for:k (-> +6), for_range:N (-> +6), function_call:range, range:N
        ...
        y[k + 1] = y[k] + (1 / 6) * h * (k1 + 2 * k2 + 2 * k3 + k4) # assignment, assignment_lhs_identifier:y, assignment_rhs_atom:1, assignment_rhs_atom:2, assignment_rhs_atom:6, assignment_rhs_atom:h, assignment_rhs_atom:k, assignment_rhs_atom:k1, assignment_rhs_atom:k2, assignment_rhs_atom:k3, assignment_rhs_atom:k4, assignment_rhs_atom:y, binary_operator:Add, binary_operator:Div, binary_operator:Mult, increment_variable:y:1, increment_variable:y:2, increment_variable:y:6, increment_variable:y:h, increment_variable:y:k, increment_variable:y:k1, increment_variable:y:k2, increment_variable:y:k3, increment_variable:y:k4, index, index_arithmetic, int_literal, literal:Num, suggest_constant_definition, variable_update:y:1, variable_update:y:2, variable_update:y:6, variable_update:y:h, variable_update:y:k, variable_update:y:k1, variable_update:y:k2, variable_update:y:k3, variable_update:y:k4, variable_update_by_assignment:y:1, variable_update_by_assignment:y:2, variable_update_by_assignment:y:6, variable_update_by_assignment:y:h, variable_update_by_assignment:y:k, variable_update_by_assignment:y:k1, variable_update_by_assignment:y:k2, variable_update_by_assignment:y:k3, variable_update_by_assignment:y:k4
        x += h # assignment_lhs_identifier:x, assignment_rhs_atom:h, augmented_assignment:Add, increment_variable:x:h, variable_update:x:h, variable_update_by_augmented_assignment:x:h
    return y # return:y
...
def sieve(n): # function:sieve (-> +33), function_returning_something:sieve (-> +33)
    ...
    while start <= end: # comparison_operator:LtE, while (-> +6)
        if temp[start] is True: # comparison_operator:Is, if (-> +4), if_test_atom:True, if_test_atom:start, if_test_atom:temp, index, literal:True
            in_prime.append(start) # call_argument:start, if_then_branch (-> +3), method_call, method_call_name:append, method_call_object:in_prime, variable_update:in_prime:start, variable_update_by_method_call:in_prime:start
            for i in range(start * start, end + 1, start): # binary_operator:Add, binary_operator:Mult, call_argument:, call_argument:start, for:i (-> +2), for_range:_:_:start (-> +2), function_call:range, int_literal, literal:Num, range:_:_:start
                if temp[i] is True: # comparison_operator:Is, if (-> +1), if_test_atom:True, if_test_atom:i, if_test_atom:temp, index, literal:True, nested_if:1 (-> +1)
                    temp[i] = False # assignment, assignment_lhs_identifier:temp, assignment_rhs_atom:False, if_then_branch, index, literal:False
        start += 1 # assignment_lhs_identifier:start, assignment_rhs_atom:1, augmented_assignment:Add, increment_variable:start:1, int_literal, literal:Num, variable_update:start:1, variable_update_by_augmented_assignment:start:1
    prime += in_prime # assignment_lhs_identifier:prime, assignment_rhs_atom:in_prime, augmented_assignment:Add, increment_variable:prime:in_prime, variable_update:prime:in_prime, variable_update_by_augmented_assignment:prime:in_prime
    ...
    while low <= n: # comparison_operator:LtE, while (-> +14)
        ...
        for each in in_prime: # accumulate_elements:t (-> +5), for:each (-> +5), for_each (-> +5), for_range:t:_:each (-> +5)
            ...
            if t < low: # comparison_operator:Lt, if (-> +1), if_test_atom:low, if_test_atom:t
                t += each # assignment_lhs_identifier:t, assignment_rhs_atom:each, augmented_assignment:Add, if_then_branch, increment_variable:t:each, variable_update:t:each, variable_update_by_augmented_assignment:t:each
        ...
        for j in range(len(temp)): # call_argument:, call_argument:temp, composition, for:j (-> +2), for_indexes (-> +2), for_range:_ (-> +2), function_call:len, function_call:range, range:_
            if temp[j] is True: # comparison_operator:Is, if (-> +1), if_test_atom:True, if_test_atom:j, if_test_atom:temp, index, literal:True
                prime.append(j + low) # binary_operator:Add, call_argument:, if_then_branch, method_call, method_call_name:append, method_call_object:prime
...
def sieve(n): # function:sieve (-> +15), function_returning_something:sieve (-> +15)
    ...
    while start <= end: # comparison_operator:LtE, while (-> +6)
        if l[start] is True: # comparison_operator:Is, if (-> +4), if_test_atom:True, if_test_atom:l, if_test_atom:start, index, literal:True
            prime.append(start) # call_argument:start, if_then_branch (-> +3), method_call, method_call_name:append, method_call_object:prime, variable_update:prime:start, variable_update_by_method_call:prime:start
            for i in range(start * start, n + 1, start): # binary_operator:Add, binary_operator:Mult, call_argument:, call_argument:start, for:i (-> +2), for_range:_:_:start (-> +2), function_call:range, int_literal, literal:Num, range:_:_:start
                if l[i] is True: # comparison_operator:Is, if (-> +1), if_test_atom:True, if_test_atom:i, if_test_atom:l, index, literal:True, nested_if:1 (-> +1)
    ...
    for j in range(end + 1, n + 1): # accumulate_elements:prime (-> +2), binary_operator:Add, call_argument:, for:j (-> +2), for_range:_:_ (-> +2), function_call:range, int_literal, literal:Num, range:_:_
        if l[j] is True: # comparison_operator:Is, if (-> +1), if_test_atom:True, if_test_atom:j, if_test_atom:l, index, literal:True
            prime.append(j) # call_argument:j, if_then_branch, method_call, method_call_name:append, method_call_object:prime, variable_update:prime:j, variable_update_by_method_call:prime:j
    return prime # return:prime
...
def method_2(boundary, steps): # function:method_2 (-> +12), function_returning_something:method_2 (-> +12)
    ...
    for i in x_i: # accumulate_elements:y (-> +2), for:i (-> +2), for_each (-> +2)
        y += (h / 3) * (4 - 2 * (cnt % 2)) * f(i) # assignment_lhs_identifier:y, assignment_rhs_atom:2, assignment_rhs_atom:3, assignment_rhs_atom:4, assignment_rhs_atom:cnt, assignment_rhs_atom:h, assignment_rhs_atom:i, augmented_assignment:Add, binary_operator:Div, binary_operator:Mod, binary_operator:Mult, binary_operator:Sub, call_argument:i, function_call:f, increment_variable:y:2, increment_variable:y:3, increment_variable:y:4, increment_variable:y:cnt, increment_variable:y:h, increment_variable:y:i, int_literal, literal:Num, suggest_constant_definition, variable_update:y:2, variable_update:y:3, variable_update:y:4, variable_update:y:cnt, variable_update:y:h, variable_update:y:i, variable_update_by_augmented_assignment:y:2, variable_update_by_augmented_assignment:y:3, variable_update_by_augmented_assignment:y:4, variable_update_by_augmented_assignment:y:cnt, variable_update_by_augmented_assignment:y:h, variable_update_by_augmented_assignment:y:i
        cnt += 1 # assignment_lhs_identifier:cnt, assignment_rhs_atom:1, augmented_assignment:Add, increment_variable:cnt:1, int_literal, literal:Num, variable_update:cnt:1, variable_update_by_augmented_assignment:cnt:1
    y += (h / 3.0) * f(b) # assignment_lhs_identifier:y, assignment_rhs_atom:3.0, assignment_rhs_atom:b, assignment_rhs_atom:h, augmented_assignment:Add, binary_operator:Div, binary_operator:Mult, call_argument:b, float_literal, function_call:f, increment_variable:y:3.0, increment_variable:y:b, increment_variable:y:h, literal:Num, suggest_constant_definition, variable_update:y:3.0, variable_update:y:b, variable_update:y:h, variable_update_by_augmented_assignment:y:3.0, variable_update_by_augmented_assignment:y:b, variable_update_by_augmented_assignment:y:h
    return y # return:y
def make_points(a, b, h): # function:make_points (-> +4), generator:make_points (-> +4)
    ...
    while x < (b - h): # binary_operator:Sub, comparison_operator:Lt, while (-> +2)
        yield x # yield:x
        x = x + h # assignment, assignment_lhs_identifier:x, assignment_rhs_atom:h, assignment_rhs_atom:x, binary_operator:Add, increment_variable:x:h, suggest_augmented_assignment, variable_update:x:h, variable_update_by_assignment:x:h
...
def method_1(boundary, steps): # function:method_1 (-> +10), function_returning_something:method_1 (-> +10)
    ...
    x_i = make_points(a, b, h) # assignment, assignment_lhs_identifier:x_i, assignment_rhs_atom:a, assignment_rhs_atom:b, assignment_rhs_atom:h, call_argument:a, call_argument:b, call_argument:h, function_call:make_points
    y = 0.0 # assignment, assignment_lhs_identifier:y, assignment_rhs_atom:0.0, float_literal, literal:Num, suggest_constant_definition
    y += (h / 2.0) * f(a) # assignment_lhs_identifier:y, assignment_rhs_atom:2.0, assignment_rhs_atom:a, assignment_rhs_atom:h, augmented_assignment:Add, binary_operator:Div, binary_operator:Mult, call_argument:a, float_literal, function_call:f, increment_variable:y:2.0, increment_variable:y:a, increment_variable:y:h, literal:Num, suggest_constant_definition, variable_update:y:2.0, variable_update:y:a, variable_update:y:h, variable_update_by_augmented_assignment:y:2.0, variable_update_by_augmented_assignment:y:a, variable_update_by_augmented_assignment:y:h
    for i in x_i: # accumulate_elements:y (-> +1), for:i (-> +1), for_each (-> +1)
        y += h * f(i) # assignment_lhs_identifier:y, assignment_rhs_atom:h, assignment_rhs_atom:i, augmented_assignment:Add, binary_operator:Mult, call_argument:i, function_call:f, increment_variable:y:h, increment_variable:y:i, variable_update:y:h, variable_update:y:i, variable_update_by_augmented_assignment:y:h, variable_update_by_augmented_assignment:y:i
    y += (h / 2.0) * f(b) # assignment_lhs_identifier:y, assignment_rhs_atom:2.0, assignment_rhs_atom:b, assignment_rhs_atom:h, augmented_assignment:Add, binary_operator:Div, binary_operator:Mult, call_argument:b, float_literal, function_call:f, increment_variable:y:2.0, increment_variable:y:b, increment_variable:y:h, literal:Num, suggest_constant_definition, variable_update:y:2.0, variable_update:y:b, variable_update:y:h, variable_update_by_augmented_assignment:y:2.0, variable_update_by_augmented_assignment:y:b, variable_update_by_augmented_assignment:y:h
    return y # return:y
def make_points(a, b, h): # function:make_points (-> +4), generator:make_points (-> +4)
    x = a + h # assignment, assignment_lhs_identifier:x, assignment_rhs_atom:a, assignment_rhs_atom:h, binary_operator:Add
    while x < (b - h): # binary_operator:Sub, comparison_operator:Lt, while (-> +2)
...
def zeller(date_input: str) -> str: # function:zeller (-> +46), function_returning_something:zeller (-> +46)
    ...
    if not 0 < len(date_input) < 11: # call_argument:date_input, chained_comparison:2, chained_inequalities:2, comparison_operator:Lt, function_call:len, if (-> +1), if_test_atom:0, if_test_atom:11, if_test_atom:date_input, int_literal, literal:Num, suggest_constant_definition, unary_operator:Not
    ...
    if not 0 < m < 13: # chained_comparison:2, chained_inequalities:2, comparison_operator:Lt, if (-> +1), if_test_atom:0, if_test_atom:13, if_test_atom:m, int_literal, literal:Num, suggest_constant_definition, unary_operator:Not
    ...
    if not 0 < d < 32: # chained_comparison:2, chained_inequalities:2, comparison_operator:Lt, if (-> +1), if_test_atom:0, if_test_atom:32, if_test_atom:d, int_literal, literal:Num, suggest_constant_definition, unary_operator:Not
    ...
    if m <= 2: # comparison_operator:LtE, if (-> +2), if_test_atom:2, if_test_atom:m, int_literal, literal:Num
        y = y - 1 # assignment, assignment_lhs_identifier:y, assignment_rhs_atom:1, assignment_rhs_atom:y, binary_operator:Sub, decrement_variable:y:1, if_then_branch (-> +1), int_literal, literal:Num, suggest_augmented_assignment, variable_update:y:1, variable_update_by_assignment:y:1
        m = m + 12 # assignment, assignment_lhs_identifier:m, assignment_rhs_atom:12, assignment_rhs_atom:m, binary_operator:Add, increment_variable:m:12, int_literal, literal:Num, suggest_augmented_assignment, suggest_constant_definition, variable_update:m:12, variable_update_by_assignment:m:12
    ...
    if f != convert_datetime_days[dt_ck.weekday()]: # comparison_operator:NotEq, if (-> +1), if_test_atom:convert_datetime_days, if_test_atom:dt_ck, if_test_atom:f, index, method_call, method_call_name:weekday, method_call_object:dt_ck
