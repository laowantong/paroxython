...
def solution(n): # function:solution (-> +8), function_returning_something:solution (-> +8)
    ...
    return sum # return, return_something
...
def solution(n): # function:solution (-> +22), function_returning_something:solution (-> +22)
    ...
    return sum(collection) # call_parameter:collection, function_call:sum, return, return_something
...
def solution(n): # function:solution (-> +9), function_returning_something:solution (-> +9)
    ...
    return result # return, return_something
...
def solution(n): # function:solution (-> +7), function_returning_something:solution (-> +7)
    ...
    return ls # return, return_something
...
def solution(n): # function:solution (-> +9), function_returning_something:solution (-> +9)
    if n <= 1: # comparison_operator:LtE, if (-> +1), if_test_id:n, int_literal, literal:Num
        return 0 # if_then_branch, int_literal, literal:Num, return, return_something
    ...
    return count + b # binary_operator:Add, return, return_something
...
def solution(n): # function:solution (-> +12), function_returning_something:solution (-> +12)
    ...
    return int(sum) # call_parameter:sum, function_call:int, return, return_something
...
def isprime(no): # function:isprime (-> +9), function_returning_something:isprime (-> +9)
    if no == 2: # comparison_operator:Eq, if (-> +3), if_test_id:no, int_literal, literal:Num
        return True # if_then_branch, literal:True, return, return_something
    elif no % 2 == 0: # binary_operator:Mod, comparison_operator:Eq, divisibility_test:2, if (-> +1), if_test_id:no, int_literal, literal:Num
        return False # if_elif_branch, literal:False, return, return_something
    ...
    for i in range(3, sq, 2): # call_parameter:sq, for:i (-> +2), for_range_step:2 (-> +2), function_call:range, int_literal, literal:Num, suggest_constant_definition, universal_quantifier (-> +3)
        if no % i == 0: # binary_operator:Mod, comparison_operator:Eq, divisibility_test, if (-> +1), if_test_id:i, if_test_id:no, int_literal, literal:Num
            return False # if_then_branch, literal:False, return, return_something
    return True # literal:True, return, return_something
def solution(n): # function:solution (-> +24), function_returning_something:solution (-> +24)
    ...
    if isprime(n): # call_parameter:n, function_call:isprime, if (-> +16), if_test_id:isprime, if_test_id:n
        return n # if_then_branch, return, return_something
    else:
        ...
        if isprime(n): # call_parameter:n, function_call:isprime, if (-> +11), if_test_id:isprime, if_test_id:n, nested_if:1 (-> +11)
            return int(n) # call_parameter:n, function_call:int, if_then_branch, return, return_something
        else:
            ...
            return maxNumber # return, return_something
...
def solution(n): # function:solution (-> +16), function_returning_something:solution (-> +16)
    ...
    return int(prime) # call_parameter:prime, function_call:int, return, return_something
...
def solution(n: int) -> int: # function:solution (-> +18), function_returning_something:solution (-> +18)
    ...
    if n == 2: # comparison_operator:Eq, if (-> +1), if_test_id:n, int_literal, literal:Num
        return 2 # if_then_branch, int_literal, literal:Num, return, return_something
    while n > 2: # comparison_operator:Gt, evolve_state (-> +6), int_literal, literal:Num, while (-> +6)
        ...
        i += 1 # assignment_lhs_identifier:i, augmented_assignment, int_literal, literal:Num
    return int(ans) # call_parameter:ans, function_call:int, return, return_something
        ...
        if strNumber == strNumber[::-1]: # comparison_operator:Eq, if (-> +5), if_test_id:strNumber, int_literal, literal:Num, slice_step
            ...
            while divisor != 99: # comparison_operator:NotEq, evolve_state (-> +3), int_literal, literal:Num, suggest_constant_definition, while (-> +3)
                if (number % divisor == 0) and (len(str(int(number / divisor))) == 3): # binary_operator:Div, binary_operator:Mod, boolean_operator:And, comparison_operator:Eq, composition, divisibility_test, function_call:int, function_call:len, function_call:str, if (-> +1), if_test_id:divisor, if_test_id:int, if_test_id:len, if_test_id:number, if_test_id:str, int_literal, literal:Num, nested_if:1 (-> +1), suggest_constant_definition
                    return number # if_then_branch, return, return_something
...
def solution(n): # function:solution (-> +7), function_returning_something:solution (-> +7)
    ...
    return answer # return, return_something
...
def solution(n): # function:solution (-> +18), function_returning_something:solution (-> +18)
    ...
    while 1: # int_literal, literal:Num, while (-> +10)
        ...
        if nfound == 0: # comparison_operator:Eq, if (-> +3), if_test_id:nfound, int_literal, literal:Num
            ...
            return i # return, return_something
...
def gcd(x, y): # function:gcd (-> +1), function_returning_something:gcd (-> +1), recursive_function:gcd (-> +1)
    return x if y == 0 else gcd(y, x % y) # binary_operator:Mod, call_parameter:y, comparison_operator:Eq, conditional_expression, function_call:gcd, int_literal, literal:Num, return, return_something
def lcm(x, y): # function:lcm (-> +1), function_returning_something:lcm (-> +1)
    return (x * y) // gcd(x, y) # binary_operator:FloorDiv, binary_operator:Mult, call_parameter:x, call_parameter:y, function_call:gcd, return, return_something
def solution(n): # function:solution (-> +4), function_returning_something:solution (-> +4)
    ...
    return g # return, return_something
...
def solution(n): # function:solution (-> +4), function_returning_something:solution (-> +4)
    ...
    return int(suma - sumb) # binary_operator:Sub, function_call:int, return, return_something
...
def solution(n): # function:solution (-> +3), function_returning_something:solution (-> +3)
    ...
    return square_of_sum - sum_of_squares # binary_operator:Sub, return, return_something
...
def solution(n): # function:solution (-> +3), function_returning_something:solution (-> +3)
    ...
    return int(square_of_sum - sum_of_squares) # binary_operator:Sub, function_call:int, return, return_something
...
def solution(n): # function:solution (-> +11), function_returning_something:solution (-> +11)
    ...
    while i != n: # comparison_operator:NotEq, while (-> +3)
        ...
        if isprime(j): # call_parameter:j, function_call:isprime, if (-> +1), if_test_id:isprime, if_test_id:j
            i += 1 # assignment_lhs_identifier:i, augmented_assignment, if_then_branch, int_literal, literal:Num
    return j # return, return_something
...
def solution(n): # function:solution (-> +15), function_returning_something:solution (-> +15)
    ...
    return primes[len(primes) - 1] # binary_operator:Sub, call_parameter:primes, function_call:len, index, index_arithmetic, int_literal, literal:Num, return, return_something
...
def prime_generator(): # function:prime_generator (-> +5), generator:prime_generator (-> +5)
    ...
    while True: # literal:True, while (-> +3)
        ...
        num += 1 # assignment_lhs_identifier:num, augmented_assignment, int_literal, literal:Num
def solution(n): # function:solution (-> +1), function_returning_something:solution (-> +1)
    return next(itertools.islice(prime_generator(), n - 1, n)) # binary_operator:Sub, call_parameter:n, composition, function_call:next, function_call:prime_generator, int_literal, literal:Num, method_call:islice, return, return_something
...
def solution(n): # function:solution (-> +8), function_returning_something:solution (-> +8)
    ...
    return LargestProduct # return, return_something
...
def solution(n): # function:solution (-> +4), function_returning_something:solution (-> +4)
    return max( # composition, function_call:max, return, return_something
        [
...
def streval(s: str) -> int: # function:streval (-> +4), function_returning_something:streval (-> +4)
    ...
    return ret # return, return_something
                ...
                if a < b < c: # chained_comparison:2, chained_inequalities:2, comparison_operator:Lt, if (-> +3), if_test_id:a, if_test_id:b, if_test_id:c
                    if (a ** 2) + (b ** 2) == (c ** 2): # binary_operator:Add, binary_operator:Pow, comparison_operator:Eq, if (-> +2), if_test_id:a, if_test_id:b, if_test_id:c, if_then_branch (-> +2), int_literal, literal:Num, nested_if:1 (-> +2)
                        if (a + b + c) == 1000: # binary_operator:Add, comparison_operator:Eq, if (-> +1), if_test_id:a, if_test_id:b, if_test_id:c, if_then_branch (-> +1), int_literal, literal:Num, nested_if:2 (-> +1), suggest_constant_definition
                            return a * b * c # binary_operator:Mult, if_then_branch, return, return_something
...
def solution(n): # function:solution (-> +10), function_returning_something:solution (-> +10)
    ...
    return product # return, return_something

# ----------------------------------------------------------------------------------------
# ../Python/project_euler/problem_09/sol3.py
# ----------------------------------------------------------------------------------------
def solution(): # function:solution (-> +7), function_returning_something:solution (-> +7)
    return [ # return, return_something
...
def sum_of_primes(n): # function:sum_of_primes (-> +8), function_returning_something:sum_of_primes (-> +8)
    if n > 2: # comparison_operator:Gt, if (-> +3), if_test_id:n, int_literal, literal:Num
        ...
        return 0 # if_else_branch, int_literal, literal:Num, return, return_something
    ...
    return sumOfPrimes # return, return_something
def solution(n): # function:solution (-> +1), function_returning_something:solution (-> +1)
    return sum_of_primes(n) # call_parameter:n, function_call:sum_of_primes, return, return_something
...
def prime_generator(): # function:prime_generator (-> +5), generator:prime_generator (-> +5)
    ...
    while True: # literal:True, while (-> +3)
        ...
        num += 1 # assignment_lhs_identifier:num, augmented_assignment, int_literal, literal:Num
def solution(n): # function:solution (-> +1), function_returning_something:solution (-> +1)
    return sum(takewhile(lambda x: x < n, prime_generator())) # comparison_operator:Lt, composition, function_call:prime_generator, function_call:sum, function_call:takewhile, lambda_function, return, return_something
...
def prime_sum(n: int) -> int: # function:prime_sum (-> +12), function_returning_something:prime_sum (-> +12)
    ...
    return s # return, return_something
...
def largest_product(grid): # function:largest_product (-> +27), function_returning_something:largest_product (-> +27)
    ...
    return largest # return, return_something
def solution(): # function:solution (-> +6), function_returning_something:solution (-> +6)
    ...
    return largest_product(grid) # call_parameter:grid, function_call:largest_product, return, return_something
    ...
    with open(os.path.dirname(__file__) + "/grid.txt") as f: # binary_operator:Add, call_parameter:__file__, composition, function_call:open, literal:Str, method_call:dirname
        ...
        for i in range(17): # for:i (-> +4), for_range_stop (-> +4), function_call:range, int_literal, literal:Num, suggest_constant_definition
            for j in range(3, 20): # for:j (-> +3), for_range_start (-> +3), function_call:range, int_literal, literal:Num, nested_for:1 (-> +3), suggest_constant_definition
                ...
                if temp > maximum: # comparison_operator:Gt, if (-> +1), if_test_id:maximum, if_test_id:temp
                    maximum = temp # assignment, assignment_lhs_identifier:maximum, assignment_rhs_identifier:temp, if_then_branch
        return maximum # return, return_something
...
def count_divisors(n): # function:count_divisors (-> +7), function_returning_something:count_divisors (-> +7)
    ...
    return nDivisors # return, return_something
def solution(): # function:solution (-> +8), function_returning_something:solution (-> +8)
    ...
    while True: # literal:True, while (-> +4)
        ...
        if count_divisors(tNum) > 500: # call_parameter:tNum, comparison_operator:Gt, function_call:count_divisors, if (-> +1), if_test_id:count_divisors, if_test_id:tNum, int_literal, literal:Num, suggest_constant_definition
            break # if_then_branch
    return tNum # return, return_something
...
def solution(n): # function:solution (-> +16), function_returning_something:solution (-> +16)
    ...
    return {"counter": pre_counter, "largest_number": largest_number} # literal:Str, return, return_something
...
def collatz_sequence(n): # function:collatz_sequence (-> +8), function_returning_something:collatz_sequence (-> +8)
    ...
    return sequence # return, return_something
def solution(n): # function:solution (-> +2), function_returning_something:solution (-> +2)
    ...
    return {"counter": result[0], "largest_number": result[1]} # index, int_literal, literal:Num, literal:Str, return, return_something
...
def lattice_paths(n): # function:lattice_paths (-> +3), function_returning_something:lattice_paths (-> +3)
    ...
    return int(factorial(n) / (factorial(k) * factorial(n - k))) # binary_operator:Div, binary_operator:Mult, binary_operator:Sub, call_parameter:k, call_parameter:n, composition, function_call:factorial, function_call:int, return, return_something
...
def solution(power): # function:solution (-> +7), function_returning_something:solution (-> +7)
    ...
    return sum_of_num # return, return_something
...
def solution(power): # function:solution (-> +5), function_returning_something:solution (-> +5)
    ...
    return r # return, return_something
...
def solution(n): # function:solution (-> +17), function_returning_something:solution (-> +17)
    ...
    return count # return, return_something
...
def solution(): # function:solution (-> +17), function_returning_something:solution (-> +17)
    ...
    return max(a[-1]) # function_call:max, index, int_literal, literal:Num, negative_index:-1, return, return_something
...
def solution(): # function:solution (-> +24), function_returning_something:solution (-> +24)
    ...
    return sundays # return, return_something
...
def factorial(n): # function:factorial (-> +4), function_returning_something:factorial (-> +4)
    ...
    return fact # return, return_something
def split_and_add(number): # function:split_and_add (-> +6), function_returning_something:split_and_add (-> +6)
    ...
    return sum_of_digits # return, return_something
def solution(n): # function:solution (-> +3), function_returning_something:solution (-> +3)
...
from math import factorial # import:math:factorial, import_module:math, import_name:factorial
def solution(n): # function:solution (-> +1), function_returning_something:solution (-> +1)
    return sum([int(x) for x in str(factorial(n))]) # call_parameter:n, call_parameter:x, composition, comprehension:List, comprehension_for_count:1, function_call:factorial, function_call:int, function_call:str, function_call:sum, return, return_something
...
from math import factorial # import:math:factorial, import_module:math, import_name:factorial
def solution(n): # function:solution (-> +1), function_returning_something:solution (-> +1)
    return sum(map(int, str(factorial(n)))) # call_parameter:int, call_parameter:n, composition, function_call:factorial, function_call:map, function_call:str, function_call:sum, return, return_something
...
def sum_of_divisors(n): # function:sum_of_divisors (-> +7), function_returning_something:sum_of_divisors (-> +7)
    ...
    return total - n # binary_operator:Sub, return, return_something
def solution(n): # function:solution (-> +8), function_returning_something:solution (-> +8)
    ...
    return total # return, return_something
...
def solution(): # function:solution (-> +12), function_returning_something:solution (-> +12)
    ...
    for i, name in enumerate(names): # call_parameter:names, for:i:name (-> +4), for_indexes_elements (-> +4), function_call:enumerate
        ...
        name_score = 0 # assignment, assignment_lhs_identifier:name_score, int_literal, literal:Num
    return total_score # return, return_something
...
def solution(): # function:solution (-> +12), function_returning_something:solution (-> +12)
    ...
    for i in range(len(name)): # accumulate_elements:1 (-> +4), call_parameter:name, composition, for:i (-> +4), for_indexes (-> +4), for_range_stop (-> +4), function_call:len, function_call:range
        ...
        temp_sum = 0 # assignment, assignment_lhs_identifier:temp_sum, int_literal, literal:Num
    return total_sum # return, return_something
...
def solution(limit=28123): # function:solution (-> +13), function_returning_something:solution (-> +13), function_with_default_positional_arguments:solution (-> +13), int_literal, literal:Num
    ...
    return res # return, return_something
...
def fib(a, b, n): # function:fib (-> +13), function_returning_something:fib (-> +13)
    if n == 1: # comparison_operator:Eq, if (-> +5), if_test_id:n, int_literal, literal:Num
        return a # if_then_branch, return, return_something
    elif n == 2: # comparison_operator:Eq, if (-> +3), if_test_id:n, int_literal, literal:Num
        return b # if_elif_branch, return, return_something
    elif n == 3: # comparison_operator:Eq, if (-> +1), if_test_id:n, int_literal, literal:Num, suggest_constant_definition
        return str(a) + str(b) # binary_operator:Add, call_parameter:a, call_parameter:b, function_call:str, if_elif_branch, return, return_something
    ...
    return c # return, return_something
def solution(n): # function:solution (-> +11), function_returning_something:solution (-> +11)
    ...
    return semidivisible # return, return_something
...
def solution(): # function:solution (-> +2), function_returning_something:solution (-> +2)
    ...
    return result[999999] # index, int_literal, literal:Num, return, return_something, suggest_constant_definition
...
def fibonacci(n): # function:fibonacci (-> +9), function_returning_something:fibonacci (-> +9)
    if n == 1 or type(n) is not int: # boolean_operator:Or, call_parameter:n, comparison_operator:Eq, comparison_operator:IsNot, function_call:type, if (-> +8), if_test_id:int, if_test_id:n, if_test_id:type, int_literal, literal:Num
        ...
        return 1 # if_elif_branch, int_literal, literal:Num, return, return_something
    else:
        ...
        return sequence[n] # index, return, return_something
def fibonacci_digits_index(n): # function:fibonacci_digits_index (-> +6), function_returning_something:fibonacci_digits_index (-> +6)
    ...
    return index # return, return_something
def solution(n): # function:solution (-> +1), function_returning_something:solution (-> +1)
    return fibonacci_digits_index(n) # call_parameter:n, function_call:fibonacci_digits_index, return, return_something
...
def solution(n): # function:solution (-> +5), function_returning_something:solution (-> +5)
    ...
    return answer + 1 # binary_operator:Add, int_literal, literal:Num, return, return_something
...
def is_prime(k: int) -> bool: # function:is_prime (-> +9), function_returning_something:is_prime (-> +9)
    if k < 2 or k % 2 == 0: # binary_operator:Mod, boolean_operator:Or, comparison_operator:Eq, comparison_operator:Lt, divisibility_test:2, if (-> +7), if_test_id:k, int_literal, literal:Num
        ...
        return True # if_elif_branch, literal:True, return, return_something
    else:
...
def solution(a_limit: int, b_limit: int) -> int: # function:solution (-> +13), function_returning_something:solution (-> +13)
    ...
    return ans # return, return_something
...
def solution(n): # function:solution (-> +8), function_returning_something:solution (-> +8)
    ...
    return len(collectPowers) # call_parameter:collectPowers, function_call:len, return, return_something

# ----------------------------------------------------------------------------------------
# ../Python/project_euler/problem_31/sol1.py
# ----------------------------------------------------------------------------------------
def one_pence(): # function:one_pence (-> +1), function_returning_something:one_pence (-> +1)
    return 1 # int_literal, literal:Num, return, return_something
def two_pence(x): # body_recursive_function:two_pence (-> +1), function:two_pence (-> +1), function_returning_something:two_pence (-> +1), recursive_function:two_pence (-> +1)
    return 0 if x < 0 else two_pence(x - 2) + one_pence() # binary_operator:Add, binary_operator:Sub, comparison_operator:Lt, conditional_expression, function_call:one_pence, function_call:two_pence, int_literal, literal:Num, return, return_something
def five_pence(x): # body_recursive_function:five_pence (-> +1), function:five_pence (-> +1), function_returning_something:five_pence (-> +1), recursive_function:five_pence (-> +1)
    return 0 if x < 0 else five_pence(x - 5) + two_pence(x) # binary_operator:Add, binary_operator:Sub, call_parameter:x, comparison_operator:Lt, conditional_expression, function_call:five_pence, function_call:two_pence, int_literal, literal:Num, return, return_something, suggest_constant_definition
def ten_pence(x): # body_recursive_function:ten_pence (-> +1), function:ten_pence (-> +1), function_returning_something:ten_pence (-> +1), recursive_function:ten_pence (-> +1)
    return 0 if x < 0 else ten_pence(x - 10) + five_pence(x) # binary_operator:Add, binary_operator:Sub, call_parameter:x, comparison_operator:Lt, conditional_expression, function_call:five_pence, function_call:ten_pence, int_literal, literal:Num, return, return_something, suggest_constant_definition
def twenty_pence(x): # body_recursive_function:twenty_pence (-> +1), function:twenty_pence (-> +1), function_returning_something:twenty_pence (-> +1), recursive_function:twenty_pence (-> +1)
    return 0 if x < 0 else twenty_pence(x - 20) + ten_pence(x) # binary_operator:Add, binary_operator:Sub, call_parameter:x, comparison_operator:Lt, conditional_expression, function_call:ten_pence, function_call:twenty_pence, int_literal, literal:Num, return, return_something, suggest_constant_definition
def fifty_pence(x): # body_recursive_function:fifty_pence (-> +1), function:fifty_pence (-> +1), function_returning_something:fifty_pence (-> +1), recursive_function:fifty_pence (-> +1)
    return 0 if x < 0 else fifty_pence(x - 50) + twenty_pence(x) # binary_operator:Add, binary_operator:Sub, call_parameter:x, comparison_operator:Lt, conditional_expression, function_call:fifty_pence, function_call:twenty_pence, int_literal, literal:Num, return, return_something, suggest_constant_definition
def one_pound(x): # body_recursive_function:one_pound (-> +1), function:one_pound (-> +1), function_returning_something:one_pound (-> +1), recursive_function:one_pound (-> +1)
    return 0 if x < 0 else one_pound(x - 100) + fifty_pence(x) # binary_operator:Add, binary_operator:Sub, call_parameter:x, comparison_operator:Lt, conditional_expression, function_call:fifty_pence, function_call:one_pound, int_literal, literal:Num, return, return_something, suggest_constant_definition
def two_pound(x): # body_recursive_function:two_pound (-> +1), function:two_pound (-> +1), function_returning_something:two_pound (-> +1), recursive_function:two_pound (-> +1)
    return 0 if x < 0 else two_pound(x - 200) + one_pound(x) # binary_operator:Add, binary_operator:Sub, call_parameter:x, comparison_operator:Lt, conditional_expression, function_call:one_pound, function_call:two_pound, int_literal, literal:Num, return, return_something, suggest_constant_definition
def solution(n): # function:solution (-> +1), function_returning_something:solution (-> +1)
    return two_pound(n) # call_parameter:n, function_call:two_pound, return, return_something
...
def isCombinationValid(combination): # function:isCombinationValid (-> +6), function_returning_something:isCombinationValid (-> +6)
    return ( # boolean_operator:Or, return, return_something
...
def solution(): # function:solution (-> +6), function_returning_something:solution (-> +6)
    return sum( # composition, function_call:sum, return, return_something
...
def solve(digit_len: int) -> str: # function:solve (-> +13), function_returning_something:solve (-> +13)
    ...
    return solutions # return, return_something
...
def is_palindrome(n): # function:is_palindrome (-> +5), function_returning_something:is_palindrome (-> +5)
    ...
    if n == n[::-1]: # comparison_operator:Eq, if (-> +3), if_test_id:n, int_literal, literal:Num, slice_step, suggest_condition_return (-> +3)
        ...
        return False # if_else_branch, literal:False, return, return_something
def solution(n): # function:solution (-> +5), function_returning_something:solution (-> +5)
    total = 0 # assignment, assignment_lhs_identifier:total, int_literal, literal:Num
...
def solution(): # function:solution (-> +13), function_returning_something:solution (-> +13)
    ...
    return len(words) # call_parameter:words, function_call:len, return, return_something
...
def solution(): # function:solution (-> +4), function_returning_something:solution (-> +4)
    ...
    return str(total)[-10:] # call_parameter:total, function_call:str, int_literal, literal:Num, return, return_something, slice, suggest_constant_definition
...
def solution(): # function:solution (-> +12), function_returning_something:solution (-> +12)
    ...
    while True: # literal:True, while (-> +10)
        if ( # if (-> +8), if_test_id:i, if_test_id:list, if_test_id:sorted, if_test_id:str
            ...
            return i # if_then_branch, return, return_something
        i += 1 # assignment_lhs_identifier:i, augmented_assignment, int_literal, literal:Num
...
def combinations(n, r): # function:combinations (-> +1), function_returning_something:combinations (-> +1)
    return factorial(n) / (factorial(r) * factorial(n - r)) # binary_operator:Div, binary_operator:Mult, binary_operator:Sub, call_parameter:n, call_parameter:r, function_call:factorial, return, return_something
def solution(): # function:solution (-> +6), function_returning_something:solution (-> +6)
    total = 0 # assignment, assignment_lhs_identifier:total, int_literal, literal:Num
...
def next_term(a_i, k, i, n): # function:next_term (-> +50), function_returning_something:next_term (-> +50), recursive_function:next_term (-> +50)
    ...
    if dn >= max_dn or c + diff >= base[k]: # binary_operator:Add, boolean_operator:Or, comparison_operator:GtE, if (-> +1), if_test_id:base, if_test_id:c, if_test_id:diff, if_test_id:dn, if_test_id:k, if_test_id:max_dn, index
        return diff, dn # if_then_branch, return, return_something
    ...
    return (diff, dn) # return, return_something
def compute(a_i, k, i, n): # function:compute (-> +25), function_returning_something:compute (-> +25)
    if i >= n: # comparison_operator:GtE, if (-> +1), if_test_id:i, if_test_id:n
        return 0, i # if_then_branch, int_literal, literal:Num, return, return_something
    ...
    return diff, i - start_i # binary_operator:Sub, return, return_something
...
def solution(n): # function:solution (-> +12), function_returning_something:solution (-> +12)
    ...
    return a_n # return, return_something
...
def partition(m): # function:partition (-> +9), function_returning_something:partition (-> +9)
    ...
    return memo[m][m - 1] - 1 # binary_operator:Sub, index, index_arithmetic, int_literal, literal:Num, return, return_something
...
def find_largest(data_file: str = "base_exp.txt") -> int: # function:find_largest (-> +6), function_returning_something:find_largest (-> +6), function_with_default_positional_arguments:find_largest (-> +6), literal:Str
    ...
    return largest[1] # index, int_literal, literal:Num, return, return_something
