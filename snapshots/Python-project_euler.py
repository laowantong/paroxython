...
def solution(n): # function:solution (-> +8), function_returning_something:solution (-> +8)
    ...
    sum += ((terms) * (6 + (terms - 1) * 3)) // 2 # assignment_lhs_identifier:sum, assignment_rhs_atom:1, assignment_rhs_atom:2, assignment_rhs_atom:3, assignment_rhs_atom:6, assignment_rhs_atom:terms, augmented_assignment:Add, binary_operator:Add, binary_operator:FloorDiv, binary_operator:Mult, binary_operator:Sub, increment_variable:sum:1, increment_variable:sum:2, increment_variable:sum:3, increment_variable:sum:6, increment_variable:sum:terms, int_literal, literal:Num, suggest_constant_definition, variable_update:sum:1, variable_update:sum:2, variable_update:sum:3, variable_update:sum:6, variable_update:sum:terms, variable_update_by_augmented_assignment:sum:1, variable_update_by_augmented_assignment:sum:2, variable_update_by_augmented_assignment:sum:3, variable_update_by_augmented_assignment:sum:6, variable_update_by_augmented_assignment:sum:terms
    ...
    sum += ((terms) * (10 + (terms - 1) * 5)) // 2 # assignment_lhs_identifier:sum, assignment_rhs_atom:1, assignment_rhs_atom:10, assignment_rhs_atom:2, assignment_rhs_atom:5, assignment_rhs_atom:terms, augmented_assignment:Add, binary_operator:Add, binary_operator:FloorDiv, binary_operator:Mult, binary_operator:Sub, increment_variable:sum:1, increment_variable:sum:10, increment_variable:sum:2, increment_variable:sum:5, increment_variable:sum:terms, int_literal, literal:Num, suggest_constant_definition, variable_update:sum:1, variable_update:sum:10, variable_update:sum:2, variable_update:sum:5, variable_update:sum:terms, variable_update_by_augmented_assignment:sum:1, variable_update_by_augmented_assignment:sum:10, variable_update_by_augmented_assignment:sum:2, variable_update_by_augmented_assignment:sum:5, variable_update_by_augmented_assignment:sum:terms
    ...
    sum -= ((terms) * (30 + (terms - 1) * 15)) // 2 # assignment_lhs_identifier:sum, assignment_rhs_atom:1, assignment_rhs_atom:15, assignment_rhs_atom:2, assignment_rhs_atom:30, assignment_rhs_atom:terms, augmented_assignment:Sub, binary_operator:Add, binary_operator:FloorDiv, binary_operator:Mult, binary_operator:Sub, decrement_variable:sum:1, decrement_variable:sum:15, decrement_variable:sum:2, decrement_variable:sum:30, decrement_variable:sum:terms, int_literal, literal:Num, suggest_constant_definition, variable_update:sum:1, variable_update:sum:15, variable_update:sum:2, variable_update:sum:30, variable_update:sum:terms, variable_update_by_augmented_assignment:sum:1, variable_update_by_augmented_assignment:sum:15, variable_update_by_augmented_assignment:sum:2, variable_update_by_augmented_assignment:sum:30, variable_update_by_augmented_assignment:sum:terms
...
def solution(n): # function:solution (-> +32), function_returning_something:solution (-> +32)
    ...
    while 1: # int_literal, literal:Num, while (-> +28)
        num += 3 # assignment_lhs_identifier:num, assignment_rhs_atom:3, augmented_assignment:Add, increment_variable:num:3, int_literal, literal:Num, suggest_constant_definition, variable_update:num:3, variable_update_by_augmented_assignment:num:3
        if num >= n: # comparison_operator:GtE, if (-> +1), if_test_atom:n, if_test_atom:num
            break # if_then_branch
        sum += num # assignment_lhs_identifier:sum, assignment_rhs_atom:num, augmented_assignment:Add, increment_variable:sum:num, variable_update:sum:num, variable_update_by_augmented_assignment:sum:num
        num += 2 # assignment_lhs_identifier:num, assignment_rhs_atom:2, augmented_assignment:Add, increment_variable:num:2, int_literal, literal:Num, variable_update:num:2, variable_update_by_augmented_assignment:num:2
        if num >= n: # comparison_operator:GtE, if (-> +1), if_test_atom:n, if_test_atom:num
            break # if_then_branch
        sum += num # assignment_lhs_identifier:sum, assignment_rhs_atom:num, augmented_assignment:Add, increment_variable:sum:num, variable_update:sum:num, variable_update_by_augmented_assignment:sum:num
        num += 1 # assignment_lhs_identifier:num, assignment_rhs_atom:1, augmented_assignment:Add, increment_variable:num:1, int_literal, literal:Num, variable_update:num:1, variable_update_by_augmented_assignment:num:1
        if num >= n: # comparison_operator:GtE, if (-> +1), if_test_atom:n, if_test_atom:num
            break # if_then_branch
        sum += num # assignment_lhs_identifier:sum, assignment_rhs_atom:num, augmented_assignment:Add, increment_variable:sum:num, variable_update:sum:num, variable_update_by_augmented_assignment:sum:num
        num += 3 # assignment_lhs_identifier:num, assignment_rhs_atom:3, augmented_assignment:Add, increment_variable:num:3, int_literal, literal:Num, suggest_constant_definition, variable_update:num:3, variable_update_by_augmented_assignment:num:3
...
def solution(n): # function:solution (-> +22), function_returning_something:solution (-> +22)
    ...
    while True: # infinite_while, literal:True, while (-> +7)
        ...
        if result < n: # comparison_operator:Lt, if (-> +5), if_test_atom:n, if_test_atom:result
            ...
            temp += 1 # assignment_lhs_identifier:temp, assignment_rhs_atom:1, augmented_assignment:Add, increment_variable:temp:1, int_literal, literal:Num, variable_update:temp:1, variable_update_by_augmented_assignment:temp:1
        else:
...
def solution(n): # function:solution (-> +9), function_returning_something:solution (-> +9)
    ...
    while a < n: # comparison_operator:Lt, while (-> +5)
        if a % 3 == 0 or a % 5 == 0: # binary_operator:Mod, boolean_operator:Or, comparison_operator:Eq, divisibility_test:3, divisibility_test:5, if (-> +3), if_test_atom:0, if_test_atom:3, if_test_atom:5, if_test_atom:a, int_literal, literal:Num, suggest_constant_definition
            result += a # assignment_lhs_identifier:result, assignment_rhs_atom:a, augmented_assignment:Add, if_then_branch, increment_variable:result:a, variable_update:result:a, variable_update_by_augmented_assignment:result:a
            ...
            result -= a # assignment_lhs_identifier:result, assignment_rhs_atom:a, augmented_assignment:Sub, decrement_variable:result:a, if_elif_branch, variable_update:result:a, variable_update_by_augmented_assignment:result:a
        a += 1 # assignment_lhs_identifier:a, assignment_rhs_atom:1, augmented_assignment:Add, increment_variable:a:1, int_literal, literal:Num, variable_update:a:1, variable_update_by_augmented_assignment:a:1
...
def solution(n): # function:solution (-> +7), function_returning_something:solution (-> +7)
    ...
    for i in range(n): # accumulate_elements:result (-> +4), call_argument:n, for:i (-> +4), for_range:n (-> +4), function_call:range, range:n
        if i % 3 == 0: # binary_operator:Mod, comparison_operator:Eq, divisibility_test:3, if (-> +3), if_test_atom:0, if_test_atom:3, if_test_atom:i, int_literal, literal:Num, suggest_constant_definition
            result += i # assignment_lhs_identifier:result, assignment_rhs_atom:i, augmented_assignment:Add, if_then_branch, increment_variable:result:i, variable_update:result:i, variable_update_by_augmented_assignment:result:i
            ...
            result += i # assignment_lhs_identifier:result, assignment_rhs_atom:i, augmented_assignment:Add, if_elif_branch, increment_variable:result:i, variable_update:result:i, variable_update_by_augmented_assignment:result:i
    return result # return:result
...
def solution(n): # function:solution (-> +8), function_returning_something:solution (-> +8)
    ...
    while j <= n: # comparison_operator:LtE, while (-> +3)
        if j % 2 == 0: # binary_operator:Mod, comparison_operator:Eq, divisibility_test:2, if (-> +1), if_test_atom:0, if_test_atom:2, if_test_atom:j, int_literal, literal:Num
            sum += j # assignment_lhs_identifier:sum, assignment_rhs_atom:j, augmented_assignment:Add, if_then_branch, increment_variable:sum:j, variable_update:sum:j, variable_update_by_augmented_assignment:sum:j
        i, j = j, i + j # assignment, assignment_lhs_identifier:i, assignment_lhs_identifier:j, assignment_rhs_atom:i, assignment_rhs_atom:j, binary_operator:Add, increment_variable:i:j, increment_variable:j:i, variable_update:i:j, variable_update:j:i, variable_update_by_assignment:i:j, variable_update_by_assignment:j:i
    return sum # return:sum
...
def solution(n): # function:solution (-> +7), function_returning_something:solution (-> +7)
    ...
    while b <= n: # comparison_operator:LtE, while (-> +3)
        ...
        a, b = b, a + b # assignment, assignment_lhs_identifier:a, assignment_lhs_identifier:b, assignment_rhs_atom:a, assignment_rhs_atom:b, binary_operator:Add, increment_variable:a:b, increment_variable:b:a, variable_update:a:b, variable_update:b:a, variable_update_by_assignment:a:b, variable_update_by_assignment:b:a
    return ls # return:ls
...
def solution(n): # function:solution (-> +9), function_returning_something:solution (-> +9)
    ...
    while 4 * b + a <= n: # binary_operator:Add, binary_operator:Mult, comparison_operator:LtE, int_literal, literal:Num, suggest_constant_definition, while (-> +2)
        a, b = b, 4 * b + a # assignment, assignment_lhs_identifier:a, assignment_lhs_identifier:b, assignment_rhs_atom:4, assignment_rhs_atom:a, assignment_rhs_atom:b, binary_operator:Add, binary_operator:Mult, increment_variable:a:4, increment_variable:a:b, increment_variable:b:4, increment_variable:b:a, int_literal, literal:Num, suggest_constant_definition, variable_update:a:4, variable_update:a:b, variable_update:b:4, variable_update:b:a, variable_update_by_assignment:a:4, variable_update_by_assignment:a:b, variable_update_by_assignment:b:4, variable_update_by_assignment:b:a
        count += a # assignment_lhs_identifier:count, assignment_rhs_atom:a, augmented_assignment:Add, increment_variable:count:a, variable_update:count:a, variable_update_by_augmented_assignment:count:a
...
def solution(n): # function:solution (-> +12), function_returning_something:solution (-> +12)
    ...
    while a[i] <= n: # comparison_operator:LtE, index, while (-> +4)
        ...
        if a[i + 2] > n: # binary_operator:Add, comparison_operator:Gt, if (-> +1), if_test_atom:2, if_test_atom:a, if_test_atom:i, if_test_atom:n, index, index_arithmetic, int_literal, literal:Num
            break # if_then_branch
        i += 1 # assignment_lhs_identifier:i, assignment_rhs_atom:1, augmented_assignment:Add, increment_variable:i:1, int_literal, literal:Num, variable_update:i:1, variable_update_by_augmented_assignment:i:1
    sum = 0 # assignment, assignment_lhs_identifier:sum, assignment_rhs_atom:0, int_literal, literal:Num
    for j in range(len(a) - 1): # accumulate_elements:sum (-> +2), binary_operator:Sub, call_argument:, call_argument:a, composition, for:j (-> +2), for_range:_ (-> +2), function_call:len, function_call:range, int_literal, literal:Num, range:_
        if a[j] % 2 == 0: # binary_operator:Mod, comparison_operator:Eq, divisibility_test:2, if (-> +1), if_test_atom:0, if_test_atom:2, if_test_atom:a, if_test_atom:j, index, int_literal, literal:Num
            sum += a[j] # assignment_lhs_identifier:sum, assignment_rhs_atom:a, assignment_rhs_atom:j, augmented_assignment:Add, if_then_branch, increment_variable:sum:a, increment_variable:sum:j, index, variable_update:sum:a, variable_update:sum:j, variable_update_by_augmented_assignment:sum:a, variable_update_by_augmented_assignment:sum:j
    return sum # return:sum
...
def solution(n): # function:solution (-> +24), function_returning_something:solution (-> +24)
    ...
    if isprime(n): # call_argument:n, function_call:isprime, if (-> +16), if_test_atom:n
        ...
        while n % 2 == 0: # binary_operator:Mod, comparison_operator:Eq, divisibility_test:2, evolve_state (-> +1), if_else_branch (-> +13), int_literal, literal:Num, while (-> +1)
            n = n / 2 # assignment, assignment_lhs_identifier:n, assignment_rhs_atom:2, assignment_rhs_atom:n, binary_operator:Div, int_literal, literal:Num, suggest_augmented_assignment, variable_update:n:2, variable_update_by_assignment:n:2
...
def solution(n: int) -> int: # function:solution (-> +18), function_returning_something:solution (-> +18)
    ...
    while n > 2: # comparison_operator:Gt, evolve_state (-> +6), int_literal, literal:Num, while (-> +6)
        ...
        while n % i == 0: # binary_operator:Mod, comparison_operator:Eq, divisibility_test, int_literal, literal:Num, while (-> +1)
            n = n / i # assignment, assignment_lhs_identifier:n, assignment_rhs_atom:i, assignment_rhs_atom:n, binary_operator:Div, suggest_augmented_assignment, variable_update:n:i, variable_update_by_assignment:n:i
        i += 1 # assignment_lhs_identifier:i, assignment_rhs_atom:1, augmented_assignment:Add, increment_variable:i:1, int_literal, literal:Num, variable_update:i:1, variable_update_by_augmented_assignment:i:1
    ...
    for number in range(n - 1, 10000, -1): # binary_operator:Sub, call_argument:, call_argument:-1, call_argument:10000, find_first_element (-> +6), for:number (-> +7), for_range:_:10000:-1 (-> +7), function_call:range, int_literal, literal:Num, range:_:10000:-1, suggest_constant_definition
        ...
        if strNumber == strNumber[::-1]: # comparison_operator:Eq, if (-> +5), if_test_atom:-1, if_test_atom:strNumber, int_literal, literal:Num, slice_step
            ...
            while divisor != 99: # comparison_operator:NotEq, evolve_state (-> +3), int_literal, literal:Num, suggest_constant_definition, while (-> +3)
                ...
                divisor -= 1 # assignment_lhs_identifier:divisor, assignment_rhs_atom:1, augmented_assignment:Sub, decrement_variable:divisor:1, int_literal, literal:Num, variable_update:divisor:1, variable_update_by_augmented_assignment:divisor:1
...
def solution(n): # function:solution (-> +18), function_returning_something:solution (-> +18)
    ...
    while 1: # int_literal, literal:Num, while (-> +10)
        i += n * (n - 1) # assignment_lhs_identifier:i, assignment_rhs_atom:1, assignment_rhs_atom:n, augmented_assignment:Add, binary_operator:Mult, binary_operator:Sub, increment_variable:i:1, increment_variable:i:n, int_literal, literal:Num, variable_update:i:1, variable_update:i:n, variable_update_by_augmented_assignment:i:1, variable_update_by_augmented_assignment:i:n
...
def solution(n): # function:solution (-> +4), function_returning_something:solution (-> +4)
    ...
    for i in range(1, n + 1): # accumulate_elements:g (-> +1), binary_operator:Add, call_argument:, call_argument:1, for:i (-> +1), for_range:1:_ (-> +1), function_call:range, int_literal, literal:Num, range:1:_
        g = lcm(g, i) # assignment, assignment_lhs_identifier:g, assignment_rhs_atom:g, assignment_rhs_atom:i, call_argument:g, call_argument:i, function_call:lcm, variable_update:g:i, variable_update_by_assignment:g:i
    return g # return:g
...
def solution(n): # function:solution (-> +7), function_returning_something:solution (-> +7)
    ...
    for i in range(1, n + 1): # accumulate_elements:suma (-> +2), accumulate_elements:sumb (-> +2), binary_operator:Add, call_argument:, call_argument:1, for:i (-> +2), for_range:1:_ (-> +2), function_call:range, int_literal, literal:Num, range:1:_
        suma += i ** 2 # assignment_lhs_identifier:suma, assignment_rhs_atom:2, assignment_rhs_atom:i, augmented_assignment:Add, binary_operator:Pow, increment_variable:suma:2, increment_variable:suma:i, int_literal, literal:Num, variable_update:suma:2, variable_update:suma:i, variable_update_by_augmented_assignment:suma:2, variable_update_by_augmented_assignment:suma:i
        sumb += i # assignment_lhs_identifier:sumb, assignment_rhs_atom:i, augmented_assignment:Add, increment_variable:sumb:i, variable_update:sumb:i, variable_update_by_augmented_assignment:sumb:i
...
def solution(n): # function:solution (-> +11), function_returning_something:solution (-> +11)
    ...
    while i != n and j < 3: # boolean_operator:And, comparison_operator:Lt, comparison_operator:NotEq, evolve_state (-> +3), int_literal, literal:Num, suggest_constant_definition, while (-> +3)
        j += 1 # assignment_lhs_identifier:j, assignment_rhs_atom:1, augmented_assignment:Add, increment_variable:j:1, int_literal, literal:Num, variable_update:j:1, variable_update_by_augmented_assignment:j:1
        if isprime(j): # call_argument:j, function_call:isprime, if (-> +1), if_test_atom:j
            i += 1 # assignment_lhs_identifier:i, assignment_rhs_atom:1, augmented_assignment:Add, if_then_branch, increment_variable:i:1, int_literal, literal:Num, variable_update:i:1, variable_update_by_augmented_assignment:i:1
    while i != n: # comparison_operator:NotEq, while (-> +3)
        j += 2 # assignment_lhs_identifier:j, assignment_rhs_atom:2, augmented_assignment:Add, increment_variable:j:2, int_literal, literal:Num, variable_update:j:2, variable_update_by_augmented_assignment:j:2
        if isprime(j): # call_argument:j, function_call:isprime, if (-> +1), if_test_atom:j
            i += 1 # assignment_lhs_identifier:i, assignment_rhs_atom:1, augmented_assignment:Add, if_then_branch, increment_variable:i:1, int_literal, literal:Num, variable_update:i:1, variable_update_by_augmented_assignment:i:1
    return j # return:j
...
def solution(n): # function:solution (-> +15), function_returning_something:solution (-> +15)
    ...
    while len(primes) < n: # call_argument:primes, comparison_operator:Lt, evolve_state (-> +5), function_call:len, while (-> +5)
        if isprime(num): # call_argument:num, function_call:isprime, if (-> +4), if_test_atom:num
            ...
            num += 1 # assignment_lhs_identifier:num, assignment_rhs_atom:1, augmented_assignment:Add, if_else_branch, increment_variable:num:1, int_literal, literal:Num, variable_update:num:1, variable_update_by_augmented_assignment:num:1
...
def solution(n: str) -> int: # function:solution (-> +12), function_returning_something:solution (-> +12)
    ...
    while cur_index < len(n) - 13: # binary_operator:Sub, call_argument:n, comparison_operator:Lt, function_call:len, int_literal, literal:Num, suggest_constant_definition, while (-> +7)
        if int(n[cur_index]) >= int(substr[0]): # call_argument:, comparison_operator:GtE, function_call:int, if (-> +6), if_test_atom:0, if_test_atom:cur_index, if_test_atom:n, if_test_atom:substr, index, int_literal, literal:Num
            substr = substr[1:] + n[cur_index] # assignment, assignment_lhs_identifier:substr, assignment_rhs_atom:1, assignment_rhs_atom:cur_index, assignment_rhs_atom:n, assignment_rhs_atom:substr, binary_operator:Add, if_then_branch (-> +1), increment_variable:substr:1, increment_variable:substr:cur_index, increment_variable:substr:n, index, int_literal, literal:Num, slice, variable_update:substr:1, variable_update:substr:cur_index, variable_update:substr:n, variable_update_by_assignment:substr:1, variable_update_by_assignment:substr:cur_index, variable_update_by_assignment:substr:n
            cur_index += 1 # assignment_lhs_identifier:cur_index, assignment_rhs_atom:1, augmented_assignment:Add, increment_variable:cur_index:1, int_literal, literal:Num, variable_update:cur_index:1, variable_update_by_augmented_assignment:cur_index:1
        else:
            LargestProduct = max(LargestProduct, streval(substr)) # assignment, assignment_lhs_identifier:LargestProduct, assignment_rhs_atom:LargestProduct, assignment_rhs_atom:substr, call_argument:, call_argument:LargestProduct, call_argument:substr, composition, function_call:max, function_call:streval, if_else_branch (-> +2), variable_update:LargestProduct:substr, variable_update_by_assignment:LargestProduct:substr
            ...
            cur_index += 13 # assignment_lhs_identifier:cur_index, assignment_rhs_atom:13, augmented_assignment:Add, increment_variable:cur_index:13, int_literal, literal:Num, suggest_constant_definition, variable_update:cur_index:13, variable_update_by_augmented_assignment:cur_index:13
    return LargestProduct # return:LargestProduct
...
def sum_of_primes(n): # function:sum_of_primes (-> +8), function_returning_something:sum_of_primes (-> +8)
    ...
    for i in range(3, n, 2): # accumulate_elements:sumOfPrimes (-> +2), call_argument:2, call_argument:3, call_argument:n, for:i (-> +2), for_range:3:n:2 (-> +2), function_call:range, int_literal, literal:Num, range:3:n:2, suggest_constant_definition
        if is_prime(i): # call_argument:i, function_call:is_prime, if (-> +1), if_test_atom:i
            sumOfPrimes += i # assignment_lhs_identifier:sumOfPrimes, assignment_rhs_atom:i, augmented_assignment:Add, if_then_branch, increment_variable:sumOfPrimes:i, variable_update:sumOfPrimes:i, variable_update_by_augmented_assignment:sumOfPrimes:i
...
def prime_sum(n: int) -> int: # function:prime_sum (-> +12), function_returning_something:prime_sum (-> +12)
    ...
    for i in range(n): # accumulate_elements:s (-> +2), call_argument:n, for:i (-> +2), for_range:n (-> +2), function_call:range, range:n
        if list_[i] == 0: # comparison_operator:Eq, if (-> +1), if_test_atom:0, if_test_atom:i, if_test_atom:list_, index, int_literal, literal:Num
            s += i # assignment_lhs_identifier:s, assignment_rhs_atom:i, augmented_assignment:Add, if_then_branch, increment_variable:s:i, variable_update:s:i, variable_update_by_augmented_assignment:s:i
    return s # return:s
...
def count_divisors(n): # function:count_divisors (-> +7), function_returning_something:count_divisors (-> +7)
    ...
    for i in range(1, int(sqrt(n)) + 1): # binary_operator:Add, call_argument:, call_argument:1, call_argument:n, composition, for:i (-> +2), for_range:1:_ (-> +2), function_call:int, function_call:range, function_call:sqrt, int_literal, literal:Num, range:1:_
        if n % i == 0: # binary_operator:Mod, comparison_operator:Eq, divisibility_test, if (-> +1), if_test_atom:0, if_test_atom:i, if_test_atom:n, int_literal, literal:Num
            nDivisors += 2 # assignment_lhs_identifier:nDivisors, assignment_rhs_atom:2, augmented_assignment:Add, if_then_branch, increment_variable:nDivisors:2, int_literal, literal:Num, variable_update:nDivisors:2, variable_update_by_augmented_assignment:nDivisors:2
    if n ** 0.5 == int(n ** 0.5): # binary_operator:Pow, call_argument:, comparison_operator:Eq, float_literal, function_call:int, if (-> +1), if_test_atom:0.5, if_test_atom:n, literal:Num, suggest_constant_definition
        nDivisors -= 1 # assignment_lhs_identifier:nDivisors, assignment_rhs_atom:1, augmented_assignment:Sub, decrement_variable:nDivisors:1, if_then_branch, int_literal, literal:Num, variable_update:nDivisors:1, variable_update_by_augmented_assignment:nDivisors:1
...
def solution(): # function:solution (-> +8), function_returning_something:solution (-> +8)
    ...
    while True: # infinite_while, literal:True, while (-> +4)
        i += 1 # assignment_lhs_identifier:i, assignment_rhs_atom:1, augmented_assignment:Add, increment_variable:i:1, int_literal, literal:Num, variable_update:i:1, variable_update_by_augmented_assignment:i:1
        tNum += i # assignment_lhs_identifier:tNum, assignment_rhs_atom:i, augmented_assignment:Add, increment_variable:tNum:i, variable_update:tNum:i, variable_update_by_augmented_assignment:tNum:i
    ...
    for input1 in range(n): # call_argument:n, for:input1 (-> +12), for_range:n (-> +12), function_call:range, range:n
        ...
        while number > 1: # comparison_operator:Gt, evolve_state (-> +6), int_literal, literal:Num, while (-> +6)
            if number % 2 == 0: # binary_operator:Mod, comparison_operator:Eq, divisibility_test:2, if (-> +5), if_test_atom:0, if_test_atom:2, if_test_atom:number, int_literal, literal:Num
                ...
                counter += 1 # assignment_lhs_identifier:counter, assignment_rhs_atom:1, augmented_assignment:Add, increment_variable:counter:1, int_literal, literal:Num, variable_update:counter:1, variable_update_by_augmented_assignment:counter:1
            else:
                number = (3 * number) + 1 # assignment, assignment_lhs_identifier:number, assignment_rhs_atom:1, assignment_rhs_atom:3, assignment_rhs_atom:number, binary_operator:Add, binary_operator:Mult, if_else_branch (-> +1), increment_variable:number:1, increment_variable:number:3, int_literal, literal:Num, suggest_constant_definition, variable_update:number:1, variable_update:number:3, variable_update_by_assignment:number:1, variable_update_by_assignment:number:3
                counter += 1 # assignment_lhs_identifier:counter, assignment_rhs_atom:1, augmented_assignment:Add, increment_variable:counter:1, int_literal, literal:Num, variable_update:counter:1, variable_update_by_augmented_assignment:counter:1
...
def collatz_sequence(n): # function:collatz_sequence (-> +8), function_returning_something:collatz_sequence (-> +8)
    ...
    while n != 1: # comparison_operator:NotEq, evolve_state (-> +5), int_literal, literal:Num, while (-> +5)
        if n % 2 == 0: # binary_operator:Mod, comparison_operator:Eq, divisibility_test:2, if (-> +3), if_test_atom:0, if_test_atom:2, if_test_atom:n, int_literal, literal:Num
            ...
            n = 3 * n + 1 # assignment, assignment_lhs_identifier:n, assignment_rhs_atom:1, assignment_rhs_atom:3, assignment_rhs_atom:n, binary_operator:Add, binary_operator:Mult, if_else_branch, increment_variable:n:1, increment_variable:n:3, int_literal, literal:Num, suggest_constant_definition, variable_update:n:1, variable_update:n:3, variable_update_by_assignment:n:1, variable_update_by_assignment:n:3
...
def lattice_paths(n): # function:lattice_paths (-> +3), function_returning_something:lattice_paths (-> +3)
    n = 2 * n # assignment, assignment_lhs_identifier:n, assignment_rhs_atom:2, assignment_rhs_atom:n, binary_operator:Mult, int_literal, literal:Num, variable_update:n:2, variable_update_by_assignment:n:2
...
def solution(power): # function:solution (-> +7), function_returning_something:solution (-> +7)
    ...
    for i in list_num: # accumulate_elements:sum_of_num (-> +1), for:i (-> +1), for_each (-> +1)
        sum_of_num += int(i) # assignment_lhs_identifier:sum_of_num, assignment_rhs_atom:i, augmented_assignment:Add, call_argument:i, function_call:int, increment_variable:sum_of_num:i, variable_update:sum_of_num:i, variable_update_by_augmented_assignment:sum_of_num:i
...
def solution(power): # function:solution (-> +5), function_returning_something:solution (-> +5)
    ...
    while n: # while (-> +1)
        r, n = r + n % 10, n // 10 # assignment, assignment_lhs_identifier:n, assignment_lhs_identifier:r, assignment_rhs_atom:10, assignment_rhs_atom:n, assignment_rhs_atom:r, binary_operator:Add, binary_operator:FloorDiv, binary_operator:Mod, increment_variable:n:10, increment_variable:n:r, increment_variable:r:10, increment_variable:r:n, int_literal, literal:Num, suggest_constant_definition, variable_update:n:10, variable_update:n:r, variable_update:r:10, variable_update:r:n, variable_update_by_assignment:n:10, variable_update_by_assignment:n:r, variable_update_by_assignment:r:10, variable_update_by_assignment:r:n
    return r # return:r
    ...
    for i in range(1, n + 1): # accumulate_elements:count (-> +12), binary_operator:Add, call_argument:, call_argument:1, for:i (-> +12), for_range:1:_ (-> +12), function_call:range, int_literal, literal:Num, range:1:_
        if i < 1000: # comparison_operator:Lt, if (-> +11), if_test_atom:1000, if_test_atom:i, int_literal, literal:Num, suggest_constant_definition
            if i >= 100: # comparison_operator:GtE, if (-> +3), if_test_atom:100, if_test_atom:i, if_then_branch (-> +8), int_literal, literal:Num, nested_if:1 (-> +3), suggest_constant_definition
                count += ones_counts[i // 100] + 7 # assignment_lhs_identifier:count, assignment_rhs_atom:100, assignment_rhs_atom:7, assignment_rhs_atom:i, assignment_rhs_atom:ones_counts, augmented_assignment:Add, binary_operator:Add, binary_operator:FloorDiv, if_then_branch (-> +2), increment_variable:count:100, increment_variable:count:7, increment_variable:count:i, increment_variable:count:ones_counts, index, index_arithmetic, int_literal, literal:Num, suggest_constant_definition, variable_update:count:100, variable_update:count:7, variable_update:count:i, variable_update:count:ones_counts, variable_update_by_augmented_assignment:count:100, variable_update_by_augmented_assignment:count:7, variable_update_by_augmented_assignment:count:i, variable_update_by_augmented_assignment:count:ones_counts
                if i % 100 != 0: # binary_operator:Mod, comparison_operator:NotEq, divisibility_test:100, if (-> +1), if_test_atom:0, if_test_atom:100, if_test_atom:i, int_literal, literal:Num, nested_if:2 (-> +1), suggest_constant_definition
                    count += 3 # assignment_lhs_identifier:count, assignment_rhs_atom:3, augmented_assignment:Add, if_then_branch, increment_variable:count:3, int_literal, literal:Num, suggest_constant_definition, variable_update:count:3, variable_update_by_augmented_assignment:count:3
            if 0 < i % 100 < 20: # binary_operator:Mod, chained_comparison:2, chained_inequalities:2, comparison_operator:Lt, if (-> +4), if_test_atom:0, if_test_atom:100, if_test_atom:20, if_test_atom:i, int_literal, literal:Num, nested_if:1 (-> +4), suggest_constant_definition
                count += ones_counts[i % 100] # assignment_lhs_identifier:count, assignment_rhs_atom:100, assignment_rhs_atom:i, assignment_rhs_atom:ones_counts, augmented_assignment:Add, binary_operator:Mod, if_then_branch, increment_variable:count:100, increment_variable:count:i, increment_variable:count:ones_counts, index, index_arithmetic, int_literal, literal:Num, suggest_constant_definition, variable_update:count:100, variable_update:count:i, variable_update:count:ones_counts, variable_update_by_augmented_assignment:count:100, variable_update_by_augmented_assignment:count:i, variable_update_by_augmented_assignment:count:ones_counts
            else:
                count += ones_counts[i % 10] # assignment_lhs_identifier:count, assignment_rhs_atom:10, assignment_rhs_atom:i, assignment_rhs_atom:ones_counts, augmented_assignment:Add, binary_operator:Mod, if_else_branch (-> +1), increment_variable:count:10, increment_variable:count:i, increment_variable:count:ones_counts, index, index_arithmetic, int_literal, literal:Num, suggest_constant_definition, variable_update:count:10, variable_update:count:i, variable_update:count:ones_counts, variable_update_by_augmented_assignment:count:10, variable_update_by_augmented_assignment:count:i, variable_update_by_augmented_assignment:count:ones_counts
                count += tens_counts[(i % 100 - i % 10) // 10] # assignment_lhs_identifier:count, assignment_rhs_atom:10, assignment_rhs_atom:100, assignment_rhs_atom:i, assignment_rhs_atom:tens_counts, augmented_assignment:Add, binary_operator:FloorDiv, binary_operator:Mod, binary_operator:Sub, increment_variable:count:10, increment_variable:count:100, increment_variable:count:i, increment_variable:count:tens_counts, index, index_arithmetic, int_literal, literal:Num, suggest_constant_definition, variable_update:count:10, variable_update:count:100, variable_update:count:i, variable_update:count:tens_counts, variable_update_by_augmented_assignment:count:10, variable_update_by_augmented_assignment:count:100, variable_update_by_augmented_assignment:count:i, variable_update_by_augmented_assignment:count:tens_counts
        else:
            count += ones_counts[i // 1000] + 8 # assignment_lhs_identifier:count, assignment_rhs_atom:1000, assignment_rhs_atom:8, assignment_rhs_atom:i, assignment_rhs_atom:ones_counts, augmented_assignment:Add, binary_operator:Add, binary_operator:FloorDiv, if_else_branch, increment_variable:count:1000, increment_variable:count:8, increment_variable:count:i, increment_variable:count:ones_counts, index, index_arithmetic, int_literal, literal:Num, suggest_constant_definition, variable_update:count:1000, variable_update:count:8, variable_update:count:i, variable_update:count:ones_counts, variable_update_by_augmented_assignment:count:1000, variable_update_by_augmented_assignment:count:8, variable_update_by_augmented_assignment:count:i, variable_update_by_augmented_assignment:count:ones_counts
...
def solution(): # function:solution (-> +24), function_returning_something:solution (-> +24)
    ...
    while year < 2001: # comparison_operator:Lt, evolve_state (-> +17), int_literal, literal:Num, suggest_constant_definition, while (-> +17)
        day += 7 # assignment_lhs_identifier:day, assignment_rhs_atom:7, augmented_assignment:Add, increment_variable:day:7, int_literal, literal:Num, suggest_constant_definition, variable_update:day:7, variable_update_by_augmented_assignment:day:7
        if (year % 4 == 0 and not year % 100 == 0) or (year % 400 == 0): # binary_operator:Mod, boolean_operator:And, boolean_operator:Or, comparison_operator:Eq, divisibility_test:100, divisibility_test:4, divisibility_test:400, if (-> +10), if_test_atom:0, if_test_atom:100, if_test_atom:4, if_test_atom:400, if_test_atom:year, int_literal, literal:Num, suggest_constant_definition, unary_operator:Not
            if day > days_per_month[month - 1] and month != 2: # binary_operator:Sub, boolean_operator:And, comparison_operator:Gt, comparison_operator:NotEq, if (-> +5), if_test_atom:1, if_test_atom:2, if_test_atom:day, if_test_atom:days_per_month, if_test_atom:month, if_then_branch (-> +5), index, index_arithmetic, int_literal, literal:Num, nested_if:1 (-> +5)
                ...
                month += 1 # assignment_lhs_identifier:month, assignment_rhs_atom:1, augmented_assignment:Add, if_elif_branch (-> +1), increment_variable:month:1, int_literal, literal:Num, variable_update:month:1, variable_update_by_augmented_assignment:month:1
                day = day - 29 # assignment, assignment_lhs_identifier:day, assignment_rhs_atom:29, assignment_rhs_atom:day, binary_operator:Sub, decrement_variable:day:29, int_literal, literal:Num, suggest_augmented_assignment, suggest_constant_definition, variable_update:day:29, variable_update_by_assignment:day:29
        else:
        ...
        if month > 12: # comparison_operator:Gt, if (-> +2), if_test_atom:12, if_test_atom:month, int_literal, literal:Num, suggest_constant_definition
            year += 1 # assignment_lhs_identifier:year, assignment_rhs_atom:1, augmented_assignment:Add, if_then_branch (-> +1), increment_variable:year:1, int_literal, literal:Num, variable_update:year:1, variable_update_by_augmented_assignment:year:1
            month = 1 # assignment, assignment_lhs_identifier:month, assignment_rhs_atom:1, int_literal, literal:Num
        if year < 2001 and day == 1: # boolean_operator:And, comparison_operator:Eq, comparison_operator:Lt, if (-> +1), if_test_atom:1, if_test_atom:2001, if_test_atom:day, if_test_atom:year, int_literal, literal:Num, suggest_constant_definition
            sundays += 1 # assignment_lhs_identifier:sundays, assignment_rhs_atom:1, augmented_assignment:Add, if_then_branch, increment_variable:sundays:1, int_literal, literal:Num, variable_update:sundays:1, variable_update_by_augmented_assignment:sundays:1
...
def split_and_add(number): # function:split_and_add (-> +6), function_returning_something:split_and_add (-> +6)
    ...
    while number > 0: # comparison_operator:Gt, evolve_state (-> +3), int_literal, literal:Num, while (-> +3)
        ...
        sum_of_digits += last_digit # assignment_lhs_identifier:sum_of_digits, assignment_rhs_atom:last_digit, augmented_assignment:Add, increment_variable:sum_of_digits:last_digit, variable_update:sum_of_digits:last_digit, variable_update_by_augmented_assignment:sum_of_digits:last_digit
        number = number // 10 # assignment, assignment_lhs_identifier:number, assignment_rhs_atom:10, assignment_rhs_atom:number, binary_operator:FloorDiv, int_literal, literal:Num, suggest_augmented_assignment, suggest_constant_definition, variable_update:number:10, variable_update_by_assignment:number:10
...
def solution(n): # function:solution (-> +7), function_returning_something:solution (-> +7)
    ...
    for j in str(fact): # accumulate_elements:result (-> +1), call_argument:fact, for:j (-> +1), function_call:str
        result += int(j) # assignment_lhs_identifier:result, assignment_rhs_atom:j, augmented_assignment:Add, call_argument:j, function_call:int, increment_variable:result:j, variable_update:result:j, variable_update_by_augmented_assignment:result:j
    return result # return:result
...
def sum_of_divisors(n): # function:sum_of_divisors (-> +7), function_returning_something:sum_of_divisors (-> +7)
    ...
    for i in range(1, int(sqrt(n) + 1)): # accumulate_elements:total (-> +4), binary_operator:Add, call_argument:, call_argument:1, call_argument:n, composition, for:i (-> +4), for_range:1:_ (-> +4), function_call:int, function_call:range, function_call:sqrt, int_literal, literal:Num, range:1:_
        if n % i == 0 and i != sqrt(n): # binary_operator:Mod, boolean_operator:And, call_argument:n, comparison_operator:Eq, comparison_operator:NotEq, divisibility_test, function_call:sqrt, if (-> +3), if_test_atom:0, if_test_atom:i, if_test_atom:n, int_literal, literal:Num
            total += i + n // i # assignment_lhs_identifier:total, assignment_rhs_atom:i, assignment_rhs_atom:n, augmented_assignment:Add, binary_operator:Add, binary_operator:FloorDiv, if_then_branch, increment_variable:total:i, increment_variable:total:n, variable_update:total:i, variable_update:total:n, variable_update_by_augmented_assignment:total:i, variable_update_by_augmented_assignment:total:n
        elif i == sqrt(n): # call_argument:n, comparison_operator:Eq, function_call:sqrt, if (-> +1), if_test_atom:i, if_test_atom:n
            total += i # assignment_lhs_identifier:total, assignment_rhs_atom:i, augmented_assignment:Add, if_elif_branch, increment_variable:total:i, variable_update:total:i, variable_update_by_augmented_assignment:total:i
...
def solution(limit=28123): # function:solution (-> +13), function_returning_something:solution (-> +13), function_with_default_positional_arguments:solution (-> +13), int_literal, literal:Num
    ...
    for i in range(2, int(limit ** 0.5) + 1): # accumulate_elements:sumDivs (-> +3), binary_operator:Add, binary_operator:Pow, call_argument:, call_argument:2, composition, float_literal, for:i (-> +3), for_range:2:_ (-> +3), for_range:_:_ (-> +3), function_call:int, function_call:range, int_literal, literal:Num, range:2:_, suggest_constant_definition
        sumDivs[i * i] += i # assignment_lhs_identifier:sumDivs, assignment_rhs_atom:i, augmented_assignment:Add, binary_operator:Mult, increment_variable:sumDivs:i, index, index_arithmetic, variable_update:sumDivs:i, variable_update_by_augmented_assignment:sumDivs:i
    ...
    for n in range(1, limit + 1): # accumulate_elements:abundants (-> +4), accumulate_elements:res (-> +4), binary_operator:Add, call_argument:, call_argument:1, for:n (-> +4), for_range:1:_ (-> +4), function_call:range, int_literal, literal:Num, range:1:_
        ...
        if not any((n - a in abundants) for a in abundants): # binary_operator:Sub, call_argument:, comparison_operator:In, comprehension:Generator, comprehension_for_count:1, function_call:any, if (-> +1), if_test_atom:a, if_test_atom:abundants, if_test_atom:n, unary_operator:Not
            res += n # assignment_lhs_identifier:res, assignment_rhs_atom:n, augmented_assignment:Add, if_then_branch, increment_variable:res:n, variable_update:res:n, variable_update_by_augmented_assignment:res:n
    ...
    for x in range(n): # call_argument:n, for:x (-> +8), for_range:n (-> +8), function_call:range, range:n
        ...
        while 1: # int_literal, literal:Num, while (-> +4)
            if len(fib(l[0], l[1], c2)) < int(l[2]): # call_argument:, call_argument:c2, comparison_operator:Lt, composition, function_call:fib, function_call:int, function_call:len, if (-> +3), if_test_atom:0, if_test_atom:1, if_test_atom:2, if_test_atom:c2, if_test_atom:l, index, int_literal, literal:Num
                c2 += 1 # assignment_lhs_identifier:c2, assignment_rhs_atom:1, augmented_assignment:Add, if_then_branch, increment_variable:c2:1, int_literal, literal:Num, variable_update:c2:1, variable_update_by_augmented_assignment:c2:1
            else:
                break # if_else_branch
        semidivisible.append(fib(l[0], l[1], c2 + 1)[int(l[2]) - 1]) # binary_operator:Add, binary_operator:Sub, call_argument:, composition, function_call:fib, function_call:int, index, index_arithmetic, int_literal, literal:Num, method_call, method_call_name:append, method_call_object:semidivisible
...
def fibonacci_digits_index(n): # function:fibonacci_digits_index (-> +6), function_returning_something:fibonacci_digits_index (-> +6)
    ...
    while digits < n: # comparison_operator:Lt, while (-> +2)
        index += 1 # assignment_lhs_identifier:index, assignment_rhs_atom:1, augmented_assignment:Add, increment_variable:index:1, int_literal, literal:Num, variable_update:index:1, variable_update_by_augmented_assignment:index:1
...
def solution(n): # function:solution (-> +5), function_returning_something:solution (-> +5)
    ...
    while len(str(next(gen))) < n: # call_argument:, call_argument:gen, comparison_operator:Lt, composition, function_call:len, function_call:next, function_call:str, while (-> +1)
        answer += 1 # assignment_lhs_identifier:answer, assignment_rhs_atom:1, augmented_assignment:Add, increment_variable:answer:1, int_literal, literal:Num, variable_update:answer:1, variable_update_by_augmented_assignment:answer:1
        ...
        for b in range(2, b_limit): # call_argument:2, call_argument:b_limit, for:b (-> +8), for_range:2:b_limit (-> +8), function_call:range, int_literal, literal:Num, nested_for:1 (-> +8), range:2:b_limit
            if is_prime(b): # call_argument:b, function_call:is_prime, if (-> +7), if_test_atom:b
                ...
                while is_prime((n ** 2) + (a * n) + b): # binary_operator:Add, binary_operator:Mult, binary_operator:Pow, call_argument:, function_call:is_prime, int_literal, literal:Num, while (-> +2)
                    count += 1 # assignment_lhs_identifier:count, assignment_rhs_atom:1, augmented_assignment:Add, increment_variable:count:1, int_literal, literal:Num, variable_update:count:1, variable_update_by_augmented_assignment:count:1
                    n += 1 # assignment_lhs_identifier:n, assignment_rhs_atom:1, augmented_assignment:Add, increment_variable:n:1, int_literal, literal:Num, variable_update:n:1, variable_update_by_augmented_assignment:n:1
...
def solve(digit_len: int) -> str: # function:solve (-> +13), function_returning_something:solve (-> +13)
    ...
    for num in range(den, last_digit): # accumulate_elements:solutions (-> +7), call_argument:den, call_argument:last_digit, for:num (-> +7), for_range:den:last_digit (-> +7), function_call:range, range:den:last_digit
        while den <= 99: # comparison_operator:LtE, evolve_state (-> +4), int_literal, literal:Num, suggest_constant_definition, while (-> +4)
            ...
            den += 1 # assignment_lhs_identifier:den, assignment_rhs_atom:1, augmented_assignment:Add, increment_variable:den:1, int_literal, literal:Num, variable_update:den:1, variable_update_by_augmented_assignment:den:1
        num += 1 # assignment_lhs_identifier:num, assignment_rhs_atom:1, augmented_assignment:Add, increment_variable:num:1, int_literal, literal:Num, variable_update:num:1, variable_update_by_augmented_assignment:num:1
...
def solution(n): # function:solution (-> +5), function_returning_something:solution (-> +5)
    ...
    for i in range(1, n): # accumulate_elements:total (-> +2), call_argument:1, call_argument:n, for:i (-> +2), for_range:1:n (-> +2), function_call:range, int_literal, literal:Num, range:1:n
        if is_palindrome(i) and is_palindrome(bin(i).split("b")[1]): # boolean_operator:And, call_argument:, call_argument:i, composition, function_call:bin, function_call:is_palindrome, if (-> +1), if_test_atom:1, if_test_atom:i, index, int_literal, literal:Num, literal:Str, method_call, method_call_name:split
            total += i # assignment_lhs_identifier:total, assignment_rhs_atom:i, augmented_assignment:Add, if_then_branch, increment_variable:total:i, variable_update:total:i, variable_update_by_augmented_assignment:total:i
    return total # return:total
...
def solution(): # function:solution (-> +13), function_returning_something:solution (-> +13)
    ...
    words = list(map(lambda word: word.strip('"'), words.strip("\r\n").split(","))) # assignment, assignment_lhs_identifier:words, assignment_rhs_atom:word, assignment_rhs_atom:words, call_argument:, composition, function_call:list, function_call:map, lambda_function, literal:Str, method_call, method_call_name:split, method_call_name:strip, method_call_object:words, method_chaining, variable_update:words:word, variable_update_by_assignment:words:word
    words = list( # assignment, assignment_lhs_identifier:words, composition, decrement_variable:words:64, decrement_variable:words:TRIANGULAR_NUMBERS, decrement_variable:words:word, decrement_variable:words:x, function_call:list, variable_update:words:64, variable_update:words:TRIANGULAR_NUMBERS, variable_update:words:word, variable_update:words:x, variable_update_by_assignment:words:64, variable_update_by_assignment:words:TRIANGULAR_NUMBERS, variable_update_by_assignment:words:word, variable_update_by_assignment:words:x
...
def solution(): # function:solution (-> +4), function_returning_something:solution (-> +4)
    ...
    for i in range(1, 1001): # accumulate_elements:total (-> +1), call_argument:1, call_argument:1001, for:i (-> +1), for_range:1:1001 (-> +1), function_call:range, int_literal, literal:Num, range:1:1001, suggest_constant_definition
        total += i ** i # assignment_lhs_identifier:total, assignment_rhs_atom:i, augmented_assignment:Add, binary_operator:Pow, increment_variable:total:i, variable_update:total:i, variable_update_by_augmented_assignment:total:i
    ...
    for i in range(1, 101): # call_argument:1, call_argument:101, for:i (-> +3), for_range:1:101 (-> +3), for_range:1:_ (-> +3), function_call:range, int_literal, literal:Num, range:1:101, suggest_constant_definition
        for j in range(1, i + 1): # binary_operator:Add, call_argument:, call_argument:1, for:j (-> +2), for_range:1:_ (-> +2), function_call:range, int_literal, literal:Num, nested_for:1 (-> +2), range:1:_
            if combinations(i, j) > 1e6: # call_argument:i, call_argument:j, comparison_operator:Gt, float_literal, function_call:combinations, if (-> +1), if_test_atom:1000000.0, if_test_atom:i, if_test_atom:j, literal:Num, suggest_constant_definition
                total += 1 # assignment_lhs_identifier:total, assignment_rhs_atom:1, augmented_assignment:Add, if_then_branch, increment_variable:total:1, int_literal, literal:Num, variable_update:total:1, variable_update_by_augmented_assignment:total:1
    return total # return:total
...
def next_term(a_i, k, i, n): # body_recursive_function:next_term (-> +50), function:next_term (-> +50), function_returning_something:next_term (-> +50), recursive_function:next_term (-> +50)
    ...
    for j in range(k, len(a_i)): # accumulate_elements:ds_b (-> +1), call_argument:, call_argument:a_i, call_argument:k, composition, for:j (-> +1), for_range:k:_ (-> +1), function_call:len, function_call:range, range:k:_
        ds_b += a_i[j] # assignment_lhs_identifier:ds_b, assignment_rhs_atom:a_i, assignment_rhs_atom:j, augmented_assignment:Add, increment_variable:ds_b:a_i, increment_variable:ds_b:j, index, variable_update:ds_b:a_i, variable_update:ds_b:j, variable_update_by_augmented_assignment:ds_b:a_i, variable_update_by_augmented_assignment:ds_b:j
    ...
    if k > ks[0]: # comparison_operator:Gt, if (-> +10), if_test_atom:0, if_test_atom:k, if_test_atom:ks, index, int_literal, literal:Num
        while True: # if_then_branch (-> +5), infinite_while, literal:True, while (-> +5)
            ...
            diff += _diff # assignment_lhs_identifier:diff, assignment_rhs_atom:_diff, augmented_assignment:Add, increment_variable:diff:_diff, variable_update:diff:_diff, variable_update_by_augmented_assignment:diff:_diff
            dn += terms_jumped # assignment_lhs_identifier:dn, assignment_rhs_atom:terms_jumped, augmented_assignment:Add, increment_variable:dn:terms_jumped, variable_update:dn:terms_jumped, variable_update_by_augmented_assignment:dn:terms_jumped
...
def compute(a_i, k, i, n): # function:compute (-> +25), function_returning_something:compute (-> +25)
    ...
    if k > len(a_i): # call_argument:a_i, comparison_operator:Gt, function_call:len, if (-> +1), if_test_atom:a_i, if_test_atom:k
        a_i.extend([0 for _ in range(k - len(a_i))]) # binary_operator:Sub, call_argument:, call_argument:a_i, composition, comprehension:List, comprehension_for_count:1, function_call:len, function_call:range, if_then_branch, int_literal, literal:Num, method_call, method_call_name:extend, method_call_object:a_i, range:_, variable_update:a_i:a_i, variable_update_by_method_call:a_i:a_i
    ...
    for j in range(len(a_i)): # accumulate_elements:ds_b (-> +4), accumulate_elements:ds_c (-> +4), call_argument:, call_argument:a_i, composition, for:j (-> +4), for_indexes (-> +4), for_range:_ (-> +4), function_call:len, function_call:range, range:_
        if j >= k: # comparison_operator:GtE, if (-> +3), if_test_atom:j, if_test_atom:k
            ds_b += a_i[j] # assignment_lhs_identifier:ds_b, assignment_rhs_atom:a_i, assignment_rhs_atom:j, augmented_assignment:Add, if_then_branch, increment_variable:ds_b:a_i, increment_variable:ds_b:j, index, variable_update:ds_b:a_i, variable_update:ds_b:j, variable_update_by_augmented_assignment:ds_b:a_i, variable_update_by_augmented_assignment:ds_b:j
        else:
            ds_c += a_i[j] # assignment_lhs_identifier:ds_c, assignment_rhs_atom:a_i, assignment_rhs_atom:j, augmented_assignment:Add, if_else_branch, increment_variable:ds_c:a_i, increment_variable:ds_c:j, index, variable_update:ds_c:a_i, variable_update:ds_c:j, variable_update_by_augmented_assignment:ds_c:a_i, variable_update_by_augmented_assignment:ds_c:j
    while i < n: # comparison_operator:Lt, while (-> +10)
        ...
        diff += addend # assignment_lhs_identifier:diff, assignment_rhs_atom:addend, augmented_assignment:Add, increment_variable:diff:addend, variable_update:diff:addend, variable_update_by_augmented_assignment:diff:addend
        ...
        for j in range(k): # accumulate_elements:ds_c (-> +3), call_argument:k, for:j (-> +3), for_range:k (-> +3), function_call:range, range:k
            ...
            ds_c += a_i[j] # assignment_lhs_identifier:ds_c, assignment_rhs_atom:a_i, assignment_rhs_atom:j, augmented_assignment:Add, increment_variable:ds_c:a_i, increment_variable:ds_c:j, index, variable_update:ds_c:a_i, variable_update:ds_c:j, variable_update_by_augmented_assignment:ds_c:a_i, variable_update_by_augmented_assignment:ds_c:j
...
def add(digits, k, addend): # function:add (-> +13), function_returning_nothing:add (-> +13)
    for j in range(k, len(digits)): # call_argument:, call_argument:digits, call_argument:k, composition, for:j (-> +9), for_range:k:_ (-> +9), function_call:len, function_call:range, range:k:_
        ...
        if s >= 10: # comparison_operator:GtE, if (-> +5), if_test_atom:10, if_test_atom:s, int_literal, literal:Num, suggest_constant_definition
            ...
            addend = addend // 10 + quotient # assignment, assignment_lhs_identifier:addend, assignment_rhs_atom:10, assignment_rhs_atom:addend, assignment_rhs_atom:quotient, binary_operator:Add, binary_operator:FloorDiv, increment_variable:addend:10, increment_variable:addend:quotient, int_literal, literal:Num, suggest_constant_definition, variable_update:addend:10, variable_update:addend:quotient, variable_update_by_assignment:addend:10, variable_update_by_assignment:addend:quotient
        else:
            digits[j] = s # assignment, assignment_lhs_identifier:digits, assignment_rhs_atom:s, if_else_branch (-> +1), index
            addend = addend // 10 # assignment, assignment_lhs_identifier:addend, assignment_rhs_atom:10, assignment_rhs_atom:addend, binary_operator:FloorDiv, int_literal, literal:Num, suggest_augmented_assignment, suggest_constant_definition, variable_update:addend:10, variable_update_by_assignment:addend:10
...
def solution(n): # function:solution (-> +12), function_returning_something:solution (-> +12)
    ...
    for j in range(len(digits)): # accumulate_elements:a_n (-> +1), call_argument:, call_argument:digits, composition, for:j (-> +1), for_indexes (-> +1), for_range:_ (-> +1), function_call:len, function_call:range, range:_
        a_n += digits[j] * 10 ** j # assignment_lhs_identifier:a_n, assignment_rhs_atom:10, assignment_rhs_atom:digits, assignment_rhs_atom:j, augmented_assignment:Add, binary_operator:Mult, binary_operator:Pow, increment_variable:a_n:10, increment_variable:a_n:digits, increment_variable:a_n:j, index, int_literal, literal:Num, suggest_constant_definition, variable_update:a_n:10, variable_update:a_n:digits, variable_update:a_n:j, variable_update_by_augmented_assignment:a_n:10, variable_update_by_augmented_assignment:a_n:digits, variable_update_by_augmented_assignment:a_n:j
