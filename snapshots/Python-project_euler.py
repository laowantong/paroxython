...
def solution(n): # function:solution (-> +8), function_returning_something:solution (-> +8)
    sum = 0 # assignment, assignment_lhs_identifier:sum, assignment_rhs_atom:0, int_literal, literal:Num, single_assignment:sum
...
def solution(n): # function:solution (-> +32), function_returning_something:solution (-> +32)
    sum = 0 # assignment, assignment_lhs_identifier:sum, assignment_rhs_atom:0, int_literal, literal:Num, single_assignment:sum
    num = 0 # assignment, assignment_lhs_identifier:num, assignment_rhs_atom:0, int_literal, literal:Num, single_assignment:num
...
def solution(n): # function:solution (-> +22), function_returning_something:solution (-> +22)
    xmulti = [] # assignment, assignment_lhs_identifier:xmulti, literal:List, single_assignment:xmulti
    zmulti = [] # assignment, assignment_lhs_identifier:zmulti, literal:List, single_assignment:zmulti
...
def solution(n): # function:solution (-> +9), function_returning_something:solution (-> +9)
    ...
    result = 0 # assignment, assignment_lhs_identifier:result, assignment_rhs_atom:0, int_literal, literal:Num, single_assignment:result
...
# ----------------------------------------------------------------------------------------
def solution(n): # function:solution (-> +7), function_returning_something:solution (-> +7)
    ls = [] # assignment, assignment_lhs_identifier:ls, literal:List, single_assignment:ls
...
# ----------------------------------------------------------------------------------------
def solution(n): # function:solution (-> +12), function_returning_something:solution (-> +12)
    a = [0, 1] # assignment, assignment_lhs_identifier:a, assignment_rhs_atom:0, assignment_rhs_atom:1, int_literal, literal:List, literal:Num, single_assignment:a
    i = 0 # assignment, assignment_lhs_identifier:i, assignment_rhs_atom:0, int_literal, literal:Num, single_assignment:i
...
def solution(n): # function:solution (-> +24), function_returning_something:solution (-> +24)
    ...
    if n <= 0: # comparison_operator:LtE, if (-> +1), if_test_atom:0, if_test_atom:n, int_literal, literal:Num
        raise ValueError("Parameter n must be greater or equal to one.") # call_argument:, function_call:ValueError, if_then_branch, literal:Str, raise:ValueError
    maxNumber = 0 # assignment, assignment_lhs_identifier:maxNumber, assignment_rhs_atom:0, int_literal, literal:Num, single_assignment:maxNumber
...
def solution(n: int) -> int: # function:solution (-> +18), function_returning_something:solution (-> +18)
    ...
    if n <= 0: # comparison_operator:LtE, if (-> +1), if_test_atom:0, if_test_atom:n, int_literal, literal:Num
        raise ValueError("Parameter n must be greater or equal to one.") # call_argument:, function_call:ValueError, if_then_branch, literal:Str, raise:ValueError
    i = 2 # assignment, assignment_lhs_identifier:i, assignment_rhs_atom:2, int_literal, literal:Num, single_assignment:i
    ans = 0 # assignment, assignment_lhs_identifier:ans, assignment_rhs_atom:0, int_literal, literal:Num, single_assignment:ans
...
# ----------------------------------------------------------------------------------------
def solution(n): # function:solution (-> +7), function_returning_something:solution (-> +7)
    answer = 0 # assignment, assignment_lhs_identifier:answer, assignment_rhs_atom:0, int_literal, literal:Num, single_assignment:answer
...
def solution(n): # function:solution (-> +18), function_returning_something:solution (-> +18)
    ...
    while 1: # int_literal, literal:Num, while (-> +10)
        ...
        nfound = 0 # assignment, assignment_lhs_identifier:nfound, assignment_rhs_atom:0, int_literal, literal:Num, single_assignment:nfound
...
# ----------------------------------------------------------------------------------------
def solution(n): # function:solution (-> +7), function_returning_something:solution (-> +7)
    suma = 0 # assignment, assignment_lhs_identifier:suma, assignment_rhs_atom:0, int_literal, literal:Num, single_assignment:suma
    sumb = 0 # assignment, assignment_lhs_identifier:sumb, assignment_rhs_atom:0, int_literal, literal:Num, single_assignment:sumb
...
def solution(n): # function:solution (-> +15), function_returning_something:solution (-> +15)
    ...
    if n <= 0: # comparison_operator:LtE, if (-> +1), if_test_atom:0, if_test_atom:n, int_literal, literal:Num
        raise ValueError("Parameter n must be greater or equal to one.") # call_argument:, function_call:ValueError, if_then_branch, literal:Str, raise:ValueError
    primes = [] # assignment, assignment_lhs_identifier:primes, literal:List, single_assignment:primes
...
def solution(n): # function:solution (-> +10), function_returning_something:solution (-> +10)
    product = -1 # assignment, assignment_lhs_identifier:product, assignment_rhs_atom:-1, int_literal, literal:Num, single_assignment:product
    d = 0 # assignment, assignment_lhs_identifier:d, assignment_rhs_atom:0, int_literal, literal:Num, single_assignment:d
...
def prime_sum(n: int) -> int: # function:prime_sum (-> +12), function_returning_something:prime_sum (-> +12)
    ...
    s = 0 # assignment, assignment_lhs_identifier:s, assignment_rhs_atom:0, int_literal, literal:Num, single_assignment:s
...
def largest_product(grid): # function:largest_product (-> +27), function_returning_something:largest_product (-> +27)
    nColumns = len(grid[0]) # assignment, assignment_lhs_identifier:nColumns, assignment_rhs_atom:0, assignment_rhs_atom:grid, call_argument:, function_call:len, index, int_literal, literal:Num, single_assignment:nColumns
    ...
    largest = 0 # assignment, assignment_lhs_identifier:largest, assignment_rhs_atom:0, int_literal, literal:Num, single_assignment:largest
    lrDiagProduct = 0 # assignment, assignment_lhs_identifier:lrDiagProduct, assignment_rhs_atom:0, int_literal, literal:Num, single_assignment:lrDiagProduct
    rlDiagProduct = 0 # assignment, assignment_lhs_identifier:rlDiagProduct, assignment_rhs_atom:0, int_literal, literal:Num, single_assignment:rlDiagProduct
...
def solution(): # function:solution (-> +26), function_returning_something:solution (-> +26)
    with open(os.path.dirname(__file__) + "/grid.txt") as f: # binary_operator:Add, call_argument:, call_argument:__file__, composition, concatenation operator:Str, function_call:open, literal:Str, method_call, method_call_name:dirname
        ...
        maximum = 0 # assignment, assignment_lhs_identifier:maximum, assignment_rhs_atom:0, int_literal, literal:Num, single_assignment:maximum
...
def count_divisors(n): # function:count_divisors (-> +7), function_returning_something:count_divisors (-> +7)
    nDivisors = 0 # assignment, assignment_lhs_identifier:nDivisors, assignment_rhs_atom:0, int_literal, literal:Num, single_assignment:nDivisors
...
# ----------------------------------------------------------------------------------------
def solution(n): # function:solution (-> +16), function_returning_something:solution (-> +16)
    largest_number = 0 # assignment, assignment_lhs_identifier:largest_number, assignment_rhs_atom:0, int_literal, literal:Num, single_assignment:largest_number
    pre_counter = 0 # assignment, assignment_lhs_identifier:pre_counter, assignment_rhs_atom:0, int_literal, literal:Num, single_assignment:pre_counter
...
def solution(power): # function:solution (-> +7), function_returning_something:solution (-> +7)
    ...
    sum_of_num = 0 # assignment, assignment_lhs_identifier:sum_of_num, assignment_rhs_atom:0, int_literal, literal:Num, single_assignment:sum_of_num
...
def solution(n): # function:solution (-> +17), function_returning_something:solution (-> +17)
    ones_counts = [0, 3, 3, 5, 4, 4, 3, 5, 5, 4, 3, 6, 6, 8, 8, 7, 7, 9, 8, 8] # assignment, assignment_lhs_identifier:ones_counts, assignment_rhs_atom:0, assignment_rhs_atom:3, assignment_rhs_atom:4, assignment_rhs_atom:5, assignment_rhs_atom:6, assignment_rhs_atom:7, assignment_rhs_atom:8, assignment_rhs_atom:9, int_literal, literal:List, literal:Num, single_assignment:ones_counts, suggest_constant_definition
    tens_counts = [0, 0, 6, 6, 5, 5, 5, 7, 6, 6] # assignment, assignment_lhs_identifier:tens_counts, assignment_rhs_atom:0, assignment_rhs_atom:5, assignment_rhs_atom:6, assignment_rhs_atom:7, int_literal, literal:List, literal:Num, single_assignment:tens_counts, suggest_constant_definition
    count = 0 # assignment, assignment_lhs_identifier:count, assignment_rhs_atom:0, int_literal, literal:Num, single_assignment:count
    ...
    for i in range(1, len(a)): # call_argument:, call_argument:1, call_argument:a, composition, for:i (-> +10), for_range:1:_ (-> +10), for_range:_ (-> +10), function_call:len, function_call:range, int_literal, literal:Num, range:1:_
        for j in range(len(a[i])): # call_argument:, composition, for:j (-> +9), for_indexes (-> +9), for_range:_ (-> +9), function_call:len, function_call:range, index, nested_for:1 (-> +9), range:_
            if j != len(a[i - 1]): # binary_operator:Sub, call_argument:, comparison_operator:NotEq, function_call:len, if (-> +3), if_test_atom:1, if_test_atom:a, if_test_atom:i, if_test_atom:j, index, index_arithmetic, int_literal, literal:Num, suggest_conditional_expression (-> +3)
                ...
                number1 = 0 # assignment, assignment_lhs_identifier:number1, assignment_rhs_atom:0, if_else_branch, int_literal, literal:Num, single_assignment:number1
            if j > 0: # comparison_operator:Gt, if (-> +3), if_test_atom:0, if_test_atom:j, int_literal, literal:Num, suggest_conditional_expression (-> +3)
                ...
                number2 = 0 # assignment, assignment_lhs_identifier:number2, assignment_rhs_atom:0, if_else_branch, int_literal, literal:Num, single_assignment:number2
...
def solution(): # function:solution (-> +24), function_returning_something:solution (-> +24)
    ...
    sundays = 0 # assignment, assignment_lhs_identifier:sundays, assignment_rhs_atom:0, int_literal, literal:Num, single_assignment:sundays
...
def split_and_add(number): # function:split_and_add (-> +6), function_returning_something:split_and_add (-> +6)
    sum_of_digits = 0 # assignment, assignment_lhs_identifier:sum_of_digits, assignment_rhs_atom:0, int_literal, literal:Num, single_assignment:sum_of_digits
...
def sum_of_divisors(n): # function:sum_of_divisors (-> +7), function_returning_something:sum_of_divisors (-> +7)
    total = 0 # assignment, assignment_lhs_identifier:total, assignment_rhs_atom:0, int_literal, literal:Num, single_assignment:total
...
def solution(): # function:solution (-> +12), function_returning_something:solution (-> +12)
    ...
    name_score = 0 # assignment, assignment_lhs_identifier:name_score, assignment_rhs_atom:0, int_literal, literal:Num, single_assignment:name_score
    total_score = 0 # assignment, assignment_lhs_identifier:total_score, assignment_rhs_atom:0, int_literal, literal:Num, single_assignment:total_score
    for i, name in enumerate(names): # accumulate_elements:total_score, call_argument:names, for:i, for_indexes_elements (-> +4), function_call:enumerate
        ...
        name_score = 0 # assignment, assignment_lhs_identifier:name_score, assignment_rhs_atom:0, for:name, int_literal, literal:Num, nested_for:1, single_assignment:name_score
...
def fib(a, b, n): # function:fib (-> +13), function_returning_something:fib (-> +13)
    ...
    temp = 0 # assignment, assignment_lhs_identifier:temp, assignment_rhs_atom:0, int_literal, literal:Num, single_assignment:temp
...
def solution(): # function:solution (-> +2), function_returning_something:solution (-> +2)
    result = list(map("".join, permutations("0123456789"))) # assignment, assignment_lhs_identifier:result, call_argument:, composition, function_call:list, function_call:map, function_call:permutations, literal:Str, single_assignment:result
...
def fibonacci(n): # function:fibonacci (-> +9), function_returning_something:fibonacci (-> +9)
    if n == 1 or type(n) is not int: # boolean_operator:Or, call_argument:n, comparison_operator:Eq, comparison_operator:IsNot, function_call:type, if (-> +8), if_test_atom:1, if_test_atom:int, if_test_atom:n, int_literal, literal:Num
        ...
        sequence = [0, 1] # assignment, assignment_lhs_identifier:sequence, assignment_rhs_atom:0, assignment_rhs_atom:1, if_else_branch (-> +3), int_literal, literal:List, literal:Num, single_assignment:sequence
...
def fibonacci_digits_index(n): # function:fibonacci_digits_index (-> +6), function_returning_something:fibonacci_digits_index (-> +6)
    digits = 0 # assignment, assignment_lhs_identifier:digits, assignment_rhs_atom:0, int_literal, literal:Num, single_assignment:digits
...
def solution(a_limit: int, b_limit: int) -> int: # function:solution (-> +13), function_returning_something:solution (-> +13)
    longest = [0, 0, 0] # assignment, assignment_lhs_identifier:longest, assignment_rhs_atom:0, int_literal, literal:List, literal:Num, single_assignment:longest
    for a in range((a_limit * -1) + 1, a_limit): # binary_operator:Add, binary_operator:Mult, call_argument:, call_argument:a_limit, for:a (-> +9), for_range:2:b_limit (-> +9), for_range:_:a_limit (-> +9), function_call:range, int_literal, literal:Num, range:_:a_limit
        for b in range(2, b_limit): # call_argument:2, call_argument:b_limit, for:b (-> +8), for_range:2:b_limit (-> +8), function_call:range, int_literal, literal:Num, nested_for:1 (-> +8), range:2:b_limit
            if is_prime(b): # call_argument:b, function_call:is_prime, if (-> +7), if_test_atom:b
                count = 0 # assignment, assignment_lhs_identifier:count, assignment_rhs_atom:0, if_then_branch (-> +6), int_literal, literal:Num, single_assignment:count
                n = 0 # assignment, assignment_lhs_identifier:n, assignment_rhs_atom:0, int_literal, literal:Num, single_assignment:n
...
def solution(): # function:solution (-> +14), function_returning_something:solution (-> +14)
    constant = [] # assignment, assignment_lhs_identifier:constant, literal:List, single_assignment:constant
    i = 1 # assignment, assignment_lhs_identifier:i, assignment_rhs_atom:1, int_literal, literal:Num, single_assignment:i
    while len(constant) < 1e6: # call_argument:constant, comparison_operator:Lt, evolve_state (-> +2), float_literal, function_call:len, literal:Num, suggest_constant_definition, while (-> +2)
        ...
        i += 1 # assignment_lhs_identifier:i, assignment_rhs_atom:1, augmented_assignment:Add, int_literal, literal:Num, variable_increment:i, variable_update:i:1, variable_update_by_augmented_assignment:i:1
    constant = "".join(constant) # assignment, assignment_lhs_identifier:constant, assignment_rhs_atom:constant, call_argument:constant, literal:Str, method_call, method_call_name:join, single_assignment:constant
    return ( # return
...
def solution(): # function:solution (-> +13), function_returning_something:solution (-> +13)
    ...
    words = "" # assignment, assignment_lhs_identifier:words, literal:Str, single_assignment:words
...
memo = {} # assignment, assignment_lhs_identifier:memo, literal:Dict, single_assignment:memo
def next_term(a_i, k, i, n): # body_recursive_function:next_term (-> +50), function:next_term (-> +50), function_returning_something:next_term (-> +50), recursive_function:next_term (-> +50)
    ds_b = 0 # assignment, assignment_lhs_identifier:ds_b, assignment_rhs_atom:0, int_literal, literal:Num, single_assignment:ds_b
    ...
    c = 0 # assignment, assignment_lhs_identifier:c, assignment_rhs_atom:0, int_literal, literal:Num, single_assignment:c
    ...
    if sub_memo != None: # comparison_operator:NotEq, if (-> +19), if_test_atom:None, if_test_atom:sub_memo, literal:None
        ...
        sub_memo = {c: []} # assignment, assignment_lhs_identifier:sub_memo, assignment_rhs_atom:c, if_else_branch (-> +1), literal:List, single_assignment:sub_memo
    ...
    j = 0 # assignment, assignment_lhs_identifier:j, assignment_rhs_atom:0, int_literal, literal:Num, single_assignment:j
...
def compute(a_i, k, i, n): # function:compute (-> +25), function_returning_something:compute (-> +25)
    ...
    while i < n: # comparison_operator:Lt, while (-> +10)
        ...
        ds_c = 0 # assignment, assignment_lhs_identifier:ds_c, assignment_rhs_atom:0, int_literal, literal:Num, single_assignment:ds_c
...
def solution(n): # function:solution (-> +12), function_returning_something:solution (-> +12)
    ...
    i = 1 # assignment, assignment_lhs_identifier:i, assignment_rhs_atom:1, int_literal, literal:Num, single_assignment:i
    dn = 0 # assignment, assignment_lhs_identifier:dn, assignment_rhs_atom:0, int_literal, literal:Num, single_assignment:dn
    while True: # infinite_while (-> +4), literal:True, while (-> +4)
        ...
        if dn == n - i: # binary_operator:Sub, comparison_operator:Eq, if (-> +1), if_test_atom:dn, if_test_atom:i, if_test_atom:n
            break # if_then_branch
    a_n = 0 # assignment, assignment_lhs_identifier:a_n, assignment_rhs_atom:0, int_literal, literal:Num, single_assignment:a_n
...
def find_largest(data_file: str = "base_exp.txt") -> int: # function:find_largest (-> +6), function_returning_something:find_largest (-> +6), function_with_default_positional_arguments:find_largest (-> +6), literal:Str
    largest = [0, 0] # assignment, assignment_lhs_identifier:largest, assignment_rhs_atom:0, int_literal, literal:List, literal:Num, single_assignment:largest
