...
def solution(n): # function:solution (-> +8), function_returning_a_value:solution (-> +8)
    sum = 0 # assignment, assignment_lhs_identifier:sum, int_literal, literal:Num, variable_definition:sum
    terms = (n - 1) // 3 # assignment, assignment_lhs_identifier:terms, assignment_rhs_identifier:n, binary_operator:FloorDiv, binary_operator:Sub, int_literal, literal:Num, suggest_constant_definition, variable_definition:terms
    sum += ((terms) * (6 + (terms - 1) * 3)) // 2 # assignment_lhs_identifier:sum, assignment_rhs_identifier:terms, augmented_assignment:sum, binary_operator:Add, binary_operator:FloorDiv, binary_operator:Mult, binary_operator:Sub, int_literal, literal:Num, suggest_constant_definition
    terms = (n - 1) // 5 # assignment, assignment_lhs_identifier:terms, assignment_rhs_identifier:n, binary_operator:FloorDiv, binary_operator:Sub, int_literal, literal:Num, suggest_constant_definition, variable_definition:terms
    sum += ((terms) * (10 + (terms - 1) * 5)) // 2 # assignment_lhs_identifier:sum, assignment_rhs_identifier:terms, augmented_assignment:sum, binary_operator:Add, binary_operator:FloorDiv, binary_operator:Mult, binary_operator:Sub, int_literal, literal:Num, suggest_constant_definition
    terms = (n - 1) // 15 # assignment, assignment_lhs_identifier:terms, assignment_rhs_identifier:n, binary_operator:FloorDiv, binary_operator:Sub, int_literal, literal:Num, suggest_constant_definition, variable_definition:terms
    sum -= ((terms) * (30 + (terms - 1) * 15)) // 2 # assignment_lhs_identifier:sum, assignment_rhs_identifier:terms, augmented_assignment:sum, binary_operator:Add, binary_operator:FloorDiv, binary_operator:Mult, binary_operator:Sub, int_literal, literal:Num, suggest_constant_definition
    return sum
...
def solution(n): # function:solution (-> +32), function_returning_a_value:solution (-> +32)
    sum = 0 # assignment, assignment_lhs_identifier:sum, int_literal, literal:Num, variable_definition:sum
    num = 0 # assignment, assignment_lhs_identifier:num, int_literal, literal:Num, variable_definition:num
    while 1: # int_literal, literal:Num, while (-> +28)
        num += 3 # assignment_lhs_identifier:num, augmented_assignment:num, int_literal, literal:Num, suggest_constant_definition
        if num >= n: # comparison_operator:GtE, if (-> +1)
            break # if_then_branch
        sum += num # assignment_lhs_identifier:sum, assignment_rhs_identifier:num, augmented_assignment:sum
        num += 2 # assignment_lhs_identifier:num, augmented_assignment:num, int_literal, literal:Num
        if num >= n: # comparison_operator:GtE, if (-> +1)
            break # if_then_branch
        sum += num # assignment_lhs_identifier:sum, assignment_rhs_identifier:num, augmented_assignment:sum
        num += 1 # assignment_lhs_identifier:num, augmented_assignment:num, int_literal, literal:Num
        if num >= n: # comparison_operator:GtE, if (-> +1)
            break # if_then_branch
        sum += num # assignment_lhs_identifier:sum, assignment_rhs_identifier:num, augmented_assignment:sum
        num += 3 # assignment_lhs_identifier:num, augmented_assignment:num, int_literal, literal:Num, suggest_constant_definition
...
def solution(n): # function:solution (-> +22), function_returning_a_value:solution (-> +22)
    xmulti = [] # assignment, assignment_lhs_identifier:xmulti, literal:List, variable_definition:xmulti
    zmulti = [] # assignment, assignment_lhs_identifier:zmulti, literal:List, variable_definition:zmulti
    z = 3 # assignment, assignment_lhs_identifier:z, int_literal, literal:Num, suggest_constant_definition, variable_definition:z
    x = 5 # assignment, assignment_lhs_identifier:x, int_literal, literal:Num, suggest_constant_definition, variable_definition:x
    temp = 1 # assignment, assignment_lhs_identifier:temp, int_literal, literal:Num, variable_definition:temp
    while True: # literal:True, while (-> +7)
        result = z * temp # assignment, assignment_lhs_identifier:result, assignment_rhs_identifier:temp, assignment_rhs_identifier:z, binary_operator:Mult, variable_definition:result
        if result < n: # comparison_operator:Lt, if (-> +5)
            ...
            temp += 1 # assignment_lhs_identifier:temp, augmented_assignment:temp, int_literal, literal:Num
        else:
            temp = 1 # assignment, assignment_lhs_identifier:temp, if_else_branch (-> +1), int_literal, literal:Num, variable_definition:temp
            break
    while True: # literal:True, while (-> +6)
        result = x * temp # assignment, assignment_lhs_identifier:result, assignment_rhs_identifier:temp, assignment_rhs_identifier:x, binary_operator:Mult, variable_definition:result
    ...
    collection = list(set(xmulti + zmulti)) # assignment, assignment_lhs_identifier:collection, assignment_rhs_identifier:list, assignment_rhs_identifier:set, assignment_rhs_identifier:xmulti, assignment_rhs_identifier:zmulti, binary_operator:Add, composition, function_call:list, function_call:set, variable_definition:collection
...
def solution(n): # function:solution (-> +9), function_returning_a_value:solution (-> +9)
    a = 3 # assignment, assignment_lhs_identifier:a, int_literal, literal:Num, suggest_constant_definition, variable_definition:a
    result = 0 # assignment, assignment_lhs_identifier:result, int_literal, literal:Num, variable_definition:result
    while a < n: # comparison_operator:Lt, while (-> +5)
        if a % 3 == 0 or a % 5 == 0: # binary_operator:Mod, boolean_operator:Or, comparison_operator:Eq, divisibility_test:3, divisibility_test:5, if (-> +3), int_literal, literal:Num, suggest_constant_definition
            result += a # assignment_lhs_identifier:result, assignment_rhs_identifier:a, augmented_assignment:result, if_then_branch
            ...
            result -= a # assignment_lhs_identifier:result, assignment_rhs_identifier:a, augmented_assignment:result, if_elif_branch
        a += 1 # assignment_lhs_identifier:a, augmented_assignment:a, int_literal, literal:Num
    return result
...
def solution(n): # function:solution (-> +7), function_returning_a_value:solution (-> +7)
    ...
    for i in range(n): # accumulate_elements:1 (-> +4), call_parameter:n, for:i (-> +4), for_range_stop (-> +4), function_call:range
        if i % 3 == 0: # binary_operator:Mod, comparison_operator:Eq, divisibility_test:3, if (-> +3), int_literal, literal:Num, suggest_constant_definition
            result += i # assignment_lhs_identifier:result, assignment_rhs_identifier:i, augmented_assignment:result, if_then_branch
            ...
            result += i # assignment_lhs_identifier:result, assignment_rhs_identifier:i, augmented_assignment:result, if_elif_branch
    return result
...
# ----------------------------------------------------------------------------------------
def solution(n): # function:solution (-> +8), function_returning_a_value:solution (-> +8)
    i = 1 # assignment, assignment_lhs_identifier:i, int_literal, literal:Num, variable_definition:i
    j = 2 # assignment, assignment_lhs_identifier:j, int_literal, literal:Num, variable_definition:j
    sum = 0 # assignment, assignment_lhs_identifier:sum, int_literal, literal:Num, variable_definition:sum
    while j <= n: # comparison_operator:LtE, while (-> +3)
        if j % 2 == 0: # binary_operator:Mod, comparison_operator:Eq, divisibility_test:2, if (-> +1), int_literal, literal:Num
            sum += j # assignment_lhs_identifier:sum, assignment_rhs_identifier:j, augmented_assignment:sum, if_then_branch
        i, j = j, i + j # assignment, assignment_lhs_identifier:i, assignment_lhs_identifier:j, assignment_rhs_identifier:i, assignment_rhs_identifier:j, binary_operator:Add, variable_definition:i, variable_definition:j
    return sum
...
# ----------------------------------------------------------------------------------------
def solution(n): # function:solution (-> +7), function_returning_a_value:solution (-> +7)
    ls = [] # assignment, assignment_lhs_identifier:ls, literal:List, variable_definition:ls
    a, b = 0, 1 # assignment, assignment_lhs_identifier:a, assignment_lhs_identifier:b, int_literal, literal:Num, literal:Tuple, variable_definition:a, variable_definition:b
    while b <= n: # comparison_operator:LtE, while (-> +3)
        ...
        a, b = b, a + b # assignment, assignment_lhs_identifier:a, assignment_lhs_identifier:b, assignment_rhs_identifier:a, assignment_rhs_identifier:b, binary_operator:Add, variable_definition:a, variable_definition:b
    return ls
...
def solution(n): # function:solution (-> +9), function_returning_a_value:solution (-> +9)
    ...
    a = 0 # assignment, assignment_lhs_identifier:a, int_literal, literal:Num, variable_definition:a
    b = 2 # assignment, assignment_lhs_identifier:b, int_literal, literal:Num, variable_definition:b
    count = 0 # assignment, assignment_lhs_identifier:count, int_literal, literal:Num, variable_definition:count
    while 4 * b + a <= n: # binary_operator:Add, binary_operator:Mult, comparison_operator:LtE, int_literal, literal:Num, suggest_constant_definition, while (-> +2)
        a, b = b, 4 * b + a # assignment, assignment_lhs_identifier:a, assignment_lhs_identifier:b, assignment_rhs_identifier:a, assignment_rhs_identifier:b, binary_operator:Add, binary_operator:Mult, int_literal, literal:Num, suggest_constant_definition, variable_definition:a, variable_definition:b
        count += a # assignment_lhs_identifier:count, assignment_rhs_identifier:a, augmented_assignment:count
...
def solution(n): # function:solution (-> +12), function_returning_a_value:solution (-> +12)
    try: # catch_exception (-> +3)
        n = int(n) # assignment, assignment_lhs_identifier:n, assignment_rhs_identifier:int, assignment_rhs_identifier:n, call_parameter:n, function_call:int, variable_definition:n
...
# ----------------------------------------------------------------------------------------
def solution(n): # function:solution (-> +12), function_returning_a_value:solution (-> +12)
    a = [0, 1] # assignment, assignment_lhs_identifier:a, int_literal, literal:List, literal:Num, variable_definition:a
    i = 0 # assignment, assignment_lhs_identifier:i, int_literal, literal:Num, variable_definition:i
    while a[i] <= n: # comparison_operator:LtE, index, while (-> +4)
        ...
        if a[i + 2] > n: # binary_operator:Add, comparison_operator:Gt, if (-> +1), index, index_arithmetic, int_literal, literal:Num
            break # if_then_branch
        i += 1 # assignment_lhs_identifier:i, augmented_assignment:i, int_literal, literal:Num
    sum = 0 # assignment, assignment_lhs_identifier:sum, int_literal, literal:Num, variable_definition:sum
    for j in range(len(a) - 1): # accumulate_elements:1 (-> +2), binary_operator:Sub, call_parameter:a, composition, for:j (-> +2), for_range_stop (-> +2), function_call:len, function_call:range, int_literal, literal:Num
        if a[j] % 2 == 0: # binary_operator:Mod, comparison_operator:Eq, divisibility_test:2, if (-> +1), index, int_literal, literal:Num
            sum += a[j] # assignment_lhs_identifier:sum, assignment_rhs_identifier:a, assignment_rhs_identifier:j, augmented_assignment:sum, if_then_branch, index
    return sum
...
def isprime(no): # function:isprime (-> +9), function_returning_a_value:isprime (-> +9)
    ...
    sq = int(math.sqrt(no)) + 1 # assignment, assignment_lhs_identifier:sq, assignment_rhs_identifier:int, assignment_rhs_identifier:math, assignment_rhs_identifier:no, binary_operator:Add, call_parameter:no, composition, function_call:int, int_literal, literal:Num, method_call:sqrt, variable_definition:sq
...
def solution(n): # function:solution (-> +24), function_returning_a_value:solution (-> +24)
    ...
    if n <= 0: # comparison_operator:LtE, if (-> +1), int_literal, literal:Num
        raise ValueError("Parameter n must be greater or equal to one.") # function_call:ValueError, if_then_branch, literal:Str, raise_exception:ValueError
    maxNumber = 0 # assignment, assignment_lhs_identifier:maxNumber, int_literal, literal:Num, variable_definition:maxNumber
    if isprime(n): # call_parameter:n, function_call:isprime, if (-> +16)
        ...
        while n % 2 == 0: # binary_operator:Mod, comparison_operator:Eq, divisibility_test:2, evolve_state (-> +1), if_else_branch (-> +13), int_literal, literal:Num, while (-> +1)
            n = n / 2 # assignment, assignment_lhs_identifier:n, assignment_rhs_identifier:n, binary_operator:Div, int_literal, literal:Num, suggest_augmented_assignment, variable_definition:n
        if isprime(n): # call_parameter:n, function_call:isprime, if (-> +11), nested_if:1 (-> +11)
            ...
            n1 = int(math.sqrt(n)) + 1 # assignment, assignment_lhs_identifier:n1, assignment_rhs_identifier:int, assignment_rhs_identifier:math, assignment_rhs_identifier:n, binary_operator:Add, call_parameter:n, composition, function_call:int, if_else_branch (-> +8), int_literal, literal:Num, method_call:sqrt, variable_definition:n1
            for i in range(3, n1, 2): # call_parameter:n1, for:i (-> +6), for_range_step:2 (-> +6), function_call:range, int_literal, literal:Num, suggest_constant_definition
                if n % i == 0: # binary_operator:Mod, comparison_operator:Eq, divisibility_test, if (-> +5), int_literal, literal:Num, nested_if:2 (-> +5)
                    if isprime(n / i): # binary_operator:Div, function_call:isprime, if (-> +4), if_then_branch (-> +4), nested_if:3 (-> +4)
                        maxNumber = n / i # assignment, assignment_lhs_identifier:maxNumber, assignment_rhs_identifier:i, assignment_rhs_identifier:n, binary_operator:Div, if_then_branch (-> +1), variable_definition:maxNumber
                        break
                    elif isprime(i): # call_parameter:i, function_call:isprime, if (-> +1), nested_if:3 (-> +1)
                        maxNumber = i # assignment, assignment_lhs_identifier:maxNumber, assignment_rhs_identifier:i, if_elif_branch, variable_definition:maxNumber
            return maxNumber
...
def solution(n): # function:solution (-> +16), function_returning_a_value:solution (-> +16)
    ...
    if n <= 0: # comparison_operator:LtE, if (-> +1), int_literal, literal:Num
        raise ValueError("Parameter n must be greater or equal to one.") # function_call:ValueError, if_then_branch, literal:Str, raise_exception:ValueError
    prime = 1 # assignment, assignment_lhs_identifier:prime, int_literal, literal:Num, variable_definition:prime
    i = 2 # assignment, assignment_lhs_identifier:i, int_literal, literal:Num, variable_definition:i
    while i * i <= n: # binary_operator:Mult, comparison_operator:LtE, evolve_state (-> +4), while (-> +4)
        while n % i == 0: # binary_operator:Mod, comparison_operator:Eq, divisibility_test, int_literal, literal:Num, while (-> +2)
            prime = i # assignment, assignment_lhs_identifier:prime, assignment_rhs_identifier:i, variable_definition:prime
            n //= i # assignment_lhs_identifier:n, assignment_rhs_identifier:i, augmented_assignment:n
        i += 1 # assignment_lhs_identifier:i, augmented_assignment:i, int_literal, literal:Num
    if n > 1: # comparison_operator:Gt, if (-> +1), int_literal, literal:Num
        prime = n # assignment, assignment_lhs_identifier:prime, assignment_rhs_identifier:n, if_then_branch, variable_definition:prime
...
def solution(n: int) -> int: # function:solution, function_returning_a_value:solution
    ...
    if n <= 0: # comparison_operator:LtE, if (-> +1), int_literal, literal:Num
        raise ValueError("Parameter n must be greater or equal to one.") # function_call:ValueError, if_then_branch, literal:Str, raise_exception:ValueError
    i = 2 # assignment, assignment_lhs_identifier:i, int_literal, literal:Num, variable_definition:i
    ans = 0 # assignment, assignment_lhs_identifier:ans, int_literal, literal:Num, variable_definition:ans
    ...
    while n > 2: # comparison_operator:Gt, evolve_state (-> +6), int_literal, literal:Num, while (-> +6)
        while n % i != 0: # binary_operator:Mod, comparison_operator:NotEq, divisibility_test, evolve_state (-> +1), int_literal, literal:Num, while (-> +1)
            i += 1 # assignment_lhs_identifier:i, augmented_assignment:i, int_literal, literal:Num
        ans = i # assignment, assignment_lhs_identifier:ans, assignment_rhs_identifier:i, variable_definition:ans
        while n % i == 0: # binary_operator:Mod, comparison_operator:Eq, divisibility_test, int_literal, literal:Num, while (-> +1)
            n = n / i # assignment, assignment_lhs_identifier:n, assignment_rhs_identifier:i, assignment_rhs_identifier:n, binary_operator:Div, suggest_augmented_assignment, variable_definition:n
        i += 1 # assignment_lhs_identifier:i, augmented_assignment:i, int_literal, literal:Num
...
def solution(n): # function:solution (-> +8), function_returning_a_value:solution (-> +8)
    for number in range(n - 1, 10000, -1): # binary_operator:Sub, find_first_element (-> +6), for:number (-> +7), for_range_step:-1 (-> +7), function_call:range, int_literal, literal:Num, suggest_constant_definition
        strNumber = str(number) # assignment, assignment_lhs_identifier:strNumber, assignment_rhs_identifier:number, assignment_rhs_identifier:str, call_parameter:number, function_call:str, variable_definition:strNumber
        if strNumber == strNumber[::-1]: # comparison_operator:Eq, if (-> +5), int_literal, literal:Num, slice_step
            divisor = 999 # assignment, assignment_lhs_identifier:divisor, if_then_branch (-> +4), int_literal, literal:Num, suggest_constant_definition, variable_definition:divisor
            while divisor != 99: # comparison_operator:NotEq, evolve_state (-> +3), int_literal, literal:Num, suggest_constant_definition, while (-> +3)
                ...
                divisor -= 1 # assignment_lhs_identifier:divisor, augmented_assignment:divisor, int_literal, literal:Num

# ----------------------------------------------------------------------------------------
# ../Python/project_euler/problem_04/sol2.py
# ----------------------------------------------------------------------------------------
def solution(n): # function:solution (-> +7), function_returning_a_value:solution (-> +7)
    answer = 0 # assignment, assignment_lhs_identifier:answer, int_literal, literal:Num, variable_definition:answer
    for i in range(999, 99, -1): # accumulate_elements:1 (-> +4), for:i (-> +4), for_range_step:-1 (-> +4), function_call:range, int_literal, literal:Num, square_nested_for (-> +4), suggest_constant_definition
        for j in range(999, 99, -1): # accumulate_elements:1 (-> +3), for:j (-> +3), for_range_step:-1 (-> +3), function_call:range, int_literal, literal:Num, nested_for:1 (-> +3), suggest_constant_definition
            t = str(i * j) # assignment, assignment_lhs_identifier:t, assignment_rhs_identifier:i, assignment_rhs_identifier:j, assignment_rhs_identifier:str, binary_operator:Mult, function_call:str, variable_definition:t
            if t == t[::-1] and i * j < n: # binary_operator:Mult, boolean_operator:And, comparison_operator:Eq, comparison_operator:Lt, if (-> +1), int_literal, literal:Num, slice_step
                answer = max(answer, i * j) # assignment, assignment_lhs_identifier:answer, assignment_rhs_identifier:answer, assignment_rhs_identifier:i, assignment_rhs_identifier:j, assignment_rhs_identifier:max, binary_operator:Mult, call_parameter:answer, function_call:max, if_then_branch, variable_definition:answer
    return answer
...
def solution(n): # function:solution (-> +18), function_returning_a_value:solution (-> +18)
    ...
    while 1: # int_literal, literal:Num, while (-> +10)
        i += n * (n - 1) # assignment_lhs_identifier:i, assignment_rhs_identifier:n, augmented_assignment:i, binary_operator:Mult, binary_operator:Sub, int_literal, literal:Num
        nfound = 0 # assignment, assignment_lhs_identifier:nfound, int_literal, literal:Num, variable_definition:nfound
        for j in range(2, n): # call_parameter:n, for:j (-> +3), for_range_start (-> +3), function_call:range, int_literal, literal:Num
            if i % j != 0: # binary_operator:Mod, comparison_operator:NotEq, divisibility_test, if (-> +2), int_literal, literal:Num
                nfound = 1 # assignment, assignment_lhs_identifier:nfound, if_then_branch (-> +1), int_literal, literal:Num, variable_definition:nfound
                break
        if nfound == 0: # comparison_operator:Eq, if (-> +3), int_literal, literal:Num
            if i == 0: # comparison_operator:Eq, if (-> +1), if_then_branch (-> +2), int_literal, literal:Num, nested_if:1 (-> +1)
                i = 1 # assignment, assignment_lhs_identifier:i, if_then_branch, int_literal, literal:Num, variable_definition:i
            return i
...
def solution(n): # function:solution (-> +4), function_returning_a_value:solution (-> +4)
    g = 1 # assignment, assignment_lhs_identifier:g, int_literal, literal:Num, variable_definition:g
    for i in range(1, n + 1): # accumulate_elements:1 (-> +1), binary_operator:Add, for:i (-> +1), for_range_start (-> +1), function_call:range, int_literal, literal:Num
        g = lcm(g, i) # assignment, assignment_lhs_identifier:g, assignment_rhs_identifier:g, assignment_rhs_identifier:i, assignment_rhs_identifier:lcm, call_parameter:g, call_parameter:i, function_call:lcm, variable_definition:g
    return g
...
# ----------------------------------------------------------------------------------------
def solution(n): # function:solution (-> +7), function_returning_a_value:solution (-> +7)
    suma = 0 # assignment, assignment_lhs_identifier:suma, int_literal, literal:Num, variable_definition:suma
    sumb = 0 # assignment, assignment_lhs_identifier:sumb, int_literal, literal:Num, variable_definition:sumb
    for i in range(1, n + 1): # accumulate_elements:2 (-> +2), binary_operator:Add, for:i (-> +2), for_range_start (-> +2), function_call:range, int_literal, literal:Num
        suma += i ** 2 # assignment_lhs_identifier:suma, assignment_rhs_identifier:i, augmented_assignment:suma, binary_operator:Pow, int_literal, literal:Num
        sumb += i # assignment_lhs_identifier:sumb, assignment_rhs_identifier:i, augmented_assignment:sumb
    sum = sumb ** 2 - suma # assignment, assignment_lhs_identifier:sum, assignment_rhs_identifier:suma, assignment_rhs_identifier:sumb, binary_operator:Pow, binary_operator:Sub, int_literal, literal:Num, variable_definition:sum
    return sum
...
# ----------------------------------------------------------------------------------------
def solution(n): # function:solution (-> +4), function_returning_a_value:solution (-> +4)
    suma = n * (n + 1) / 2 # assignment, assignment_lhs_identifier:suma, assignment_rhs_identifier:n, binary_operator:Add, binary_operator:Div, binary_operator:Mult, int_literal, literal:Num, variable_definition:suma
    suma **= 2 # assignment_lhs_identifier:suma, augmented_assignment:suma, int_literal, literal:Num
    sumb = n * (n + 1) * (2 * n + 1) / 6 # assignment, assignment_lhs_identifier:sumb, assignment_rhs_identifier:n, binary_operator:Add, binary_operator:Div, binary_operator:Mult, int_literal, literal:Num, suggest_constant_definition, variable_definition:sumb
...
# ----------------------------------------------------------------------------------------
def solution(n): # function:solution (-> +3), function_returning_a_value:solution (-> +3)
    sum_of_squares = n * (n + 1) * (2 * n + 1) / 6 # assignment, assignment_lhs_identifier:sum_of_squares, assignment_rhs_identifier:n, binary_operator:Add, binary_operator:Div, binary_operator:Mult, int_literal, literal:Num, suggest_constant_definition, variable_definition:sum_of_squares
    square_of_sum = (n * (n + 1) / 2) ** 2 # assignment, assignment_lhs_identifier:square_of_sum, assignment_rhs_identifier:n, binary_operator:Add, binary_operator:Div, binary_operator:Mult, binary_operator:Pow, int_literal, literal:Num, variable_definition:square_of_sum
...
def isprime(n): # function:isprime (-> +10), function_returning_a_value:isprime (-> +10)
    if n == 2: # comparison_operator:Eq, if (-> +8), int_literal, literal:Num
        ...
        sq = int(sqrt(n)) + 1 # assignment, assignment_lhs_identifier:sq, assignment_rhs_identifier:int, assignment_rhs_identifier:n, assignment_rhs_identifier:sqrt, binary_operator:Add, call_parameter:n, composition, function_call:int, function_call:sqrt, if_else_branch (-> +3), int_literal, literal:Num, variable_definition:sq
...
def solution(n): # function:solution (-> +11), function_returning_a_value:solution (-> +11)
    i = 0 # assignment, assignment_lhs_identifier:i, int_literal, literal:Num, variable_definition:i
    j = 1 # assignment, assignment_lhs_identifier:j, int_literal, literal:Num, variable_definition:j
    while i != n and j < 3: # boolean_operator:And, comparison_operator:Lt, comparison_operator:NotEq, evolve_state (-> +3), int_literal, literal:Num, suggest_constant_definition, while (-> +3)
        j += 1 # assignment_lhs_identifier:j, augmented_assignment:j, int_literal, literal:Num
        if isprime(j): # call_parameter:j, function_call:isprime, if (-> +1)
            i += 1 # assignment_lhs_identifier:i, augmented_assignment:i, if_then_branch, int_literal, literal:Num
    while i != n: # comparison_operator:NotEq, while (-> +3)
        j += 2 # assignment_lhs_identifier:j, augmented_assignment:j, int_literal, literal:Num
        if isprime(j): # call_parameter:j, function_call:isprime, if (-> +1)
            i += 1 # assignment_lhs_identifier:i, augmented_assignment:i, if_then_branch, int_literal, literal:Num
    return j
...
def solution(n): # function:solution (-> +15), function_returning_a_value:solution (-> +15)
    ...
    if n <= 0: # comparison_operator:LtE, if (-> +1), int_literal, literal:Num
        raise ValueError("Parameter n must be greater or equal to one.") # function_call:ValueError, if_then_branch, literal:Str, raise_exception:ValueError
    primes = [] # assignment, assignment_lhs_identifier:primes, literal:List, variable_definition:primes
    num = 2 # assignment, assignment_lhs_identifier:num, int_literal, literal:Num, variable_definition:num
    while len(primes) < n: # call_parameter:primes, comparison_operator:Lt, function_call:len, while (-> +5)
        if isprime(num): # call_parameter:num, function_call:isprime, if (-> +4)
            ...
            num += 1 # assignment_lhs_identifier:num, augmented_assignment:num, if_else_branch, int_literal, literal:Num
...
N = """73167176531330624919225119674426574742355349194934\ # assignment, assignment_lhs_identifier:N, variable_definition:N
...
def solution(n): # function:solution (-> +8), function_returning_a_value:solution (-> +8)
    LargestProduct = -sys.maxsize - 1 # assignment, assignment_lhs_identifier:LargestProduct, assignment_rhs_identifier:sys, binary_operator:Sub, int_literal, literal:Num, unary_operator:USub, variable_definition:LargestProduct
    for i in range(len(n) - 12): # accumulate_elements:1 (-> +5), binary_operator:Sub, call_parameter:n, composition, for:i (-> +5), for_range_stop (-> +5), function_call:len, function_call:range, int_literal, literal:Num, suggest_constant_definition
        product = 1 # assignment, assignment_lhs_identifier:product, int_literal, literal:Num, variable_definition:product
        for j in range(13): # accumulate_elements:1 (-> +1), for:j (-> +1), for_range_stop (-> +1), function_call:range, int_literal, literal:Num, nested_for:1 (-> +1), suggest_constant_definition
            product *= int(n[i + j]) # assignment_lhs_identifier:product, assignment_rhs_identifier:i, assignment_rhs_identifier:int, assignment_rhs_identifier:j, assignment_rhs_identifier:n, augmented_assignment:product, binary_operator:Add, function_call:int, index, index_arithmetic
        if product > LargestProduct: # comparison_operator:Gt, if (-> +1)
            LargestProduct = product # assignment, assignment_lhs_identifier:LargestProduct, assignment_rhs_identifier:product, if_then_branch, variable_definition:LargestProduct
...
N = ( # assignment, assignment_lhs_identifier:N, variable_definition:N
...
def streval(s: str) -> int: # function:streval, function_returning_a_value:streval
    ret = 1 # assignment, assignment_lhs_identifier:ret, int_literal, literal:Num, variable_definition:ret
    for it in s: # accumulate_elements:1 (-> +1), for:it (-> +1), for_each (-> +1)
        ret *= int(it) # assignment_lhs_identifier:ret, assignment_rhs_identifier:int, assignment_rhs_identifier:it, augmented_assignment:ret, call_parameter:it, function_call:int
    return ret
def solution(n: str) -> int: # function:solution, function_returning_a_value:solution
    LargestProduct = -sys.maxsize - 1 # assignment, assignment_lhs_identifier:LargestProduct, assignment_rhs_identifier:sys, binary_operator:Sub, int_literal, literal:Num, unary_operator:USub, variable_definition:LargestProduct
    substr = n[:13] # assignment, assignment_lhs_identifier:substr, assignment_rhs_identifier:n, int_literal, literal:Num, slice, suggest_constant_definition, variable_definition:substr
    cur_index = 13 # assignment, assignment_lhs_identifier:cur_index, int_literal, literal:Num, suggest_constant_definition, variable_definition:cur_index
    while cur_index < len(n) - 13: # binary_operator:Sub, call_parameter:n, comparison_operator:Lt, function_call:len, int_literal, literal:Num, suggest_constant_definition, while (-> +7)
        if int(n[cur_index]) >= int(substr[0]): # comparison_operator:GtE, function_call:int, if (-> +6), index, int_literal, literal:Num
            substr = substr[1:] + n[cur_index] # assignment, assignment_lhs_identifier:substr, assignment_rhs_identifier:cur_index, assignment_rhs_identifier:n, assignment_rhs_identifier:substr, binary_operator:Add, if_then_branch (-> +1), index, int_literal, literal:Num, slice, variable_definition:substr
            cur_index += 1 # assignment_lhs_identifier:cur_index, augmented_assignment:cur_index, int_literal, literal:Num
        else:
            LargestProduct = max(LargestProduct, streval(substr)) # assignment, assignment_lhs_identifier:LargestProduct, assignment_rhs_identifier:LargestProduct, assignment_rhs_identifier:max, assignment_rhs_identifier:streval, assignment_rhs_identifier:substr, call_parameter:LargestProduct, call_parameter:substr, composition, function_call:max, function_call:streval, if_else_branch (-> +2), variable_definition:LargestProduct
            substr = n[cur_index : cur_index + 13] # assignment, assignment_lhs_identifier:substr, assignment_rhs_identifier:cur_index, assignment_rhs_identifier:n, binary_operator:Add, int_literal, literal:Num, slice, suggest_constant_definition, variable_definition:substr
            cur_index += 13 # assignment_lhs_identifier:cur_index, augmented_assignment:cur_index, int_literal, literal:Num, suggest_constant_definition
    return LargestProduct
...
def solution(n): # function:solution (-> +10), function_returning_a_value:solution (-> +10)
    product = -1 # assignment, assignment_lhs_identifier:product, int_literal, literal:Num, variable_definition:product
    d = 0 # assignment, assignment_lhs_identifier:d, int_literal, literal:Num, variable_definition:d
    for a in range(1, n // 3): # binary_operator:FloorDiv, for:a (-> +6), for_range_start (-> +6), function_call:range, int_literal, literal:Num, suggest_constant_definition
        b = (n * n - 2 * a * n) // (2 * n - 2 * a) # assignment, assignment_lhs_identifier:b, assignment_rhs_identifier:a, assignment_rhs_identifier:n, binary_operator:FloorDiv, binary_operator:Mult, binary_operator:Sub, int_literal, literal:Num, variable_definition:b
        c = n - a - b # assignment, assignment_lhs_identifier:c, assignment_rhs_identifier:a, assignment_rhs_identifier:b, assignment_rhs_identifier:n, binary_operator:Sub, variable_definition:c
        if c * c == (a * a + b * b): # binary_operator:Add, binary_operator:Mult, comparison_operator:Eq, if (-> +3)
            d = a * b * c # assignment, assignment_lhs_identifier:d, assignment_rhs_identifier:a, assignment_rhs_identifier:b, assignment_rhs_identifier:c, binary_operator:Mult, if_then_branch (-> +2), variable_definition:d
            if d >= product: # comparison_operator:GtE, if (-> +1), nested_if:1 (-> +1)
                product = d # assignment, assignment_lhs_identifier:product, assignment_rhs_identifier:d, if_then_branch, variable_definition:product
    return product
...
def sum_of_primes(n): # function:sum_of_primes (-> +8), function_returning_a_value:sum_of_primes (-> +8)
    if n > 2: # comparison_operator:Gt, if (-> +3), int_literal, literal:Num
        sumOfPrimes = 2 # assignment, assignment_lhs_identifier:sumOfPrimes, if_then_branch, int_literal, literal:Num, variable_definition:sumOfPrimes
    else:
    ...
    for i in range(3, n, 2): # accumulate_elements:1 (-> +2), call_parameter:n, for:i (-> +2), for_range_step:2 (-> +2), function_call:range, int_literal, literal:Num, suggest_constant_definition
        if is_prime(i): # call_parameter:i, function_call:is_prime, if (-> +1)
            sumOfPrimes += i # assignment_lhs_identifier:sumOfPrimes, assignment_rhs_identifier:i, augmented_assignment:sumOfPrimes, if_then_branch
    return sumOfPrimes
def solution(n): # function:solution (-> +1), function_returning_a_value:solution (-> +1)
...
def prime_sum(n: int) -> int: # function:prime_sum, function_returning_a_value:prime_sum
    list_ = [0 for i in range(n + 1)] # assignment, assignment_lhs_identifier:list_, assignment_rhs_identifier:i, assignment_rhs_identifier:n, assignment_rhs_identifier:range, binary_operator:Add, comprehension:List, comprehension_for_count:1, function_call:range, int_literal, literal:Num, variable_definition:list_
    ...
    s = 0 # assignment, assignment_lhs_identifier:s, int_literal, literal:Num, variable_definition:s
    for i in range(n): # accumulate_elements:1 (-> +2), call_parameter:n, for:i (-> +2), for_range_stop (-> +2), function_call:range
        if list_[i] == 0: # comparison_operator:Eq, if (-> +1), index, int_literal, literal:Num
            s += i # assignment_lhs_identifier:s, assignment_rhs_identifier:i, augmented_assignment:s, if_then_branch
    return s
...
def largest_product(grid): # function:largest_product (-> +27), function_returning_a_value:largest_product (-> +27)
    nColumns = len(grid[0]) # assignment, assignment_lhs_identifier:nColumns, assignment_rhs_identifier:grid, assignment_rhs_identifier:len, function_call:len, index, int_literal, literal:Num, variable_definition:nColumns
    nRows = len(grid) # assignment, assignment_lhs_identifier:nRows, assignment_rhs_identifier:grid, assignment_rhs_identifier:len, call_parameter:grid, function_call:len, variable_definition:nRows
    largest = 0 # assignment, assignment_lhs_identifier:largest, int_literal, literal:Num, variable_definition:largest
    lrDiagProduct = 0 # assignment, assignment_lhs_identifier:lrDiagProduct, int_literal, literal:Num, variable_definition:lrDiagProduct
    rlDiagProduct = 0 # assignment, assignment_lhs_identifier:rlDiagProduct, int_literal, literal:Num, variable_definition:rlDiagProduct
    for i in range(nColumns): # call_parameter:nColumns, for:i (-> +20), for_range_stop (-> +20), function_call:range
        for j in range(nRows - 3): # binary_operator:Sub, for:j (-> +19), for_range_stop (-> +19), function_call:range, int_literal, literal:Num, nested_for:1 (-> +19), suggest_constant_definition
            ...
            if i > 2: # comparison_operator:Gt, if (-> +5), int_literal, literal:Num
                rlDiagProduct = ( # assignment, assignment_lhs_identifier:rlDiagProduct, if_then_branch (-> +4), variable_definition:rlDiagProduct
                    grid[i][j] # assignment_rhs_identifier:grid, assignment_rhs_identifier:i, assignment_rhs_identifier:j, binary_operator:Mult, index
...
def solution(): # function:solution (-> +26), function_returning_a_value:solution (-> +26)
    with open(os.path.dirname(__file__) + "/grid.txt") as f: # binary_operator:Add, call_parameter:__file__, composition, function_call:open, literal:Str, method_call:dirname
        l = [] # assignment, assignment_lhs_identifier:l, literal:List, variable_definition:l
        ...
        maximum = 0 # assignment, assignment_lhs_identifier:maximum, int_literal, literal:Num, variable_definition:maximum
        ...
        for i in range(17): # for:i (-> +4), for_range_stop (-> +4), function_call:range, int_literal, literal:Num, suggest_constant_definition
            for j in range(3, 20): # for:j (-> +3), for_range_start (-> +3), function_call:range, int_literal, literal:Num, nested_for:1 (-> +3), suggest_constant_definition
                temp = l[i][j] * l[i + 1][j - 1] * l[i + 2][j - 2] * l[i + 3][j - 3] # assignment, assignment_lhs_identifier:temp, assignment_rhs_identifier:i, assignment_rhs_identifier:j, assignment_rhs_identifier:l, binary_operator:Add, binary_operator:Mult, binary_operator:Sub, index, index_arithmetic, int_literal, literal:Num, suggest_constant_definition, variable_definition:temp
                if temp > maximum: # comparison_operator:Gt, if (-> +1)
                    maximum = temp # assignment, assignment_lhs_identifier:maximum, assignment_rhs_identifier:temp, if_then_branch, variable_definition:maximum
        return maximum
...
def count_divisors(n): # function:count_divisors (-> +7), function_returning_a_value:count_divisors (-> +7)
    nDivisors = 0 # assignment, assignment_lhs_identifier:nDivisors, int_literal, literal:Num, variable_definition:nDivisors
    for i in range(1, int(sqrt(n)) + 1): # binary_operator:Add, call_parameter:n, composition, for:i (-> +2), for_range_start (-> +2), function_call:int, function_call:range, function_call:sqrt, int_literal, literal:Num
        if n % i == 0: # binary_operator:Mod, comparison_operator:Eq, divisibility_test, if (-> +1), int_literal, literal:Num
            nDivisors += 2 # assignment_lhs_identifier:nDivisors, augmented_assignment:nDivisors, if_then_branch, int_literal, literal:Num
    if n ** 0.5 == int(n ** 0.5): # binary_operator:Pow, comparison_operator:Eq, float_literal, function_call:int, if (-> +1), literal:Num, suggest_constant_definition
        nDivisors -= 1 # assignment_lhs_identifier:nDivisors, augmented_assignment:nDivisors, if_then_branch, int_literal, literal:Num
    return nDivisors
def solution(): # function:solution (-> +8), function_returning_a_value:solution (-> +8)
    tNum = 1 # assignment, assignment_lhs_identifier:tNum, int_literal, literal:Num, variable_definition:tNum
    i = 1 # assignment, assignment_lhs_identifier:i, int_literal, literal:Num, variable_definition:i
    while True: # literal:True, while (-> +4)
        i += 1 # assignment_lhs_identifier:i, augmented_assignment:i, int_literal, literal:Num
        tNum += i # assignment_lhs_identifier:tNum, assignment_rhs_identifier:i, augmented_assignment:tNum
...
# ----------------------------------------------------------------------------------------
def solution(n): # function:solution (-> +16), function_returning_a_value:solution (-> +16)
    largest_number = 0 # assignment, assignment_lhs_identifier:largest_number, int_literal, literal:Num, variable_definition:largest_number
    pre_counter = 0 # assignment, assignment_lhs_identifier:pre_counter, int_literal, literal:Num, variable_definition:pre_counter
    for input1 in range(n): # call_parameter:n, for:input1 (-> +12), for_range_stop (-> +12), function_call:range
        counter = 1 # assignment, assignment_lhs_identifier:counter, int_literal, literal:Num, variable_definition:counter
        number = input1 # assignment, assignment_lhs_identifier:number, assignment_rhs_identifier:input1, variable_definition:number
        while number > 1: # comparison_operator:Gt, evolve_state (-> +6), int_literal, literal:Num, while (-> +6)
            if number % 2 == 0: # binary_operator:Mod, comparison_operator:Eq, divisibility_test:2, if (-> +5), int_literal, literal:Num
                number /= 2 # assignment_lhs_identifier:number, augmented_assignment:number, if_then_branch (-> +1), int_literal, literal:Num
                counter += 1 # assignment_lhs_identifier:counter, augmented_assignment:counter, int_literal, literal:Num
            else:
                number = (3 * number) + 1 # assignment, assignment_lhs_identifier:number, assignment_rhs_identifier:number, binary_operator:Add, binary_operator:Mult, if_else_branch (-> +1), int_literal, literal:Num, suggest_constant_definition, variable_definition:number
                counter += 1 # assignment_lhs_identifier:counter, augmented_assignment:counter, int_literal, literal:Num
        if counter > pre_counter: # comparison_operator:Gt, if (-> +2)
            largest_number = input1 # assignment, assignment_lhs_identifier:largest_number, assignment_rhs_identifier:input1, if_then_branch (-> +1), variable_definition:largest_number
            pre_counter = counter # assignment, assignment_lhs_identifier:pre_counter, assignment_rhs_identifier:counter, variable_definition:pre_counter
...
def collatz_sequence(n): # function:collatz_sequence (-> +8), function_returning_a_value:collatz_sequence (-> +8)
    sequence = [n] # assignment, assignment_lhs_identifier:sequence, assignment_rhs_identifier:n, variable_definition:sequence
    while n != 1: # comparison_operator:NotEq, evolve_state (-> +5), int_literal, literal:Num, while (-> +5)
        if n % 2 == 0: # binary_operator:Mod, comparison_operator:Eq, divisibility_test:2, if (-> +3), int_literal, literal:Num
            n //= 2 # assignment_lhs_identifier:n, augmented_assignment:n, if_then_branch, int_literal, literal:Num
        else:
            n = 3 * n + 1 # assignment, assignment_lhs_identifier:n, assignment_rhs_identifier:n, binary_operator:Add, binary_operator:Mult, if_else_branch, int_literal, literal:Num, suggest_constant_definition, variable_definition:n
...
def lattice_paths(n): # function:lattice_paths (-> +3), function_returning_a_value:lattice_paths (-> +3)
    n = 2 * n # assignment, assignment_lhs_identifier:n, assignment_rhs_identifier:n, binary_operator:Mult, int_literal, literal:Num, variable_definition:n
    k = n / 2 # assignment, assignment_lhs_identifier:k, assignment_rhs_identifier:n, binary_operator:Div, int_literal, literal:Num, variable_definition:k
...
def solution(power): # function:solution (-> +7), function_returning_a_value:solution (-> +7)
    num = 2 ** power # assignment, assignment_lhs_identifier:num, assignment_rhs_identifier:power, binary_operator:Pow, int_literal, literal:Num, variable_definition:num
    string_num = str(num) # assignment, assignment_lhs_identifier:string_num, assignment_rhs_identifier:num, assignment_rhs_identifier:str, call_parameter:num, function_call:str, variable_definition:string_num
    list_num = list(string_num) # assignment, assignment_lhs_identifier:list_num, assignment_rhs_identifier:list, assignment_rhs_identifier:string_num, call_parameter:string_num, function_call:list, variable_definition:list_num
    sum_of_num = 0 # assignment, assignment_lhs_identifier:sum_of_num, int_literal, literal:Num, variable_definition:sum_of_num
    for i in list_num: # accumulate_elements:1 (-> +1), for:i (-> +1), for_each (-> +1)
        sum_of_num += int(i) # assignment_lhs_identifier:sum_of_num, assignment_rhs_identifier:i, assignment_rhs_identifier:int, augmented_assignment:sum_of_num, call_parameter:i, function_call:int
    return sum_of_num
...
def solution(power): # function:solution (-> +5), function_returning_a_value:solution (-> +5)
    n = 2 ** power # assignment, assignment_lhs_identifier:n, assignment_rhs_identifier:power, binary_operator:Pow, int_literal, literal:Num, variable_definition:n
    r = 0 # assignment, assignment_lhs_identifier:r, int_literal, literal:Num, variable_definition:r
    while n: # while (-> +1)
        r, n = r + n % 10, n // 10 # assignment, assignment_lhs_identifier:n, assignment_lhs_identifier:r, assignment_rhs_identifier:n, assignment_rhs_identifier:r, binary_operator:Add, binary_operator:FloorDiv, binary_operator:Mod, int_literal, literal:Num, suggest_constant_definition, variable_definition:n, variable_definition:r
    return r
...
def solution(n): # function:solution (-> +17), function_returning_a_value:solution (-> +17)
    ones_counts = [0, 3, 3, 5, 4, 4, 3, 5, 5, 4, 3, 6, 6, 8, 8, 7, 7, 9, 8, 8] # assignment, assignment_lhs_identifier:ones_counts, int_literal, literal:List, literal:Num, suggest_constant_definition, variable_definition:ones_counts
    tens_counts = [0, 0, 6, 6, 5, 5, 5, 7, 6, 6] # assignment, assignment_lhs_identifier:tens_counts, int_literal, literal:List, literal:Num, suggest_constant_definition, variable_definition:tens_counts
    count = 0 # assignment, assignment_lhs_identifier:count, int_literal, literal:Num, variable_definition:count
    for i in range(1, n + 1): # accumulate_elements:1 (-> +12), binary_operator:Add, for:i (-> +12), for_range_start (-> +12), function_call:range, int_literal, literal:Num
        if i < 1000: # comparison_operator:Lt, if (-> +11), int_literal, literal:Num, suggest_constant_definition
            if i >= 100: # comparison_operator:GtE, if (-> +3), if_then_branch (-> +8), int_literal, literal:Num, nested_if:1 (-> +3), suggest_constant_definition
                count += ones_counts[i // 100] + 7 # assignment_lhs_identifier:count, assignment_rhs_identifier:i, assignment_rhs_identifier:ones_counts, augmented_assignment:count, binary_operator:Add, binary_operator:FloorDiv, if_then_branch (-> +2), index, index_arithmetic, int_literal, literal:Num, suggest_constant_definition
                if i % 100 != 0: # binary_operator:Mod, comparison_operator:NotEq, divisibility_test:100, if (-> +1), int_literal, literal:Num, nested_if:2 (-> +1), suggest_constant_definition
                    count += 3 # assignment_lhs_identifier:count, augmented_assignment:count, if_then_branch, int_literal, literal:Num, suggest_constant_definition
            if 0 < i % 100 < 20: # binary_operator:Mod, chained_comparison:2, comparison_operator:Lt, if (-> +4), int_literal, literal:Num, nested_if:1 (-> +4), suggest_constant_definition
                count += ones_counts[i % 100] # assignment_lhs_identifier:count, assignment_rhs_identifier:i, assignment_rhs_identifier:ones_counts, augmented_assignment:count, binary_operator:Mod, if_then_branch, index, index_arithmetic, int_literal, literal:Num, suggest_constant_definition
            else:
                count += ones_counts[i % 10] # assignment_lhs_identifier:count, assignment_rhs_identifier:i, assignment_rhs_identifier:ones_counts, augmented_assignment:count, binary_operator:Mod, if_else_branch (-> +1), index, index_arithmetic, int_literal, literal:Num, suggest_constant_definition
                count += tens_counts[(i % 100 - i % 10) // 10] # assignment_lhs_identifier:count, assignment_rhs_identifier:i, assignment_rhs_identifier:tens_counts, augmented_assignment:count, binary_operator:FloorDiv, binary_operator:Mod, binary_operator:Sub, index, index_arithmetic, int_literal, literal:Num, suggest_constant_definition
        else:
            count += ones_counts[i // 1000] + 8 # assignment_lhs_identifier:count, assignment_rhs_identifier:i, assignment_rhs_identifier:ones_counts, augmented_assignment:count, binary_operator:Add, binary_operator:FloorDiv, if_else_branch, index, index_arithmetic, int_literal, literal:Num, suggest_constant_definition
    return count
...
def solution(): # function:solution (-> +17), function_returning_a_value:solution (-> +17)
    script_dir = os.path.dirname(os.path.realpath(__file__)) # assignment, assignment_lhs_identifier:script_dir, assignment_rhs_identifier:__file__, assignment_rhs_identifier:os, call_parameter:__file__, composition, method_call:dirname, method_call:realpath, variable_definition:script_dir
    triangle = os.path.join(script_dir, "triangle.txt") # assignment, assignment_lhs_identifier:triangle, assignment_rhs_identifier:os, assignment_rhs_identifier:script_dir, call_parameter:script_dir, literal:Str, method_call:join, variable_definition:triangle
    with open(triangle, "r") as f: # call_parameter:triangle, function_call:open, literal:Str
        triangle = f.readlines() # assignment, assignment_lhs_identifier:triangle, assignment_rhs_identifier:f, method_call:readlines, variable_definition:triangle
    a = [[int(y) for y in x.rstrip("\r\n").split(" ")] for x in triangle] # assignment, assignment_lhs_identifier:a, assignment_rhs_identifier:int, assignment_rhs_identifier:triangle, assignment_rhs_identifier:x, assignment_rhs_identifier:y, call_parameter:y, comprehension:List, comprehension_for_count:1, function_call:int, literal:Str, method_call:rstrip, method_call:split, method_call_object:x, method_chaining, variable_definition:a
    for i in range(1, len(a)): # call_parameter:a, composition, for:i (-> +10), for_range_start (-> +10), function_call:len, function_call:range, int_literal, literal:Num
        for j in range(len(a[i])): # composition, for:j (-> +9), for_indexes (-> +9), for_range_stop (-> +9), function_call:len, function_call:range, index, nested_for:1 (-> +9)
            if j != len(a[i - 1]): # binary_operator:Sub, comparison_operator:NotEq, function_call:len, if (-> +3), index, index_arithmetic, int_literal, literal:Num, suggest_conditional_expression (-> +3)
                number1 = a[i - 1][j] # assignment, assignment_lhs_identifier:number1, assignment_rhs_identifier:a, assignment_rhs_identifier:i, assignment_rhs_identifier:j, binary_operator:Sub, if_then_branch, index, index_arithmetic, int_literal, literal:Num, variable_definition:number1
            else:
                number1 = 0 # assignment, assignment_lhs_identifier:number1, if_else_branch, int_literal, literal:Num, variable_definition:number1
            if j > 0: # comparison_operator:Gt, if (-> +3), int_literal, literal:Num, suggest_conditional_expression (-> +3)
                number2 = a[i - 1][j - 1] # assignment, assignment_lhs_identifier:number2, assignment_rhs_identifier:a, assignment_rhs_identifier:i, assignment_rhs_identifier:j, binary_operator:Sub, if_then_branch, index, index_arithmetic, int_literal, literal:Num, variable_definition:number2
            else:
                number2 = 0 # assignment, assignment_lhs_identifier:number2, if_else_branch, int_literal, literal:Num, variable_definition:number2
            a[i][j] += max(number1, number2) # assignment_rhs_identifier:max, assignment_rhs_identifier:number1, assignment_rhs_identifier:number2, call_parameter:number1, call_parameter:number2, function_call:max, index
...
def solution(): # function:solution (-> +24), function_returning_a_value:solution (-> +24)
    days_per_month = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31] # assignment, assignment_lhs_identifier:days_per_month, int_literal, literal:List, literal:Num, suggest_constant_definition, variable_definition:days_per_month
    day = 6 # assignment, assignment_lhs_identifier:day, int_literal, literal:Num, suggest_constant_definition, variable_definition:day
    month = 1 # assignment, assignment_lhs_identifier:month, int_literal, literal:Num, variable_definition:month
    year = 1901 # assignment, assignment_lhs_identifier:year, int_literal, literal:Num, suggest_constant_definition, variable_definition:year
    sundays = 0 # assignment, assignment_lhs_identifier:sundays, int_literal, literal:Num, variable_definition:sundays
    while year < 2001: # comparison_operator:Lt, evolve_state (-> +17), int_literal, literal:Num, suggest_constant_definition, while (-> +17)
        day += 7 # assignment_lhs_identifier:day, augmented_assignment:day, int_literal, literal:Num, suggest_constant_definition
        if (year % 4 == 0 and not year % 100 == 0) or (year % 400 == 0): # binary_operator:Mod, boolean_operator:And, boolean_operator:Or, comparison_operator:Eq, divisibility_test:100, divisibility_test:4, divisibility_test:400, if (-> +10), int_literal, literal:Num, suggest_constant_definition, unary_operator:Not
            if day > days_per_month[month - 1] and month != 2: # binary_operator:Sub, boolean_operator:And, comparison_operator:Gt, comparison_operator:NotEq, if (-> +5), if_then_branch (-> +5), index, index_arithmetic, int_literal, literal:Num, nested_if:1 (-> +5)
                month += 1 # assignment_lhs_identifier:month, augmented_assignment:month, if_then_branch (-> +1), int_literal, literal:Num
                day = day - days_per_month[month - 2] # assignment, assignment_lhs_identifier:day, assignment_rhs_identifier:day, assignment_rhs_identifier:days_per_month, assignment_rhs_identifier:month, binary_operator:Sub, index, index_arithmetic, int_literal, literal:Num, suggest_augmented_assignment, variable_definition:day
                ...
                month += 1 # assignment_lhs_identifier:month, augmented_assignment:month, if_elif_branch (-> +1), int_literal, literal:Num
                day = day - 29 # assignment, assignment_lhs_identifier:day, assignment_rhs_identifier:day, binary_operator:Sub, int_literal, literal:Num, suggest_augmented_assignment, suggest_constant_definition, variable_definition:day
        else:
        ...
        if month > 12: # comparison_operator:Gt, if (-> +2), int_literal, literal:Num, suggest_constant_definition
            year += 1 # assignment_lhs_identifier:year, augmented_assignment:year, if_then_branch (-> +1), int_literal, literal:Num
            month = 1 # assignment, assignment_lhs_identifier:month, int_literal, literal:Num, variable_definition:month
        if year < 2001 and day == 1: # boolean_operator:And, comparison_operator:Eq, comparison_operator:Lt, if (-> +1), int_literal, literal:Num, suggest_constant_definition
            sundays += 1 # assignment_lhs_identifier:sundays, augmented_assignment:sundays, if_then_branch, int_literal, literal:Num
    return sundays
...
def factorial(n): # function:factorial (-> +4), function_returning_a_value:factorial (-> +4)
    fact = 1 # assignment, assignment_lhs_identifier:fact, int_literal, literal:Num, variable_definition:fact
    for i in range(1, n + 1): # accumulate_elements:1 (-> +1), binary_operator:Add, for:i (-> +1), for_range_start (-> +1), function_call:range, int_literal, literal:Num
        fact *= i # assignment_lhs_identifier:fact, assignment_rhs_identifier:i, augmented_assignment:fact
    return fact
def split_and_add(number): # function:split_and_add (-> +6), function_returning_a_value:split_and_add (-> +6)
    sum_of_digits = 0 # assignment, assignment_lhs_identifier:sum_of_digits, int_literal, literal:Num, variable_definition:sum_of_digits
    while number > 0: # comparison_operator:Gt, evolve_state (-> +3), int_literal, literal:Num, while (-> +3)
        last_digit = number % 10 # assignment, assignment_lhs_identifier:last_digit, assignment_rhs_identifier:number, binary_operator:Mod, int_literal, literal:Num, suggest_constant_definition, variable_definition:last_digit
        sum_of_digits += last_digit # assignment_lhs_identifier:sum_of_digits, assignment_rhs_identifier:last_digit, augmented_assignment:sum_of_digits
        number = number // 10 # assignment, assignment_lhs_identifier:number, assignment_rhs_identifier:number, binary_operator:FloorDiv, int_literal, literal:Num, suggest_augmented_assignment, suggest_constant_definition, variable_definition:number
    return sum_of_digits
def solution(n): # function:solution (-> +3), function_returning_a_value:solution (-> +3)
    f = factorial(n) # assignment, assignment_lhs_identifier:f, assignment_rhs_identifier:factorial, assignment_rhs_identifier:n, call_parameter:n, function_call:factorial, variable_definition:f
    result = split_and_add(f) # assignment, assignment_lhs_identifier:result, assignment_rhs_identifier:f, assignment_rhs_identifier:split_and_add, call_parameter:f, function_call:split_and_add, variable_definition:result
    return result
...
def solution(n): # function:solution (-> +7), function_returning_a_value:solution (-> +7)
    ...
    for j in str(fact): # accumulate_elements:1 (-> +1), call_parameter:fact, for:j (-> +1), function_call:str
        result += int(j) # assignment_lhs_identifier:result, assignment_rhs_identifier:int, assignment_rhs_identifier:j, augmented_assignment:result, call_parameter:j, function_call:int
    return result
...
def sum_of_divisors(n): # function:sum_of_divisors (-> +7), function_returning_a_value:sum_of_divisors (-> +7)
    total = 0 # assignment, assignment_lhs_identifier:total, int_literal, literal:Num, variable_definition:total
    for i in range(1, int(sqrt(n) + 1)): # accumulate_elements:1 (-> +4), binary_operator:Add, call_parameter:n, composition, for:i (-> +4), for_range_start (-> +4), function_call:int, function_call:range, function_call:sqrt, int_literal, literal:Num
        if n % i == 0 and i != sqrt(n): # binary_operator:Mod, boolean_operator:And, call_parameter:n, comparison_operator:Eq, comparison_operator:NotEq, divisibility_test, function_call:sqrt, if (-> +3), int_literal, literal:Num
            total += i + n // i # assignment_lhs_identifier:total, assignment_rhs_identifier:i, assignment_rhs_identifier:n, augmented_assignment:total, binary_operator:Add, binary_operator:FloorDiv, if_then_branch
        elif i == sqrt(n): # call_parameter:n, comparison_operator:Eq, function_call:sqrt, if (-> +1)
            total += i # assignment_lhs_identifier:total, assignment_rhs_identifier:i, augmented_assignment:total, if_elif_branch
    return total - n # binary_operator:Sub
def solution(n): # function:solution (-> +8), function_returning_a_value:solution (-> +8)
    total = sum( # assignment, assignment_lhs_identifier:total, assignment_rhs_identifier:sum, composition, function_call:sum, variable_definition:total
        [
...
def solution(): # function:solution (-> +12), function_returning_a_value:solution (-> +12)
    with open(os.path.dirname(__file__) + "/p022_names.txt") as file: # binary_operator:Add, call_parameter:__file__, composition, function_call:open, literal:Str, method_call:dirname
        names = str(file.readlines()[0]) # assignment, assignment_lhs_identifier:names, assignment_rhs_identifier:file, assignment_rhs_identifier:str, composition, function_call:str, index, int_literal, literal:Num, method_call:readlines, method_call_object:file, variable_definition:names
        names = names.replace('"', "").split(",") # assignment, assignment_lhs_identifier:names, assignment_rhs_identifier:names, literal:Str, method_call:replace, method_call:split, method_call_object:names, method_chaining, variable_definition:names
    names.sort() # method_call:sort, method_call_object:names
    name_score = 0 # assignment, assignment_lhs_identifier:name_score, int_literal, literal:Num, variable_definition:name_score
    total_score = 0 # assignment, assignment_lhs_identifier:total_score, int_literal, literal:Num, variable_definition:total_score
    for i, name in enumerate(names): # call_parameter:names, for:i:name (-> +4), for_indexes_elements (-> +4), function_call:enumerate
        for letter in name: # accumulate_elements:1 (-> +1), for:letter (-> +1), for_each (-> +1), nested_for:1 (-> +1)
            name_score += ord(letter) - 64 # assignment_lhs_identifier:name_score, assignment_rhs_identifier:letter, assignment_rhs_identifier:ord, augmented_assignment:name_score, binary_operator:Sub, call_parameter:letter, function_call:ord, int_literal, literal:Num, suggest_constant_definition
        total_score += (i + 1) * name_score # assignment_lhs_identifier:total_score, assignment_rhs_identifier:i, assignment_rhs_identifier:name_score, augmented_assignment:total_score, binary_operator:Add, binary_operator:Mult, int_literal, literal:Num
        name_score = 0 # assignment, assignment_lhs_identifier:name_score, int_literal, literal:Num, variable_definition:name_score
    return total_score
...
import os # import:os
def solution(): # function:solution (-> +12), function_returning_a_value:solution (-> +12)
    total_sum = 0 # assignment, assignment_lhs_identifier:total_sum, int_literal, literal:Num, variable_definition:total_sum
    temp_sum = 0 # assignment, assignment_lhs_identifier:temp_sum, int_literal, literal:Num, variable_definition:temp_sum
    with open(os.path.dirname(__file__) + "/p022_names.txt") as file: # binary_operator:Add, call_parameter:__file__, composition, function_call:open, literal:Str, method_call:dirname
        name = str(file.readlines()[0]) # assignment, assignment_lhs_identifier:name, assignment_rhs_identifier:file, assignment_rhs_identifier:str, composition, function_call:str, index, int_literal, literal:Num, method_call:readlines, method_call_object:file, variable_definition:name
        name = name.replace('"', "").split(",") # assignment, assignment_lhs_identifier:name, assignment_rhs_identifier:name, literal:Str, method_call:replace, method_call:split, method_call_object:name, method_chaining, variable_definition:name
    ...
    for i in range(len(name)): # accumulate_elements:1 (-> +4), call_parameter:name, composition, for:i (-> +4), for_indexes (-> +4), for_range_stop (-> +4), function_call:len, function_call:range
        for j in name[i]: # accumulate_elements:1 (-> +1), for:j (-> +1), index, nested_for:1 (-> +1)
            temp_sum += ord(j) - ord("A") + 1 # assignment_lhs_identifier:temp_sum, assignment_rhs_identifier:j, assignment_rhs_identifier:ord, augmented_assignment:temp_sum, binary_operator:Add, binary_operator:Sub, call_parameter:j, function_call:ord, int_literal, literal:Num, literal:Str
        total_sum += (i + 1) * temp_sum # assignment_lhs_identifier:total_sum, assignment_rhs_identifier:i, assignment_rhs_identifier:temp_sum, augmented_assignment:total_sum, binary_operator:Add, binary_operator:Mult, int_literal, literal:Num
        temp_sum = 0 # assignment, assignment_lhs_identifier:temp_sum, int_literal, literal:Num, variable_definition:temp_sum
    return total_sum
...
def solution(limit=28123): # function:solution (-> +13), function_returning_a_value:solution (-> +13), function_with_default_positional_arguments:solution (-> +13), int_literal, literal:Num
    sumDivs = [1] * (limit + 1) # assignment, assignment_lhs_identifier:sumDivs, assignment_rhs_identifier:limit, binary_operator:Add, binary_operator:Mult, int_literal, literal:List, literal:Num, variable_definition:sumDivs
    for i in range(2, int(limit ** 0.5) + 1): # accumulate_elements:1 (-> +3), binary_operator:Add, binary_operator:Pow, composition, float_literal, for:i (-> +3), for_range_start (-> +3), function_call:int, function_call:range, int_literal, literal:Num, suggest_constant_definition
        sumDivs[i * i] += i # assignment_lhs_identifier:sumDivs, assignment_rhs_identifier:i, augmented_assignment:sumDivs, binary_operator:Mult, index, index_arithmetic
        for k in range(i + 1, limit // i + 1): # accumulate_elements:1 (-> +1), binary_operator:Add, binary_operator:FloorDiv, for:k (-> +1), for_range_start (-> +1), function_call:range, int_literal, literal:Num, nested_for:1 (-> +1)
            sumDivs[k * i] += k + i # assignment_lhs_identifier:sumDivs, assignment_rhs_identifier:i, assignment_rhs_identifier:k, augmented_assignment:sumDivs, binary_operator:Add, binary_operator:Mult, index, index_arithmetic
    abundants = set() # assignment, assignment_lhs_identifier:abundants, assignment_rhs_identifier:set, function_call:set, variable_definition:abundants
    res = 0 # assignment, assignment_lhs_identifier:res, int_literal, literal:Num, variable_definition:res
    for n in range(1, limit + 1): # accumulate_elements:2 (-> +4), binary_operator:Add, for:n (-> +4), for_range_start (-> +4), function_call:range, int_literal, literal:Num
        ...
        if not any((n - a in abundants) for a in abundants): # binary_operator:Sub, comparison_operator:In, comprehension:Generator, comprehension_for_count:1, function_call:any, if (-> +1), unary_operator:Not
            res += n # assignment_lhs_identifier:res, assignment_rhs_identifier:n, augmented_assignment:res, if_then_branch
    return res
...
def fib(a, b, n): # function:fib (-> +13), function_returning_a_value:fib (-> +13)
    ...
    temp = 0 # assignment, assignment_lhs_identifier:temp, int_literal, literal:Num, variable_definition:temp
    for x in range(2, n): # call_parameter:n, for:x (-> +4), for_range_start (-> +4), function_call:range, int_literal, literal:Num
        c = str(a) + str(b) # assignment, assignment_lhs_identifier:c, assignment_rhs_identifier:a, assignment_rhs_identifier:b, assignment_rhs_identifier:str, binary_operator:Add, call_parameter:a, call_parameter:b, function_call:str, variable_definition:c
        temp = b # assignment, assignment_lhs_identifier:temp, assignment_rhs_identifier:b, variable_definition:temp
        b = c # assignment, assignment_lhs_identifier:b, assignment_rhs_identifier:c, variable_definition:b
        a = temp # assignment, assignment_lhs_identifier:a, assignment_rhs_identifier:temp, variable_definition:a
    return c
def solution(n): # function:solution (-> +11), function_returning_a_value:solution (-> +11)
    semidivisible = [] # assignment, assignment_lhs_identifier:semidivisible, literal:List, variable_definition:semidivisible
    for x in range(n): # call_parameter:n, for:x (-> +8), for_range_stop (-> +8), function_call:range
        l = [i for i in input().split()] # assignment, assignment_lhs_identifier:l, assignment_rhs_identifier:i, assignment_rhs_identifier:input, comprehension:List, comprehension_for_count:1, function_call:input, method_call:split, variable_definition:l
        c2 = 1 # assignment, assignment_lhs_identifier:c2, int_literal, literal:Num, variable_definition:c2
        while 1: # int_literal, literal:Num, while (-> +4)
            if len(fib(l[0], l[1], c2)) < int(l[2]): # call_parameter:c2, comparison_operator:Lt, composition, function_call:fib, function_call:int, function_call:len, if (-> +3), index, int_literal, literal:Num
                c2 += 1 # assignment_lhs_identifier:c2, augmented_assignment:c2, if_then_branch, int_literal, literal:Num
            else:
                break # if_else_branch
...
def solution(): # function:solution (-> +2), function_returning_a_value:solution (-> +2)
    result = list(map("".join, permutations("0123456789"))) # assignment, assignment_lhs_identifier:result, assignment_rhs_identifier:list, assignment_rhs_identifier:map, assignment_rhs_identifier:permutations, composition, function_call:list, function_call:map, function_call:permutations, literal:Str, variable_definition:result
...
def fibonacci(n): # function:fibonacci (-> +9), function_returning_a_value:fibonacci (-> +9)
    if n == 1 or type(n) is not int: # boolean_operator:Or, call_parameter:n, comparison_operator:Eq, comparison_operator:IsNot, function_call:type, if (-> +8), int_literal, literal:Num
        ...
        sequence = [0, 1] # assignment, assignment_lhs_identifier:sequence, if_else_branch (-> +3), int_literal, literal:List, literal:Num, variable_definition:sequence
...
def fibonacci_digits_index(n): # function:fibonacci_digits_index (-> +6), function_returning_a_value:fibonacci_digits_index (-> +6)
    digits = 0 # assignment, assignment_lhs_identifier:digits, int_literal, literal:Num, variable_definition:digits
    index = 2 # assignment, assignment_lhs_identifier:index, int_literal, literal:Num, variable_definition:index
    while digits < n: # comparison_operator:Lt, while (-> +2)
        index += 1 # assignment_lhs_identifier:index, augmented_assignment:index, int_literal, literal:Num
        digits = len(str(fibonacci(index))) # assignment, assignment_lhs_identifier:digits, assignment_rhs_identifier:fibonacci, assignment_rhs_identifier:index, assignment_rhs_identifier:len, assignment_rhs_identifier:str, call_parameter:index, composition, function_call:fibonacci, function_call:len, function_call:str, variable_definition:digits
    return index
def solution(n): # function:solution (-> +1), function_returning_a_value:solution (-> +1)
...
def solution(n): # function:solution (-> +5), function_returning_a_value:solution (-> +5)
    answer = 1 # assignment, assignment_lhs_identifier:answer, int_literal, literal:Num, variable_definition:answer
    gen = fibonacci_generator() # assignment, assignment_lhs_identifier:gen, assignment_rhs_identifier:fibonacci_generator, function_call:fibonacci_generator, variable_definition:gen
    while len(str(next(gen))) < n: # call_parameter:gen, comparison_operator:Lt, composition, function_call:len, function_call:next, function_call:str, while (-> +1)
        answer += 1 # assignment_lhs_identifier:answer, augmented_assignment:answer, int_literal, literal:Num
...
# ----------------------------------------------------------------------------------------
def solution(n): # function:solution (-> +12), function_returning_a_value:solution (-> +12)
    f1, f2 = 1, 1 # assignment, assignment_lhs_identifier:f1, assignment_lhs_identifier:f2, int_literal, literal:Num, literal:Tuple, variable_definition:f1, variable_definition:f2
    index = 2 # assignment, assignment_lhs_identifier:index, int_literal, literal:Num, variable_definition:index
    while True: # literal:True, while (-> +8)
        i = 0 # assignment, assignment_lhs_identifier:i, int_literal, literal:Num, variable_definition:i
        f = f1 + f2 # assignment, assignment_lhs_identifier:f, assignment_rhs_identifier:f1, assignment_rhs_identifier:f2, binary_operator:Add, variable_definition:f
        f1, f2 = f2, f # assignment, assignment_lhs_identifier:f1, assignment_lhs_identifier:f2, assignment_rhs_identifier:f, assignment_rhs_identifier:f2, variable_definition:f1, variable_definition:f2
        index += 1 # assignment_lhs_identifier:index, augmented_assignment:index, int_literal, literal:Num
...
def solution(a_limit: int, b_limit: int) -> int: # function:solution, function_returning_a_value:solution
    longest = [0, 0, 0] # assignment, assignment_lhs_identifier:longest, int_literal, literal:List, literal:Num, variable_definition:longest
    for a in range((a_limit * -1) + 1, a_limit): # binary_operator:Add, binary_operator:Mult, call_parameter:a_limit, for:a (-> +9), for_range_start (-> +9), function_call:range, int_literal, literal:Num
        for b in range(2, b_limit): # call_parameter:b_limit, for:b (-> +8), for_range_start (-> +8), function_call:range, int_literal, literal:Num, nested_for:1 (-> +8)
            if is_prime(b): # call_parameter:b, function_call:is_prime, if (-> +7)
                count = 0 # assignment, assignment_lhs_identifier:count, if_then_branch (-> +6), int_literal, literal:Num, variable_definition:count
                n = 0 # assignment, assignment_lhs_identifier:n, int_literal, literal:Num, variable_definition:n
                while is_prime((n ** 2) + (a * n) + b): # binary_operator:Add, binary_operator:Mult, binary_operator:Pow, function_call:is_prime, int_literal, literal:Num, while (-> +2)
                    count += 1 # assignment_lhs_identifier:count, augmented_assignment:count, int_literal, literal:Num
                    n += 1 # assignment_lhs_identifier:n, augmented_assignment:n, int_literal, literal:Num
                if count > longest[0]: # comparison_operator:Gt, if (-> +1), index, int_literal, literal:Num, nested_if:1 (-> +1)
                    longest = [count, a, b] # assignment, assignment_lhs_identifier:longest, assignment_rhs_identifier:a, assignment_rhs_identifier:b, assignment_rhs_identifier:count, if_then_branch, variable_definition:longest
    ans = longest[1] * longest[2] # assignment, assignment_lhs_identifier:ans, assignment_rhs_identifier:longest, binary_operator:Mult, index, int_literal, literal:Num, variable_definition:ans
    return ans
...
def diagonal_sum(n): # function:diagonal_sum (-> +6), function_returning_a_value:diagonal_sum (-> +6)
    total = 1 # assignment, assignment_lhs_identifier:total, int_literal, literal:Num, variable_definition:total
    for i in range(1, int(ceil(n / 2.0))): # binary_operator:Div, composition, float_literal, for:i (-> +3), for_range_start (-> +3), function_call:ceil, function_call:int, function_call:range, int_literal, literal:Num, suggest_constant_definition
        odd = 2 * i + 1 # assignment, assignment_lhs_identifier:odd, assignment_rhs_identifier:i, binary_operator:Add, binary_operator:Mult, int_literal, literal:Num, variable_definition:odd
        even = 2 * i # assignment, assignment_lhs_identifier:even, assignment_rhs_identifier:i, binary_operator:Mult, int_literal, literal:Num, variable_definition:even
        total = total + 4 * odd ** 2 - 6 * even # assignment, assignment_lhs_identifier:total, assignment_rhs_identifier:even, assignment_rhs_identifier:odd, assignment_rhs_identifier:total, binary_operator:Add, binary_operator:Mult, binary_operator:Pow, binary_operator:Sub, int_literal, literal:Num, suggest_constant_definition, variable_definition:total
    return total
...
# ----------------------------------------------------------------------------------------
def solution(n): # function:solution (-> +8), function_returning_a_value:solution (-> +8)
    collectPowers = set() # assignment, assignment_lhs_identifier:collectPowers, assignment_rhs_identifier:set, function_call:set, variable_definition:collectPowers
    currentPow = 0 # assignment, assignment_lhs_identifier:currentPow, int_literal, literal:Num, variable_definition:currentPow
    N = n + 1 # assignment, assignment_lhs_identifier:N, assignment_rhs_identifier:n, binary_operator:Add, int_literal, literal:Num, variable_definition:N
    for a in range(2, N): # call_parameter:N, for:a (-> +3), for_range_start (-> +3), function_call:range, int_literal, literal:Num, square_nested_for (-> +3)
        for b in range(2, N): # call_parameter:N, for:b (-> +2), for_range_start (-> +2), function_call:range, int_literal, literal:Num, nested_for:1 (-> +2)
            currentPow = a ** b # assignment, assignment_lhs_identifier:currentPow, assignment_rhs_identifier:a, assignment_rhs_identifier:b, binary_operator:Pow, variable_definition:currentPow
...
def solve(digit_len: int) -> str: # function:solve, function_returning_a_value:solve
    solutions = [] # assignment, assignment_lhs_identifier:solutions, literal:List, variable_definition:solutions
    den = 11 # assignment, assignment_lhs_identifier:den, int_literal, literal:Num, suggest_constant_definition, variable_definition:den
    last_digit = int("1" + "0" * digit_len) # assignment, assignment_lhs_identifier:last_digit, assignment_rhs_identifier:digit_len, assignment_rhs_identifier:int, binary_operator:Add, binary_operator:Mult, function_call:int, literal:Str, variable_definition:last_digit
    for num in range(den, last_digit): # accumulate_elements:1 (-> +7), call_parameter:den, call_parameter:last_digit, for:num (-> +7), for_range_start (-> +7), function_call:range
        while den <= 99: # comparison_operator:LtE, evolve_state (-> +4), int_literal, literal:Num, suggest_constant_definition, while (-> +4)
            ...
            den += 1 # assignment_lhs_identifier:den, augmented_assignment:den, int_literal, literal:Num
        num += 1 # assignment_lhs_identifier:num, augmented_assignment:num, int_literal, literal:Num
        den = 10 # assignment, assignment_lhs_identifier:den, int_literal, literal:Num, suggest_constant_definition, variable_definition:den
    solutions = " , ".join(solutions) # assignment, assignment_lhs_identifier:solutions, assignment_rhs_identifier:solutions, call_parameter:solutions, literal:Str, method_call:join, variable_definition:solutions
    return solutions
...
def is_palindrome(n): # function:is_palindrome (-> +5), function_returning_a_value:is_palindrome (-> +5)
    n = str(n) # assignment, assignment_lhs_identifier:n, assignment_rhs_identifier:n, assignment_rhs_identifier:str, call_parameter:n, function_call:str, variable_definition:n
...
def solution(n): # function:solution (-> +5), function_returning_a_value:solution (-> +5)
    ...
    for i in range(1, n): # accumulate_elements:1 (-> +2), call_parameter:n, for:i (-> +2), for_range_start (-> +2), function_call:range, int_literal, literal:Num
        if is_palindrome(i) and is_palindrome(bin(i).split("b")[1]): # boolean_operator:And, call_parameter:i, composition, function_call:bin, function_call:is_palindrome, if (-> +1), index, int_literal, literal:Num, literal:Str, method_call:split
            total += i # assignment_lhs_identifier:total, assignment_rhs_identifier:i, augmented_assignment:total, if_then_branch
    return total
...
def solution(): # function:solution (-> +14), function_returning_a_value:solution (-> +14)
    constant = [] # assignment, assignment_lhs_identifier:constant, literal:List, variable_definition:constant
    i = 1 # assignment, assignment_lhs_identifier:i, int_literal, literal:Num, variable_definition:i
    while len(constant) < 1e6: # call_parameter:constant, comparison_operator:Lt, evolve_state (-> +2), float_literal, function_call:len, literal:Num, suggest_constant_definition, while (-> +2)
        ...
        i += 1 # assignment_lhs_identifier:i, augmented_assignment:i, int_literal, literal:Num
    constant = "".join(constant) # assignment, assignment_lhs_identifier:constant, assignment_rhs_identifier:constant, call_parameter:constant, literal:Str, method_call:join, variable_definition:constant
    return (
...
# ----------------------------------------------------------------------------------------
import os # import:os
TRIANGULAR_NUMBERS = [int(0.5 * n * (n + 1)) for n in range(1, 101)] # assignment, assignment_lhs_identifier:TRIANGULAR_NUMBERS, assignment_rhs_identifier:int, assignment_rhs_identifier:n, assignment_rhs_identifier:range, binary_operator:Add, binary_operator:Mult, comprehension:List, comprehension_for_count:1, float_literal, function_call:int, function_call:range, int_literal, literal:Num, variable_definition:TRIANGULAR_NUMBERS
def solution(): # function:solution (-> +13), function_returning_a_value:solution (-> +13)
    script_dir = os.path.dirname(os.path.realpath(__file__)) # assignment, assignment_lhs_identifier:script_dir, assignment_rhs_identifier:__file__, assignment_rhs_identifier:os, call_parameter:__file__, composition, method_call:dirname, method_call:realpath, variable_definition:script_dir
    wordsFilePath = os.path.join(script_dir, "words.txt") # assignment, assignment_lhs_identifier:wordsFilePath, assignment_rhs_identifier:os, assignment_rhs_identifier:script_dir, call_parameter:script_dir, literal:Str, method_call:join, variable_definition:wordsFilePath
    words = "" # assignment, assignment_lhs_identifier:words, literal:Str, variable_definition:words
    with open(wordsFilePath, "r") as f: # call_parameter:wordsFilePath, function_call:open, literal:Str
        words = f.readline() # assignment, assignment_lhs_identifier:words, assignment_rhs_identifier:f, method_call:readline, variable_definition:words
    ...
    words = list( # assignment, assignment_lhs_identifier:words, assignment_rhs_identifier:list, composition, function_call:list, variable_definition:words
...
def solution(): # function:solution (-> +4), function_returning_a_value:solution (-> +4)
    ...
    for i in range(1, 1001): # accumulate_elements:1 (-> +1), for:i (-> +1), for_range_start (-> +1), function_call:range, int_literal, literal:Num, suggest_constant_definition
        total += i ** i # assignment_lhs_identifier:total, assignment_rhs_identifier:i, augmented_assignment:total, binary_operator:Pow
    ...
    for i in range(1, 101): # for:i (-> +3), for_range_start (-> +3), function_call:range, int_literal, literal:Num, suggest_constant_definition
        for j in range(1, i + 1): # binary_operator:Add, for:j (-> +2), for_range_start (-> +2), function_call:range, int_literal, literal:Num, nested_for:1 (-> +2)
            if combinations(i, j) > 1e6: # call_parameter:i, call_parameter:j, comparison_operator:Gt, float_literal, function_call:combinations, if (-> +1), literal:Num, suggest_constant_definition
                total += 1 # assignment_lhs_identifier:total, augmented_assignment:total, if_then_branch, int_literal, literal:Num
    return total

# ----------------------------------------------------------------------------------------
# ../Python/project_euler/problem_551/sol1.py
# ----------------------------------------------------------------------------------------
ks = [k for k in range(2, 20 + 1)] # assignment, assignment_lhs_identifier:ks, assignment_rhs_identifier:k, assignment_rhs_identifier:range, binary_operator:Add, comprehension:List, comprehension_for_count:1, function_call:range, int_literal, literal:Num, variable_definition:ks
base = [10 ** k for k in range(ks[-1] + 1)] # assignment, assignment_lhs_identifier:base, assignment_rhs_identifier:k, assignment_rhs_identifier:ks, assignment_rhs_identifier:range, binary_operator:Add, binary_operator:Pow, comprehension:List, comprehension_for_count:1, function_call:range, index, int_literal, literal:Num, negative_index:-1, variable_definition:base
memo = {} # assignment, assignment_lhs_identifier:memo, literal:Dict, variable_definition:memo
def next_term(a_i, k, i, n): # function:next_term (-> +50), function_returning_a_value:next_term (-> +50), recursive_function:next_term (-> +50)
    ds_b = 0 # assignment, assignment_lhs_identifier:ds_b, int_literal, literal:Num, variable_definition:ds_b
    for j in range(k, len(a_i)): # accumulate_elements:1 (-> +1), call_parameter:a_i, call_parameter:k, composition, for:j (-> +1), for_range_start (-> +1), function_call:len, function_call:range
        ds_b += a_i[j] # assignment_lhs_identifier:ds_b, assignment_rhs_identifier:a_i, assignment_rhs_identifier:j, augmented_assignment:ds_b, index
    c = 0 # assignment, assignment_lhs_identifier:c, int_literal, literal:Num, variable_definition:c
    for j in range(min(len(a_i), k)): # accumulate_elements:1 (-> +1), call_parameter:a_i, call_parameter:k, composition, for:j (-> +1), for_range_stop (-> +1), function_call:len, function_call:min, function_call:range
        c += a_i[j] * base[j] # assignment_lhs_identifier:c, assignment_rhs_identifier:a_i, assignment_rhs_identifier:base, assignment_rhs_identifier:j, augmented_assignment:c, binary_operator:Mult, index
    diff, dn = 0, 0 # assignment, assignment_lhs_identifier:diff, assignment_lhs_identifier:dn, int_literal, literal:Num, literal:Tuple, variable_definition:diff, variable_definition:dn
    max_dn = n - i # assignment, assignment_lhs_identifier:max_dn, assignment_rhs_identifier:i, assignment_rhs_identifier:n, binary_operator:Sub, variable_definition:max_dn
    sub_memo = memo.get(ds_b) # assignment, assignment_lhs_identifier:sub_memo, assignment_rhs_identifier:ds_b, assignment_rhs_identifier:memo, call_parameter:ds_b, method_call:get, variable_definition:sub_memo
    if sub_memo != None: # comparison_operator:NotEq, if (-> +19), literal:None
        jumps = sub_memo.get(c) # assignment, assignment_lhs_identifier:jumps, assignment_rhs_identifier:c, assignment_rhs_identifier:sub_memo, call_parameter:c, if_then_branch (-> +15), method_call:get, variable_definition:jumps
        if jumps != None and len(jumps) > 0: # boolean_operator:And, call_parameter:jumps, comparison_operator:Gt, comparison_operator:NotEq, function_call:len, if (-> +14), int_literal, literal:None, literal:Num, nested_if:1 (-> +14)
            max_jump = -1 # assignment, assignment_lhs_identifier:max_jump, if_then_branch (-> +11), int_literal, literal:Num, variable_definition:max_jump
            for _k in range(len(jumps) - 1, -1, -1): # binary_operator:Sub, call_parameter:jumps, composition, for:_k (-> +3), for_range_step:-1 (-> +3), function_call:len, function_call:range, int_literal, literal:Num
                if jumps[_k][2] <= k and jumps[_k][1] <= max_dn: # boolean_operator:And, comparison_operator:LtE, if (-> +2), index, int_literal, literal:Num, nested_if:2 (-> +2)
                    max_jump = _k # assignment, assignment_lhs_identifier:max_jump, assignment_rhs_identifier:_k, if_then_branch (-> +1), variable_definition:max_jump
                    break
            if max_jump >= 0: # comparison_operator:GtE, if (-> +6), int_literal, literal:Num, nested_if:2 (-> +6)
                diff, dn, _kk = jumps[max_jump] # assignment, assignment_lhs_identifier:_kk, assignment_lhs_identifier:diff, assignment_lhs_identifier:dn, assignment_rhs_identifier:jumps, assignment_rhs_identifier:max_jump, if_then_branch (-> +5), index, variable_definition:_kk, variable_definition:diff, variable_definition:dn
                new_c = diff + c # assignment, assignment_lhs_identifier:new_c, assignment_rhs_identifier:c, assignment_rhs_identifier:diff, binary_operator:Add, variable_definition:new_c
                for j in range(min(k, len(a_i))): # call_parameter:a_i, call_parameter:k, composition, for:j (-> +1), for_range_stop (-> +1), function_call:len, function_call:min, function_call:range
                    new_c, a_i[j] = divmod(new_c, 10) # assignment, assignment_lhs_identifier:a_i, assignment_lhs_identifier:new_c, assignment_rhs_identifier:divmod, assignment_rhs_identifier:new_c, call_parameter:new_c, function_call:divmod, index, int_literal, literal:Num, suggest_constant_definition, variable_definition:a_i, variable_definition:new_c
        ...
        sub_memo = {c: []} # assignment, assignment_lhs_identifier:sub_memo, assignment_rhs_identifier:c, if_else_branch (-> +1), literal:List, variable_definition:sub_memo
    ...
    if k > ks[0]: # comparison_operator:Gt, if (-> +10), index, int_literal, literal:Num
        while True: # if_then_branch (-> +5), literal:True, while (-> +5)
            _diff, terms_jumped = next_term(a_i, k - 1, i + dn, n) # assignment, assignment_lhs_identifier:_diff, assignment_lhs_identifier:terms_jumped, assignment_rhs_identifier:a_i, assignment_rhs_identifier:dn, assignment_rhs_identifier:i, assignment_rhs_identifier:k, assignment_rhs_identifier:n, assignment_rhs_identifier:next_term, binary_operator:Add, binary_operator:Sub, call_parameter:a_i, call_parameter:n, function_call:next_term, int_literal, literal:Num, variable_definition:_diff, variable_definition:terms_jumped
            diff += _diff # assignment_lhs_identifier:diff, assignment_rhs_identifier:_diff, augmented_assignment:diff
            dn += terms_jumped # assignment_lhs_identifier:dn, assignment_rhs_identifier:terms_jumped, augmented_assignment:dn
            if dn >= max_dn or c + diff >= base[k]: # binary_operator:Add, boolean_operator:Or, comparison_operator:GtE, if (-> +1), index, nested_if:1 (-> +1)
                break # if_then_branch
    else:
        _diff, terms_jumped = compute(a_i, k, i + dn, n) # assignment, assignment_lhs_identifier:_diff, assignment_lhs_identifier:terms_jumped, assignment_rhs_identifier:a_i, assignment_rhs_identifier:compute, assignment_rhs_identifier:dn, assignment_rhs_identifier:i, assignment_rhs_identifier:k, assignment_rhs_identifier:n, binary_operator:Add, call_parameter:a_i, call_parameter:k, call_parameter:n, function_call:compute, if_else_branch (-> +2), variable_definition:_diff, variable_definition:terms_jumped
        diff += _diff # assignment_lhs_identifier:diff, assignment_rhs_identifier:_diff, augmented_assignment:diff
        dn += terms_jumped # assignment_lhs_identifier:dn, assignment_rhs_identifier:terms_jumped, augmented_assignment:dn
    jumps = sub_memo[c] # assignment, assignment_lhs_identifier:jumps, assignment_rhs_identifier:c, assignment_rhs_identifier:sub_memo, index, variable_definition:jumps
    j = 0 # assignment, assignment_lhs_identifier:j, int_literal, literal:Num, variable_definition:j
...
def compute(a_i, k, i, n): # function:compute (-> +25), function_returning_a_value:compute (-> +25)
    ...
    start_i = i # assignment, assignment_lhs_identifier:start_i, assignment_rhs_identifier:i, variable_definition:start_i
    ds_b, ds_c, diff = 0, 0, 0 # assignment, assignment_lhs_identifier:diff, assignment_lhs_identifier:ds_b, assignment_lhs_identifier:ds_c, int_literal, literal:Num, literal:Tuple, variable_definition:diff, variable_definition:ds_b, variable_definition:ds_c
    for j in range(len(a_i)): # accumulate_elements:2 (-> +4), call_parameter:a_i, composition, for:j (-> +4), for_indexes (-> +4), for_range_stop (-> +4), function_call:len, function_call:range
        if j >= k: # comparison_operator:GtE, if (-> +3)
            ds_b += a_i[j] # assignment_lhs_identifier:ds_b, assignment_rhs_identifier:a_i, assignment_rhs_identifier:j, augmented_assignment:ds_b, if_then_branch, index
        else:
            ds_c += a_i[j] # assignment_lhs_identifier:ds_c, assignment_rhs_identifier:a_i, assignment_rhs_identifier:j, augmented_assignment:ds_c, if_else_branch, index
    while i < n: # comparison_operator:Lt, while (-> +10)
        i += 1 # assignment_lhs_identifier:i, augmented_assignment:i, int_literal, literal:Num
        addend = ds_c + ds_b # assignment, assignment_lhs_identifier:addend, assignment_rhs_identifier:ds_b, assignment_rhs_identifier:ds_c, binary_operator:Add, variable_definition:addend
        diff += addend # assignment_lhs_identifier:diff, assignment_rhs_identifier:addend, augmented_assignment:diff
        ds_c = 0 # assignment, assignment_lhs_identifier:ds_c, int_literal, literal:Num, variable_definition:ds_c
        for j in range(k): # accumulate_elements:1 (-> +3), call_parameter:k, for:j (-> +3), for_range_stop (-> +3), function_call:range
            s = a_i[j] + addend # assignment, assignment_lhs_identifier:s, assignment_rhs_identifier:a_i, assignment_rhs_identifier:addend, assignment_rhs_identifier:j, binary_operator:Add, index, variable_definition:s
            addend, a_i[j] = divmod(s, 10) # assignment, assignment_lhs_identifier:a_i, assignment_lhs_identifier:addend, assignment_rhs_identifier:divmod, assignment_rhs_identifier:s, call_parameter:s, function_call:divmod, index, int_literal, literal:Num, suggest_constant_definition, variable_definition:a_i, variable_definition:addend
            ds_c += a_i[j] # assignment_lhs_identifier:ds_c, assignment_rhs_identifier:a_i, assignment_rhs_identifier:j, augmented_assignment:ds_c, index
...
def add(digits, k, addend): # function:add (-> +13), procedure:add (-> +13)
    for j in range(k, len(digits)): # call_parameter:digits, call_parameter:k, composition, for:j (-> +9), for_range_start (-> +9), function_call:len, function_call:range
        s = digits[j] + addend # assignment, assignment_lhs_identifier:s, assignment_rhs_identifier:addend, assignment_rhs_identifier:digits, assignment_rhs_identifier:j, binary_operator:Add, index, variable_definition:s
        if s >= 10: # comparison_operator:GtE, if (-> +5), int_literal, literal:Num, suggest_constant_definition
            quotient, digits[j] = divmod(s, 10) # assignment, assignment_lhs_identifier:digits, assignment_lhs_identifier:quotient, assignment_rhs_identifier:divmod, assignment_rhs_identifier:s, call_parameter:s, function_call:divmod, if_then_branch (-> +1), index, int_literal, literal:Num, suggest_constant_definition, variable_definition:digits, variable_definition:quotient
            addend = addend // 10 + quotient # assignment, assignment_lhs_identifier:addend, assignment_rhs_identifier:addend, assignment_rhs_identifier:quotient, binary_operator:Add, binary_operator:FloorDiv, int_literal, literal:Num, suggest_constant_definition, variable_definition:addend
        else:
            digits[j] = s # assignment, assignment_lhs_identifier:digits, assignment_rhs_identifier:s, if_else_branch (-> +1), index
            addend = addend // 10 # assignment, assignment_lhs_identifier:addend, assignment_rhs_identifier:addend, binary_operator:FloorDiv, int_literal, literal:Num, suggest_augmented_assignment, suggest_constant_definition, variable_definition:addend
    ...
    while addend > 0: # comparison_operator:Gt, int_literal, literal:Num, while (-> +2)
        addend, digit = divmod(addend, 10) # assignment, assignment_lhs_identifier:addend, assignment_lhs_identifier:digit, assignment_rhs_identifier:addend, assignment_rhs_identifier:divmod, call_parameter:addend, function_call:divmod, int_literal, literal:Num, suggest_constant_definition, variable_definition:addend, variable_definition:digit
        digits.append(digit) # call_parameter:digit, method_call:append, method_call_object:digits
def solution(n): # function:solution (-> +12), function_returning_a_value:solution (-> +12)
    digits = [1] # assignment, assignment_lhs_identifier:digits, int_literal, literal:List, literal:Num, variable_definition:digits
    i = 1 # assignment, assignment_lhs_identifier:i, int_literal, literal:Num, variable_definition:i
    dn = 0 # assignment, assignment_lhs_identifier:dn, int_literal, literal:Num, variable_definition:dn
    while True: # literal:True, while (-> +4)
        diff, terms_jumped = next_term(digits, 20, i + dn, n) # assignment, assignment_lhs_identifier:diff, assignment_lhs_identifier:terms_jumped, assignment_rhs_identifier:digits, assignment_rhs_identifier:dn, assignment_rhs_identifier:i, assignment_rhs_identifier:n, assignment_rhs_identifier:next_term, binary_operator:Add, call_parameter:digits, call_parameter:n, function_call:next_term, int_literal, literal:Num, suggest_constant_definition, variable_definition:diff, variable_definition:terms_jumped
        dn += terms_jumped # assignment_lhs_identifier:dn, assignment_rhs_identifier:terms_jumped, augmented_assignment:dn
        if dn == n - i: # binary_operator:Sub, comparison_operator:Eq, if (-> +1)
            break # if_then_branch
    a_n = 0 # assignment, assignment_lhs_identifier:a_n, int_literal, literal:Num, variable_definition:a_n
    for j in range(len(digits)): # accumulate_elements:1 (-> +1), call_parameter:digits, composition, for:j (-> +1), for_indexes (-> +1), for_range_stop (-> +1), function_call:len, function_call:range
        a_n += digits[j] * 10 ** j # assignment_lhs_identifier:a_n, assignment_rhs_identifier:digits, assignment_rhs_identifier:j, augmented_assignment:a_n, binary_operator:Mult, binary_operator:Pow, index, int_literal, literal:Num, suggest_constant_definition
    return a_n
...
def partition(m): # function:partition (-> +9), function_returning_a_value:partition (-> +9)
    memo = [[0 for _ in range(m)] for _ in range(m + 1)] # assignment, assignment_lhs_identifier:memo, assignment_rhs_identifier:_, assignment_rhs_identifier:m, assignment_rhs_identifier:range, binary_operator:Add, call_parameter:m, comprehension:List, comprehension_for_count:1, function_call:range, int_literal, literal:Num, variable_definition:memo
    ...
    for n in range(m + 1): # binary_operator:Add, for:n (-> +4), for_range_stop (-> +4), function_call:range, int_literal, literal:Num
        for k in range(1, m): # call_parameter:m, for:k (-> +3), for_range_start (-> +3), function_call:range, int_literal, literal:Num, nested_for:1 (-> +3)
            memo[n][k] += memo[n][k - 1] # assignment_rhs_identifier:k, assignment_rhs_identifier:memo, assignment_rhs_identifier:n, binary_operator:Sub, index, index_arithmetic, int_literal, literal:Num
            if n > k: # comparison_operator:Gt, if (-> +1)
                memo[n][k] += memo[n - k - 1][k] # assignment_rhs_identifier:k, assignment_rhs_identifier:memo, assignment_rhs_identifier:n, binary_operator:Sub, if_then_branch, index, index_arithmetic, int_literal, literal:Num
...
def find_largest(data_file: str = "base_exp.txt") -> int: # function:find_largest, function_returning_a_value:find_largest, function_with_default_positional_arguments:find_largest, literal:Str
    largest = [0, 0] # assignment, assignment_lhs_identifier:largest, int_literal, literal:List, literal:Num, variable_definition:largest
    for i, line in enumerate(open(os.path.join(os.path.dirname(__file__), data_file))): # call_parameter:__file__, call_parameter:data_file, composition, for:i:line (-> +3), for_indexes_elements (-> +3), function_call:enumerate, function_call:open, method_call:dirname, method_call:join
        ...
        if x * log10(a) > largest[0]: # binary_operator:Mult, call_parameter:a, comparison_operator:Gt, function_call:log10, if (-> +1), index, int_literal, literal:Num
            largest = [x * log10(a), i + 1] # assignment, assignment_lhs_identifier:largest, assignment_rhs_identifier:a, assignment_rhs_identifier:i, assignment_rhs_identifier:log10, assignment_rhs_identifier:x, binary_operator:Add, binary_operator:Mult, call_parameter:a, function_call:log10, if_then_branch, int_literal, literal:Num, variable_definition:largest
