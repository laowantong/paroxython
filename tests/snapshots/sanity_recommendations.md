# Table of contents
- [`7 programs of learning cost 0`](#7-programs-of-learning-cost-0)
    - [`123.2146-assert-condition.py`](#program-1232146-assert-conditionpy-learning-cost-0)
    - [`173.2427-format-a-number-with-grouped-thousands.py`](#program-1732427-format-a-number-with-grouped-thousandspy-learning-cost-0)
    - [`173.2429-format-a-number-with-grouped-thousands.py`](#program-1732429-format-a-number-with-grouped-thousandspy-learning-cost-0)
    - [`003.19-create-a-procedure.py`](#program-00319-create-a-procedurepy-learning-cost-0)
    - [`007.183-iterate-over-list-indexes-and-values.py`](#program-007183-iterate-over-list-indexes-and-valuespy-learning-cost-0)
    - [`071.379-echo-program-implementation.py`](#program-071379-echo-program-implementationpy-learning-cost-0)
    - [`108.1291-determine-if-variable-name-is-defined.py`](#program-1081291-determine-if-variable-name-is-definedpy-learning-cost-0)
- [`11 programs of learning cost in ]0.5, 1[`](#11-programs-of-learning-cost-in-05-1)
...
- [`49 programs of learning cost in [1, 2[`](#49-programs-of-learning-cost-in-1-2)
    ...
    - [`049.242-split-a-space-separated-string.py`](#program-049242-split-a-space-separated-stringpy-learning-cost-1625)
    - [`057.3173-filter-list.py`](#program-0573173-filter-listpy-learning-cost-1625)
    - [`062.1091-find-substring-position.py`](#program-0621091-find-substring-positionpy-learning-cost-1625)
    - [`089.1097-handle-invalid-argument.py`](#program-0891097-handle-invalid-argumentpy-learning-cost-1625)
    - [`096.1094-check-string-prefix.py`](#program-0961094-check-string-prefixpy-learning-cost-1625)
    ...
    - [`003.2372-create-a-procedure.py`](#program-0032372-create-a-procedurepy-learning-cost-1625)
    - [`010.1478-shuffle-a-list.py`](#program-0101478-shuffle-a-listpy-learning-cost-1625)
    - [`011.47-pick-a-random-element-from-a-list.py`](#program-01147-pick-a-random-element-from-a-listpy-learning-cost-1625)
    - [`014.3410-pick-uniformly-a-random-floating-point-number-in-ab.py`](#program-0143410-pick-uniformly-a-random-floating-point-number-in-abpy-learning-cost-1625)
    - [`015.184-pick-uniformly-a-random-integer-in-ab.py`](#program-015184-pick-uniformly-a-random-integer-in-abpy-learning-cost-1625)
...
- [`89 programs of learning cost in [2, 4[`](#89-programs-of-learning-cost-in-2-4)
    ...
    - [`027.193-create-a-3-dimensional-array.py`](#program-027193-create-a-3-dimensional-arraypy-learning-cost-25)
    - [`032.196-integer-exponentiation-by-squaring.py`](#program-032196-integer-exponentiation-by-squaringpy-learning-cost-25)
    - [`061.576-get-current-date.py`](#program-061576-get-current-datepy-learning-cost-25)
    - [`069.1086-seed-random-generator.py`](#program-0691086-seed-random-generatorpy-learning-cost-25)
    - [`070.1087-use-clock-as-random-generator-seed.py`](#program-0701087-use-clock-as-random-generator-seedpy-learning-cost-25)
    ...
    - [`138.2161-create-temp-file.py`](#program-1382161-create-temp-filepy-learning-cost-25)
    - [`139.2162-create-temp-directory.py`](#program-1392162-create-temp-directorypy-learning-cost-25)
    ...
    - [`087.1139-stop-program.py`](#program-0871139-stop-programpy-learning-cost-25625)
    ...
    - [`133.2160-case-insensitive-string-contains.py`](#program-1332160-case-insensitive-string-containspy-learning-cost-259375)
    - [`186.2699-exit-program-cleanly.py`](#program-1862699-exit-program-cleanlypy-learning-cost-259375)
    ...
    - [`050.572-make-an-infinite-loop.py`](#program-050572-make-an-infinite-looppy-learning-cost-28125)
    ...
    - [`059.669-write-to-standard-error-stream.py`](#program-059669-write-to-standard-error-streampy-learning-cost-35625)
    ...
    - [`034.625-create-a-set-of-objects.py`](#program-034625-create-a-set-of-objectspy-learning-cost-3875)
- [`50 programs of learning cost in [4, 8[`](#50-programs-of-learning-cost-in-4-8)
...
- [`15 programs of learning cost in [8, 16[`](#15-programs-of-learning-cost-in-8-16)
    ...
    - [`043.676-break-outer-loop.py`](#program-043676-break-outer-looppy-learning-cost-934375)
...
- [`3 programs of learning cost in [16, 32[`](#3-programs-of-learning-cost-in-16-32)
    ...
    - [`040.2279-graph-with-adjacency-lists.py`](#program-0402279-graph-with-adjacency-listspy-learning-cost-198125)
...
## 7 programs of learning cost 0

### Program `123.2146-assert-condition.py` (learning cost 0)
...
### Program `173.2427-format-a-number-with-grouped-thousands.py` (learning cost 0)
...
### Program `173.2429-format-a-number-with-grouped-thousands.py` (learning cost 0)
...
### Program `003.19-create-a-procedure.py` (learning cost 0)
...
### Program `007.183-iterate-over-list-indexes-and-values.py` (learning cost 0)
...
### Program `071.379-echo-program-implementation.py` (learning cost 0)
...
### Program `108.1291-determine-if-variable-name-is-defined.py` (learning cost 0)
...
## 11 programs of learning cost in ]0.5, 1[
...
### Program `019.3164-reverse-a-list.py` (learning cost 0.96875)
...
| Cost  | Taxon | Lines |
|----|----|----|
| 0.96875 | `call/method/sequence/mutable/reverse` | 1 |
---

### Program `044.190-insert-element-in-list.py` (learning cost 0.96875)
...
| Cost  | Taxon | Lines |
|----|----|----|
| 0.96875 | `call/method/sequence/mutable/insert` | 1 |
---

### Program `171.2446-add-an-element-at-the-end-of-a-list.py` (learning cost 0.96875)
...
| Cost  | Taxon | Lines |
|----|----|----|
| 0.96875 | `call/method/sequence/mutable/append` | 1 |
---

### Program `100.1142-sort-by-a-comparator.py` (learning cost 0.984375)
...
### Program `049.242-split-a-space-separated-string.py` (learning cost 1.625)
...
### Program `062.1091-find-substring-position.py` (learning cost 1.625)
...
### Program `089.1097-handle-invalid-argument.py` (learning cost 1.625)
...
### Program `096.1094-check-string-prefix.py` (learning cost 1.625)
...
### Program `003.2372-create-a-procedure.py` (learning cost 1.625)
...
### Program `010.1478-shuffle-a-list.py` (learning cost 1.625)
...
### Program `011.47-pick-a-random-element-from-a-list.py` (learning cost 1.625)
...
### Program `014.3410-pick-uniformly-a-random-floating-point-number-in-ab.py` (learning cost 1.625)
...
### Program `015.184-pick-uniformly-a-random-integer-in-ab.py` (learning cost 1.625)
...
### Program `164.2169-open-url-in-default-browser.py` (learning cost 1.625)
...
### Program `052.666-check-if-map-contains-value.py` (learning cost 1.6875)
...
| Cost  | Taxon | Lines |
|----|----|----|
| 0.9375 | `call/method/dictionary/values` | 1 |
| 0.75 | `test/belonging` | 1 |
---
...
### Program `063.1088-replace-fragment-of-a-string.py` (learning cost 1.84375)
...
### Program `097.1095-check-string-suffix.py` (learning cost 1.84375)
...
### Program `167.3175-trim-prefix.py` (learning cost 1.84375)
...
### Program `168.3174-trim-suffix.py` (learning cost 1.84375)
...
### Program `135.2158-remove-item-from-list-by-its-value.py` (learning cost 1.90625)
...
| Cost  | Taxon | Lines |
|----|----|----|
| 0.96875 | `call/method/sequence/mutable/remove` | 1 |
| 0.9375 | `call/method/set/remove` | 1 |
---

## 89 programs of learning cost in [2, 4[

### Program `023.1102-convert-real-number-to-string-with-2-decimal-places.py` (learning cost 2.5)
...
### Program `065.1085-format-decimal-number.py` (learning cost 2.5)
...
### Program `076.1083-binary-digits-from-an-integer.py` (learning cost 2.5)
...
### Program `153.1980-concatenate-string-with-integer.py` (learning cost 2.5)
...
### Program `027.193-create-a-3-dimensional-array.py` (learning cost 2.5)
...
### Program `061.576-get-current-date.py` (learning cost 2.5)
...
### Program `069.1086-seed-random-generator.py` (learning cost 2.5)
...
### Program `070.1087-use-clock-as-random-generator-seed.py` (learning cost 2.5)
...
### Program `138.2161-create-temp-file.py` (learning cost 2.5)
...
### Program `139.2162-create-temp-directory.py` (learning cost 2.5)
...
### Program `087.1139-stop-program.py` (learning cost 2.5625)
...
### Program `133.2160-case-insensitive-string-contains.py` (learning cost 2.59375)
...
### Program `186.2699-exit-program-cleanly.py` (learning cost 2.59375)
...
### Program `150.2154-remove-trailing-slash.py` (learning cost 2.71875)
...
### Program `116.1257-remove-occurrences-of-word-from-string.py` (learning cost 2.78125)
...
### Program `050.572-make-an-infinite-loop.py` (learning cost 2.8125)
...
### Program `014.185-pick-uniformly-a-random-floating-point-number-in-ab.py` (learning cost 3.25)
...
### Program `033.1420-atomically-read-and-update-variable.py` (learning cost 3.25)
...
| 0.75 | `call/method` | 2, 3, 7 |
| 0.875 | `library/standard/threading` | 1 |
| 0.875 | `variable/assignment/single` | 2, 5 |
---

### Program `144.2915-check-if-file-exists.py` (learning cost 3.3125)
...
### Program `103.2276-load-xml-file-into-struct.py` (learning cost 3.375)
...
### Program `111.2168-launch-other-program.py` (learning cost 3.375)
...
### Program `127.2274-source-code-inclusion.py` (learning cost 3.375)
...
### Program `132.2040-measure-duration-of-procedure-execution.py` (learning cost 3.375)
...
### Program `179.2688-get-center-of-a-rectangle.py` (learning cost 3.5625)
...
### Program `059.669-write-to-standard-error-stream.py` (learning cost 3.5625)

```python
1   import sys
2   print >>sys.stderr, "%s is negative" % x
```

| Cost  | Taxon | Lines |
|----|----|----|
| 0.875 | `library/standard/sys` | 1 |
| 0.9375 | `operator/bitwise/shift/right` | 2 |
...
| Cost  | Taxon | Lines |
|----|----|----|
| 0.9375 | `call/method/dictionary/pop` | 1 |
| 0.96875 | `call/method/sequence/mutable/pop` | 1 |
| 0.9375 | `call/method/set/pop` | 1 |
| 0.875 | `type/elementary/null` | 1 |
---
...
### Program `034.625-create-a-set-of-objects.py` (learning cost 3.875)
...
## 50 programs of learning cost in [4, 8[
...
| 0.875 | `library/standard/sys` | 1 |
| 0.875 | `type/elementary/string` | 3, 5 |
| 0.875 | `variable/assignment/single` | 5 |
---

### Program `177.2725-find-files-with-a-given-list-of-filename-extensions.py` (learning cost 4.25)
...
| Cost  | Taxon | Lines |
|----|----|----|
| 0.75 | `call/method` | 4, 5, 7 |
| 0.875 | `library/standard/os` | 2 |
| 0.875 | `library/standard/re` | 1 |
| 0.875 | `type/elementary/string` | 4, 7 |
| 0.875 | `variable/assignment/single` | 3 |
---

### Program `167.2611-trim-prefix.py` (learning cost 4.3125)
...
### Program `075.675-compute-lcm.py` (learning cost 4.3125)
...
### Program `126.2137-multiple-return-values.py` (learning cost 4.3125)
...
| 0.875 | `subroutine/argument/no` | 1-2 |
| 0.75 | `subroutine/function` | 1-2 |
| 0.875 | `type/container/tuple` | 2 |
| 0.9375 | `type/elementary/boolean/true` | 2 |
| 0.875 | `type/elementary/string` | 2 |
---

### Program `147.2171-remove-all-non-ascii-characters.py` (learning cost 4.3125)
...
| 0.875 | `library/standard/re` | 1 |
| 0.875 | `type/elementary/string` | 2 |
| 0.9375 | `type/elementary/string/empty` | 2 |
| 0.875 | `variable/assignment/single` | 2 |
---
...
| 0.9375 | `type/container/tuple/assignment` | 2 |
| 0.875 | `type/elementary/string` | 2 |
...
| 0.9375 | `type/elementary/number/complex` | 1, 2 |
| 0.9375 | `type/elementary/number/integer` | 1 |
...
### Program `073.673-create-a-factory.py` (learning cost 4.9375)
...
### Program `067.1426-binomial-coefficient-n-choose-k.py` (learning cost 5.0)
...
| 0.9375 | `variable/assignment/parallel/4` | 2 |
---

### Program `099.1429-format-date-yyyy-mm-dd.py` (learning cost 5.125)
...
| 0.75 | `call/method` | 3 |
| 0.9375 | `library/standard/datetime/date` | 1 |
| 0.9375 | `type/elementary/number/integer` | 2, 2, 2 |
| 0.875 | `type/elementary/string` | 3 |
| 0.875 | `variable/assignment/single` | 2, 3 |
---
...
| 0.875 | `library/standard/threading` | 1 |
| 0.875 | `type/container/tuple` | 2 |
| 0.9375 | `type/elementary/number/floating_point` | 2 |
| 0.9375 | `type/elementary/number/integer` | 2 |
| 0.875 | `variable/assignment/single` | 2 |
---
...
### Program `160.2165-detect-if-32-bit-or-64-bit-architecture.py` (learning cost 5.9375)
...
| 0.9375 | `type/elementary/number/integer` | 2, 4 |
...
| 0.9375 | `type/container/dictionary/empty` | 5 |
| 0.9375 | `type/container/tuple/assignment` | 7 |
| 0.875 | `type/elementary/string` | 3, 4 |
| 0.9375 | `variable/assignment/parallel/2` | 7 |
| 0.875 | `variable/assignment/single` | 3, 4, 5, 6 |
---

### Program `174.2687-make-http-post-request.py` (learning cost 6.21875)
...
| 0.9375 | `subroutine/method/naming/magic` | 2-5 |
| 0.75 | `subroutine/procedure` | 2-5 |
| 0.9375 | `type/container/list/empty` | 4 |
| 0.875 | `type/elementary/null` | 2 |
| 0.75 | `variable/assignment` | 3, 4, 5 |
---

### Program `025.195-send-a-value-to-another-thread.py` (learning cost 6.6875)
...
| 0.9375 | `type/elementary/boolean/true` | 4 |
...
| 0.9375 | `type/elementary/number/floating_point` | 3 |
| 0.9375 | `type/elementary/number/integer` | 3 |
| 0.875 | `variable/assignment/single` | 3 |
---
...
| 0.9375 | `type/elementary/number/integer` | 3, 5 |
| 0.96875 | `type/elementary/number/integer/zero` | 2 |
---

### Program `043.676-break-outer-loop.py` (learning cost 9.34375)
...
| 0.9375 | `type/elementary/number/integer` | 4 |
| 0.875 | `variable/assignment/single` | 3 |
---
...
| 0.96875 | `call/method/sequence/string/index` | 4 |
| 0.875 | `flow/conditional/no_else` | 3-4 |
...
| 0.9375 | `type/container/set/empty` | 3 |
...
| 0.9375 | `call/method/set/add` | 7 |
| 0.9375 | `call/method/set/pop` | 5 |
...
| 0.875 | `type/container/list` | 1 |
| 0.9375 | `type/container/list/empty` | 3 |
| 0.9375 | `type/container/set/empty` | 2 |
...
|----|----|----|
| 0.75 | `call/function` | 5 |
| 0.9375 | `call/method/dictionary/pop` | 4 |
| 0.96875 | `call/method/sequence/mutable/append` | 9 |
| 0.96875 | `call/method/sequence/mutable/pop` | 4 |
| 0.9375 | `call/method/set/pop` | 4 |
| 0.875 | `flow/conditional/no_else` | 7-9 |
...
| 0.9375 | `type/elementary/boolean/true` | 8 |
...
| 0.875 | `type/container/list` | 3 |
| 0.9375 | `type/container/tuple/assignment` | 15 |
| 0.96875 | `type/elementary/number/integer/zero` | 3 |
| 0.75 | `variable/assignment` | 3, 4, 9 |
| 0.9375 | `variable/assignment/parallel/2` | 15 |
---

### Program `040.2279-graph-with-adjacency-lists.py` (learning cost 19.8125)
...
| Cost  | Taxon | Lines |
|----|----|----|
| 0.75 | `call/function` | 13 |
| 0.9375 | `call/function/builtin/zip` | 10 |
| 0.75 | `call/method` | 8 |
| 0.9375 | `call/method/set/add` | 11, 12 |
| 0.5 | `class` | 2-3, 4-12 |
...
| 0.875 | `type/container/tuple` | 13, 13 |
| 0.9375 | `type/elementary/number/integer` | 10, 13, 13, 13, 13, 13, 13 |
| 0.96875 | `type/elementary/number/integer/zero` | 13 |
...
| 0.9375 | `type/elementary/number/integer` | 6, 6, 6, 6, 6, 15 |
| 0.875 | `type/elementary/string` | 10, 10, 11, 13 |
| 0.9375 | `type/elementary/string/empty` | 10 |
| 0.875 | `variable/assignment/single` | 9, 11, 13 |
---

# Summary
<details>
  <summary>224 initially.</summary>
  <ol>
    <li><code>001.1159-print-hello-world.py</code></li>
    <li><code>001.3-print-hello-world.py</code></li>
    <li><code>002.11-print-hello-10-times.py</code></li>
    <li><code>002.1493-print-hello-10-times.py</code></li>
    <li><code>002.3117-print-hello-10-times.py</code></li>
    <li><code>003.19-create-a-procedure.py</code></li>
    <li><code>003.2372-create-a-procedure.py</code></li>
    <li><code>004.24-create-a-function-which-returns-the-square-of-an-integer.py</code></li>
    <li><code>004.2921-create-a-function-which-returns-the-square-of-an-integer.py</code></li>
    <li><code>005.663-create-a-2d-point-data-structure.py</code></li>
    <li><code>006.32-iterate-over-list-values.py</code></li>
    <li><code>007.183-iterate-over-list-indexes-and-values.py</code></li>
    <li><code>008.39-initialize-a-new-map-associative-array.py</code></li>
    ...
    <li><code>010.182-shuffle-a-list.py</code></li>
    <li><code>011.47-pick-a-random-element-from-a-list.py</code></li>
    <li><code>012.181-check-if-list-contains-a-value.py</code></li>
    <li><code>013.574-iterate-over-map-keys-and-values.py</code></li>
    <li><code>014.185-pick-uniformly-a-random-floating-point-number-in-ab.py</code></li>
    <li><code>014.3410-pick-uniformly-a-random-floating-point-number-in-ab.py</code></li>
    <li><code>015.184-pick-uniformly-a-random-integer-in-ab.py</code></li>
    ...
    <li><code>019.197-reverse-a-list.py</code></li>
    <li><code>019.1983-reverse-a-list.py</code></li>
    <li><code>019.3164-reverse-a-list.py</code></li>
    <li><code>020.573-return-two-values.py</code></li>
    <li><code>021.84-swap-values-of-variables-a-and-b.py</code></li>
    <li><code>022.243-convert-string-to-integer.py</code></li>
    <li><code>023.1102-convert-real-number-to-string-with-2-decimal-places.py</code></li>
    <li><code>024.664-assign-to-string-the-japanese-word-.py</code></li>
    <li><code>025.195-send-a-value-to-another-thread.py</code></li>
    <li><code>026.194-create-a-2-dimensional-array.py</code></li>
    <li><code>027.192-create-a-3-dimensional-array.py</code></li>
    <li><code>027.193-create-a-3-dimensional-array.py</code></li>
    <li><code>028.350-sort-by-a-property.py</code></li>
    <li><code>029.199-remove-item-from-list-by-its-index.py</code></li>
    <li><code>030.189-parallelize-execution-of-1000-independent-tasks.py</code></li>
    <li><code>031.188-recursive-factorial-simple.py</code></li>
    <li><code>032.196-integer-exponentiation-by-squaring.py</code></li>
    <li><code>033.1420-atomically-read-and-update-variable.py</code></li>
    <li><code>034.625-create-a-set-of-objects.py</code></li>
    <li><code>035.667-first-class-function--compose.py</code></li>
    <li><code>036.670-first-class-function--generic-composition.py</code></li>
    <li><code>037.671-currying.py</code></li>
    <li><code>038.186-extract-a-substring.py</code></li>
    <li><code>039.571-check-if-string-contains-a-word.py</code></li>
    <li><code>040.2279-graph-with-adjacency-lists.py</code></li>
    <li><code>041.187-reverse-a-string.py</code></li>
    ...
    <li><code>043.676-break-outer-loop.py</code></li>
    <li><code>044.190-insert-element-in-list.py</code></li>
    <li><code>045.570-pause-execution-for-5-seconds.py</code></li>
    <li><code>046.191-extract-beginning-of-string-prefix.py</code></li>
    <li><code>047.198-extract-string-suffix.py</code></li>
    <li><code>048.210-multi-line-string-literal.py</code></li>
    <li><code>049.242-split-a-space-separated-string.py</code></li>
    <li><code>050.572-make-an-infinite-loop.py</code></li>
    <li><code>051.230-check-if-map-contains-key.py</code></li>
    <li><code>052.666-check-if-map-contains-value.py</code></li>
    <li><code>053.1933-join-a-list-of-strings.py</code></li>
    <li><code>053.240-join-a-list-of-strings.py</code></li>
    <li><code>054.241-compute-sum-of-integers.py</code></li>
    <li><code>055.575-convert-integer-to-string.py</code></li>
    <li><code>056.1424-launch-1000-parallel-tasks-and-wait-for-completion.py</code></li>
    <li><code>057.260-filter-list.py</code></li>
    <li><code>057.3173-filter-list.py</code></li>
    <li><code>058.665-extract-file-content-to-a-string.py</code></li>
    <li><code>059.668-write-to-standard-error-stream.py</code></li>
    <li><code>059.669-write-to-standard-error-stream.py</code></li>
    <li><code>060.1084-read-command-line-argument.py</code></li>
    <li><code>061.576-get-current-date.py</code></li>
    <li><code>062.1091-find-substring-position.py</code></li>
    <li><code>063.1088-replace-fragment-of-a-string.py</code></li>
    <li><code>064.274-big-integer--value-3-power-247.py</code></li>
    <li><code>065.1085-format-decimal-number.py</code></li>
    <li><code>066.672-big-integer-exponentiation.py</code></li>
    ...
    <li><code>071.379-echo-program-implementation.py</code></li>
    <li><code>073.673-create-a-factory.py</code></li>
    <li><code>074.674-compute-gcd.py</code></li>
    <li><code>075.675-compute-lcm.py</code></li>
