...
- [`223 programs of learning cost (default: no group)`](#223-programs-of-learning-cost-default-no-group)
    - [`001.0003-print-hello-world.py`](#program-0010003-print-hello-worldpy-learning-cost-3625)
    - [`001.1159-print-hello-world.py`](#program-0011159-print-hello-worldpy-learning-cost-26875)
    - [`002.0011-print-hello-10-times.py`](#program-0020011-print-hello-10-timespy-learning-cost-64375)
    ...
    - [`003.0019-create-a-procedure.py`](#program-0030019-create-a-procedurepy-learning-cost-51875)
    ...
    - [`007.0183-iterate-over-list-indexes-and-values.py`](#program-0070183-iterate-over-list-indexes-and-valuespy-learning-cost-646875)
    - [`008.0039-initialize-a-new-map-associative-array.py`](#program-0080039-initialize-a-new-map-associative-arraypy-learning-cost-35625)
    ...
    - [`013.0574-iterate-over-map-keys-and-values.py`](#program-0130574-iterate-over-map-keys-and-valuespy-learning-cost-634375)
    ...
    - [`020.0573-return-two-values.py`](#program-0200573-return-two-valuespy-learning-cost-10625)
    - [`021.0084-swap-values-of-variables-a-and-b.py`](#program-0210084-swap-values-of-variables-a-and-bpy-learning-cost-190625)
    - [`022.0243-convert-string-to-integer.py`](#program-0220243-convert-string-to-integerpy-learning-cost-278125)
    ...
    - [`024.0664-assign-to-string-the-japanese-word-.py`](#program-0240664-assign-to-string-the-japanese-word-py-learning-cost-175)
    - [`025.0195-send-a-value-to-another-thread.py`](#program-0250195-send-a-value-to-another-threadpy-learning-cost-86875)
    ...
    - [`027.0193-create-a-3-dimensional-array.py`](#program-0270193-create-a-3-dimensional-arraypy-learning-cost-2625)
    ...
    - [`030.0189-parallelize-execution-of-1000-independent-tasks.py`](#program-0300189-parallelize-execution-of-1000-independent-taskspy-learning-cost-821875)
    ...
    - [`034.0625-create-a-set-of-objects.py`](#program-0340625-create-a-set-of-objectspy-learning-cost-646875)
    ...
    - [`040.2279-graph-with-adjacency-lists.py`](#program-0402279-graph-with-adjacency-listspy-learning-cost-21625)
    - [`041.0187-reverse-a-string.py`](#program-0410187-reverse-a-stringpy-learning-cost-625)
    - [`041.2714-reverse-a-string.py`](#program-0412714-reverse-a-stringpy-learning-cost-275)
    - [`042.1264-continue-outer-loop.py`](#program-0421264-continue-outer-looppy-learning-cost-990625)
    - [`042.3168-continue-outer-loop.py`](#program-0423168-continue-outer-looppy-learning-cost-628125)
    - [`043.0676-break-outer-loop.py`](#program-0430676-break-outer-looppy-learning-cost-1009375)
    ...
    - [`048.0210-multi-line-string-literal.py`](#program-0480210-multi-line-string-literalpy-learning-cost-175)
    ...
    - [`053.0240-join-a-list-of-strings.py`](#program-0530240-join-a-list-of-stringspy-learning-cost-35)
    ...
    - [`056.1424-launch-1000-parallel-tasks-and-wait-for-completion.py`](#program-0561424-launch-1000-parallel-tasks-and-wait-for-completionpy-learning-cost-975)
    ...
    - [`058.0665-extract-file-content-to-a-string.py`](#program-0580665-extract-file-content-to-a-stringpy-learning-cost-35625)
    - [`059.0668-write-to-standard-error-stream.py`](#program-0590668-write-to-standard-error-streampy-learning-cost-35625)
    ...
    - [`071.0379-echo-program-implementation.py`](#program-0710379-echo-program-implementationpy-learning-cost-7875)
    ...
    - [`076.1083-binary-digits-from-an-integer.py`](#program-0761083-binary-digits-from-an-integerpy-learning-cost-35)
    ...
    - [`089.1097-handle-invalid-argument.py`](#program-0891097-handle-invalid-argumentpy-learning-cost-175)
    ...
    - [`099.1429-format-date-yyyy-mm-dd.py`](#program-0991429-format-date-yyyy-mm-ddpy-learning-cost-5375)
    ...
    - [`104.3264-save-object-into-xml-file.py`](#program-1043264-save-object-into-xml-filepy-learning-cost-118125)
    ...
    - [`125.2167-measure-function-call-duration.py`](#program-1252167-measure-function-call-durationpy-learning-cost-79375)
    ...
    - [`128.2085-breadth-first-traversing-of-a-tree.py`](#program-1282085-breadth-first-traversing-of-a-treepy-learning-cost-1478125)
    ...
    - [`139.2162-create-temp-directory.py`](#program-1392162-create-temp-directorypy-learning-cost-2625)
    ...
    - [`162.2164-execute-procedures-depending-on-options.py`](#program-1622164-execute-procedures-depending-on-optionspy-learning-cost-78125)
    - [`163.2170-print-list-elements-by-group-of-2.py`](#program-1632170-print-list-elements-by-group-of-2py-learning-cost-725)
    - [`163.3177-print-list-elements-by-group-of-2.py`](#program-1633177-print-list-elements-by-group-of-2py-learning-cost-1340625)
    ...
    - [`179.2689-get-center-of-a-rectangle.py`](#program-1792689-get-center-of-a-rectanglepy-learning-cost-7125)
...
### Program `001.0003-print-hello-world.py` (learning cost 3.625)
...
### Program `002.0011-print-hello-10-times.py` (learning cost 6.4375)
...
### Program `003.0019-create-a-procedure.py` (learning cost 5.1875)
...
### Program `007.0183-iterate-over-list-indexes-and-values.py` (learning cost 6.46875)
...
### Program `008.0039-initialize-a-new-map-associative-array.py` (learning cost 3.5625)
...
### Program `013.0574-iterate-over-map-keys-and-values.py` (learning cost 6.34375)
...
### Program `020.0573-return-two-values.py` (learning cost 10.625)
...
| 0.875 | `type/container/sequence` | 4 |
| 0 | `metadata/sloc/4` | 1-4 |
---

### Program `021.0084-swap-values-of-variables-a-and-b.py` (learning cost 1.90625)
...
### Program `022.0243-convert-string-to-integer.py` (learning cost 2.78125)
...
### Program `023.1102-convert-real-number-to-string-with-2-decimal-places.py` (learning cost 3.5)
...
### Program `024.0664-assign-to-string-the-japanese-word-.py` (learning cost 1.75)
...
### Program `025.0195-send-a-value-to-another-thread.py` (learning cost 8.6875)
...
| Cost  | Taxon | Lines |
|----|----|----|
| 0.875 | `call/function/Queue` | 2 |
| 0.875 | `call/function/Thread` | 3 |
...
### Program `027.0193-create-a-3-dimensional-array.py` (learning cost 2.625)
...
### Program `030.0189-parallelize-execution-of-1000-independent-tasks.py` (learning cost 8.21875)
...
### Program `034.0625-create-a-set-of-objects.py` (learning cost 6.46875)
...
### Program `040.2279-graph-with-adjacency-lists.py` (learning cost 21.625)
...
| 0.875 | `type/container/set` | 11, 12 |
...
### Program `041.0187-reverse-a-string.py` (learning cost 6.25)
...
### Program `042.1264-continue-outer-loop.py` (learning cost 9.90625)
...
| Cost  | Taxon | Lines |
|----|----|----|
| 0.875 | `call/function/Exception` | 5 |
| 0.9375 | `call/function/builtin/print` | 6 |
...
### Program `043.0676-break-outer-loop.py` (learning cost 10.09375)
...
### Program `048.0210-multi-line-string-literal.py` (learning cost 1.75)
...
### Program `053.0240-join-a-list-of-strings.py` (learning cost 3.5)
...
### Program `053.1933-join-a-list-of-strings.py` (learning cost 5.1875)
...
### Program `056.1424-launch-1000-parallel-tasks-and-wait-for-completion.py` (learning cost 9.75)
...
### Program `059.0668-write-to-standard-error-stream.py` (learning cost 3.5625)
...
### Program `068.2271-create-a-bitset.py` (learning cost 9.0)
...
### Program `071.0379-echo-program-implementation.py` (learning cost 7.875)
...
### Program `076.1083-binary-digits-from-an-integer.py` (learning cost 3.5)
...
### Program `089.1097-handle-invalid-argument.py` (learning cost 1.75)
...
| Cost  | Taxon | Lines |
|----|----|----|
| 0.875 | `call/function/ValueError` | 1 |
| 0.875 | `type/elementary/string` | 1 |
| 0 | `metadata/sloc/1` | 1 |
---
...
### Program `099.1429-format-date-yyyy-mm-dd.py` (learning cost 5.375)
...
### Program `104.3264-save-object-into-xml-file.py` (learning cost 11.8125)
...
| Cost  | Taxon | Lines |
|----|----|----|
| 0.875 | `call/function/TestClass` | 10 |
...
### Program `113.2157-iterate-over-map-entries-ordered-by-values.py` (learning cost 8.03125)
...
### Program `119.3263-deduplicate-list.py` (learning cost 16.34375)
...
| 0.875 | `type/container/list` | 1, 7 |
| 0.9375 | `type/container/list/empty` | 3 |
| 0.875 | `type/container/set` | 6 |
...
### Program `125.2167-measure-function-call-duration.py` (learning cost 7.9375)
...
### Program `128.2085-breadth-first-traversing-of-a-tree.py` (learning cost 14.78125)
...
| 0.875 | `type/container/list` | 8 |
| 0.875 | `type/container/set` | 7 |
| 0.9375 | `type/container/set/empty` | 2 |
...
### Program `145.1822-print-log-line-with-datetime.py` (learning cost 6.125)
...
### Program `147.2171-remove-all-non-ascii-characters.py` (learning cost 4.4375)
...
### Program `153.1980-concatenate-string-with-integer.py` (learning cost 3.5)
...
### Program `154.2155-halfway-between-two-hex-color-codes.py` (learning cost 11.71875)
...
### Program `154.2292-halfway-between-two-hex-color-codes.py` (learning cost 27.03125)
...
| 0.875 | `type/container/string` | 10 |
...
### Program `162.2164-execute-procedures-depending-on-options.py` (learning cost 7.8125)
...
### Program `163.3177-print-list-elements-by-group-of-2.py` (learning cost 13.40625)
...
### Program `174.2687-make-http-post-request.py` (learning cost 8.875)
...
### Program `177.2709-find-files-with-a-given-list-of-filename-extensions.py` (learning cost 8.5625)
...
### Program `177.2725-find-files-with-a-given-list-of-filename-extensions.py` (learning cost 7.0)
...
### Program `179.2689-get-center-of-a-rectangle.py` (learning cost 7.125)
...
### Program `183.3025-make-http-put-request.py` (learning cost 6.3125)
